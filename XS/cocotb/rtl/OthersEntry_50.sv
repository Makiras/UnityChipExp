...
module OthersEntry_50(
  ...
  always @(posedge clock) begin
    if (io_commonIn_enq_valid) begin
      ...
      entryReg_status_srcStatus_0_srcState <=
        entryReg_status_srcStatus_0_srcState & ~common_srcLoadCancelVec_0 | (|_GEN)
        | wakeupByIQ;
      if (wakeupByIQ) begin
      ...
      entryReg_status_srcStatus_1_srcState <=
        entryReg_status_srcStatus_1_srcState & ~common_srcLoadCancelVec_1 | (|_GEN_0)
        | wakeupByIQ_1;
  ...
  assign io_commonOut_canIssue =
    (validReg_last_REG
     ...
     & ~entryReg_status_issued & ~entryReg_status_blocked | validReg_last_REG
