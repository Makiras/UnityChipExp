...
module PipelineConnectPipe(
  ...
  input  [6:0]   io_in_bits_numUops,
  input  [6:0]   io_in_bits_numWB,
  input  [2:0]   io_in_bits_commitType,
  input  [34:0]  io_in_bits_debug_fuType,
  input          io_out_ready,
  output         io_out_valid,
  ...
  output [6:0]   io_out_bits_numUops,
  output [6:0]   io_out_bits_numWB,
  output [2:0]   io_out_bits_commitType,
  output [34:0]  io_out_bits_debug_fuType,
  ...
  reg          data_firstUop;
  reg          data_lastUop;
  reg  [6:0]   data_numUops;
  reg  [6:0]   data_numWB;
  reg  [2:0]   data_commitType;
  reg  [34:0]  data_debug_fuType;
  ...
  always @(posedge clock) begin
    if (leftFire) begin
      ...
      data_numUops <= io_in_bits_numUops;
      data_numWB <= io_in_bits_numWB;
      data_commitType <= io_in_bits_commitType;
      data_debug_fuType <= io_in_bits_debug_fuType;
    end
    data_vpu_fpu_isFpToVecInst <= ~leftFire & data_vpu_fpu_isFpToVecInst;
    data_vpu_fpu_isFP32Instr <= ~leftFire & data_vpu_fpu_isFP32Instr;
    data_vpu_fpu_isFP64Instr <= ~leftFire & data_vpu_fpu_isFP64Instr;
    data_vpu_fpu_isReduction <= ~leftFire & data_vpu_fpu_isReduction;
    data_vpu_lastUop <= ~leftFire & data_vpu_lastUop;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        data_pc = {_RANDOM[5'h1][31:1], _RANDOM[5'h2][18:0]};
        data_foldpc = _RANDOM[5'h2][28:19];
        ...
        data_preDecodeInfo_valid = _RANDOM[5'h3][26];
        data_preDecodeInfo_isRVC = _RANDOM[5'h3][27];
        data_preDecodeInfo_brType = _RANDOM[5'h3][29:28];
        data_preDecodeInfo_isCall = _RANDOM[5'h3][30];
        data_preDecodeInfo_isRet = _RANDOM[5'h3][31];
        ...
        data_vpu_frm = _RANDOM[5'h9][26:24];
        data_vpu_fpu_isFpToVecInst = _RANDOM[5'h9][27];
        data_vpu_fpu_isFP32Instr = _RANDOM[5'h9][28];
        data_vpu_fpu_isFP64Instr = _RANDOM[5'h9][29];
        data_vpu_fpu_isReduction = _RANDOM[5'h9][30];
        data_vpu_fpu_isFoldTo1_2 = _RANDOM[5'h9][31];
        data_vpu_fpu_isFoldTo1_4 = _RANDOM[5'hA][0];
        data_vpu_fpu_isFoldTo1_8 = _RANDOM[5'hA][1];
        data_vpu_vxrm = _RANDOM[5'hA][3:2];
        data_vpu_vuopIdx = _RANDOM[5'hA][10:4];
        data_vpu_lastUop = _RANDOM[5'hA][11];
        data_vpu_vmask =
          {_RANDOM[5'hA][31:12],
           _RANDOM[5'hB],
           _RANDOM[5'hC],
           _RANDOM[5'hD],
           _RANDOM[5'hE][11:0]};
        data_vpu_vl = _RANDOM[5'hE][19:12];
        data_vpu_nf = _RANDOM[5'hE][22:20];
        data_vpu_veew = _RANDOM[5'hE][24:23];
        data_vpu_isReverse = _RANDOM[5'hE][25];
        ...
        data_vpu_isMove = _RANDOM[5'hE][30];
        ...
        data_numUops = _RANDOM[5'hF][27:21];
        data_numWB = {_RANDOM[5'hF][31:28], _RANDOM[5'h10][2:0]};
        data_commitType = _RANDOM[5'h10][5:3];
        data_debug_fuType = {_RANDOM[5'h10][31:8], _RANDOM[5'h11][10:0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        valid = 1'h0;
    end // initial
  ...
  assign io_out_bits_vpu_vl = data_vpu_vl;
  ...
  assign io_out_bits_numUops = data_numUops;
  assign io_out_bits_numWB = data_numWB;
  assign io_out_bits_commitType = data_commitType;
  assign io_out_bits_debug_fuType = data_debug_fuType;
endmodule
