...
module RegionWays(
  ...
  wire              w_total_hits_0 =
    regions_0_region == io_write_region & regions_0_valid;
  wire              w_total_hits_1 =
  ...
  wire              w_hit =
    w_total_hits_0 | w_total_hits_1 | w_total_hits_2 | w_total_hits_3 | w_total_hits_4
    | w_total_hits_5 | w_total_hits_6 | w_total_hits_7 | w_total_hits_8 | w_total_hits_9
    | w_total_hits_10 | w_total_hits_11 | w_total_hits_12 | w_total_hits_13
    | w_total_hits_14 | w_total_hits_15;
  ...
  wire [4:0]        _GEN =
    5'({1'h0,
        4'({1'h0,
            3'({1'h0, 2'({1'h0, w_total_hits_0} + {1'h0, w_total_hits_1})}
               + {1'h0, 2'({1'h0, w_total_hits_2} + {1'h0, w_total_hits_3})})}
           + {1'h0,
              3'({1'h0, 2'({1'h0, w_total_hits_4} + {1'h0, w_total_hits_5})}
                 + {1'h0, 2'({1'h0, w_total_hits_6} + {1'h0, w_total_hits_7})})})}
       + {1'h0,
          4'({1'h0,
              3'({1'h0, 2'({1'h0, w_total_hits_8} + {1'h0, w_total_hits_9})}
                 + {1'h0, 2'({1'h0, w_total_hits_10} + {1'h0, w_total_hits_11})})}
             + {1'h0,
                3'({1'h0, 2'({1'h0, w_total_hits_12} + {1'h0, w_total_hits_13})}
                   + {1'h0, 2'({1'h0, w_total_hits_14} + {1'h0, w_total_hits_15})})})});
  wire              _GEN_0 = |(_GEN[4:1]);
  wire              _GEN_1 = ~w_hit & valid & io_write_valid;
  wire [15:0]       _GEN_2 =
    {{regions_15_valid},
     {regions_14_valid},
     {regions_13_valid},
  ...
  wire [15:0][29:0] _GEN_3 =
    {{regions_15_region},
     ...
     {regions_0_region}};
  wire              u_total_hits_0 =
    regions_0_region == io_update_region_0 & regions_0_valid;
  wire              u_total_hits_1 =
  ...
  wire [4:0]        _GEN_4 =
    5'({1'h0,
        4'({1'h0,
            3'({1'h0, 2'({1'h0, u_total_hits_0} + {1'h0, u_total_hits_1})}
               + {1'h0, 2'({1'h0, u_total_hits_2} + {1'h0, u_total_hits_3})})}
           + {1'h0,
              3'({1'h0, 2'({1'h0, u_total_hits_4} + {1'h0, u_total_hits_5})}
                 + {1'h0, 2'({1'h0, u_total_hits_6} + {1'h0, u_total_hits_7})})})}
       + {1'h0,
          4'({1'h0,
              3'({1'h0, 2'({1'h0, u_total_hits_8} + {1'h0, u_total_hits_9})}
                 + {1'h0, 2'({1'h0, u_total_hits_10} + {1'h0, u_total_hits_11})})}
             + {1'h0,
                3'({1'h0, 2'({1'h0, u_total_hits_12} + {1'h0, u_total_hits_13})}
                   + {1'h0, 2'({1'h0, u_total_hits_14} + {1'h0, u_total_hits_15})})})});
  wire              _GEN_5 = |(_GEN_4[4:1]);
  wire              u_total_hits_1_0 =
    regions_0_region == io_update_region_1 & regions_0_valid;
  ...
  wire [4:0]        _GEN_6 =
    5'({1'h0,
        4'({1'h0,
            3'({1'h0, 2'({1'h0, u_total_hits_1_0} + {1'h0, u_total_hits_1_1})}
               + {1'h0, 2'({1'h0, u_total_hits_1_2} + {1'h0, u_total_hits_1_3})})}
           + {1'h0,
              3'({1'h0, 2'({1'h0, u_total_hits_1_4} + {1'h0, u_total_hits_1_5})}
                 + {1'h0, 2'({1'h0, u_total_hits_1_6} + {1'h0, u_total_hits_1_7})})})}
       + {1'h0,
          4'({1'h0,
              3'({1'h0, 2'({1'h0, u_total_hits_1_8} + {1'h0, u_total_hits_1_9})}
                 + {1'h0, 2'({1'h0, u_total_hits_1_10} + {1'h0, u_total_hits_1_11})})}
             + {1'h0,
                3'({1'h0, 2'({1'h0, u_total_hits_1_12} + {1'h0, u_total_hits_1_13})}
                   + {1'h0,
                      2'({1'h0, u_total_hits_1_14} + {1'h0, u_total_hits_1_15})})})});
  ...
  `endif // not def SYNTHESIS
  wire              _GEN_8 = w_pointer == 4'h0;
  wire              _GEN_9 = w_pointer == 4'h1;
  wire              _GEN_10 = w_pointer == 4'h2;
  wire              _GEN_11 = w_pointer == 4'h3;
  wire              _GEN_12 = w_pointer == 4'h4;
  wire              _GEN_13 = w_pointer == 4'h5;
  wire              _GEN_14 = w_pointer == 4'h6;
  wire              _GEN_15 = w_pointer == 4'h7;
  wire              _GEN_16 = w_pointer == 4'h8;
  wire              _GEN_17 = w_pointer == 4'h9;
  wire              _GEN_18 = w_pointer == 4'hA;
  wire              _GEN_19 = w_pointer == 4'hB;
  wire              _GEN_20 = w_pointer == 4'hC;
  wire              _GEN_21 = w_pointer == 4'hD;
  wire              _GEN_22 = w_pointer == 4'hE;
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      regions_0_valid <= io_write_valid & ~_GEN_2[w_pointer] & _GEN_8 | regions_0_valid;
      if (io_write_valid & _GEN_8)
        regions_0_region <= io_write_region;
      regions_1_valid <= io_write_valid & ~_GEN_2[w_pointer] & _GEN_9 | regions_1_valid;
      if (io_write_valid & _GEN_9)
        regions_1_region <= io_write_region;
      regions_2_valid <= io_write_valid & ~_GEN_2[w_pointer] & _GEN_10 | regions_2_valid;
      if (io_write_valid & _GEN_10)
        regions_2_region <= io_write_region;
      regions_3_valid <= io_write_valid & ~_GEN_2[w_pointer] & _GEN_11 | regions_3_valid;
      if (io_write_valid & _GEN_11)
        regions_3_region <= io_write_region;
      regions_4_valid <= io_write_valid & ~_GEN_2[w_pointer] & _GEN_12 | regions_4_valid;
      if (io_write_valid & _GEN_12)
        regions_4_region <= io_write_region;
      regions_5_valid <= io_write_valid & ~_GEN_2[w_pointer] & _GEN_13 | regions_5_valid;
      if (io_write_valid & _GEN_13)
        regions_5_region <= io_write_region;
      regions_6_valid <= io_write_valid & ~_GEN_2[w_pointer] & _GEN_14 | regions_6_valid;
      if (io_write_valid & _GEN_14)
        regions_6_region <= io_write_region;
      regions_7_valid <= io_write_valid & ~_GEN_2[w_pointer] & _GEN_15 | regions_7_valid;
      if (io_write_valid & _GEN_15)
        regions_7_region <= io_write_region;
      regions_8_valid <= io_write_valid & ~_GEN_2[w_pointer] & _GEN_16 | regions_8_valid;
      if (io_write_valid & _GEN_16)
        regions_8_region <= io_write_region;
      regions_9_valid <= io_write_valid & ~_GEN_2[w_pointer] & _GEN_17 | regions_9_valid;
      if (io_write_valid & _GEN_17)
        regions_9_region <= io_write_region;
      regions_10_valid <=
        io_write_valid & ~_GEN_2[w_pointer] & _GEN_18 | regions_10_valid;
      if (io_write_valid & _GEN_18)
        regions_10_region <= io_write_region;
      regions_11_valid <=
        io_write_valid & ~_GEN_2[w_pointer] & _GEN_19 | regions_11_valid;
      if (io_write_valid & _GEN_19)
        regions_11_region <= io_write_region;
      regions_12_valid <=
        io_write_valid & ~_GEN_2[w_pointer] & _GEN_20 | regions_12_valid;
      if (io_write_valid & _GEN_20)
        regions_12_region <= io_write_region;
      regions_13_valid <=
        io_write_valid & ~_GEN_2[w_pointer] & _GEN_21 | regions_13_valid;
      if (io_write_valid & _GEN_21)
        regions_13_region <= io_write_region;
      regions_14_valid <=
        io_write_valid & ~_GEN_2[w_pointer] & _GEN_22 | regions_14_valid;
      if (io_write_valid & _GEN_22)
        regions_14_region <= io_write_region;
      regions_15_valid <=
        io_write_valid & ~_GEN_2[w_pointer] & (&w_pointer) | regions_15_valid;
  ...
  assign io_resp_hit_0 = _GEN_2[io_req_pointer_0];
  assign io_resp_hit_1 = _GEN_2[io_req_pointer_1];
  assign io_resp_region_0 = _GEN_3[io_req_pointer_0];
  assign io_resp_region_1 = _GEN_3[io_req_pointer_1];
  assign io_update_hit_0 =
    u_total_hits_0 | u_total_hits_1 | u_total_hits_2 | u_total_hits_3 | u_total_hits_4
    | u_total_hits_5 | u_total_hits_6 | u_total_hits_7 | u_total_hits_8 | u_total_hits_9
    | u_total_hits_10 | u_total_hits_11 | u_total_hits_12 | u_total_hits_13
    | u_total_hits_14 | u_total_hits_15 | u_bypass;
  assign io_update_hit_1 =
    u_total_hits_1_0 | u_total_hits_1_1 | u_total_hits_1_2 | u_total_hits_1_3
    | u_total_hits_1_4 | u_total_hits_1_5 | u_total_hits_1_6 | u_total_hits_1_7
    | u_total_hits_1_8 | u_total_hits_1_9 | u_total_hits_1_10 | u_total_hits_1_11
    | u_total_hits_1_12 | u_total_hits_1_13 | u_total_hits_1_14 | u_total_hits_1_15
    | u_bypass_1;
