...
module TageTable(
  ...
  wire [7:0]  idx_history_probe = io_req_bits_ghist[7:0];
  wire        _GEN = idx_history_probe != io_req_bits_folded_hist_hist_14_folded_hist;
  `ifndef SYNTHESIS
  ...
  wire [7:0]  _GEN_0 = io_req_bits_pc[8:1] ^ io_req_bits_folded_hist_hist_14_folded_hist;
  wire        s0_bank_req_1h_0 = _GEN_0[1:0] == 2'h0;
  wire        s0_bank_req_1h_1 = _GEN_0[1:0] == 2'h1;
  wire        s0_bank_req_1h_2 = _GEN_0[1:0] == 2'h2;
  wire        _s1_bank_req_1h_T = ~powerOnResetState & io_req_valid;
  wire [8:0]  _table_banks_3_io_r_req_bits_setIdx_T = {io_req_bits_pc[11:9], _GEN_0[7:2]};
  ...
  wire        per_br_hit_1 =
    s1_unhashed_idx[0] & _hit_selected_T_6 | ~(s1_unhashed_idx[0]) & _hit_selected_T_13;
  wire [7:0]  _GEN_1 = io_update_pc[8:1] ^ io_update_ghist[7:0];
  wire [7:0]  update_tag =
    _GEN_1 ^ {io_update_ghist[6:1], io_update_ghist[0] ^ io_update_ghist[7], 1'h0};
  wire        update_req_bank_1h_0 = _GEN_1[1:0] == 2'h0;
  wire        update_req_bank_1h_1 = _GEN_1[1:0] == 2'h1;
  wire        update_req_bank_1h_2 = _GEN_1[1:0] == 2'h2;
  wire [8:0]  update_idx_in_bank = {io_update_pc[11:9], _GEN_1[7:2]};
  wire        _per_bank_update_way_mask_T_9 =
    (~(io_update_pc[1]) & io_update_mask_0 | io_update_pc[1] & io_update_mask_1)
    & per_bank_not_silent_update_0_0;
  wire        _per_bank_update_way_mask_T_19 =
    (io_update_pc[1] & io_update_mask_0 | ~(io_update_pc[1]) & io_update_mask_1)
    & per_bank_not_silent_update_0_1;
  wire [1:0]  per_bank_update_way_mask_0 =
    {_per_bank_update_way_mask_T_19, _per_bank_update_way_mask_T_9};
  wire        _per_bank_update_way_mask_T_30 =
    (~(io_update_pc[1]) & io_update_mask_0 | io_update_pc[1] & io_update_mask_1)
    & per_bank_not_silent_update_1_0;
  wire        _per_bank_update_way_mask_T_40 =
    (io_update_pc[1] & io_update_mask_0 | ~(io_update_pc[1]) & io_update_mask_1)
    & per_bank_not_silent_update_1_1;
  wire [1:0]  per_bank_update_way_mask_1 =
    {_per_bank_update_way_mask_T_40, _per_bank_update_way_mask_T_30};
  wire        _per_bank_update_way_mask_T_51 =
    (~(io_update_pc[1]) & io_update_mask_0 | io_update_pc[1] & io_update_mask_1)
    & per_bank_not_silent_update_2_0;
  wire        _per_bank_update_way_mask_T_61 =
    (io_update_pc[1] & io_update_mask_0 | ~(io_update_pc[1]) & io_update_mask_1)
    & per_bank_not_silent_update_2_1;
  wire [1:0]  per_bank_update_way_mask_2 =
    {_per_bank_update_way_mask_T_61, _per_bank_update_way_mask_T_51};
  wire        _per_bank_update_way_mask_T_72 =
    (~(io_update_pc[1]) & io_update_mask_0 | io_update_pc[1] & io_update_mask_1)
    & per_bank_not_silent_update_3_0;
  wire        _per_bank_update_way_mask_T_82 =
    (io_update_pc[1] & io_update_mask_0 | ~(io_update_pc[1]) & io_update_mask_1)
    & per_bank_not_silent_update_3_1;
  wire [1:0]  per_bank_update_way_mask_3 =
    {_per_bank_update_way_mask_T_82, _per_bank_update_way_mask_T_72};
  ...
  wire        _s1_bank_has_write_on_this_req_WIRE_3 =
    (|per_bank_update_way_mask_3) & (&(_GEN_1[1:0]));
  wire        bank_conflict_probe =
    _s1_bank_has_write_on_this_req_WIRE_0 & s0_bank_req_1h_0
    | _s1_bank_has_write_on_this_req_WIRE_1 & s0_bank_req_1h_1
    | _s1_bank_has_write_on_this_req_WIRE_2 & s0_bank_req_1h_2
    | _s1_bank_has_write_on_this_req_WIRE_3 & (&(_GEN_0[1:0]));
  wire [1:0]  _GEN_2 = {1'h0, io_update_pc[1]};
  ...
  wire        _GEN_3 = io_update_pc[1] ? io_update_takens_1 : io_update_takens_0;
  wire [2:0]  _GEN_4 = io_update_pc[1] ? io_update_oldCtrs_1 : io_update_oldCtrs_0;
  wire        _GEN_5 = (|_GEN_4) | _GEN_3;
  wire        _GEN_6 = io_update_pc[1] ? io_update_alloc_1 : io_update_alloc_0;
  wire [2:0]  per_bank_update_wdata_0_0_ctr =
    _GEN_6
      ? (_GEN_3 ? 3'h4 : 3'h3)
      : wrbypass_data_valid
          ? ((&_wrbypass_io_T_6) & _GEN_3
               ? 3'h7
               : _wrbypass_io_T_6 == 3'h0 & ~_GEN_3
                   ? 3'h0
                   : _GEN_3 ? 3'(_wrbypass_io_T_6 + 3'h1) : 3'(_wrbypass_io_T_6 - 3'h1))
          : (&_GEN_4) & _GEN_3
              ? 3'h7
              : _GEN_5 ? (_GEN_3 ? 3'(_GEN_4 + 3'h1) : 3'(_GEN_4 - 3'h1)) : 3'h0;
  assign per_bank_not_silent_update_0_0 =
    (wrbypass_data_valid
       ? ~((&_wrbypass_io_T_6) & _GEN_3 | _wrbypass_io_T_6 == 3'h0 & ~_GEN_3)
       : ~((&_GEN_4) & _GEN_3 | _GEN_4 == 3'h0 & ~_GEN_3)) | _GEN_6;
  ...
  wire        wrbypass_data_valid_1 =
    ...
    & (io_update_pc[1] & _bank_wrbypasses_0_0_io_hit_data_0_valid | ~(io_update_pc[1])
       & _bank_wrbypasses_0_1_io_hit_data_0_valid);
  wire        _GEN_7 = io_update_pc[1] ? io_update_takens_0 : io_update_takens_1;
  wire [2:0]  _GEN_8 = io_update_pc[1] ? io_update_oldCtrs_0 : io_update_oldCtrs_1;
  wire        _GEN_9 = io_update_pc[1] ? io_update_alloc_0 : io_update_alloc_1;
  wire [2:0]  per_bank_update_wdata_0_1_ctr =
    _GEN_9
      ? (_GEN_7 ? 3'h4 : 3'h3)
      : wrbypass_data_valid_1
          ? ((&_wrbypass_io_T_28) & _GEN_7
               ? 3'h7
               : _wrbypass_io_T_28 == 3'h0 & ~_GEN_7
                   ? 3'h0
                   : _GEN_7 ? 3'(_wrbypass_io_T_28 + 3'h1) : 3'(_wrbypass_io_T_28 - 3'h1))
          : (&_GEN_8) & _GEN_7
              ? 3'h7
              : _GEN_8 == 3'h0 & ~_GEN_7
                  ? 3'h0
                  : _GEN_7 ? 3'(_GEN_8 + 3'h1) : 3'(_GEN_8 - 3'h1);
  assign per_bank_not_silent_update_0_1 =
    (wrbypass_data_valid_1
       ? ~((&_wrbypass_io_T_28) & _GEN_7 | _wrbypass_io_T_28 == 3'h0 & ~_GEN_7)
       : ~((&_GEN_8) & _GEN_7 | _GEN_8 == 3'h0 & ~_GEN_7)) | _GEN_9;
  wire        _bank_wrbypasses_0_0_io_wen_T = io_update_mask_0 & update_req_bank_1h_0;
  wire        _bank_wrbypasses_0_1_io_wen_T = io_update_mask_1 & update_req_bank_1h_0;
  ...
  wire [2:0]  per_bank_update_wdata_1_0_ctr =
    _GEN_6
      ...
      : wrbypass_data_valid_2
          ? ((&_wrbypass_io_T_50) & _GEN_3
               ? 3'h7
               : _wrbypass_io_T_50 == 3'h0 & ~_GEN_3
                   ? 3'h0
                   : _GEN_3 ? 3'(_wrbypass_io_T_50 + 3'h1) : 3'(_wrbypass_io_T_50 - 3'h1))
          : (&_GEN_4) & _GEN_3
              ? 3'h7
              : _GEN_5 ? (_GEN_3 ? 3'(_GEN_4 + 3'h1) : 3'(_GEN_4 - 3'h1)) : 3'h0;
  assign per_bank_not_silent_update_1_0 =
    (wrbypass_data_valid_2
       ? ~((&_wrbypass_io_T_50) & _GEN_3 | _wrbypass_io_T_50 == 3'h0 & ~_GEN_3)
       : ~((&_GEN_4) & _GEN_3 | _GEN_4 == 3'h0 & ~_GEN_3)) | _GEN_6;
  ...
  wire [2:0]  per_bank_update_wdata_1_1_ctr =
    _GEN_9
      ...
      : wrbypass_data_valid_3
          ? ((&_wrbypass_io_T_72) & _GEN_7
               ? 3'h7
               : _wrbypass_io_T_72 == 3'h0 & ~_GEN_7
                   ? 3'h0
                   : _GEN_7 ? 3'(_wrbypass_io_T_72 + 3'h1) : 3'(_wrbypass_io_T_72 - 3'h1))
          : (&_GEN_8) & _GEN_7
              ? 3'h7
              : _GEN_8 == 3'h0 & ~_GEN_7
                  ? 3'h0
  ...
  assign per_bank_not_silent_update_1_1 =
    (wrbypass_data_valid_3
       ? ~((&_wrbypass_io_T_72) & _GEN_7 | _wrbypass_io_T_72 == 3'h0 & ~_GEN_7)
       : ~((&_GEN_8) & _GEN_7 | _GEN_8 == 3'h0 & ~_GEN_7)) | _GEN_9;
  wire        _bank_wrbypasses_1_0_io_wen_T = io_update_mask_0 & update_req_bank_1h_1;
  wire        _bank_wrbypasses_1_1_io_wen_T = io_update_mask_1 & update_req_bank_1h_1;
  ...
  wire [2:0]  per_bank_update_wdata_2_0_ctr =
    _GEN_6
      ...
      : wrbypass_data_valid_4
          ? ((&_wrbypass_io_T_94) & _GEN_3
               ? 3'h7
               : _wrbypass_io_T_94 == 3'h0 & ~_GEN_3
                   ? 3'h0
                   : _GEN_3 ? 3'(_wrbypass_io_T_94 + 3'h1) : 3'(_wrbypass_io_T_94 - 3'h1))
          : (&_GEN_4) & _GEN_3
              ? 3'h7
              : _GEN_5 ? (_GEN_3 ? 3'(_GEN_4 + 3'h1) : 3'(_GEN_4 - 3'h1)) : 3'h0;
  assign per_bank_not_silent_update_2_0 =
    (wrbypass_data_valid_4
       ? ~((&_wrbypass_io_T_94) & _GEN_3 | _wrbypass_io_T_94 == 3'h0 & ~_GEN_3)
       : ~((&_GEN_4) & _GEN_3 | _GEN_4 == 3'h0 & ~_GEN_3)) | _GEN_6;
  ...
  wire [2:0]  per_bank_update_wdata_2_1_ctr =
    _GEN_9
      ...
      : wrbypass_data_valid_5
          ? ((&_wrbypass_io_T_116) & _GEN_7
               ? 3'h7
               : _wrbypass_io_T_116 == 3'h0 & ~_GEN_7
                   ? 3'h0
                   : _GEN_7
  ...
  assign per_bank_not_silent_update_2_1 =
    (wrbypass_data_valid_5
       ? ~((&_wrbypass_io_T_116) & _GEN_7 | _wrbypass_io_T_116 == 3'h0 & ~_GEN_7)
       : ~((&_GEN_8) & _GEN_7 | _GEN_8 == 3'h0 & ~_GEN_7)) | _GEN_9;
  wire        _bank_wrbypasses_2_0_io_wen_T = io_update_mask_0 & update_req_bank_1h_2;
  wire        _bank_wrbypasses_2_1_io_wen_T = io_update_mask_1 & update_req_bank_1h_2;
  ...
  wire [2:0]  per_bank_update_wdata_3_0_ctr =
    _GEN_6
      ...
      : wrbypass_data_valid_6
          ? ((&_wrbypass_io_T_138) & _GEN_3
               ? 3'h7
               : _wrbypass_io_T_138 == 3'h0 & ~_GEN_3
                   ? 3'h0
                   : _GEN_3
  ...
  assign per_bank_not_silent_update_3_0 =
    (wrbypass_data_valid_6
       ? ~((&_wrbypass_io_T_138) & _GEN_3 | _wrbypass_io_T_138 == 3'h0 & ~_GEN_3)
       : ~((&_GEN_4) & _GEN_3 | _GEN_4 == 3'h0 & ~_GEN_3)) | _GEN_6;
  ...
  wire [2:0]  per_bank_update_wdata_3_1_ctr =
    _GEN_9
      ...
      : wrbypass_data_valid_7
          ? ((&_wrbypass_io_T_160) & _GEN_7
               ? 3'h7
               : _wrbypass_io_T_160 == 3'h0 & ~_GEN_7
                   ? 3'h0
                   : _GEN_7
  ...
  assign per_bank_not_silent_update_3_1 =
    (wrbypass_data_valid_7
       ? ~((&_wrbypass_io_T_160) & _GEN_7 | _wrbypass_io_T_160 == 3'h0 & ~_GEN_7)
       : ~((&_GEN_8) & _GEN_7 | _GEN_8 == 3'h0 & ~_GEN_7)) | _GEN_9;
  wire        _bank_wrbypasses_3_0_io_wen_T = io_update_mask_0 & (&(_GEN_1[1:0]));
  wire        _bank_wrbypasses_3_1_io_wen_T = io_update_mask_1 & (&(_GEN_1[1:0]));
  wire        _GEN_10 = _bank_wrbypasses_0_0_io_wen_T & ~_bank_wrbypasses_0_0_io_hit;
  wire        _GEN_11 = _bank_wrbypasses_0_0_io_wen_T & _bank_wrbypasses_0_0_io_hit;
  wire        _GEN_12 = _bank_wrbypasses_1_0_io_wen_T & ~_bank_wrbypasses_1_0_io_hit;
  wire        _GEN_13 = _bank_wrbypasses_1_0_io_wen_T & _bank_wrbypasses_1_0_io_hit;
  wire        _GEN_14 = _bank_wrbypasses_2_0_io_wen_T & ~_bank_wrbypasses_2_0_io_hit;
  wire        _GEN_15 = _bank_wrbypasses_2_0_io_wen_T & _bank_wrbypasses_2_0_io_hit;
  wire        _GEN_16 = _bank_wrbypasses_3_0_io_wen_T & ~_bank_wrbypasses_3_0_io_hit;
  wire        _GEN_17 = _bank_wrbypasses_3_0_io_wen_T & _bank_wrbypasses_3_0_io_hit;
  wire        _GEN_18 = _bank_wrbypasses_0_1_io_wen_T & ~_bank_wrbypasses_0_1_io_hit;
  wire        _GEN_19 = _bank_wrbypasses_0_1_io_wen_T & _bank_wrbypasses_0_1_io_hit;
  wire        _GEN_20 = _bank_wrbypasses_1_1_io_wen_T & ~_bank_wrbypasses_1_1_io_hit;
  wire        _GEN_21 = _bank_wrbypasses_1_1_io_wen_T & _bank_wrbypasses_1_1_io_hit;
  wire        _GEN_22 = _bank_wrbypasses_2_1_io_wen_T & ~_bank_wrbypasses_2_1_io_hit;
  wire        _GEN_23 = _bank_wrbypasses_2_1_io_wen_T & _bank_wrbypasses_2_1_io_hit;
  wire        _GEN_24 = _bank_wrbypasses_3_1_io_wen_T & ~_bank_wrbypasses_3_1_io_hit;
  wire        _GEN_25 = _bank_wrbypasses_3_1_io_wen_T & _bank_wrbypasses_3_1_io_hit;
  wire        _GEN_26 = _us_extra_reset_T_1 & update_req_bank_1h_0;
  wire        _GEN_27 = per_bank_not_silent_update_0_0 | per_bank_not_silent_update_0_1;
  wire        _GEN_28 = _GEN_26 & _GEN_27;
  wire        _GEN_29 = _GEN_26 & ~_GEN_27;
  wire        _GEN_30 = _us_extra_reset_T_1 & update_req_bank_1h_1;
  wire        _GEN_31 = per_bank_not_silent_update_1_0 | per_bank_not_silent_update_1_1;
  wire        _GEN_32 = _GEN_30 & _GEN_31;
  wire        _GEN_33 = _GEN_30 & ~_GEN_31;
  wire        _GEN_34 = _us_extra_reset_T_1 & update_req_bank_1h_2;
  wire        _GEN_35 = per_bank_not_silent_update_2_0 | per_bank_not_silent_update_2_1;
  wire        _GEN_36 = _GEN_34 & _GEN_35;
  wire        _GEN_37 = _GEN_34 & ~_GEN_35;
  wire        _GEN_38 = _us_extra_reset_T_1 & (&(_GEN_1[1:0]));
  wire        _GEN_39 = per_bank_not_silent_update_3_0 | per_bank_not_silent_update_3_1;
  wire        _GEN_40 = _GEN_38 & _GEN_39;
  wire        _GEN_41 = _GEN_38 & ~_GEN_39;
  wire [1:0]  _GEN_42 = 2'({1'h0, per_br_hit_0} + {1'h0, per_br_hit_1});
  wire [1:0]  _GEN_43 = per_bank_update_way_mask_0 >> _GEN_2;
  wire        _GEN_44 = _s1_bank_has_write_on_this_req_WIRE_0 & _GEN_43[0];
  wire        _GEN_45 =
    _s1_bank_has_write_on_this_req_WIRE_0 & _per_bank_update_way_mask_T_9;
  wire [1:0]  _GEN_46 = per_bank_update_way_mask_0 >> ~(io_update_pc[1]);
  wire        _GEN_47 = _s1_bank_has_write_on_this_req_WIRE_0 & _GEN_46[0];
  wire        _GEN_48 =
    _s1_bank_has_write_on_this_req_WIRE_0 & _per_bank_update_way_mask_T_19;
  wire [1:0]  _GEN_49 = per_bank_update_way_mask_1 >> _GEN_2;
  wire        _GEN_50 = _s1_bank_has_write_on_this_req_WIRE_1 & _GEN_49[0];
  wire        _GEN_51 =
    _s1_bank_has_write_on_this_req_WIRE_1 & _per_bank_update_way_mask_T_30;
  wire [1:0]  _GEN_52 = per_bank_update_way_mask_1 >> ~(io_update_pc[1]);
  wire        _GEN_53 = _s1_bank_has_write_on_this_req_WIRE_1 & _GEN_52[0];
  wire        _GEN_54 =
    _s1_bank_has_write_on_this_req_WIRE_1 & _per_bank_update_way_mask_T_40;
  wire [1:0]  _GEN_55 = per_bank_update_way_mask_2 >> _GEN_2;
  wire        _GEN_56 = _s1_bank_has_write_on_this_req_WIRE_2 & _GEN_55[0];
  wire        _GEN_57 =
    _s1_bank_has_write_on_this_req_WIRE_2 & _per_bank_update_way_mask_T_51;
  wire [1:0]  _GEN_58 = per_bank_update_way_mask_2 >> ~(io_update_pc[1]);
  wire        _GEN_59 = _s1_bank_has_write_on_this_req_WIRE_2 & _GEN_58[0];
  wire        _GEN_60 =
    _s1_bank_has_write_on_this_req_WIRE_2 & _per_bank_update_way_mask_T_61;
  wire [1:0]  _GEN_61 = per_bank_update_way_mask_3 >> _GEN_2;
  wire        _GEN_62 = _s1_bank_has_write_on_this_req_WIRE_3 & _GEN_61[0];
  wire        _GEN_63 =
    _s1_bank_has_write_on_this_req_WIRE_3 & _per_bank_update_way_mask_T_72;
  wire [1:0]  _GEN_64 = per_bank_update_way_mask_3 >> ~(io_update_pc[1]);
  wire        _GEN_65 = _s1_bank_has_write_on_this_req_WIRE_3 & _GEN_64[0];
  wire        _GEN_66 =
    _s1_bank_has_write_on_this_req_WIRE_3 & _per_bank_update_way_mask_T_82;
  always @(posedge clock) begin
    if (_s1_bank_req_1h_T) begin
      s1_unhashed_idx <= io_req_bits_pc[49:1];
      s1_tag <= _GEN_0 ^ {io_req_bits_folded_hist_hist_7_folded_hist, 1'h0};
      s1_bank_req_1h_0 <= s0_bank_req_1h_0;
      s1_bank_req_1h_1 <= s0_bank_req_1h_1;
      s1_bank_req_1h_2 <= s0_bank_req_1h_2;
      s1_bank_req_1h_3 <= &(_GEN_0[1:0]);
    end
  ...
  FoldedSRAMTemplate us (
    ...
    .io_r_req_bits_setIdx  ({io_req_bits_pc[11:9], _GEN_0}),
    ...
    .io_w_req_bits_setIdx  ({io_update_pc[11:9], _GEN_1}),
  ...
  FoldedSRAMTemplate_1 table_banks_3 (
    ...
    .io_r_req_valid           (_s1_bank_req_1h_T & (&(_GEN_0[1:0]))),
    .io_r_req_bits_setIdx     (_table_banks_3_io_r_req_bits_setIdx_T),
  ...
  WrBypass bank_wrbypasses_0_0 (
    .clock               (clock),
    .reset               (reset),
    .io_wen              (_bank_wrbypasses_0_0_io_wen_T),
  ...
  WrBypass bank_wrbypasses_0_1 (
    .clock               (clock),
    .reset               (reset),
    .io_wen              (_bank_wrbypasses_0_1_io_wen_T),
    .io_write_idx        (update_idx_in_bank),
    .io_write_data_0
  ...
  WrBypass bank_wrbypasses_1_0 (
    .clock               (clock),
    .reset               (reset),
    .io_wen              (_bank_wrbypasses_1_0_io_wen_T),
    .io_write_idx        (update_idx_in_bank),
    .io_write_data_0
  ...
  WrBypass bank_wrbypasses_1_1 (
    .clock               (clock),
    .reset               (reset),
    .io_wen              (_bank_wrbypasses_1_1_io_wen_T),
    .io_write_idx        (update_idx_in_bank),
    .io_write_data_0
  ...
  WrBypass bank_wrbypasses_2_0 (
    .clock               (clock),
    .reset               (reset),
    .io_wen              (_bank_wrbypasses_2_0_io_wen_T),
    .io_write_idx        (update_idx_in_bank),
    .io_write_data_0
  ...
  WrBypass bank_wrbypasses_2_1 (
    .clock               (clock),
    .reset               (reset),
    .io_wen              (_bank_wrbypasses_2_1_io_wen_T),
    .io_write_idx        (update_idx_in_bank),
    .io_write_data_0
  ...
  WrBypass bank_wrbypasses_3_0 (
    .clock               (clock),
    .reset               (reset),
    .io_wen              (_bank_wrbypasses_3_0_io_wen_T),
    .io_write_idx        (update_idx_in_bank),
    .io_write_data_0
  ...
  WrBypass bank_wrbypasses_3_1 (
    .clock               (clock),
    .reset               (reset),
    .io_wen              (_bank_wrbypasses_3_1_io_wen_T),
    .io_write_idx        (update_idx_in_bank),
    .io_write_data_0
  ...
  assign io_resps_0_valid = per_br_hit_0;
  ...
  assign io_resps_1_valid = per_br_hit_1;
