...
module RequestArb(
  ...
  wire        releaseNeedData = task_s2_bits_opcode == 4'h7;
  ...
  wire        _GEN_5 = io_sinkA_valid & io_fromMainPipe_blockA_s1;
  wire        _GEN_6 = io_sinkB_valid & io_fromMainPipe_blockB_s1;
  wire        _GEN_7 = io_sinkC_valid & io_fromMainPipe_blockC_s1;
  wire        _GEN_8 = io_sinkA_valid & io_fromGrantBuffer_blockSinkReqEntrance_blockA_s1;
  wire        _GEN_9 = io_sinkB_valid & io_fromGrantBuffer_blockSinkReqEntrance_blockB_s1;
  wire        _GEN_10 =
    io_sinkC_valid & io_fromGrantBuffer_blockSinkReqEntrance_blockC_s1;
  wire        _GEN_11 = io_sinkA_valid & ~block_A & ~io_dirRead_s1_ready;
  wire        _GEN_12 = io_sinkB_valid & ~block_B & ~io_dirRead_s1_ready;
  wire        _GEN_13 = io_sinkC_valid & ~block_C & ~io_dirRead_s1_ready;
  wire        _GEN_14 = io_sinkA_valid & sink_ready_basic & ~block_A;
  wire        _GEN_15 = _GEN_14 & _sinkValids_T_3 & ~_sinkValids_T_1;
  wire        _GEN_16 = _GEN_14 & _sinkValids_T_1;
  wire        _GEN_17 = io_sinkB_valid & sink_ready_basic & ~block_B & _sinkValids_T_1;
  wire        _GEN_18 = io_sinkA_valid & mshr_task_s1_valid;
  wire        _GEN_19 = io_sinkB_valid & mshr_task_s1_valid;
  wire        _GEN_20 = io_sinkC_valid & mshr_task_s1_valid;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        mshr_task_s1_bits_fromL2pft = _RANDOM[5'h4][16];
        mshr_task_s1_bits_needHint = _RANDOM[5'h4][17];
        mshr_task_s1_bits_dirty = _RANDOM[5'h4][18];
        mshr_task_s1_bits_way = _RANDOM[5'h4][21:19];
        mshr_task_s1_bits_meta_dirty = _RANDOM[5'h4][22];
        mshr_task_s1_bits_meta_state = _RANDOM[5'h4][24:23];
        mshr_task_s1_bits_meta_clients = _RANDOM[5'h4][25];
        mshr_task_s1_bits_meta_alias = _RANDOM[5'h4][27:26];
        mshr_task_s1_bits_meta_prefetch = _RANDOM[5'h4][28];
        mshr_task_s1_bits_meta_prefetchSrc = _RANDOM[5'h4][31:29];
        mshr_task_s1_bits_meta_accessed = _RANDOM[5'h5][0];
        mshr_task_s1_bits_meta_tagErr = _RANDOM[5'h5][1];
        mshr_task_s1_bits_meta_dataErr = _RANDOM[5'h5][2];
        mshr_task_s1_bits_metaWen = _RANDOM[5'h5][3];
        mshr_task_s1_bits_tagWen = _RANDOM[5'h5][4];
        mshr_task_s1_bits_dsWen = _RANDOM[5'h5][5];
        mshr_task_s1_bits_wayMask = _RANDOM[5'h5][13:6];
        mshr_task_s1_bits_replTask = _RANDOM[5'h5][14];
        mshr_task_s1_bits_cmoTask = _RANDOM[5'h5][15];
        mshr_task_s1_bits_reqSource = _RANDOM[5'h5][19:16];
        mshr_task_s1_bits_mergeA = _RANDOM[5'h5][20];
        mshr_task_s1_bits_aMergeTask_off = _RANDOM[5'h5][26:21];
        mshr_task_s1_bits_aMergeTask_alias = _RANDOM[5'h5][28:27];
        mshr_task_s1_bits_aMergeTask_vaddr =
          {_RANDOM[5'h5][31:29], _RANDOM[5'h6], _RANDOM[5'h7][8:0]};
        mshr_task_s1_bits_aMergeTask_isKeyword = _RANDOM[5'h7][9];
        mshr_task_s1_bits_aMergeTask_opcode = _RANDOM[5'h7][12:10];
        mshr_task_s1_bits_aMergeTask_param = _RANDOM[5'h7][15:13];
        mshr_task_s1_bits_aMergeTask_sourceId = _RANDOM[5'h7][22:16];
        mshr_task_s1_bits_aMergeTask_meta_dirty = _RANDOM[5'h7][23];
        mshr_task_s1_bits_aMergeTask_meta_state = _RANDOM[5'h7][25:24];
        mshr_task_s1_bits_aMergeTask_meta_clients = _RANDOM[5'h7][26];
        mshr_task_s1_bits_aMergeTask_meta_alias = _RANDOM[5'h7][28:27];
        mshr_task_s1_bits_aMergeTask_meta_prefetch = _RANDOM[5'h7][29];
        mshr_task_s1_bits_aMergeTask_meta_prefetchSrc =
          {_RANDOM[5'h7][31:30], _RANDOM[5'h8][0]};
        mshr_task_s1_bits_aMergeTask_meta_accessed = _RANDOM[5'h8][1];
        mshr_task_s1_bits_aMergeTask_meta_tagErr = _RANDOM[5'h8][2];
        mshr_task_s1_bits_aMergeTask_meta_dataErr = _RANDOM[5'h8][3];
        mshr_task_s1_bits_snpHitRelease = _RANDOM[5'h8][4];
        mshr_task_s1_bits_snpHitReleaseToB = _RANDOM[5'h8][5];
        mshr_task_s1_bits_snpHitReleaseWithData = _RANDOM[5'h8][6];
        mshr_task_s1_bits_snpHitReleaseIdx = _RANDOM[5'h8][14:7];
        ds_mcp2_stall = _RANDOM[5'h8][15];
        task_s2_valid = _RANDOM[5'h8][16];
        task_s2_bits_channel = _RANDOM[5'h8][19:17];
        task_s2_bits_txChannel = _RANDOM[5'h8][22:20];
        task_s2_bits_set = _RANDOM[5'h8][31:23];
        task_s2_bits_tag = _RANDOM[5'h9][30:0];
        task_s2_bits_off = {_RANDOM[5'h9][31], _RANDOM[5'hA][4:0]};
        task_s2_bits_alias = _RANDOM[5'hA][6:5];
        task_s2_bits_vaddr = {_RANDOM[5'hA][31:7], _RANDOM[5'hB][18:0]};
        task_s2_bits_isKeyword = _RANDOM[5'hB][19];
        task_s2_bits_opcode = _RANDOM[5'hB][23:20];
        task_s2_bits_param = _RANDOM[5'hB][26:24];
        task_s2_bits_size = _RANDOM[5'hB][29:27];
        task_s2_bits_sourceId = {_RANDOM[5'hB][31:30], _RANDOM[5'hC][4:0]};
        task_s2_bits_bufIdx = _RANDOM[5'hC][6:5];
        task_s2_bits_needProbeAckData = _RANDOM[5'hC][7];
        task_s2_bits_denied = _RANDOM[5'hC][8];
        task_s2_bits_corrupt = _RANDOM[5'hC][9];
        task_s2_bits_mshrTask = _RANDOM[5'hC][10];
        task_s2_bits_mshrId = _RANDOM[5'hC][18:11];
        task_s2_bits_aliasTask = _RANDOM[5'hC][19];
        task_s2_bits_useProbeData = _RANDOM[5'hC][20];
        task_s2_bits_mshrRetry = _RANDOM[5'hC][21];
        task_s2_bits_fromL2pft = _RANDOM[5'hC][22];
        task_s2_bits_needHint = _RANDOM[5'hC][23];
        task_s2_bits_dirty = _RANDOM[5'hC][24];
        task_s2_bits_way = _RANDOM[5'hC][27:25];
        task_s2_bits_meta_dirty = _RANDOM[5'hC][28];
        task_s2_bits_meta_state = _RANDOM[5'hC][30:29];
        task_s2_bits_meta_clients = _RANDOM[5'hC][31];
        task_s2_bits_meta_alias = _RANDOM[5'hD][1:0];
        ...
        task_s2_bits_meta_tagErr = _RANDOM[5'hD][7];
        task_s2_bits_meta_dataErr = _RANDOM[5'hD][8];
        task_s2_bits_metaWen = _RANDOM[5'hD][9];
        task_s2_bits_tagWen = _RANDOM[5'hD][10];
        task_s2_bits_dsWen = _RANDOM[5'hD][11];
        task_s2_bits_wayMask = _RANDOM[5'hD][19:12];
        task_s2_bits_replTask = _RANDOM[5'hD][20];
        task_s2_bits_cmoTask = _RANDOM[5'hD][21];
        task_s2_bits_reqSource = _RANDOM[5'hD][25:22];
        task_s2_bits_mergeA = _RANDOM[5'hD][26];
        task_s2_bits_aMergeTask_off = {_RANDOM[5'hD][31:27], _RANDOM[5'hE][0]};
        task_s2_bits_aMergeTask_alias = _RANDOM[5'hE][2:1];
        task_s2_bits_aMergeTask_vaddr = {_RANDOM[5'hE][31:3], _RANDOM[5'hF][14:0]};
        task_s2_bits_aMergeTask_isKeyword = _RANDOM[5'hF][15];
        task_s2_bits_aMergeTask_opcode = _RANDOM[5'hF][18:16];
        task_s2_bits_aMergeTask_param = _RANDOM[5'hF][21:19];
        task_s2_bits_aMergeTask_sourceId = _RANDOM[5'hF][28:22];
        task_s2_bits_aMergeTask_meta_dirty = _RANDOM[5'hF][29];
        task_s2_bits_aMergeTask_meta_state = _RANDOM[5'hF][31:30];
        task_s2_bits_aMergeTask_meta_clients = _RANDOM[5'h10][0];
        task_s2_bits_aMergeTask_meta_alias = _RANDOM[5'h10][2:1];
        task_s2_bits_aMergeTask_meta_prefetch = _RANDOM[5'h10][3];
        task_s2_bits_aMergeTask_meta_prefetchSrc = _RANDOM[5'h10][6:4];
        task_s2_bits_aMergeTask_meta_accessed = _RANDOM[5'h10][7];
        task_s2_bits_aMergeTask_meta_tagErr = _RANDOM[5'h10][8];
        task_s2_bits_aMergeTask_meta_dataErr = _RANDOM[5'h10][9];
        task_s2_bits_snpHitRelease = _RANDOM[5'h10][10];
        task_s2_bits_snpHitReleaseToB = _RANDOM[5'h10][11];
        task_s2_bits_snpHitReleaseWithData = _RANDOM[5'h10][12];
        task_s2_bits_snpHitReleaseIdx = _RANDOM[5'h10][20:13];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        resetFinish = 1'h0;
        resetIdx = 9'h1FF;
  ...
  assign io_refillBufRead_s2_valid =
    ...
    & (task_s2_bits_channel[1] & (_io_refillBufRead_s2_valid_T_1 | _snoopNeedData_T_1)
       ...
       & (task_s2_bits_opcode == 4'h6 | releaseNeedData) | mshrTask_s2_a_upwards
       & ~task_s2_bits_useProbeData);
  assign io_refillBufRead_s2_bits_id = task_s2_bits_mshrId;
  assign io_releaseBufRead_s2_valid =
    mshrTask_s2
    & (releaseNeedData | task_s2_bits_channel[1] & _snoopNeedData_T_1
