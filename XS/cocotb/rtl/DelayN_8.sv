  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        REG_bp_ctrl_ubtb_enable = _RANDOM[5'h0][27];
        REG_bp_ctrl_btb_enable = _RANDOM[5'h0][28];
        REG_bp_ctrl_tage_enable = _RANDOM[5'h0][30];
        REG_bp_ctrl_sc_enable = _RANDOM[5'h0][31];
        REG_bp_ctrl_ras_enable = _RANDOM[5'h1][0];
        REG_ldld_vio_check_enable = _RANDOM[5'h1][6];
        REG_cache_error_enable = _RANDOM[5'h1][8];
        REG_hd_misalign_st_enable = _RANDOM[5'h1][10];
        REG_hd_misalign_ld_enable = _RANDOM[5'h1][11];
        REG_distribute_csr_w_valid = _RANDOM[5'h1][14];
        REG_distribute_csr_w_bits_addr = _RANDOM[5'h1][26:15];
        REG_distribute_csr_w_bits_data =
          {_RANDOM[5'h1][31:27], _RANDOM[5'h2], _RANDOM[5'h3][26:0]};
        REG_frontend_trigger_tUpdate_valid = _RANDOM[5'h3][28];
        REG_frontend_trigger_tUpdate_bits_addr = _RANDOM[5'h3][30:29];
        REG_frontend_trigger_tUpdate_bits_tdata_matchType =
          {_RANDOM[5'h3][31], _RANDOM[5'h4][0]};
        REG_frontend_trigger_tUpdate_bits_tdata_select = _RANDOM[5'h4][1];
        REG_frontend_trigger_tUpdate_bits_tdata_action = _RANDOM[5'h4][6:3];
        REG_frontend_trigger_tUpdate_bits_tdata_chain = _RANDOM[5'h4][7];
        REG_frontend_trigger_tUpdate_bits_tdata_tdata2 =
          {_RANDOM[5'h4][31:11], _RANDOM[5'h5], _RANDOM[5'h6][10:0]};
        REG_frontend_trigger_tEnableVec_0 = _RANDOM[5'h6][11];
        REG_frontend_trigger_tEnableVec_1 = _RANDOM[5'h6][12];
        REG_frontend_trigger_tEnableVec_2 = _RANDOM[5'h6][13];
        REG_frontend_trigger_tEnableVec_3 = _RANDOM[5'h6][14];
        REG_frontend_trigger_debugMode = _RANDOM[5'h6][15];
        REG_frontend_trigger_triggerCanRaiseBpExp = _RANDOM[5'h6][16];
        REG_mem_trigger_tUpdate_valid = _RANDOM[5'h6][17];
        REG_mem_trigger_tUpdate_bits_addr = _RANDOM[5'h6][19:18];
        REG_mem_trigger_tUpdate_bits_tdata_matchType = _RANDOM[5'h6][21:20];
        REG_mem_trigger_tUpdate_bits_tdata_select = _RANDOM[5'h6][22];
        REG_mem_trigger_tUpdate_bits_tdata_action = _RANDOM[5'h6][27:24];
        REG_mem_trigger_tUpdate_bits_tdata_chain = _RANDOM[5'h6][28];
        REG_mem_trigger_tUpdate_bits_tdata_store = _RANDOM[5'h6][30];
        REG_mem_trigger_tUpdate_bits_tdata_load = _RANDOM[5'h6][31];
        REG_mem_trigger_tUpdate_bits_tdata_tdata2 = {_RANDOM[5'h7], _RANDOM[5'h8]};
        REG_mem_trigger_tEnableVec_0 = _RANDOM[5'h9][0];
        REG_mem_trigger_tEnableVec_1 = _RANDOM[5'h9][1];
        REG_mem_trigger_tEnableVec_2 = _RANDOM[5'h9][2];
        REG_mem_trigger_tEnableVec_3 = _RANDOM[5'h9][3];
        REG_mem_trigger_debugMode = _RANDOM[5'h9][4];
        REG_mem_trigger_triggerCanRaiseBpExp = _RANDOM[5'h9][5];
        REG_fsIsOff = _RANDOM[5'h9][7];
        REG_1_l1I_pf_enable = _RANDOM[5'h9][8];
        REG_1_bp_ctrl_ubtb_enable = _RANDOM[5'hA][3];
        REG_1_bp_ctrl_btb_enable = _RANDOM[5'hA][4];
        REG_1_bp_ctrl_tage_enable = _RANDOM[5'hA][6];
        REG_1_bp_ctrl_sc_enable = _RANDOM[5'hA][7];
        REG_1_bp_ctrl_ras_enable = _RANDOM[5'hA][8];
        REG_1_ldld_vio_check_enable = _RANDOM[5'hA][14];
        REG_1_cache_error_enable = _RANDOM[5'hA][16];
        REG_1_hd_misalign_st_enable = _RANDOM[5'hA][18];
        REG_1_hd_misalign_ld_enable = _RANDOM[5'hA][19];
        REG_1_distribute_csr_w_valid = _RANDOM[5'hA][22];
        REG_1_distribute_csr_w_bits_addr = {_RANDOM[5'hA][31:23], _RANDOM[5'hB][2:0]};
        REG_1_distribute_csr_w_bits_data =
          {_RANDOM[5'hB][31:3], _RANDOM[5'hC], _RANDOM[5'hD][2:0]};
        REG_1_frontend_trigger_tUpdate_valid = _RANDOM[5'hD][4];
        REG_1_frontend_trigger_tUpdate_bits_addr = _RANDOM[5'hD][6:5];
        REG_1_frontend_trigger_tUpdate_bits_tdata_matchType = _RANDOM[5'hD][8:7];
        REG_1_frontend_trigger_tUpdate_bits_tdata_select = _RANDOM[5'hD][9];
        REG_1_frontend_trigger_tUpdate_bits_tdata_action = _RANDOM[5'hD][14:11];
        REG_1_frontend_trigger_tUpdate_bits_tdata_chain = _RANDOM[5'hD][15];
        REG_1_frontend_trigger_tUpdate_bits_tdata_tdata2 =
          {_RANDOM[5'hD][31:19], _RANDOM[5'hE], _RANDOM[5'hF][18:0]};
        REG_1_frontend_trigger_tEnableVec_0 = _RANDOM[5'hF][19];
        REG_1_frontend_trigger_tEnableVec_1 = _RANDOM[5'hF][20];
        REG_1_frontend_trigger_tEnableVec_2 = _RANDOM[5'hF][21];
        REG_1_frontend_trigger_tEnableVec_3 = _RANDOM[5'hF][22];
        REG_1_frontend_trigger_debugMode = _RANDOM[5'hF][23];
        REG_1_frontend_trigger_triggerCanRaiseBpExp = _RANDOM[5'hF][24];
        REG_1_mem_trigger_tUpdate_valid = _RANDOM[5'hF][25];
        REG_1_mem_trigger_tUpdate_bits_addr = _RANDOM[5'hF][27:26];
        REG_1_mem_trigger_tUpdate_bits_tdata_matchType = _RANDOM[5'hF][29:28];
        REG_1_mem_trigger_tUpdate_bits_tdata_select = _RANDOM[5'hF][30];
        REG_1_mem_trigger_tUpdate_bits_tdata_action = _RANDOM[5'h10][3:0];
        REG_1_mem_trigger_tUpdate_bits_tdata_chain = _RANDOM[5'h10][4];
        REG_1_mem_trigger_tUpdate_bits_tdata_store = _RANDOM[5'h10][6];
        REG_1_mem_trigger_tUpdate_bits_tdata_load = _RANDOM[5'h10][7];
        REG_1_mem_trigger_tUpdate_bits_tdata_tdata2 =
          {_RANDOM[5'h10][31:8], _RANDOM[5'h11], _RANDOM[5'h12][7:0]};
        REG_1_mem_trigger_tEnableVec_0 = _RANDOM[5'h12][8];
        REG_1_mem_trigger_tEnableVec_1 = _RANDOM[5'h12][9];
        REG_1_mem_trigger_tEnableVec_2 = _RANDOM[5'h12][10];
        REG_1_mem_trigger_tEnableVec_3 = _RANDOM[5'h12][11];
        REG_1_mem_trigger_debugMode = _RANDOM[5'h12][12];
        REG_1_mem_trigger_triggerCanRaiseBpExp = _RANDOM[5'h12][13];
        REG_1_fsIsOff = _RANDOM[5'h12][15];
      `endif // RANDOMIZE_REG_INIT
    end // initial
