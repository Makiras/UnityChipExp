...
module RequestBuffer_4(
  ...
  wire [117:0] _buffer_ext_R0_data;
  wire [117:0] _buffer_ext_R1_data;
  wire [117:0] _buffer_ext_R2_data;
  wire [117:0] _buffer_ext_R3_data;
  reg          valids_0;
  reg          valids_1;
  reg          valids_2;
  reg          valids_3;
  ...
  wire [3:0]   _full_T = {valids_0, valids_1, valids_2, valids_3};
  ...
  wire         alloc_probe =
    ~(&_full_T) & io_in_valid & ~(~_output_pipe_q_io_deq_valid & io_out_ready) & ~dup;
  wire         _GEN = alloc_probe & insert_idx == 2'h0;
  wire         _GEN_0 = alloc_probe & insert_idx == 2'h1;
  wire         _GEN_1 = alloc_probe & insert_idx == 2'h2;
  wire         _GEN_2 = alloc_probe & (&insert_idx);
  `ifndef SYNTHESIS
    wire [3:0] _GEN_3 =
      4'({1'h0,
          3'({1'h0,
              2'({1'h0, conflict_mask_0}
                 + 2'({1'h0, conflict_mask_1} + {1'h0, conflict_mask_2}))}
             + 3'({1'h0, 2'({1'h0, conflict_mask_3} + {1'h0, conflict_mask_4})}
                  + {1'h0, 2'({1'h0, conflict_mask_5} + {1'h0, conflict_mask_6})}))}
         + {1'h0,
            3'({1'h0,
                2'({1'h0, conflict_mask_7}
                   + 2'({1'h0, conflict_mask_8} + {1'h0, conflict_mask_9}))}
               + 3'({1'h0, 2'({1'h0, conflict_mask_10} + {1'h0, conflict_mask_11})}
                    + {1'h0, 2'({1'h0, conflict_mask_12} + {1'h0, conflict_mask_13})}))});
    always @(posedge clock) begin
      if (alloc_probe & ~reset & (|(_GEN_3[3:1]))) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed\n    at RequestBuffer.scala:73 assert(PopCount(conflict_mask) <= 1.U)\n");
        if (`STOP_COND_)
  ...
  wire         _GEN_4 = _output_pipe_q_io_enq_ready & _issue_arb_io_out_valid;
  wire         _GEN_5 = _GEN_4 & _issue_arb_io_chosen == 2'h0;
  wire         _GEN_6 = _GEN_4 & _issue_arb_io_chosen == 2'h1;
  wire         _GEN_7 = _GEN_4 & _issue_arb_io_chosen == 2'h2;
  wire         _GEN_8 = _GEN_4 & (&_issue_arb_io_chosen);
  ...
  wire         _GEN_9 = dup & ~(&_full_T);
  wire         _perfEvents_T_3 = ~(&_full_T) & io_in_valid;
  wire         _GEN_10 = ~_output_pipe_q_io_deq_valid & _perfEvents_T_3;
  wire [2:0]   _GEN_11 = {1'h0, 2'({1'h0, valids_0} + {1'h0, valids_1})};
  wire [2:0]   _GEN_12 = {1'h0, 2'({1'h0, valids_2} + {1'h0, valids_3})};
  ...
  wire         _GEN_13 = _perfEvents_T_3 & io_in_bits_isPrefetch;
  wire         _GEN_14 = _perfEvents_T_3 & ~io_in_bits_isPrefetch;
  wire         _rdys_T_4 =
    {conflict_mask_0,
     conflict_mask_1,
     conflict_mask_2,
      ...
      if (valids_0)
        rdys_0 <=
          ...
          & {~_GEN_5 & buffer_dep_mask_0_0,
             ...
             ~_GEN_8 & buffer_dep_mask_0_3} == 4'h0;
      else if (_GEN)
        rdys_0 <= _rdys_T_4;
      if (valids_1)
        rdys_1 <=
          ...
          & {~_GEN_5 & buffer_dep_mask_1_0,
             ...
             ~_GEN_8 & buffer_dep_mask_1_3} == 4'h0;
      else if (_GEN_0)
        rdys_1 <= _rdys_T_4;
      if (valids_2)
        rdys_2 <=
          ...
          & {~_GEN_5 & buffer_dep_mask_2_0,
             ...
             ~_GEN_8 & buffer_dep_mask_2_3} == 4'h0;
      else if (_GEN_1)
        rdys_2 <= _rdys_T_4;
      if (valids_3)
        rdys_3 <=
          ...
          & {~_GEN_5 & buffer_dep_mask_3_0,
             ...
             ~_GEN_8 & buffer_dep_mask_3_3} == 4'h0;
      else if (_GEN_2)
        rdys_3 <= _rdys_T_4;
    end
  ...
  always @(posedge clock) begin
    ...
    buffer_dep_mask_0_0 <= ~_GEN_5 & (_GEN ? req_deps_0 : buffer_dep_mask_0_0);
    buffer_dep_mask_0_1 <= ~_GEN_6 & (_GEN ? req_deps_1 : buffer_dep_mask_0_1);
    buffer_dep_mask_0_2 <= ~_GEN_7 & (_GEN ? req_deps_2 : buffer_dep_mask_0_2);
    buffer_dep_mask_0_3 <= ~_GEN_8 & (_GEN ? req_deps_3 : buffer_dep_mask_0_3);
    buffer_dep_mask_1_0 <= ~_GEN_5 & (_GEN_0 ? req_deps_0 : buffer_dep_mask_1_0);
    buffer_dep_mask_1_1 <= ~_GEN_6 & (_GEN_0 ? req_deps_1 : buffer_dep_mask_1_1);
    buffer_dep_mask_1_2 <= ~_GEN_7 & (_GEN_0 ? req_deps_2 : buffer_dep_mask_1_2);
    buffer_dep_mask_1_3 <= ~_GEN_8 & (_GEN_0 ? req_deps_3 : buffer_dep_mask_1_3);
    buffer_dep_mask_2_0 <= ~_GEN_5 & (_GEN_1 ? req_deps_0 : buffer_dep_mask_2_0);
    buffer_dep_mask_2_1 <= ~_GEN_6 & (_GEN_1 ? req_deps_1 : buffer_dep_mask_2_1);
    buffer_dep_mask_2_2 <= ~_GEN_7 & (_GEN_1 ? req_deps_2 : buffer_dep_mask_2_2);
    buffer_dep_mask_2_3 <= ~_GEN_8 & (_GEN_1 ? req_deps_3 : buffer_dep_mask_2_3);
    buffer_dep_mask_3_0 <= ~_GEN_5 & (_GEN_2 ? req_deps_0 : buffer_dep_mask_3_0);
    buffer_dep_mask_3_1 <= ~_GEN_6 & (_GEN_2 ? req_deps_1 : buffer_dep_mask_3_1);
    buffer_dep_mask_3_2 <= ~_GEN_7 & (_GEN_2 ? req_deps_2 : buffer_dep_mask_3_2);
    buffer_dep_mask_3_3 <= ~_GEN_8 & (_GEN_2 ? req_deps_3 : buffer_dep_mask_3_3);
  end // always @(posedge)
  ...
  FastArbiter_26 issue_arb (
    ...
    .io_in_0_bits_reqSource        (_buffer_ext_R3_data[117:114]),
    ...
    .io_in_1_bits_reqSource        (_buffer_ext_R2_data[117:114]),
    ...
    .io_in_2_bits_reqSource        (_buffer_ext_R1_data[117:114]),
    ...
    .io_in_3_bits_reqSource        (_buffer_ext_R0_data[117:114]),
  ...
  assign io_in_ready = ~(&_full_T);
  assign io_out_valid =
    ~_output_pipe_q_io_deq_valid & io_in_valid & ~(&_full_T)
