  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        ptwResp_s1_entry_pbmt = _RANDOM[4'h2][4:3];
        ptwResp_s1_entry_perm_d = _RANDOM[4'h2][5];
        ptwResp_s1_entry_perm_a = _RANDOM[4'h2][6];
        ptwResp_s1_entry_perm_g = _RANDOM[4'h2][7];
        ptwResp_s1_entry_perm_u = _RANDOM[4'h2][8];
        ptwResp_s1_entry_perm_x = _RANDOM[4'h2][9];
        ptwResp_s1_entry_perm_w = _RANDOM[4'h2][10];
        ptwResp_s1_entry_perm_r = _RANDOM[4'h2][11];
        ptwResp_s1_entry_level = _RANDOM[4'h2][13:12];
        ptwResp_s1_entry_v = _RANDOM[4'h2][15];
        ptwResp_s1_entry_ppn = {_RANDOM[4'h2][31:16], _RANDOM[4'h3][24:0]};
        ptwResp_s1_addr_low = _RANDOM[4'h3][27:25];
        ptwResp_s1_ppn_low_0 = _RANDOM[4'h3][30:28];
        ptwResp_s1_ppn_low_1 = {_RANDOM[4'h3][31], _RANDOM[4'h4][1:0]};
        ptwResp_s1_ppn_low_2 = _RANDOM[4'h4][4:2];
        ptwResp_s1_ppn_low_3 = _RANDOM[4'h4][7:5];
        ptwResp_s1_ppn_low_4 = _RANDOM[4'h4][10:8];
        ptwResp_s1_ppn_low_5 = _RANDOM[4'h4][13:11];
        ptwResp_s1_ppn_low_6 = _RANDOM[4'h4][16:14];
        ptwResp_s1_ppn_low_7 = _RANDOM[4'h4][19:17];
        ptwResp_s1_valididx_0 = _RANDOM[4'h4][20];
        ptwResp_s1_valididx_1 = _RANDOM[4'h4][21];
        ptwResp_s1_valididx_2 = _RANDOM[4'h4][22];
        ptwResp_s1_valididx_3 = _RANDOM[4'h4][23];
        ptwResp_s1_valididx_4 = _RANDOM[4'h4][24];
        ptwResp_s1_valididx_5 = _RANDOM[4'h4][25];
        ptwResp_s1_valididx_6 = _RANDOM[4'h4][26];
        ptwResp_s1_valididx_7 = _RANDOM[4'h4][27];
        ptwResp_s1_pteidx_0 = _RANDOM[4'h4][28];
        ptwResp_s1_pteidx_1 = _RANDOM[4'h4][29];
        ptwResp_s1_pteidx_2 = _RANDOM[4'h4][30];
        ptwResp_s1_pteidx_3 = _RANDOM[4'h4][31];
        ptwResp_s1_pteidx_4 = _RANDOM[4'h5][0];
        ptwResp_s1_pteidx_5 = _RANDOM[4'h5][1];
        ptwResp_s1_pteidx_6 = _RANDOM[4'h5][2];
        ptwResp_s1_pteidx_7 = _RANDOM[4'h5][3];
        ptwResp_s1_pf = _RANDOM[4'h5][4];
        ptwResp_s1_af = _RANDOM[4'h5][5];
        ptwResp_s2_entry_tag = {_RANDOM[4'h5][31:6], _RANDOM[4'h6][11:0]};
        ptwResp_s2_entry_vmid = {_RANDOM[4'h6][31:28], _RANDOM[4'h7][9:0]};
        ptwResp_s2_entry_pbmt = _RANDOM[4'h7][11:10];
        ptwResp_s2_entry_ppn = {_RANDOM[4'h7][31:12], _RANDOM[4'h8][17:0]};
        ptwResp_s2_entry_perm_d = _RANDOM[4'h8][18];
        ptwResp_s2_entry_perm_a = _RANDOM[4'h8][19];
        ptwResp_s2_entry_perm_g = _RANDOM[4'h8][20];
        ptwResp_s2_entry_perm_u = _RANDOM[4'h8][21];
        ptwResp_s2_entry_perm_x = _RANDOM[4'h8][22];
        ptwResp_s2_entry_perm_w = _RANDOM[4'h8][23];
        ptwResp_s2_entry_perm_r = _RANDOM[4'h8][24];
        ptwResp_s2_entry_level = _RANDOM[4'h8][26:25];
        ptwResp_s2_gpf = _RANDOM[4'h8][29];
        ptwResp_s2_gaf = _RANDOM[4'h8][30];
        load_filter_0_ptw_resp_valid_last_REG = _RANDOM[4'h8][31];
        store_filter_0_ptw_resp_valid_last_REG = _RANDOM[4'h9][0];
        prefetch_filter_0_ptw_resp_valid_last_REG = _RANDOM[4'h9][1];
        io_hint_req_0_REG_id = _RANDOM[4'h9][5:2];
        io_hint_req_0_REG_full = _RANDOM[4'h9][6];
        io_hint_req_1_REG_id = _RANDOM[4'h9][10:7];
        io_hint_req_1_REG_full = _RANDOM[4'h9][11];
        io_hint_req_2_REG_id = _RANDOM[4'h9][15:12];
        io_hint_req_2_REG_full = _RANDOM[4'h9][16];
        io_hint_resp_valid_REG = _RANDOM[4'h9][17];
        io_hint_resp_bits_r_id = _RANDOM[4'h9][21:18];
        io_hint_resp_bits_r_replay_all = _RANDOM[4'h9][22];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        load_filter_0_ptw_resp_valid_last_REG = 1'h0;
        store_filter_0_ptw_resp_valid_last_REG = 1'h0;
