...
module TLToAXI4_1(
  ...
  wire            inc = _GEN[auto_in_a_bits_source] == 3'h0 & _inc_T_4;
  wire            _dec_T_9 = auto_in_d_ready & nodeIn_d_valid;
  wire            dec = d_sel_shiftAmount == 3'h0 & d_last & _dec_T_9;
  wire            inc_1 = _GEN[auto_in_a_bits_source] == 3'h1 & _inc_T_4;
  wire            dec_1 = d_sel_shiftAmount == 3'h1 & d_last & _dec_T_9;
  wire            inc_2 = _GEN[auto_in_a_bits_source] == 3'h2 & _inc_T_4;
  wire            dec_2 = d_sel_shiftAmount == 3'h2 & d_last & _dec_T_9;
  wire            inc_3 = _GEN[auto_in_a_bits_source] == 3'h3 & _inc_T_4;
  wire            dec_3 = d_sel_shiftAmount == 3'h3 & d_last & _dec_T_9;
  wire            inc_4 = _GEN[auto_in_a_bits_source] == 3'h4 & _inc_T_4;
