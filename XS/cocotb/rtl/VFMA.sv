...
module VFMA(
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        perfVec_1_eliminatedMove = _RANDOM[8'h52][22];
        perfVec_1_renameTime =
          {_RANDOM[8'h52][31:23], _RANDOM[8'h53], _RANDOM[8'h54][22:0]};
        perfVec_1_dispatchTime =
          {_RANDOM[8'h54][31:23], _RANDOM[8'h55], _RANDOM[8'h56][22:0]};
        perfVec_1_enqRsTime =
          {_RANDOM[8'h56][31:23], _RANDOM[8'h57], _RANDOM[8'h58][22:0]};
        perfVec_1_selectTime =
          {_RANDOM[8'h58][31:23], _RANDOM[8'h59], _RANDOM[8'h5A][22:0]};
        perfVec_1_issueTime =
          {_RANDOM[8'h5A][31:23], _RANDOM[8'h5B], _RANDOM[8'h5C][22:0]};
        perfVec_1_writebackTime =
          {_RANDOM[8'h5C][31:23], _RANDOM[8'h5D], _RANDOM[8'h5E][22:0]};
        perfVec_1_runahead_checkpoint_id =
          {_RANDOM[8'h5E][31:23], _RANDOM[8'h5F], _RANDOM[8'h60][22:0]};
        perfVec_1_tlbFirstReqTime =
          {_RANDOM[8'h60][31:23], _RANDOM[8'h61], _RANDOM[8'h62][22:0]};
        perfVec_1_tlbRespTime =
          {_RANDOM[8'h62][31:23], _RANDOM[8'h63], _RANDOM[8'h64][22:0]};
        perfVec_2_eliminatedMove = _RANDOM[8'h64][23];
        perfVec_2_renameTime =
          {_RANDOM[8'h64][31:24], _RANDOM[8'h65], _RANDOM[8'h66][23:0]};
        perfVec_2_dispatchTime =
          {_RANDOM[8'h66][31:24], _RANDOM[8'h67], _RANDOM[8'h68][23:0]};
        perfVec_2_enqRsTime =
          {_RANDOM[8'h68][31:24], _RANDOM[8'h69], _RANDOM[8'h6A][23:0]};
        perfVec_2_selectTime =
          {_RANDOM[8'h6A][31:24], _RANDOM[8'h6B], _RANDOM[8'h6C][23:0]};
        perfVec_2_issueTime =
          {_RANDOM[8'h6C][31:24], _RANDOM[8'h6D], _RANDOM[8'h6E][23:0]};
        perfVec_2_writebackTime =
          {_RANDOM[8'h6E][31:24], _RANDOM[8'h6F], _RANDOM[8'h70][23:0]};
        perfVec_2_runahead_checkpoint_id =
          {_RANDOM[8'h70][31:24], _RANDOM[8'h71], _RANDOM[8'h72][23:0]};
        perfVec_2_tlbFirstReqTime =
          {_RANDOM[8'h72][31:24], _RANDOM[8'h73], _RANDOM[8'h74][23:0]};
        perfVec_2_tlbRespTime =
          {_RANDOM[8'h74][31:24], _RANDOM[8'h75], _RANDOM[8'h76][23:0]};
        perfVec_3_eliminatedMove = _RANDOM[8'h76][24];
        perfVec_3_renameTime =
          {_RANDOM[8'h76][31:25], _RANDOM[8'h77], _RANDOM[8'h78][24:0]};
        perfVec_3_dispatchTime =
          {_RANDOM[8'h78][31:25], _RANDOM[8'h79], _RANDOM[8'h7A][24:0]};
        perfVec_3_enqRsTime =
          {_RANDOM[8'h7A][31:25], _RANDOM[8'h7B], _RANDOM[8'h7C][24:0]};
        perfVec_3_selectTime =
          {_RANDOM[8'h7C][31:25], _RANDOM[8'h7D], _RANDOM[8'h7E][24:0]};
        perfVec_3_issueTime =
          {_RANDOM[8'h7E][31:25], _RANDOM[8'h7F], _RANDOM[8'h80][24:0]};
        perfVec_3_writebackTime =
          {_RANDOM[8'h80][31:25], _RANDOM[8'h81], _RANDOM[8'h82][24:0]};
  ...
  assign io_out_bits_res_fflags =
    (_GEN_2[0] ? _vfmas_0_io_fflags[4:0] : 5'h0)
    | (_GEN_2[1] ? _vfmas_0_io_fflags[9:5] : 5'h0)
    | (_GEN_2[2] ? _vfmas_0_io_fflags[14:10] : 5'h0)
    | (_GEN_2[3] ? _vfmas_0_io_fflags[19:15] : 5'h0)
    | (_GEN_2[4] ? _vfmas_1_io_fflags[4:0] : 5'h0)
    | (_GEN_2[5] ? _vfmas_1_io_fflags[9:5] : 5'h0)
    | (_GEN_2[6] ? _vfmas_1_io_fflags[14:10] : 5'h0)
    | (_GEN_2[7] ? _vfmas_1_io_fflags[19:15] : 5'h0);
