...
module TLDebugModuleInner(
  ...
  `ifndef SYNTHESIS
    ...
    always @(posedge clock) begin
      ...
      if (_GEN_5 & _GEN_4 & hartExceptionWrEn & ~reset
          & (|(auto_tl_in_a_bits_data[41:32]))) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (_GEN_5 & ~_GEN_4 & (&ctrlStateReg) & ~reset) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (~reset & ~(~io_dmactive | ~hartExceptionWrEn | _GEN_4)) begin
        if (`ASSERT_VERBOSE_COND_)
  ...
  always @(posedge clock) begin
    ...
    if (io_dmactive) begin
      ...
      else if (~(~(|ctrlStateReg) | _GEN_2) & _GEN_4 & hartExceptionWrEn)
      ...
      else if ((|ctrlStateReg) & _GEN_2 & ~commandRegIsUnsupported
      ...
      if (|ctrlStateReg) begin
        ...
        else if (_GEN_4 & (hartExceptionWrEn | ~goReg & hartHaltedWrEn))
          ctrlStateReg <= 2'h0;
      end
      else if (_GEN_6)
        ctrlStateReg <= 2'h1;
