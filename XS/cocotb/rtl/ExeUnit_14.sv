...
module ExeUnit_14(
  ...
  wire [63:0]  _VSetRvfWvf_io_out_bits_perfDebugInfo_writebackTime;
  ...
  wire [63:0]  _Vipu_io_out_bits_perfDebugInfo_writebackTime;
  ...
  wire [63:0]  _Vfcvt_io_out_bits_perfDebugInfo_writebackTime;
  ...
  wire [63:0]  _Vfalu_io_out_bits_perfDebugInfo_writebackTime;
  ...
  wire         clk_en_3_probe = _VSetRvfWvf_io_in_ready & _in1ToN_io_out_3_valid;
  reg          inPipe_2_1;
  reg          inPipe_2_2;
  ...
  wire [2:0]   _GEN =
    3'({1'h0, 2'({1'h0, _Vfalu_io_out_valid} + {1'h0, _Vfcvt_io_out_valid})}
       + {1'h0, 2'({1'h0, _Vipu_io_out_valid} + {1'h0, _VSetRvfWvf_io_out_valid})});
  ...
  `endif // not def SYNTHESIS
  wire [127:0] _GEN_2 = _Vipu_io_out_valid ? _Vipu_io_out_bits_res_data : 128'h0;
  wire [63:0]  _GEN_3 =
    _VSetRvfWvf_io_out_valid ? _VSetRvfWvf_io_out_bits_res_data : 64'h0;
  wire [127:0] io_out_bits_data_4_0 =
    (_Vfalu_io_out_valid ? _Vfalu_io_out_bits_res_data : 128'h0)
    | (_Vfcvt_io_out_valid ? _Vfcvt_io_out_bits_res_data : 128'h0) | _GEN_2;
  ...
  VFAlu Vfalu (
    ...
    .io_out_bits_perfDebugInfo_writebackTime
      (_Vfalu_io_out_bits_perfDebugInfo_writebackTime),
  ...
  VCVT_8 Vfcvt (
    ...
    .io_out_bits_perfDebugInfo_writebackTime
      (_Vfcvt_io_out_bits_perfDebugInfo_writebackTime),
    .io_out_bits_perfDebugInfo_runahead_checkpoint_id
  ...
  VIPU Vipu (
    ...
    .io_out_bits_perfDebugInfo_writebackTime
      (_Vipu_io_out_bits_perfDebugInfo_writebackTime),
    .io_out_bits_perfDebugInfo_runahead_checkpoint_id
  ...
  VSetRvfWvf VSetRvfWvf (
    ...
    .io_out_bits_perfDebugInfo_writebackTime
      (_VSetRvfWvf_io_out_bits_perfDebugInfo_writebackTime),
    .io_out_bits_perfDebugInfo_runahead_checkpoint_id
  ...
  Dispatcher_14 in1ToN (
    ...
    .io_out_0_bits_perfDebugInfo_tlbRespTime
      (_in1ToN_io_out_0_bits_perfDebugInfo_tlbRespTime),
    .io_out_1_ready                                     (_Vfcvt_io_in_ready),
    ...
    .io_out_1_bits_perfDebugInfo_tlbRespTime
      (_in1ToN_io_out_1_bits_perfDebugInfo_tlbRespTime),
    .io_out_2_ready                                     (_Vipu_io_in_ready),
    ...
    .io_out_2_bits_vpu_vstart
      (_in1ToN_io_out_2_bits_vpu_vstart),
    ...
    .io_out_2_bits_perfDebugInfo_tlbRespTime
      (_in1ToN_io_out_2_bits_perfDebugInfo_tlbRespTime),
    .io_out_3_ready                                     (_VSetRvfWvf_io_in_ready),
  ...
  assign io_out_bits_data_0 =
    {io_out_bits_data_4_0[127:64], io_out_bits_data_4_0[63:0] | _GEN_3};
  assign io_out_bits_data_1 = {_GEN_2[127:64], _GEN_2[63:0] | _GEN_3};
  ...
  assign io_out_bits_debugInfo_eliminatedMove =
    _Vfalu_io_out_valid & _Vfalu_io_out_bits_perfDebugInfo_eliminatedMove
    | _Vfcvt_io_out_valid & _Vfcvt_io_out_bits_perfDebugInfo_eliminatedMove
    | _Vipu_io_out_valid & _Vipu_io_out_bits_perfDebugInfo_eliminatedMove
    | _VSetRvfWvf_io_out_valid & _VSetRvfWvf_io_out_bits_perfDebugInfo_eliminatedMove;
  assign io_out_bits_debugInfo_renameTime =
    (_Vfalu_io_out_valid ? _Vfalu_io_out_bits_perfDebugInfo_renameTime : 64'h0)
    | (_Vfcvt_io_out_valid ? _Vfcvt_io_out_bits_perfDebugInfo_renameTime : 64'h0)
    | (_Vipu_io_out_valid ? _Vipu_io_out_bits_perfDebugInfo_renameTime : 64'h0)
    | (_VSetRvfWvf_io_out_valid
         ? _VSetRvfWvf_io_out_bits_perfDebugInfo_renameTime
         : 64'h0);
  assign io_out_bits_debugInfo_dispatchTime =
    (_Vfalu_io_out_valid ? _Vfalu_io_out_bits_perfDebugInfo_dispatchTime : 64'h0)
    | (_Vfcvt_io_out_valid ? _Vfcvt_io_out_bits_perfDebugInfo_dispatchTime : 64'h0)
    | (_Vipu_io_out_valid ? _Vipu_io_out_bits_perfDebugInfo_dispatchTime : 64'h0)
    | (_VSetRvfWvf_io_out_valid
         ? _VSetRvfWvf_io_out_bits_perfDebugInfo_dispatchTime
         : 64'h0);
  assign io_out_bits_debugInfo_enqRsTime =
    (_Vfalu_io_out_valid ? _Vfalu_io_out_bits_perfDebugInfo_enqRsTime : 64'h0)
    | (_Vfcvt_io_out_valid ? _Vfcvt_io_out_bits_perfDebugInfo_enqRsTime : 64'h0)
    | (_Vipu_io_out_valid ? _Vipu_io_out_bits_perfDebugInfo_enqRsTime : 64'h0)
    | (_VSetRvfWvf_io_out_valid
         ? _VSetRvfWvf_io_out_bits_perfDebugInfo_enqRsTime
         : 64'h0);
  assign io_out_bits_debugInfo_selectTime =
    (_Vfalu_io_out_valid ? _Vfalu_io_out_bits_perfDebugInfo_selectTime : 64'h0)
    | (_Vfcvt_io_out_valid ? _Vfcvt_io_out_bits_perfDebugInfo_selectTime : 64'h0)
    | (_Vipu_io_out_valid ? _Vipu_io_out_bits_perfDebugInfo_selectTime : 64'h0)
    | (_VSetRvfWvf_io_out_valid
         ? _VSetRvfWvf_io_out_bits_perfDebugInfo_selectTime
         : 64'h0);
  assign io_out_bits_debugInfo_issueTime =
    (_Vfalu_io_out_valid ? _Vfalu_io_out_bits_perfDebugInfo_issueTime : 64'h0)
    | (_Vfcvt_io_out_valid ? _Vfcvt_io_out_bits_perfDebugInfo_issueTime : 64'h0)
    | (_Vipu_io_out_valid ? _Vipu_io_out_bits_perfDebugInfo_issueTime : 64'h0)
    | (_VSetRvfWvf_io_out_valid
         ? _VSetRvfWvf_io_out_bits_perfDebugInfo_issueTime
         : 64'h0);
  assign io_out_bits_debugInfo_writebackTime =
    (_Vfalu_io_out_valid ? _Vfalu_io_out_bits_perfDebugInfo_writebackTime : 64'h0)
    | (_Vfcvt_io_out_valid ? _Vfcvt_io_out_bits_perfDebugInfo_writebackTime : 64'h0)
    | (_Vipu_io_out_valid ? _Vipu_io_out_bits_perfDebugInfo_writebackTime : 64'h0)
    | (_VSetRvfWvf_io_out_valid
         ? _VSetRvfWvf_io_out_bits_perfDebugInfo_writebackTime
         : 64'h0);
  ...
  assign io_out_bits_debugInfo_tlbFirstReqTime =
    (_Vfalu_io_out_valid ? _Vfalu_io_out_bits_perfDebugInfo_tlbFirstReqTime : 64'h0)
    | (_Vfcvt_io_out_valid ? _Vfcvt_io_out_bits_perfDebugInfo_tlbFirstReqTime : 64'h0)
    | (_Vipu_io_out_valid ? _Vipu_io_out_bits_perfDebugInfo_tlbFirstReqTime : 64'h0)
    | (_VSetRvfWvf_io_out_valid
         ? _VSetRvfWvf_io_out_bits_perfDebugInfo_tlbFirstReqTime
         : 64'h0);
  assign io_out_bits_debugInfo_tlbRespTime =
    (_Vfalu_io_out_valid ? _Vfalu_io_out_bits_perfDebugInfo_tlbRespTime : 64'h0)
    | (_Vfcvt_io_out_valid ? _Vfcvt_io_out_bits_perfDebugInfo_tlbRespTime : 64'h0)
    | (_Vipu_io_out_valid ? _Vipu_io_out_bits_perfDebugInfo_tlbRespTime : 64'h0)
    | (_VSetRvfWvf_io_out_valid
         ? _VSetRvfWvf_io_out_bits_perfDebugInfo_tlbRespTime
         : 64'h0);
endmodule
