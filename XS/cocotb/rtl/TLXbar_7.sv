...
module TLXbar_7(
  ...
  wire        out_3_a_valid =
    beatsLeft_3
      ...
      : _out_3_a_valid_T | portsAOI_filtered_2_3_valid;
  reg         beatsLeft_4;
  ...
  wire        _in_0_b_valid_T = portsBIO_filtered_0_valid | portsBIO_filtered_1_0_valid;
  reg         state_4_0;
  reg         state_4_1;
  reg         state_4_2;
  reg         state_4_3;
  ...
  wire        in_0_b_valid =
    beatsLeft_4
      ? state_4_0 & portsBIO_filtered_0_valid | state_4_1 & portsBIO_filtered_1_0_valid
        ...
        & portsBIO_filtered_3_0_valid
      : _in_0_b_valid_T | portsBIO_filtered_2_0_valid | portsBIO_filtered_3_0_valid;
  reg         beatsLeft_5;
  ...
  `ifndef SYNTHESIS
    wire prefixOR_2_4 = winner_4_0 | winner_4_1;
    wire prefixOR_2_5 = winner_5_0 | winner_5_1;
    wire prefixOR_2_6 = winner_6_0 | winner_6_1;
    wire prefixOR_2_7 = winner_7_0 | winner_7_1;
    always @(posedge clock) begin
      ...
      if (~reset
          & ~((~winner_1_0 | ~winner_1_1)
              & (~(winner_1_0 | winner_1_1) | ~winner_1_2))) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed\n    at Arbiter.scala:77 assert((prefixOR zip winner) map { case (p,w) => !p || !w } reduce {_ && _})\n");
        if (`STOP_COND_)
          xs_assert_v2(`__FILE__, `__LINE__);
      ...
      if (~reset
          & ~((~winner_2_0 | ~winner_2_1)
              & (~(winner_2_0 | winner_2_1) | ~winner_2_2))) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed\n    at Arbiter.scala:77 assert((prefixOR zip winner) map { case (p,w) => !p || !w } reduce {_ && _})\n");
        if (`STOP_COND_)
          xs_assert_v2(`__FILE__, `__LINE__);
      ...
      if (~reset
          & ~(~(_out_2_a_valid_T | portsAOI_filtered_2_2_valid) | winner_2_0 | winner_2_1
              | winner_2_2)) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed\n    at Arbiter.scala:79 assert (!valids.reduce(_||_) || winner.reduce(_||_))\n");
        if (`STOP_COND_)
      ...
      if (~reset
          & ~(~(_out_3_a_valid_T | portsAOI_filtered_2_3_valid) | winner_3_0 | winner_3_1
              | winner_3_2)) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed\n    at Arbiter.scala:79 assert (!valids.reduce(_||_) || winner.reduce(_||_))\n");
        if (`STOP_COND_)
      ...
      if (~reset
          & ~((~winner_4_0 | ~winner_4_1) & (~prefixOR_2_4 | ~winner_4_2)
              & (~(prefixOR_2_4 | winner_4_2) | ~winner_4_3))) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed\n    at Arbiter.scala:77 assert((prefixOR zip winner) map { case (p,w) => !p || !w } reduce {_ && _})\n");
        if (`STOP_COND_)
          xs_assert_v2(`__FILE__, `__LINE__);
      ...
      if (~reset
          & ~(~(_in_0_b_valid_T | portsBIO_filtered_2_0_valid
                | portsBIO_filtered_3_0_valid) | winner_4_0 | winner_4_1 | winner_4_2
              | winner_4_3)) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed\n    at Arbiter.scala:79 assert (!valids.reduce(_||_) || winner.reduce(_||_))\n");
        if (`STOP_COND_)
      ...
      if (~reset
          & ~((~winner_5_0 | ~winner_5_1) & (~prefixOR_2_5 | ~winner_5_2)
              & (~(prefixOR_2_5 | winner_5_2) | ~winner_5_3))) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed\n    at Arbiter.scala:77 assert((prefixOR zip winner) map { case (p,w) => !p || !w } reduce {_ && _})\n");
        if (`STOP_COND_)
          xs_assert_v2(`__FILE__, `__LINE__);
      ...
      if (~reset
          & ~(~(_in_0_d_valid_T | portsDIO_filtered_2_0_valid
                | portsDIO_filtered_3_0_valid) | winner_5_0 | winner_5_1 | winner_5_2
              | winner_5_3)) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed\n    at Arbiter.scala:79 assert (!valids.reduce(_||_) || winner.reduce(_||_))\n");
        if (`STOP_COND_)
      ...
      if (~reset
          & ~((~winner_6_0 | ~winner_6_1) & (~prefixOR_2_6 | ~winner_6_2)
              & (~(prefixOR_2_6 | winner_6_2) | ~winner_6_3))) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed\n    at Arbiter.scala:77 assert((prefixOR zip winner) map { case (p,w) => !p || !w } reduce {_ && _})\n");
        if (`STOP_COND_)
          xs_assert_v2(`__FILE__, `__LINE__);
      ...
      if (~reset
          & ~(~(_in_1_d_valid_T | portsDIO_filtered_2_1_valid
                | portsDIO_filtered_3_1_valid) | winner_6_0 | winner_6_1 | winner_6_2
              | winner_6_3)) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed\n    at Arbiter.scala:79 assert (!valids.reduce(_||_) || winner.reduce(_||_))\n");
        if (`STOP_COND_)
      ...
      if (~reset
          & ~((~winner_7_0 | ~winner_7_1) & (~prefixOR_2_7 | ~winner_7_2)
              & (~(prefixOR_2_7 | winner_7_2) | ~winner_7_3))) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed\n    at Arbiter.scala:77 assert((prefixOR zip winner) map { case (p,w) => !p || !w } reduce {_ && _})\n");
        if (`STOP_COND_)
          xs_assert_v2(`__FILE__, `__LINE__);
      ...
      if (~reset
          & ~(~(_in_2_d_valid_T | portsDIO_filtered_2_2_valid
                | portsDIO_filtered_3_2_valid) | winner_7_0 | winner_7_1 | winner_7_2
              | winner_7_3)) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed\n    at Arbiter.scala:79 assert (!valids.reduce(_||_) || winner.reduce(_||_))\n");
        if (`STOP_COND_)
  ...
  wire        in_2_d_valid =
    beatsLeft_7
      ? state_7_0 & portsDIO_filtered_2_valid | state_7_1 & portsDIO_filtered_1_2_valid
        ...
        & portsDIO_filtered_3_2_valid
      : _in_2_d_valid_T | portsDIO_filtered_2_2_valid | portsDIO_filtered_3_2_valid;
