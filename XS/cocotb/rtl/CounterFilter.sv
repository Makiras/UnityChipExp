...
module CounterFilter(
    ...
    always @(posedge clock) begin
      if (~reset & ~(~io_ld_in_0_valid | canAlloc_0)) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed: port0 can not accept CounterFilter enq request, check if SIZE >= (Ldu stages - 2) * LduCnt\n    at FDP.scala:114 assert(!needAlloc(i) || canAlloc(i), s\"port${i} can not accept CounterFilter enq request, check if SIZE >= (Ldu stages - 2) * LduCnt\")\n");
        if (`STOP_COND_)
          xs_assert_v2(`__FILE__, `__LINE__);
      end
      if (~reset & ~(~io_ld_in_1_valid | canAlloc_1)) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed: port1 can not accept CounterFilter enq request, check if SIZE >= (Ldu stages - 2) * LduCnt\n    at FDP.scala:114 assert(!needAlloc(i) || canAlloc(i), s\"port${i} can not accept CounterFilter enq request, check if SIZE >= (Ldu stages - 2) * LduCnt\")\n");
        if (`STOP_COND_)
          xs_assert_v2(`__FILE__, `__LINE__);
      end
      if (~reset & ~(~io_ld_in_2_valid | canAlloc_2)) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed: port2 can not accept CounterFilter enq request, check if SIZE >= (Ldu stages - 2) * LduCnt\n    at FDP.scala:114 assert(!needAlloc(i) || canAlloc(i), s\"port${i} can not accept CounterFilter enq request, check if SIZE >= (Ldu stages - 2) * LduCnt\")\n");
        if (`STOP_COND_)
          xs_assert_v2(`__FILE__, `__LINE__);
      end
    end // always @(posedge)
  ...
  wire            _GEN_16 = _GEN_1[_GEN] == 4'h0;
  wire            _GEN_17 = _GEN_1[_GEN] == 4'h1;
  wire            _GEN_18 = _GEN_1[_GEN] == 4'h2;
  wire            _GEN_19 = _GEN_1[_GEN] == 4'h3;
  wire            _GEN_20 = _GEN_1[_GEN] == 4'h4;
  wire            _GEN_21 = _GEN_1[_GEN] == 4'h5;
  wire            _GEN_22 = _GEN_1[_GEN] == 4'h6;
  wire            _GEN_23 = _GEN_1[_GEN] == 4'h7;
  wire            _GEN_24 = _GEN_1[_GEN] == 4'h8;
  wire            _GEN_25 = _GEN_1[_GEN] == 4'h9;
  wire            _GEN_26 = _GEN_1[_GEN] == 4'hA;
  wire            _GEN_27 = _GEN_1[_GEN] == 4'hB;
  wire            _GEN_28 = canAlloc_2 & _GEN_1[index] == 4'h0;
  wire            _GEN_29 =
    _GEN_28 | (canAlloc_1 ? _GEN_16 | _GEN_4 | valids_0 : _GEN_4 | valids_0);
  wire            _GEN_30 = canAlloc_2 & _GEN_1[index] == 4'h1;
  wire            _GEN_31 =
    _GEN_30 | (canAlloc_1 ? _GEN_17 | _GEN_5 | valids_1 : _GEN_5 | valids_1);
  wire            _GEN_32 = canAlloc_2 & _GEN_1[index] == 4'h2;
  wire            _GEN_33 =
    _GEN_32 | (canAlloc_1 ? _GEN_18 | _GEN_6 | valids_2 : _GEN_6 | valids_2);
  wire            _GEN_34 = canAlloc_2 & _GEN_1[index] == 4'h3;
  wire            _GEN_35 =
    _GEN_34 | (canAlloc_1 ? _GEN_19 | _GEN_7 | valids_3 : _GEN_7 | valids_3);
  wire            _GEN_36 = canAlloc_2 & _GEN_1[index] == 4'h4;
  wire            _GEN_37 =
    _GEN_36 | (canAlloc_1 ? _GEN_20 | _GEN_8 | valids_4 : _GEN_8 | valids_4);
  wire            _GEN_38 = canAlloc_2 & _GEN_1[index] == 4'h5;
  wire            _GEN_39 =
    _GEN_38 | (canAlloc_1 ? _GEN_21 | _GEN_9 | valids_5 : _GEN_9 | valids_5);
  wire            _GEN_40 = canAlloc_2 & _GEN_1[index] == 4'h6;
  wire            _GEN_41 =
    _GEN_40 | (canAlloc_1 ? _GEN_22 | _GEN_10 | valids_6 : _GEN_10 | valids_6);
  wire            _GEN_42 = canAlloc_2 & _GEN_1[index] == 4'h7;
  wire            _GEN_43 =
    _GEN_42 | (canAlloc_1 ? _GEN_23 | _GEN_11 | valids_7 : _GEN_11 | valids_7);
  wire            _GEN_44 = canAlloc_2 & _GEN_1[index] == 4'h8;
  wire            _GEN_45 =
    _GEN_44 | (canAlloc_1 ? _GEN_24 | _GEN_12 | valids_8 : _GEN_12 | valids_8);
  wire            _GEN_46 = canAlloc_2 & _GEN_1[index] == 4'h9;
  wire            _GEN_47 =
    _GEN_46 | (canAlloc_1 ? _GEN_25 | _GEN_13 | valids_9 : _GEN_13 | valids_9);
  wire            _GEN_48 = canAlloc_2 & _GEN_1[index] == 4'hA;
  wire            _GEN_49 =
    _GEN_48 | (canAlloc_1 ? _GEN_26 | _GEN_14 | valids_10 : _GEN_14 | valids_10);
  wire            _GEN_50 = canAlloc_2 & _GEN_1[index] == 4'hB;
  wire            _GEN_51 =
    _GEN_50 | (canAlloc_1 ? _GEN_27 | _GEN_15 | valids_11 : _GEN_15 | valids_11);
  wire [2:0]      _GEN_52 = {canAlloc_2, canAlloc_1, canAlloc_0};
  wire [4:0]      _GEN_53 = {3'h0, _allocNum_T_2};
  wire [4:0]      enqPtrExt_0_new_value = 5'({1'h0, enqPtrExt_0_value} + _GEN_53);
  ...
  wire [4:0]      enqPtrExt_1_new_value = 5'({1'h0, enqPtrExt_1_value} + _GEN_53);
  ...
  wire [4:0]      enqPtrExt_2_new_value = 5'({1'h0, enqPtrExt_2_value} + _GEN_53);
  ...
  wire            _GEN_54 = (|last3CycleAlloc) & deqPtrExt_0_value == 4'h0;
  wire            _GEN_55 = (|last3CycleAlloc) & deqPtrExt_0_value == 4'h1;
  wire            _GEN_56 = (|last3CycleAlloc) & deqPtrExt_0_value == 4'h2;
  wire            _GEN_57 = (|last3CycleAlloc) & deqPtrExt_0_value == 4'h3;
  wire            _GEN_58 = (|last3CycleAlloc) & deqPtrExt_0_value == 4'h4;
  wire            _GEN_59 = (|last3CycleAlloc) & deqPtrExt_0_value == 4'h5;
  wire            _GEN_60 = (|last3CycleAlloc) & deqPtrExt_0_value == 4'h6;
  wire            _GEN_61 = (|last3CycleAlloc) & deqPtrExt_0_value == 4'h7;
  wire            _GEN_62 = (|last3CycleAlloc) & deqPtrExt_0_value == 4'h8;
  wire            _GEN_63 = (|last3CycleAlloc) & deqPtrExt_0_value == 4'h9;
  wire            _GEN_64 = (|last3CycleAlloc) & deqPtrExt_0_value == 4'hA;
  wire            _GEN_65 = (|last3CycleAlloc) & deqPtrExt_0_value == 4'hB;
  wire [4:0]      _GEN_66 = {3'h0, last3CycleAlloc};
  wire [4:0]      deqPtrExt_0_new_value = 5'({1'h0, deqPtrExt_0_value} + _GEN_66);
  ...
  wire [4:0]      deqPtrExt_1_new_value = 5'({1'h0, deqPtrExt_1_value} + _GEN_66);
  wire [5:0]      _deqPtrExt_1_diff_T_4 = 6'({1'h0, deqPtrExt_1_new_value} - 6'hC);
  wire [4:0]      deqPtrExt_2_new_value = 5'({1'h0, deqPtrExt_2_value} + _GEN_66);
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      valids_0 <=
        ...
        & (last3CycleAlloc[1]
             ? ~(deqPtrExt_1_value == 4'h0 | _GEN_54) & _GEN_29
             : ~_GEN_54 & _GEN_29);
      valids_1 <=
        ~((&last3CycleAlloc) & deqPtrExt_2_value == 4'h1)
        & (last3CycleAlloc[1]
             ? ~(deqPtrExt_1_value == 4'h1 | _GEN_55) & _GEN_31
             : ~_GEN_55 & _GEN_31);
      valids_2 <=
        ~((&last3CycleAlloc) & deqPtrExt_2_value == 4'h2)
        & (last3CycleAlloc[1]
             ? ~(deqPtrExt_1_value == 4'h2 | _GEN_56) & _GEN_33
             : ~_GEN_56 & _GEN_33);
      valids_3 <=
        ~((&last3CycleAlloc) & deqPtrExt_2_value == 4'h3)
        & (last3CycleAlloc[1]
             ? ~(deqPtrExt_1_value == 4'h3 | _GEN_57) & _GEN_35
             : ~_GEN_57 & _GEN_35);
      valids_4 <=
        ~((&last3CycleAlloc) & deqPtrExt_2_value == 4'h4)
        & (last3CycleAlloc[1]
             ? ~(deqPtrExt_1_value == 4'h4 | _GEN_58) & _GEN_37
             : ~_GEN_58 & _GEN_37);
      valids_5 <=
        ~((&last3CycleAlloc) & deqPtrExt_2_value == 4'h5)
        & (last3CycleAlloc[1]
             ? ~(deqPtrExt_1_value == 4'h5 | _GEN_59) & _GEN_39
             : ~_GEN_59 & _GEN_39);
      valids_6 <=
        ~((&last3CycleAlloc) & deqPtrExt_2_value == 4'h6)
        & (last3CycleAlloc[1]
             ? ~(deqPtrExt_1_value == 4'h6 | _GEN_60) & _GEN_41
             : ~_GEN_60 & _GEN_41);
      valids_7 <=
        ~((&last3CycleAlloc) & deqPtrExt_2_value == 4'h7)
        & (last3CycleAlloc[1]
             ? ~(deqPtrExt_1_value == 4'h7 | _GEN_61) & _GEN_43
             : ~_GEN_61 & _GEN_43);
      valids_8 <=
        ~((&last3CycleAlloc) & deqPtrExt_2_value == 4'h8)
        & (last3CycleAlloc[1]
             ? ~(deqPtrExt_1_value == 4'h8 | _GEN_62) & _GEN_45
             : ~_GEN_62 & _GEN_45);
      valids_9 <=
        ~((&last3CycleAlloc) & deqPtrExt_2_value == 4'h9)
        & (last3CycleAlloc[1]
             ? ~(deqPtrExt_1_value == 4'h9 | _GEN_63) & _GEN_47
             : ~_GEN_63 & _GEN_47);
      valids_10 <=
        ~((&last3CycleAlloc) & deqPtrExt_2_value == 4'hA)
        & (last3CycleAlloc[1]
             ? ~(deqPtrExt_1_value == 4'hA | _GEN_64) & _GEN_49
             : ~_GEN_64 & _GEN_49);
      valids_11 <=
        ~((&last3CycleAlloc) & deqPtrExt_2_value == 4'hB)
        & (last3CycleAlloc[1]
             ? ~(deqPtrExt_1_value == 4'hB | _GEN_65) & _GEN_51
             : ~_GEN_65 & _GEN_51);
      enqPtrExt_0_flag <= (|_GEN_52) & enqPtrExt_0_reverse_flag ^ enqPtrExt_0_flag;
      if (|_GEN_52) begin
        enqPtrExt_0_value <=
      ...
      enqPtrExt_1_flag <= (|_GEN_52) & enqPtrExt_1_reverse_flag ^ enqPtrExt_1_flag;
      enqPtrExt_2_flag <= (|_GEN_52) & enqPtrExt_2_reverse_flag ^ enqPtrExt_2_flag;
