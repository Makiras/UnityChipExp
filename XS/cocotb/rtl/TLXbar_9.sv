...
module TLXbar_9(
  ...
  wire        out_0_a_valid =
    beatsLeft
      ...
      : _out_0_a_valid_T | auto_in_2_a_valid | auto_in_3_a_valid;
  reg         beatsLeft_1;
  ...
  wire        _out_0_c_valid_T = auto_in_0_c_valid | auto_in_1_c_valid;
  reg         state_1_0;
  reg         state_1_1;
  reg         state_1_2;
  reg         state_1_3;
  ...
  wire        out_0_c_valid =
    beatsLeft_1
      ...
      : _out_0_c_valid_T | auto_in_2_c_valid | auto_in_3_c_valid;
  reg         beatsLeft_2;
  ...
  wire        _out_0_e_valid_T = auto_in_0_e_valid | auto_in_1_e_valid;
  `ifndef SYNTHESIS
    wire prefixOR_2 = winner_0 | winner_1;
    wire prefixOR_2_1 = winner_1_0 | winner_1_1;
    wire prefixOR_2_2 = winner_2_0 | winner_2_1;
    always @(posedge clock) begin
      if (~reset
          & ~((~winner_0 | ~winner_1) & (~prefixOR_2 | ~winner_2)
              & (~(prefixOR_2 | winner_2) | ~winner_3))) begin
      ...
      if (~reset
          & ~(~(_out_0_a_valid_T | auto_in_2_a_valid | auto_in_3_a_valid) | winner_0
              | winner_1 | winner_2 | winner_3)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (~reset
          & ~((~winner_1_0 | ~winner_1_1) & (~prefixOR_2_1 | ~winner_1_2)
              & (~(prefixOR_2_1 | winner_1_2) | ~winner_1_3))) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed\n    at Arbiter.scala:77 assert((prefixOR zip winner) map { case (p,w) => !p || !w } reduce {_ && _})\n");
        if (`STOP_COND_)
          xs_assert_v2(`__FILE__, `__LINE__);
      ...
      if (~reset
          & ~(~(_out_0_c_valid_T | auto_in_2_c_valid | auto_in_3_c_valid) | winner_1_0
              | winner_1_1 | winner_1_2 | winner_1_3)) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed\n    at Arbiter.scala:79 assert (!valids.reduce(_||_) || winner.reduce(_||_))\n");
        if (`STOP_COND_)
          xs_assert_v2(`__FILE__, `__LINE__);
      ...
      if (~reset
          & ~((~winner_2_0 | ~winner_2_1) & (~prefixOR_2_2 | ~winner_2_2)
              & (~(prefixOR_2_2 | winner_2_2) | ~winner_2_3))) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed\n    at Arbiter.scala:77 assert((prefixOR zip winner) map { case (p,w) => !p || !w } reduce {_ && _})\n");
        if (`STOP_COND_)
          xs_assert_v2(`__FILE__, `__LINE__);
      ...
      if (~reset
          & ~(~(_out_0_e_valid_T | auto_in_2_e_valid | auto_in_3_e_valid) | winner_2_0
              | winner_2_1 | winner_2_2 | winner_2_3)) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed\n    at Arbiter.scala:79 assert (!valids.reduce(_||_) || winner.reduce(_||_))\n");
        if (`STOP_COND_)
          xs_assert_v2(`__FILE__, `__LINE__);
  ...
  wire        out_0_e_valid =
    beatsLeft_2
      ...
      : _out_0_e_valid_T | auto_in_2_e_valid | auto_in_3_e_valid;
