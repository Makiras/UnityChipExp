...
module ExeUnit_7(
  ...
  wire        _Div_io_out_bits_perfDebugInfo_eliminatedMove;
  wire [63:0] _Div_io_out_bits_perfDebugInfo_renameTime;
  wire [63:0] _Div_io_out_bits_perfDebugInfo_dispatchTime;
  ...
  wire [63:0] _Div_io_out_bits_perfDebugInfo_writebackTime;
  wire [63:0] _Div_io_out_bits_perfDebugInfo_runahead_checkpoint_id;
  ...
  wire [63:0] _Fence_io_out_bits_res_data;
  ...
  wire [63:0] _Fence_io_out_bits_perfDebugInfo_writebackTime;
  ...
  wire [63:0] _csr_io_out_bits_perfDebugInfo_writebackTime;
  ...
  wire        clk_en_2_probe = _GEN | uncer_en_reg_2;
  reg         busy;
  ...
  wire [1:0]  _GEN_0 =
    2'({1'h0, _csr_io_out_valid}
       + 2'({1'h0, _Fence_io_out_valid} + {1'h0, _Div_io_out_valid}));
  wire        _GEN_1 = _GEN_0[1];
  wire [2:0]  _GEN_2 = {_Div_io_out_valid, _Fence_io_out_valid, _csr_io_out_valid};
  `ifndef SYNTHESIS
  ...
  wire [63:0] _GEN_3 = _csr_io_out_valid ? _csr_io_out_bits_res_data : 64'h0;
  wire [63:0] _GEN_4 = _Div_io_out_valid ? _Div_io_out_bits_res_data : 64'h0;
  ...
  CSR csr (
    ...
    .io_out_bits_perfDebugInfo_writebackTime
      (_csr_io_out_bits_perfDebugInfo_writebackTime),
  ...
  Fence Fence (
    ...
    .io_out_bits_res_data                             (_Fence_io_out_bits_res_data),
    .io_out_bits_perfDebugInfo_eliminatedMove
    ...
    .io_out_bits_perfDebugInfo_writebackTime
      (_Fence_io_out_bits_perfDebugInfo_writebackTime),
    .io_out_bits_perfDebugInfo_runahead_checkpoint_id
  ...
  DivUnit Div (
    ...
    .io_out_bits_ctrl_robIdx_value
      (_Div_io_out_bits_ctrl_robIdx_value),
    ...
    .io_out_bits_perfDebugInfo_eliminatedMove
      (_Div_io_out_bits_perfDebugInfo_eliminatedMove),
    .io_out_bits_perfDebugInfo_renameTime
      (_Div_io_out_bits_perfDebugInfo_renameTime),
    .io_out_bits_perfDebugInfo_dispatchTime
      (_Div_io_out_bits_perfDebugInfo_dispatchTime),
    .io_out_bits_perfDebugInfo_enqRsTime
      (_Div_io_out_bits_perfDebugInfo_enqRsTime),
    .io_out_bits_perfDebugInfo_selectTime
      (_Div_io_out_bits_perfDebugInfo_selectTime),
    .io_out_bits_perfDebugInfo_issueTime
      (_Div_io_out_bits_perfDebugInfo_issueTime),
    .io_out_bits_perfDebugInfo_writebackTime
      (_Div_io_out_bits_perfDebugInfo_writebackTime),
    .io_out_bits_perfDebugInfo_runahead_checkpoint_id
      (_Div_io_out_bits_perfDebugInfo_runahead_checkpoint_id),
    .io_out_bits_perfDebugInfo_tlbFirstReqTime
  ...
  DelayN_218 csr_io_csrio_exception_delay (
    .clock                         (clock),
  ...
  DelayN_219 csr_io_csrio_robDeqPtr_delay (
    .clock        (clock),
  ...
  assign io_out_bits_data_0 =
    _GEN_3 | (_Fence_io_out_valid ? _Fence_io_out_bits_res_data : 64'h0) | _GEN_4;
  assign io_out_bits_data_1 = _GEN_3 | _GEN_4;
  ...
  assign io_out_bits_debugInfo_eliminatedMove =
    _csr_io_out_valid & _csr_io_out_bits_perfDebugInfo_eliminatedMove
    | _Fence_io_out_valid & _Fence_io_out_bits_perfDebugInfo_eliminatedMove
    | _Div_io_out_valid & _Div_io_out_bits_perfDebugInfo_eliminatedMove;
  assign io_out_bits_debugInfo_renameTime =
    (_csr_io_out_valid ? _csr_io_out_bits_perfDebugInfo_renameTime : 64'h0)
    | (_Fence_io_out_valid ? _Fence_io_out_bits_perfDebugInfo_renameTime : 64'h0)
    | (_Div_io_out_valid ? _Div_io_out_bits_perfDebugInfo_renameTime : 64'h0);
  assign io_out_bits_debugInfo_dispatchTime =
    (_csr_io_out_valid ? _csr_io_out_bits_perfDebugInfo_dispatchTime : 64'h0)
    | (_Fence_io_out_valid ? _Fence_io_out_bits_perfDebugInfo_dispatchTime : 64'h0)
    | (_Div_io_out_valid ? _Div_io_out_bits_perfDebugInfo_dispatchTime : 64'h0);
  assign io_out_bits_debugInfo_enqRsTime =
    (_csr_io_out_valid ? _csr_io_out_bits_perfDebugInfo_enqRsTime : 64'h0)
    | (_Fence_io_out_valid ? _Fence_io_out_bits_perfDebugInfo_enqRsTime : 64'h0)
    | (_Div_io_out_valid ? _Div_io_out_bits_perfDebugInfo_enqRsTime : 64'h0);
  assign io_out_bits_debugInfo_selectTime =
    (_csr_io_out_valid ? _csr_io_out_bits_perfDebugInfo_selectTime : 64'h0)
    | (_Fence_io_out_valid ? _Fence_io_out_bits_perfDebugInfo_selectTime : 64'h0)
    | (_Div_io_out_valid ? _Div_io_out_bits_perfDebugInfo_selectTime : 64'h0);
  assign io_out_bits_debugInfo_issueTime =
    (_csr_io_out_valid ? _csr_io_out_bits_perfDebugInfo_issueTime : 64'h0)
    | (_Fence_io_out_valid ? _Fence_io_out_bits_perfDebugInfo_issueTime : 64'h0)
    | (_Div_io_out_valid ? _Div_io_out_bits_perfDebugInfo_issueTime : 64'h0);
  assign io_out_bits_debugInfo_writebackTime =
    (_csr_io_out_valid ? _csr_io_out_bits_perfDebugInfo_writebackTime : 64'h0)
    | (_Fence_io_out_valid ? _Fence_io_out_bits_perfDebugInfo_writebackTime : 64'h0)
    | (_Div_io_out_valid ? _Div_io_out_bits_perfDebugInfo_writebackTime : 64'h0);
  assign io_out_bits_debugInfo_runahead_checkpoint_id =
    (_csr_io_out_valid ? _csr_io_out_bits_perfDebugInfo_runahead_checkpoint_id : 64'h0)
    | (_Fence_io_out_valid
         ? _Fence_io_out_bits_perfDebugInfo_runahead_checkpoint_id
         : 64'h0)
    | (_Div_io_out_valid ? _Div_io_out_bits_perfDebugInfo_runahead_checkpoint_id : 64'h0);
  assign io_out_bits_debugInfo_tlbFirstReqTime =
    (_csr_io_out_valid ? _csr_io_out_bits_perfDebugInfo_tlbFirstReqTime : 64'h0)
    | (_Fence_io_out_valid ? _Fence_io_out_bits_perfDebugInfo_tlbFirstReqTime : 64'h0)
    | (_Div_io_out_valid ? _Div_io_out_bits_perfDebugInfo_tlbFirstReqTime : 64'h0);
  assign io_out_bits_debugInfo_tlbRespTime =
    (_csr_io_out_valid ? _csr_io_out_bits_perfDebugInfo_tlbRespTime : 64'h0)
    | (_Fence_io_out_valid ? _Fence_io_out_bits_perfDebugInfo_tlbRespTime : 64'h0)
    | (_Div_io_out_valid ? _Div_io_out_bits_perfDebugInfo_tlbRespTime : 64'h0);
