...
module AXI4ToTL(
  ...
  `ifndef SYNTHESIS
    ...
    always @(posedge clock) begin
      if (~reset & ~(~auto_in_ar_valid | _r_size1_T_1[22:8] == ~(_GEN_2[14:0]))) begin
      ...
      if (~reset & ~(~auto_in_aw_valid | _w_size1_T_1[22:8] == ~(_GEN_3[14:0]))) begin
        if (`ASSERT_VERBOSE_COND_)
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      if (_GEN_5 & ~_q_b_deq_q_io_deq_bits_id)
