...
module FDivSqrt(
  ...
  wire        _GEN_0 = _fdiv_io_start_ready_o | _io_out_bits_perfDebugInfo_T;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        outCtrl_r_fpu_fmt = _RANDOM[5'h1][1:0];
        io_out_bits_ctrl_robIdx_r_flag = _RANDOM[5'h7][5];
        io_out_bits_ctrl_robIdx_r_value = _RANDOM[5'h7][13:6];
        io_out_bits_ctrl_pdest_r = _RANDOM[5'h7][21:14];
        io_out_bits_ctrl_fpWen_r = _RANDOM[5'h7][22];
        io_out_bits_ctrl_fpu_r_wflags = _RANDOM[5'h7][25];
        io_out_bits_perfDebugInfo_r_eliminatedMove = _RANDOM[5'h8][1];
        io_out_bits_perfDebugInfo_r_renameTime =
          {_RANDOM[5'h8][31:2], _RANDOM[5'h9], _RANDOM[5'hA][1:0]};
        io_out_bits_perfDebugInfo_r_dispatchTime =
          {_RANDOM[5'hA][31:2], _RANDOM[5'hB], _RANDOM[5'hC][1:0]};
        io_out_bits_perfDebugInfo_r_enqRsTime =
          {_RANDOM[5'hC][31:2], _RANDOM[5'hD], _RANDOM[5'hE][1:0]};
        io_out_bits_perfDebugInfo_r_selectTime =
          {_RANDOM[5'hE][31:2], _RANDOM[5'hF], _RANDOM[5'h10][1:0]};
        io_out_bits_perfDebugInfo_r_issueTime =
          {_RANDOM[5'h10][31:2], _RANDOM[5'h11], _RANDOM[5'h12][1:0]};
        io_out_bits_perfDebugInfo_r_writebackTime =
          {_RANDOM[5'h12][31:2], _RANDOM[5'h13], _RANDOM[5'h14][1:0]};
        io_out_bits_perfDebugInfo_r_runahead_checkpoint_id =
          {_RANDOM[5'h14][31:2], _RANDOM[5'h15], _RANDOM[5'h16][1:0]};
        io_out_bits_perfDebugInfo_r_tlbFirstReqTime =
          {_RANDOM[5'h16][31:2], _RANDOM[5'h17], _RANDOM[5'h18][1:0]};
        io_out_bits_perfDebugInfo_r_tlbRespTime =
          {_RANDOM[5'h18][31:2], _RANDOM[5'h19], _RANDOM[5'h1A][1:0]};
      `endif // RANDOMIZE_REG_INIT
    end // initial
