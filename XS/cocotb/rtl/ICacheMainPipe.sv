...
module ICacheMainPipe(
  ...
  wire        x3_probe = s0_can_go & io_fetch_req_valid;
  ...
  wire [6:0]  _GEN = {1'h0, s2_req_vaddr_0[5:0]};
  wire [6:0]  _s2_bankSel_bankIdxHigh_T_1 = 7'(_GEN + 7'h20);
  wire        s2_bankSel_bankSel_0 = s2_req_vaddr_0[5:3] == 3'h0;
  wire        s2_bankSel_bankSel_1 =
    s2_bankSel_bankIdxLow < 4'h2 & (|(_s2_bankSel_bankIdxHigh_T_1[6:3]));
  wire        s2_bankSel_bankSel_2 =
    s2_bankSel_bankIdxLow < 4'h3 & (|(_s2_bankSel_bankIdxHigh_T_1[6:4]));
  wire        s2_bankSel_bankSel_3 =
    s2_bankSel_bankIdxLow < 4'h4 & _s2_bankSel_bankIdxHigh_T_1[6:3] > 4'h2;
  wire        s2_bankSel_bankSel_4 =
    s2_bankSel_bankIdxLow < 4'h5 & (|(_s2_bankSel_bankIdxHigh_T_1[6:5]));
  wire        s2_bankSel_bankSel_5 =
    s2_bankSel_bankIdxLow < 4'h6 & _s2_bankSel_bankIdxHigh_T_1[6:3] > 4'h4;
  wire        s2_bankSel_bankSel_6 =
    s2_bankSel_bankIdxLow < 4'h7 & _s2_bankSel_bankIdxHigh_T_1[6:3] > 4'h5;
  wire        s2_bankSel_bankSel_7 = _s2_bankSel_bankIdxHigh_T_1[6:3] > 4'h6;
  wire        s2_bankSel_bankSel_8 =
    s2_bankSel_bankIdxLow < 4'h9 & _s2_bankSel_bankIdxHigh_T_1[6];
  wire        s2_bankSel_bankSel_9 =
    s2_bankSel_bankIdxLow < 4'hA & _s2_bankSel_bankIdxHigh_T_1[6:3] > 4'h8;
  wire        s2_bankSel_bankSel_10 =
  ...
  reg         REG;
  wire        _GEN_0 = s2_data_corrupt_0 & REG;
  reg         REG_1;
  wire        _GEN_1 = s2_data_corrupt_1 & REG_1;
  reg         REG_2;
  wire        _GEN_2 = s2_meta_corrupt_0 & REG_2;
  reg         REG_3;
  wire        _GEN_3 = s2_meta_corrupt_1 & REG_3;
  reg         s2_l2_corrupt_0;
  reg         s2_l2_corrupt_1;
  ...
  wire        _GEN_4 = _toMSHRArbiter_io_out_valid & ~io_mshr_req_ready;
  wire        io_fetch_topdownIcacheMiss_0 = s2_should_fetch_0 | s2_should_fetch_1;
  wire [1:0]  s2_exception_out_0 =
    (|s2_exception_0) ? s2_exception_0 : {2{s2_l2_corrupt_0}};
  wire [1:0]  io_fetch_resp_bits_exception_1_0 =
    s2_doubleline ? ((|s2_exception_1) ? s2_exception_1 : {2{s2_l2_corrupt_1}}) : 2'h0;
  wire        io_fetch_resp_bits_pmp_mmio_1_0 = s2_doubleline & s2_pmp_mmio_1;
  wire [1:0]  io_fetch_resp_bits_itlb_pbmt_1_0 = s2_doubleline ? s2_itlb_pbmt_1 : 2'h0;
  assign s2_ready = ~io_fetch_topdownIcacheMiss_0 & ~io_respStall | ~s2_valid;
  wire        s2_fire =
    s2_valid & ~io_fetch_topdownIcacheMiss_0 & ~io_respStall & ~io_flush;
  reg         REG_4;
  reg  [47:0] io_errors_0_bits_paddr_REG;
  reg         REG_5;
  reg  [47:0] io_errors_1_bits_paddr_REG;
  wire        _GEN_5 = s2_valid & io_fetch_topdownIcacheMiss_0;
  wire        _GEN_6 = io_fetch_req_valid & ~s0_fire;
  wire        discards_0 =
    (|s2_exception_out_0) | s2_pmp_mmio_0 | s2_itlb_pbmt_0 == 2'h1
    | s2_itlb_pbmt_0 == 2'h2;
  wire        discards_1 =
    (|io_fetch_resp_bits_exception_1_0) | io_fetch_resp_bits_pmp_mmio_1_0
    | io_fetch_resp_bits_itlb_pbmt_1_0 == 2'h1 | io_fetch_resp_bits_itlb_pbmt_1_0 == 2'h2;
  wire [7:0]  diffMainPipeOut_coreid = {2'h0, io_hartId};
  wire [3:0]  bankSel_bankIdxLow = {1'h0, s2_req_vaddr_0[5:3]};
  wire [6:0]  _bankSel_bankIdxHigh_T_1 = 7'(_GEN + 7'h20);
  wire        bankSel_bankSel_0 = s2_req_vaddr_0[5:3] == 3'h0;
  wire        bankSel_bankSel_8 = bankSel_bankIdxLow < 4'h9 & _bankSel_bankIdxHigh_T_1[6];
  wire        diffMainPipeOut_valid =
    s2_fire & (bankSel_bankSel_0 | bankSel_bankSel_8)
    & ((|(s2_req_vaddr_0[5:3])) ? ~discards_1 : ~discards_0);
  wire [3:0]  bankSel_bankIdxLow_1 = {1'h0, s2_req_vaddr_0[5:3]};
  wire [6:0]  _bankSel_bankIdxHigh_T_4 = 7'(_GEN + 7'h20);
  wire        bankSel_bankSel_1_1 =
    bankSel_bankIdxLow_1 < 4'h2 & (|(_bankSel_bankIdxHigh_T_4[6:3]));
  wire        bankSel_bankSel_1_9 =
    bankSel_bankIdxLow_1 < 4'hA & _bankSel_bankIdxHigh_T_4[6:3] > 4'h8;
  wire        diffMainPipeOut_1_valid =
    s2_fire & (bankSel_bankSel_1_1 | bankSel_bankSel_1_9)
    & ((|(s2_req_vaddr_0[5:4])) ? ~discards_1 : ~discards_0);
  wire [47:0] _GEN_7 = {s2_req_ptags_1, s2_req_vaddr_1[11:6], 6'h0};
  wire [47:0] _GEN_8 = {s2_req_ptags_0, s2_req_vaddr_0[11:6], 6'h0};
  wire [3:0]  bankSel_bankIdxLow_2 = {1'h0, s2_req_vaddr_0[5:3]};
  wire [6:0]  _bankSel_bankIdxHigh_T_7 = 7'(_GEN + 7'h20);
  wire        bankSel_bankSel_2_2 =
    bankSel_bankIdxLow_2 < 4'h3 & (|(_bankSel_bankIdxHigh_T_7[6:4]));
  wire        bankSel_bankSel_2_10 =
    bankSel_bankIdxLow_2 < 4'hB & _bankSel_bankIdxHigh_T_7[6:3] > 4'h9;
  wire        lineSel_2_2 = s2_req_vaddr_0[5:3] > 3'h2;
  wire        diffMainPipeOut_2_valid =
    s2_fire & (bankSel_bankSel_2_2 | bankSel_bankSel_2_10)
    & (lineSel_2_2 ? ~discards_1 : ~discards_0);
  wire [3:0]  bankSel_bankIdxLow_3 = {1'h0, s2_req_vaddr_0[5:3]};
  wire [6:0]  _bankSel_bankIdxHigh_T_10 = 7'(_GEN + 7'h20);
  wire        bankSel_bankSel_3_3 =
    bankSel_bankIdxLow_3 < 4'h4 & _bankSel_bankIdxHigh_T_10[6:3] > 4'h2;
  wire        bankSel_bankSel_3_11 = _bankSel_bankIdxHigh_T_10[6:3] > 4'hA;
  wire        diffMainPipeOut_3_valid =
    s2_fire & (bankSel_bankSel_3_3 | bankSel_bankSel_3_11)
    & (s2_req_vaddr_0[5] ? ~discards_1 : ~discards_0);
  wire [3:0]  bankSel_bankIdxLow_4 = {1'h0, s2_req_vaddr_0[5:3]};
  wire [6:0]  _bankSel_bankIdxHigh_T_13 = 7'(_GEN + 7'h20);
  wire        bankSel_bankSel_4_4 =
    bankSel_bankIdxLow_4 < 4'h5 & (|(_bankSel_bankIdxHigh_T_13[6:5]));
  wire        bankSel_bankSel_4_12 =
    bankSel_bankIdxLow_4 < 4'hD & _bankSel_bankIdxHigh_T_13[6:3] > 4'hB;
  wire        lineSel_4_4 = s2_req_vaddr_0[5:3] > 3'h4;
  wire        diffMainPipeOut_4_valid =
    s2_fire & (bankSel_bankSel_4_4 | bankSel_bankSel_4_12)
    & (lineSel_4_4 ? ~discards_1 : ~discards_0);
  wire [3:0]  bankSel_bankIdxLow_5 = {1'h0, s2_req_vaddr_0[5:3]};
  wire [6:0]  _bankSel_bankIdxHigh_T_16 = 7'(_GEN + 7'h20);
  wire        bankSel_bankSel_5_5 =
    bankSel_bankIdxLow_5 < 4'h6 & _bankSel_bankIdxHigh_T_16[6:3] > 4'h4;
  wire        bankSel_bankSel_5_13 = _bankSel_bankIdxHigh_T_16[6:3] > 4'hC;
  wire        lineSel_5_5 = s2_req_vaddr_0[5:3] > 3'h5;
  wire        diffMainPipeOut_5_valid =
    s2_fire & (bankSel_bankSel_5_5 | bankSel_bankSel_5_13)
    & (lineSel_5_5 ? ~discards_1 : ~discards_0);
  wire [3:0]  bankSel_bankIdxLow_6 = {1'h0, s2_req_vaddr_0[5:3]};
  wire [6:0]  _bankSel_bankIdxHigh_T_19 = 7'(_GEN + 7'h20);
  wire        bankSel_bankSel_6_6 =
    bankSel_bankIdxLow_6 < 4'h7 & _bankSel_bankIdxHigh_T_19[6:3] > 4'h5;
  wire        bankSel_bankSel_6_14 = _bankSel_bankIdxHigh_T_19[6:3] > 4'hD;
  wire        diffMainPipeOut_6_valid =
    s2_fire & (bankSel_bankSel_6_6 | bankSel_bankSel_6_14)
    & ((&(s2_req_vaddr_0[5:3])) ? ~discards_1 : ~discards_0);
  wire [6:0]  _bankSel_bankIdxHigh_T_22 = 7'(_GEN + 7'h20);
  wire        bankSel_bankSel_7_7 = _bankSel_bankIdxHigh_T_22[6:3] > 4'h6;
  `ifndef SYNTHESIS
    ...
    wire       bankSel_bankSel_1_0 = s2_req_vaddr_0[5:3] == 3'h0;
    wire       bankSel_bankSel_1_2 =
      bankSel_bankIdxLow_1 < 4'h3 & (|(_bankSel_bankIdxHigh_T_4[6:4]));
    wire       bankSel_bankSel_1_3 =
      bankSel_bankIdxLow_1 < 4'h4 & _bankSel_bankIdxHigh_T_4[6:3] > 4'h2;
    wire       bankSel_bankSel_1_4 =
      bankSel_bankIdxLow_1 < 4'h5 & (|(_bankSel_bankIdxHigh_T_4[6:5]));
    wire       bankSel_bankSel_1_5 =
      bankSel_bankIdxLow_1 < 4'h6 & _bankSel_bankIdxHigh_T_4[6:3] > 4'h4;
    wire       bankSel_bankSel_1_6 =
      bankSel_bankIdxLow_1 < 4'h7 & _bankSel_bankIdxHigh_T_4[6:3] > 4'h5;
    wire       bankSel_bankSel_1_7 = _bankSel_bankIdxHigh_T_4[6:3] > 4'h6;
    wire       bankSel_bankSel_1_8 =
      bankSel_bankIdxLow_1 < 4'h9 & _bankSel_bankIdxHigh_T_4[6];
    wire       bankSel_bankSel_1_10 =
      bankSel_bankIdxLow_1 < 4'hB & _bankSel_bankIdxHigh_T_4[6:3] > 4'h9;
    wire       bankSel_bankSel_1_11 = _bankSel_bankIdxHigh_T_4[6:3] > 4'hA;
    wire       bankSel_bankSel_1_12 =
      bankSel_bankIdxLow_1 < 4'hD & _bankSel_bankIdxHigh_T_4[6:3] > 4'hB;
    wire       bankSel_bankSel_1_13 = _bankSel_bankIdxHigh_T_4[6:3] > 4'hC;
    wire       bankSel_bankSel_1_14 = _bankSel_bankIdxHigh_T_4[6:3] > 4'hD;
    wire       bankSel_bankSel_2_0 = s2_req_vaddr_0[5:3] == 3'h0;
    wire       bankSel_bankSel_2_1 =
      bankSel_bankIdxLow_2 < 4'h2 & (|(_bankSel_bankIdxHigh_T_7[6:3]));
    wire       bankSel_bankSel_2_3 =
      bankSel_bankIdxLow_2 < 4'h4 & _bankSel_bankIdxHigh_T_7[6:3] > 4'h2;
    wire       bankSel_bankSel_2_4 =
      bankSel_bankIdxLow_2 < 4'h5 & (|(_bankSel_bankIdxHigh_T_7[6:5]));
    wire       bankSel_bankSel_2_5 =
      bankSel_bankIdxLow_2 < 4'h6 & _bankSel_bankIdxHigh_T_7[6:3] > 4'h4;
    wire       bankSel_bankSel_2_6 =
      bankSel_bankIdxLow_2 < 4'h7 & _bankSel_bankIdxHigh_T_7[6:3] > 4'h5;
    wire       bankSel_bankSel_2_7 = _bankSel_bankIdxHigh_T_7[6:3] > 4'h6;
    wire       bankSel_bankSel_2_8 =
      bankSel_bankIdxLow_2 < 4'h9 & _bankSel_bankIdxHigh_T_7[6];
    wire       bankSel_bankSel_2_9 =
      bankSel_bankIdxLow_2 < 4'hA & _bankSel_bankIdxHigh_T_7[6:3] > 4'h8;
    wire       bankSel_bankSel_2_11 = _bankSel_bankIdxHigh_T_7[6:3] > 4'hA;
    wire       bankSel_bankSel_2_12 =
      bankSel_bankIdxLow_2 < 4'hD & _bankSel_bankIdxHigh_T_7[6:3] > 4'hB;
    wire       bankSel_bankSel_2_13 = _bankSel_bankIdxHigh_T_7[6:3] > 4'hC;
    wire       bankSel_bankSel_2_14 = _bankSel_bankIdxHigh_T_7[6:3] > 4'hD;
    wire       bankSel_bankSel_3_0 = s2_req_vaddr_0[5:3] == 3'h0;
    wire       bankSel_bankSel_3_1 =
      bankSel_bankIdxLow_3 < 4'h2 & (|(_bankSel_bankIdxHigh_T_10[6:3]));
    wire       bankSel_bankSel_3_2 =
      bankSel_bankIdxLow_3 < 4'h3 & (|(_bankSel_bankIdxHigh_T_10[6:4]));
    wire       bankSel_bankSel_3_4 =
      bankSel_bankIdxLow_3 < 4'h5 & (|(_bankSel_bankIdxHigh_T_10[6:5]));
    wire       bankSel_bankSel_3_5 =
      bankSel_bankIdxLow_3 < 4'h6 & _bankSel_bankIdxHigh_T_10[6:3] > 4'h4;
    wire       bankSel_bankSel_3_6 =
      bankSel_bankIdxLow_3 < 4'h7 & _bankSel_bankIdxHigh_T_10[6:3] > 4'h5;
    wire       bankSel_bankSel_3_7 = _bankSel_bankIdxHigh_T_10[6:3] > 4'h6;
    wire       bankSel_bankSel_3_8 =
      bankSel_bankIdxLow_3 < 4'h9 & _bankSel_bankIdxHigh_T_10[6];
    wire       bankSel_bankSel_3_9 =
      bankSel_bankIdxLow_3 < 4'hA & _bankSel_bankIdxHigh_T_10[6:3] > 4'h8;
    wire       bankSel_bankSel_3_10 =
      bankSel_bankIdxLow_3 < 4'hB & _bankSel_bankIdxHigh_T_10[6:3] > 4'h9;
    wire       bankSel_bankSel_3_12 =
      bankSel_bankIdxLow_3 < 4'hD & _bankSel_bankIdxHigh_T_10[6:3] > 4'hB;
    wire       bankSel_bankSel_3_13 = _bankSel_bankIdxHigh_T_10[6:3] > 4'hC;
    wire       bankSel_bankSel_3_14 = _bankSel_bankIdxHigh_T_10[6:3] > 4'hD;
    wire       bankSel_bankSel_4_0 = s2_req_vaddr_0[5:3] == 3'h0;
    wire       bankSel_bankSel_4_1 =
      bankSel_bankIdxLow_4 < 4'h2 & (|(_bankSel_bankIdxHigh_T_13[6:3]));
    wire       bankSel_bankSel_4_2 =
      bankSel_bankIdxLow_4 < 4'h3 & (|(_bankSel_bankIdxHigh_T_13[6:4]));
    wire       bankSel_bankSel_4_3 =
      bankSel_bankIdxLow_4 < 4'h4 & _bankSel_bankIdxHigh_T_13[6:3] > 4'h2;
    wire       bankSel_bankSel_4_5 =
      bankSel_bankIdxLow_4 < 4'h6 & _bankSel_bankIdxHigh_T_13[6:3] > 4'h4;
    wire       bankSel_bankSel_4_6 =
      bankSel_bankIdxLow_4 < 4'h7 & _bankSel_bankIdxHigh_T_13[6:3] > 4'h5;
    wire       bankSel_bankSel_4_7 = _bankSel_bankIdxHigh_T_13[6:3] > 4'h6;
    wire       bankSel_bankSel_4_8 =
      bankSel_bankIdxLow_4 < 4'h9 & _bankSel_bankIdxHigh_T_13[6];
    wire       bankSel_bankSel_4_9 =
      bankSel_bankIdxLow_4 < 4'hA & _bankSel_bankIdxHigh_T_13[6:3] > 4'h8;
    wire       bankSel_bankSel_4_10 =
      bankSel_bankIdxLow_4 < 4'hB & _bankSel_bankIdxHigh_T_13[6:3] > 4'h9;
    wire       bankSel_bankSel_4_11 = _bankSel_bankIdxHigh_T_13[6:3] > 4'hA;
    wire       bankSel_bankSel_4_13 = _bankSel_bankIdxHigh_T_13[6:3] > 4'hC;
    wire       bankSel_bankSel_4_14 = _bankSel_bankIdxHigh_T_13[6:3] > 4'hD;
    wire       bankSel_bankSel_5_0 = s2_req_vaddr_0[5:3] == 3'h0;
    wire       bankSel_bankSel_5_1 =
      bankSel_bankIdxLow_5 < 4'h2 & (|(_bankSel_bankIdxHigh_T_16[6:3]));
    wire       bankSel_bankSel_5_2 =
      bankSel_bankIdxLow_5 < 4'h3 & (|(_bankSel_bankIdxHigh_T_16[6:4]));
    wire       bankSel_bankSel_5_3 =
      bankSel_bankIdxLow_5 < 4'h4 & _bankSel_bankIdxHigh_T_16[6:3] > 4'h2;
    wire       bankSel_bankSel_5_4 =
      bankSel_bankIdxLow_5 < 4'h5 & (|(_bankSel_bankIdxHigh_T_16[6:5]));
    wire       bankSel_bankSel_5_6 =
      bankSel_bankIdxLow_5 < 4'h7 & _bankSel_bankIdxHigh_T_16[6:3] > 4'h5;
    wire       bankSel_bankSel_5_7 = _bankSel_bankIdxHigh_T_16[6:3] > 4'h6;
    wire       bankSel_bankSel_5_8 =
      bankSel_bankIdxLow_5 < 4'h9 & _bankSel_bankIdxHigh_T_16[6];
    wire       bankSel_bankSel_5_9 =
      bankSel_bankIdxLow_5 < 4'hA & _bankSel_bankIdxHigh_T_16[6:3] > 4'h8;
    wire       bankSel_bankSel_5_10 =
      bankSel_bankIdxLow_5 < 4'hB & _bankSel_bankIdxHigh_T_16[6:3] > 4'h9;
    wire       bankSel_bankSel_5_11 = _bankSel_bankIdxHigh_T_16[6:3] > 4'hA;
    wire       bankSel_bankSel_5_12 =
      bankSel_bankIdxLow_5 < 4'hD & _bankSel_bankIdxHigh_T_16[6:3] > 4'hB;
    wire       bankSel_bankSel_5_14 = _bankSel_bankIdxHigh_T_16[6:3] > 4'hD;
    wire       bankSel_bankSel_6_0 = s2_req_vaddr_0[5:3] == 3'h0;
    wire       bankSel_bankSel_6_1 =
      bankSel_bankIdxLow_6 < 4'h2 & (|(_bankSel_bankIdxHigh_T_19[6:3]));
    wire       bankSel_bankSel_6_2 =
      bankSel_bankIdxLow_6 < 4'h3 & (|(_bankSel_bankIdxHigh_T_19[6:4]));
    wire       bankSel_bankSel_6_3 =
      bankSel_bankIdxLow_6 < 4'h4 & _bankSel_bankIdxHigh_T_19[6:3] > 4'h2;
    wire       bankSel_bankSel_6_4 =
      bankSel_bankIdxLow_6 < 4'h5 & (|(_bankSel_bankIdxHigh_T_19[6:5]));
    wire       bankSel_bankSel_6_5 =
      bankSel_bankIdxLow_6 < 4'h6 & _bankSel_bankIdxHigh_T_19[6:3] > 4'h4;
    wire       bankSel_bankSel_6_7 = _bankSel_bankIdxHigh_T_19[6:3] > 4'h6;
    wire       bankSel_bankSel_6_8 =
      bankSel_bankIdxLow_6 < 4'h9 & _bankSel_bankIdxHigh_T_19[6];
    wire       bankSel_bankSel_6_9 =
      bankSel_bankIdxLow_6 < 4'hA & _bankSel_bankIdxHigh_T_19[6:3] > 4'h8;
    wire       bankSel_bankSel_6_10 =
      bankSel_bankIdxLow_6 < 4'hB & _bankSel_bankIdxHigh_T_19[6:3] > 4'h9;
    wire       bankSel_bankSel_6_11 = _bankSel_bankIdxHigh_T_19[6:3] > 4'hA;
    wire       bankSel_bankSel_6_12 =
      bankSel_bankIdxLow_6 < 4'hD & _bankSel_bankIdxHigh_T_19[6:3] > 4'hB;
    wire       bankSel_bankSel_6_13 = _bankSel_bankIdxHigh_T_19[6:3] > 4'hC;
    wire [3:0] bankSel_bankIdxLow_7 = {1'h0, s2_req_vaddr_0[5:3]};
    wire       bankSel_bankSel_7_0 = s2_req_vaddr_0[5:3] == 3'h0;
    wire       bankSel_bankSel_7_1 =
      bankSel_bankIdxLow_7 < 4'h2 & (|(_bankSel_bankIdxHigh_T_22[6:3]));
    wire       bankSel_bankSel_7_2 =
      bankSel_bankIdxLow_7 < 4'h3 & (|(_bankSel_bankIdxHigh_T_22[6:4]));
    wire       bankSel_bankSel_7_3 =
      bankSel_bankIdxLow_7 < 4'h4 & _bankSel_bankIdxHigh_T_22[6:3] > 4'h2;
    wire       bankSel_bankSel_7_4 =
      bankSel_bankIdxLow_7 < 4'h5 & (|(_bankSel_bankIdxHigh_T_22[6:5]));
    wire       bankSel_bankSel_7_5 =
      bankSel_bankIdxLow_7 < 4'h6 & _bankSel_bankIdxHigh_T_22[6:3] > 4'h4;
    wire       bankSel_bankSel_7_6 =
      bankSel_bankIdxLow_7 < 4'h7 & _bankSel_bankIdxHigh_T_22[6:3] > 4'h5;
    wire       bankSel_bankSel_7_8 =
      bankSel_bankIdxLow_7 < 4'h9 & _bankSel_bankIdxHigh_T_22[6];
    wire       bankSel_bankSel_7_9 =
      bankSel_bankIdxLow_7 < 4'hA & _bankSel_bankIdxHigh_T_22[6:3] > 4'h8;
    wire       bankSel_bankSel_7_10 =
      bankSel_bankIdxLow_7 < 4'hB & _bankSel_bankIdxHigh_T_22[6:3] > 4'h9;
    wire       bankSel_bankSel_7_11 = _bankSel_bankIdxHigh_T_22[6:3] > 4'hA;
    wire       bankSel_bankSel_7_12 =
      bankSel_bankIdxLow_7 < 4'hD & _bankSel_bankIdxHigh_T_22[6:3] > 4'hB;
    wire       bankSel_bankSel_7_13 = _bankSel_bankIdxHigh_T_22[6:3] > 4'hC;
    wire       bankSel_bankSel_7_14 = _bankSel_bankIdxHigh_T_22[6:3] > 4'hD;
    always @(posedge clock) begin
      if (s0_fire & ~reset
          & ~(io_fetch_req_bits_pcMemRead_4_startAddr[13:6] == io_wayLookupRead_bits_entry_vSetIdx_0
              & io_fetch_req_bits_pcMemRead_4_nextlineStart[13:6] == io_wayLookupRead_bits_entry_vSetIdx_1)) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed: vSetIdx from ftq and wayLookup mismatch! vaddr=0x%x ftq: vSet0=0x%x vSet1=0x%x wayLookup: vSet0=0x%x vSet1=0x%x\n    at ICacheMainPipe.scala:199 assert(\n",
                 io_fetch_req_bits_pcMemRead_4_startAddr,
                 io_fetch_req_bits_pcMemRead_4_startAddr[13:6],
                 io_fetch_req_bits_pcMemRead_4_nextlineStart[13:6],
      ...
      if (~reset
          & ~(~s2_valid
              | 5'({1'h0,
                    4'({1'h0,
                        3'({1'h0,
                            2'({1'h0, s2_bankSel_bankSel_0}
                               + {1'h0, s2_bankSel_bankSel_1})}
                           + {1'h0,
                              2'({1'h0, s2_bankSel_bankSel_2}
                                 + {1'h0, s2_bankSel_bankSel_3})})}
                       + {1'h0,
                          3'({1'h0,
                              2'({1'h0, s2_bankSel_bankSel_4}
                                 + {1'h0, s2_bankSel_bankSel_5})}
                             + {1'h0,
                                2'({1'h0, s2_bankSel_bankSel_6}
                                   + {1'h0, s2_bankSel_bankSel_7})})})}
                   + {1'h0,
                      4'({1'h0,
                          3'({1'h0,
                              2'({1'h0, s2_bankSel_bankSel_8}
                                 + {1'h0, s2_bankSel_bankSel_9})}
                             + {1'h0,
                                2'({1'h0, s2_bankSel_bankSel_10}
                                   + {1'h0, s2_bankSel_bankSel_11})})}
                         + {1'h0,
                            3'({1'h0,
                                2'({1'h0, s2_bankSel_bankSel_12}
                                   + {1'h0, s2_bankSel_bankSel_13})}
                               + {1'h0,
                                  2'({1'h0, s2_bankSel_bankSel_14}
                                     + {1'h0,
                                        &(_s2_bankSel_bankIdxHigh_T_1[6:3])})})})}) == 5'h5)) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed: The number of bank visits must be %d, but bankSel=0x%x\n    at ICache.scala:156 assert(\n",
                 3'h5,
                 {&(_s2_bankSel_bankIdxHigh_T_1[6:3]),
                  s2_bankSel_bankSel_14,
                  s2_bankSel_bankSel_13,
                  s2_bankSel_bankSel_12,
                  s2_bankSel_bankSel_11,
                  s2_bankSel_bankSel_10,
                  s2_bankSel_bankSel_9,
                  s2_bankSel_bankSel_8,
                  s2_bankSel_bankSel_7,
                  s2_bankSel_bankSel_6,
                  s2_bankSel_bankSel_5,
                  s2_bankSel_bankSel_4,
                  s2_bankSel_bankSel_3,
                  s2_bankSel_bankSel_2,
                  s2_bankSel_bankSel_1,
                  s2_bankSel_bankSel_0});
        if (`STOP_COND_)
          xs_assert_v2(`__FILE__, `__LINE__);
      end
      if (~reset
          & ~(~s2_valid
              | 5'({1'h0,
                    4'({1'h0,
                        3'({1'h0,
                            2'({1'h0, bankSel_bankSel_0} + {1'h0, bankSel_bankSel_1})}
                           + {1'h0,
                              2'({1'h0, bankSel_bankSel_2} + {1'h0, bankSel_bankSel_3})})}
                       + {1'h0,
                          3'({1'h0,
                              2'({1'h0, bankSel_bankSel_4} + {1'h0, bankSel_bankSel_5})}
                             + {1'h0,
                                2'({1'h0, bankSel_bankSel_6}
                                   + {1'h0, bankSel_bankSel_7})})})}
                   + {1'h0,
                      4'({1'h0,
                          3'({1'h0,
                              2'({1'h0, bankSel_bankSel_8} + {1'h0, bankSel_bankSel_9})}
                             + {1'h0,
                                2'({1'h0, bankSel_bankSel_10}
                                   + {1'h0, bankSel_bankSel_11})})}
                         + {1'h0,
                            3'({1'h0,
                                2'({1'h0, bankSel_bankSel_12}
                                   + {1'h0, bankSel_bankSel_13})}
                               + {1'h0,
                                  2'({1'h0, bankSel_bankSel_14}
                                     + {1'h0,
                                        &(_bankSel_bankIdxHigh_T_1[6:3])})})})}) == 5'h5)) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed: The number of bank visits must be %d, but bankSel=0x%x\n    at ICache.scala:156 assert(\n",
                 3'h5,
                 {&(_bankSel_bankIdxHigh_T_1[6:3]),
                  bankSel_bankSel_14,
                  bankSel_bankSel_13,
                  bankSel_bankSel_12,
                  bankSel_bankSel_11,
      ...
      if (~reset
          & ~(~s2_valid
              | 5'({1'h0,
                    4'({1'h0,
                        3'({1'h0,
                            2'({1'h0, bankSel_bankSel_1_0} + {1'h0, bankSel_bankSel_1_1})}
                           + {1'h0,
                              2'({1'h0, bankSel_bankSel_1_2}
                                 + {1'h0, bankSel_bankSel_1_3})})}
                       + {1'h0,
                          3'({1'h0,
                              2'({1'h0, bankSel_bankSel_1_4}
                                 + {1'h0, bankSel_bankSel_1_5})}
                             + {1'h0,
                                2'({1'h0, bankSel_bankSel_1_6}
                                   + {1'h0, bankSel_bankSel_1_7})})})}
                   + {1'h0,
                      4'({1'h0,
                          3'({1'h0,
                              2'({1'h0, bankSel_bankSel_1_8}
                                 + {1'h0, bankSel_bankSel_1_9})}
                             + {1'h0,
                                2'({1'h0, bankSel_bankSel_1_10}
                                   + {1'h0, bankSel_bankSel_1_11})})}
                         + {1'h0,
                            3'({1'h0,
                                2'({1'h0, bankSel_bankSel_1_12}
                                   + {1'h0, bankSel_bankSel_1_13})}
                               + {1'h0,
                                  2'({1'h0, bankSel_bankSel_1_14}
                                     + {1'h0,
                                        &(_bankSel_bankIdxHigh_T_4[6:3])})})})}) == 5'h5)) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed: The number of bank visits must be %d, but bankSel=0x%x\n    at ICache.scala:156 assert(\n",
                 3'h5,
                 {&(_bankSel_bankIdxHigh_T_4[6:3]),
                  bankSel_bankSel_1_14,
                  bankSel_bankSel_1_13,
                  bankSel_bankSel_1_12,
                  bankSel_bankSel_1_11,
                  bankSel_bankSel_1_10,
                  bankSel_bankSel_1_9,
                  bankSel_bankSel_1_8,
                  bankSel_bankSel_1_7,
                  bankSel_bankSel_1_6,
      ...
      if (~reset
          & ~(~s2_valid
              | 5'({1'h0,
                    4'({1'h0,
                        3'({1'h0,
                            2'({1'h0, bankSel_bankSel_2_0} + {1'h0, bankSel_bankSel_2_1})}
                           + {1'h0,
                              2'({1'h0, bankSel_bankSel_2_2}
                                 + {1'h0, bankSel_bankSel_2_3})})}
                       + {1'h0,
                          3'({1'h0,
                              2'({1'h0, bankSel_bankSel_2_4}
                                 + {1'h0, bankSel_bankSel_2_5})}
                             + {1'h0,
                                2'({1'h0, bankSel_bankSel_2_6}
                                   + {1'h0, bankSel_bankSel_2_7})})})}
                   + {1'h0,
                      4'({1'h0,
                          3'({1'h0,
                              2'({1'h0, bankSel_bankSel_2_8}
                                 + {1'h0, bankSel_bankSel_2_9})}
                             + {1'h0,
                                2'({1'h0, bankSel_bankSel_2_10}
                                   + {1'h0, bankSel_bankSel_2_11})})}
                         + {1'h0,
                            3'({1'h0,
                                2'({1'h0, bankSel_bankSel_2_12}
                                   + {1'h0, bankSel_bankSel_2_13})}
                               + {1'h0,
                                  2'({1'h0, bankSel_bankSel_2_14}
                                     + {1'h0,
                                        &(_bankSel_bankIdxHigh_T_7[6:3])})})})}) == 5'h5)) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed: The number of bank visits must be %d, but bankSel=0x%x\n    at ICache.scala:156 assert(\n",
                 3'h5,
                 {&(_bankSel_bankIdxHigh_T_7[6:3]),
                  bankSel_bankSel_2_14,
                  bankSel_bankSel_2_13,
                  bankSel_bankSel_2_12,
                  bankSel_bankSel_2_11,
                  bankSel_bankSel_2_10,
                  bankSel_bankSel_2_9,
                  bankSel_bankSel_2_8,
                  bankSel_bankSel_2_7,
                  bankSel_bankSel_2_6,
      ...
      if (~reset
          & ~(~s2_valid
              | 5'({1'h0,
                    4'({1'h0,
                        3'({1'h0,
                            2'({1'h0, bankSel_bankSel_3_0} + {1'h0, bankSel_bankSel_3_1})}
                           + {1'h0,
                              2'({1'h0, bankSel_bankSel_3_2}
                                 + {1'h0, bankSel_bankSel_3_3})})}
                       + {1'h0,
                          3'({1'h0,
                              2'({1'h0, bankSel_bankSel_3_4}
                                 + {1'h0, bankSel_bankSel_3_5})}
                             + {1'h0,
                                2'({1'h0, bankSel_bankSel_3_6}
                                   + {1'h0, bankSel_bankSel_3_7})})})}
                   + {1'h0,
                      4'({1'h0,
                          3'({1'h0,
                              2'({1'h0, bankSel_bankSel_3_8}
                                 + {1'h0, bankSel_bankSel_3_9})}
                             + {1'h0,
                                2'({1'h0, bankSel_bankSel_3_10}
                                   + {1'h0, bankSel_bankSel_3_11})})}
                         + {1'h0,
                            3'({1'h0,
                                2'({1'h0, bankSel_bankSel_3_12}
                                   + {1'h0, bankSel_bankSel_3_13})}
                               + {1'h0,
                                  2'({1'h0, bankSel_bankSel_3_14}
                                     + {1'h0,
                                        &(_bankSel_bankIdxHigh_T_10[6:3])})})})}) == 5'h5)) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed: The number of bank visits must be %d, but bankSel=0x%x\n    at ICache.scala:156 assert(\n",
                 3'h5,
                 {&(_bankSel_bankIdxHigh_T_10[6:3]),
                  bankSel_bankSel_3_14,
                  bankSel_bankSel_3_13,
                  bankSel_bankSel_3_12,
                  bankSel_bankSel_3_11,
                  bankSel_bankSel_3_10,
                  bankSel_bankSel_3_9,
                  bankSel_bankSel_3_8,
                  bankSel_bankSel_3_7,
                  bankSel_bankSel_3_6,
      ...
      if (~reset
          & ~(~s2_valid
              | 5'({1'h0,
                    4'({1'h0,
                        3'({1'h0,
                            2'({1'h0, bankSel_bankSel_4_0} + {1'h0, bankSel_bankSel_4_1})}
                           + {1'h0,
                              2'({1'h0, bankSel_bankSel_4_2}
                                 + {1'h0, bankSel_bankSel_4_3})})}
                       + {1'h0,
                          3'({1'h0,
                              2'({1'h0, bankSel_bankSel_4_4}
                                 + {1'h0, bankSel_bankSel_4_5})}
                             + {1'h0,
                                2'({1'h0, bankSel_bankSel_4_6}
                                   + {1'h0, bankSel_bankSel_4_7})})})}
                   + {1'h0,
                      4'({1'h0,
                          3'({1'h0,
                              2'({1'h0, bankSel_bankSel_4_8}
                                 + {1'h0, bankSel_bankSel_4_9})}
                             + {1'h0,
                                2'({1'h0, bankSel_bankSel_4_10}
                                   + {1'h0, bankSel_bankSel_4_11})})}
                         + {1'h0,
                            3'({1'h0,
                                2'({1'h0, bankSel_bankSel_4_12}
                                   + {1'h0, bankSel_bankSel_4_13})}
                               + {1'h0,
                                  2'({1'h0, bankSel_bankSel_4_14}
                                     + {1'h0,
                                        &(_bankSel_bankIdxHigh_T_13[6:3])})})})}) == 5'h5)) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed: The number of bank visits must be %d, but bankSel=0x%x\n    at ICache.scala:156 assert(\n",
                 3'h5,
                 {&(_bankSel_bankIdxHigh_T_13[6:3]),
                  bankSel_bankSel_4_14,
                  bankSel_bankSel_4_13,
                  bankSel_bankSel_4_12,
                  bankSel_bankSel_4_11,
                  bankSel_bankSel_4_10,
                  bankSel_bankSel_4_9,
                  bankSel_bankSel_4_8,
                  bankSel_bankSel_4_7,
                  bankSel_bankSel_4_6,
      ...
      if (~reset
          & ~(~s2_valid
              | 5'({1'h0,
                    4'({1'h0,
                        3'({1'h0,
                            2'({1'h0, bankSel_bankSel_5_0} + {1'h0, bankSel_bankSel_5_1})}
                           + {1'h0,
                              2'({1'h0, bankSel_bankSel_5_2}
                                 + {1'h0, bankSel_bankSel_5_3})})}
                       + {1'h0,
                          3'({1'h0,
                              2'({1'h0, bankSel_bankSel_5_4}
                                 + {1'h0, bankSel_bankSel_5_5})}
                             + {1'h0,
                                2'({1'h0, bankSel_bankSel_5_6}
                                   + {1'h0, bankSel_bankSel_5_7})})})}
                   + {1'h0,
                      4'({1'h0,
                          3'({1'h0,
                              2'({1'h0, bankSel_bankSel_5_8}
                                 + {1'h0, bankSel_bankSel_5_9})}
                             + {1'h0,
                                2'({1'h0, bankSel_bankSel_5_10}
                                   + {1'h0, bankSel_bankSel_5_11})})}
                         + {1'h0,
                            3'({1'h0,
                                2'({1'h0, bankSel_bankSel_5_12}
                                   + {1'h0, bankSel_bankSel_5_13})}
                               + {1'h0,
                                  2'({1'h0, bankSel_bankSel_5_14}
                                     + {1'h0,
                                        &(_bankSel_bankIdxHigh_T_16[6:3])})})})}) == 5'h5)) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed: The number of bank visits must be %d, but bankSel=0x%x\n    at ICache.scala:156 assert(\n",
                 3'h5,
                 {&(_bankSel_bankIdxHigh_T_16[6:3]),
                  bankSel_bankSel_5_14,
                  bankSel_bankSel_5_13,
                  bankSel_bankSel_5_12,
                  bankSel_bankSel_5_11,
                  bankSel_bankSel_5_10,
                  bankSel_bankSel_5_9,
                  bankSel_bankSel_5_8,
                  bankSel_bankSel_5_7,
                  bankSel_bankSel_5_6,
      ...
      if (~reset
          & ~(~s2_valid
              | 5'({1'h0,
                    4'({1'h0,
                        3'({1'h0,
                            2'({1'h0, bankSel_bankSel_6_0} + {1'h0, bankSel_bankSel_6_1})}
                           + {1'h0,
                              2'({1'h0, bankSel_bankSel_6_2}
                                 + {1'h0, bankSel_bankSel_6_3})})}
                       + {1'h0,
                          3'({1'h0,
                              2'({1'h0, bankSel_bankSel_6_4}
                                 + {1'h0, bankSel_bankSel_6_5})}
                             + {1'h0,
                                2'({1'h0, bankSel_bankSel_6_6}
                                   + {1'h0, bankSel_bankSel_6_7})})})}
                   + {1'h0,
                      4'({1'h0,
                          3'({1'h0,
                              2'({1'h0, bankSel_bankSel_6_8}
                                 + {1'h0, bankSel_bankSel_6_9})}
                             + {1'h0,
                                2'({1'h0, bankSel_bankSel_6_10}
                                   + {1'h0, bankSel_bankSel_6_11})})}
                         + {1'h0,
                            3'({1'h0,
                                2'({1'h0, bankSel_bankSel_6_12}
                                   + {1'h0, bankSel_bankSel_6_13})}
                               + {1'h0,
                                  2'({1'h0, bankSel_bankSel_6_14}
                                     + {1'h0,
                                        &(_bankSel_bankIdxHigh_T_19[6:3])})})})}) == 5'h5)) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed: The number of bank visits must be %d, but bankSel=0x%x\n    at ICache.scala:156 assert(\n",
                 3'h5,
                 {&(_bankSel_bankIdxHigh_T_19[6:3]),
                  bankSel_bankSel_6_14,
                  bankSel_bankSel_6_13,
                  bankSel_bankSel_6_12,
                  bankSel_bankSel_6_11,
                  bankSel_bankSel_6_10,
                  bankSel_bankSel_6_9,
                  bankSel_bankSel_6_8,
                  bankSel_bankSel_6_7,
                  bankSel_bankSel_6_6,
      ...
      if (~reset
          & ~(~s2_valid
              | 5'({1'h0,
                    4'({1'h0,
                        3'({1'h0,
                            2'({1'h0, bankSel_bankSel_7_0} + {1'h0, bankSel_bankSel_7_1})}
                           + {1'h0,
                              2'({1'h0, bankSel_bankSel_7_2}
                                 + {1'h0, bankSel_bankSel_7_3})})}
                       + {1'h0,
                          3'({1'h0,
                              2'({1'h0, bankSel_bankSel_7_4}
                                 + {1'h0, bankSel_bankSel_7_5})}
                             + {1'h0,
                                2'({1'h0, bankSel_bankSel_7_6}
                                   + {1'h0, bankSel_bankSel_7_7})})})}
                   + {1'h0,
                      4'({1'h0,
                          3'({1'h0,
                              2'({1'h0, bankSel_bankSel_7_8}
                                 + {1'h0, bankSel_bankSel_7_9})}
                             + {1'h0,
                                2'({1'h0, bankSel_bankSel_7_10}
                                   + {1'h0, bankSel_bankSel_7_11})})}
                         + {1'h0,
                            3'({1'h0,
                                2'({1'h0, bankSel_bankSel_7_12}
                                   + {1'h0, bankSel_bankSel_7_13})}
                               + {1'h0,
                                  2'({1'h0, bankSel_bankSel_7_14}
                                     + {1'h0,
                                        &(_bankSel_bankIdxHigh_T_22[6:3])})})})}) == 5'h5)) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed: The number of bank visits must be %d, but bankSel=0x%x\n    at ICache.scala:156 assert(\n",
                 3'h5,
                 {&(_bankSel_bankIdxHigh_T_22[6:3]),
                  bankSel_bankSel_7_14,
                  bankSel_bankSel_7_13,
                  bankSel_bankSel_7_12,
                  bankSel_bankSel_7_11,
                  bankSel_bankSel_7_10,
                  bankSel_bankSel_7_9,
                  bankSel_bankSel_7_8,
                  bankSel_bankSel_7_7,
                  bankSel_bankSel_7_6,
  ...
  `endif // not def SYNTHESIS
  wire        diffMainPipeOut_7_valid =
    s2_fire & (bankSel_bankSel_7_7 | (&(_bankSel_bankIdxHigh_T_22[6:3]))) & ~discards_0;
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      if (x3_probe)
        cntFtqFireInterval <= 32'h1;
      else
        cntFtqFireInterval <= 32'(cntFtqFireInterval + 32'h1);
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        cntFtqFireInterval = _RANDOM[6'h0];
        ...
        REG = _RANDOM[6'h32][25];
        REG_1 = _RANDOM[6'h32][26];
        REG_2 = _RANDOM[6'h32][27];
        REG_3 = _RANDOM[6'h32][28];
  ...
  Arbiter2_ICacheMissReq toMSHRArbiter (
    ...
    .io_out_valid          (_toMSHRArbiter_io_out_valid),
    .io_out_bits_blkPaddr  (io_mshr_req_bits_blkPaddr),
    .io_out_bits_vSetIdx   (io_mshr_req_bits_vSetIdx)
  );
  DummyDPICWrapper diffMainPipeOut_module (
    .clock          (clock),
    .io_valid       (diffMainPipeOut_valid),
    .io_bits_valid  (diffMainPipeOut_valid),
    .io_bits_addr
      ({16'h0,
        (|(s2_req_vaddr_0[5:3]))
          ? {s2_req_ptags_1, s2_req_vaddr_1[11:6]}
          : {s2_req_ptags_0, s2_req_vaddr_0[11:6]},
        6'h0}),
    .io_bits_data_0 (s2_datas_0),
    .io_bits_data_1 (64'h0),
    .io_bits_data_2 (64'h0),
    .io_bits_data_3 (64'h0),
    .io_bits_data_4 (64'h0),
    .io_bits_data_5 (64'h0),
    .io_bits_data_6 (64'h0),
    .io_bits_data_7 (64'h0),
    .io_bits_coreid (diffMainPipeOut_coreid),
    .io_bits_index  (8'h3)
  );
  DummyDPICWrapper diffMainPipeOut_module_1 (
    .clock          (clock),
    .io_valid       (diffMainPipeOut_1_valid),
    .io_bits_valid  (diffMainPipeOut_1_valid),
    .io_bits_addr
      ({16'h0, (|(s2_req_vaddr_0[5:4])) ? 48'(_GEN_7 + 48'h8) : 48'(_GEN_8 + 48'h8)}),
    .io_bits_data_0 (s2_datas_1),
    .io_bits_data_1 (64'h0),
    .io_bits_data_2 (64'h0),
    .io_bits_data_3 (64'h0),
    .io_bits_data_4 (64'h0),
  ...
  DummyDPICWrapper diffMainPipeOut_module_2 (
    .clock          (clock),
    .io_valid       (diffMainPipeOut_2_valid),
    .io_bits_valid  (diffMainPipeOut_2_valid),
    .io_bits_addr   ({16'h0, lineSel_2_2 ? 48'(_GEN_7 + 48'h10) : 48'(_GEN_8 + 48'h10)}),
    .io_bits_data_0 (s2_datas_2),
    .io_bits_data_1 (64'h0),
    .io_bits_data_2 (64'h0),
    .io_bits_data_3 (64'h0),
    .io_bits_data_4 (64'h0),
  ...
  DummyDPICWrapper diffMainPipeOut_module_3 (
    .clock          (clock),
    .io_valid       (diffMainPipeOut_3_valid),
    .io_bits_valid  (diffMainPipeOut_3_valid),
    .io_bits_addr
      ({16'h0, s2_req_vaddr_0[5] ? 48'(_GEN_7 + 48'h18) : 48'(_GEN_8 + 48'h18)}),
    .io_bits_data_0 (s2_datas_3),
    .io_bits_data_1 (64'h0),
    .io_bits_data_2 (64'h0),
    .io_bits_data_3 (64'h0),
    .io_bits_data_4 (64'h0),
  ...
  DummyDPICWrapper diffMainPipeOut_module_4 (
    .clock          (clock),
    .io_valid       (diffMainPipeOut_4_valid),
    .io_bits_valid  (diffMainPipeOut_4_valid),
    .io_bits_addr   ({16'h0, lineSel_4_4 ? 48'(_GEN_7 + 48'h20) : 48'(_GEN_8 + 48'h20)}),
    .io_bits_data_0 (s2_datas_4),
    .io_bits_data_1 (64'h0),
    .io_bits_data_2 (64'h0),
    .io_bits_data_3 (64'h0),
    .io_bits_data_4 (64'h0),
  ...
  DummyDPICWrapper diffMainPipeOut_module_5 (
    .clock          (clock),
    .io_valid       (diffMainPipeOut_5_valid),
    .io_bits_valid  (diffMainPipeOut_5_valid),
    .io_bits_addr   ({16'h0, lineSel_5_5 ? 48'(_GEN_7 + 48'h28) : 48'(_GEN_8 + 48'h28)}),
    .io_bits_data_0 (s2_datas_5),
    .io_bits_data_1 (64'h0),
    .io_bits_data_2 (64'h0),
    .io_bits_data_3 (64'h0),
    .io_bits_data_4 (64'h0),
  ...
  DummyDPICWrapper diffMainPipeOut_module_6 (
    .clock          (clock),
    .io_valid       (diffMainPipeOut_6_valid),
    .io_bits_valid  (diffMainPipeOut_6_valid),
    .io_bits_addr
      ({16'h0, (&(s2_req_vaddr_0[5:3])) ? 48'(_GEN_7 + 48'h30) : 48'(_GEN_8 + 48'h30)}),
    .io_bits_data_0 (s2_datas_6),
    .io_bits_data_1 (64'h0),
    .io_bits_data_2 (64'h0),
    .io_bits_data_3 (64'h0),
    .io_bits_data_4 (64'h0),
  ...
  DummyDPICWrapper diffMainPipeOut_module_7 (
    .clock          (clock),
    .io_valid       (diffMainPipeOut_7_valid),
    .io_bits_valid  (diffMainPipeOut_7_valid),
    .io_bits_addr   ({16'h0, 48'(_GEN_8 + 48'h38)}),
    .io_bits_data_0 (s2_datas_7),
    .io_bits_data_1 (64'h0),
    .io_bits_data_2 (64'h0),
    .io_bits_data_3 (64'h0),
    .io_bits_data_4 (64'h0),
  ...
  assign io_fetch_resp_bits_exception_0 = s2_exception_out_0;
  assign io_fetch_resp_bits_exception_1 = io_fetch_resp_bits_exception_1_0;
  assign io_fetch_resp_bits_pmp_mmio_0 = s2_pmp_mmio_0;
  assign io_fetch_resp_bits_pmp_mmio_1 = io_fetch_resp_bits_pmp_mmio_1_0;
  assign io_fetch_resp_bits_itlb_pbmt_0 = s2_itlb_pbmt_0;
  assign io_fetch_resp_bits_itlb_pbmt_1 = io_fetch_resp_bits_itlb_pbmt_1_0;
