...
module StdFreeList_2(
  ...
  wire             _io_canAllocate_T = freeRegCnt > 5'h5;
  ...
  wire [5:0]       _GEN_22 = {1'h0, _GEN_21[lastCycleSnpt_snptSelect]};
  ...
  wire [7:0][20:0] _GEN_24 =
    {{headPtrOH},
     ...
     {headPtrOH}};
  wire [5:0]       _GEN_25 = {1'h0, archHeadPtr_value};
  ...
  wire [5:0]       enqPtr_new_value_3 = 6'(_GEN_3 + {4'h0, 2'(_GEN_4 + _tailPtr_T_1)});
  ...
  wire [5:0]       enqPtr_new_value_4 =
    6'(_GEN_3 + {3'h0, 3'(_GEN_26 + {1'h0, 2'(_GEN_6 + _GEN_7)})});
  ...
  wire [5:0]       enqPtr_new_value_5 =
    6'(_GEN_3 + {3'h0, 3'(_GEN_26 + {1'h0, 2'(_GEN_6 + 2'(_GEN_7 + _GEN_8))})});
