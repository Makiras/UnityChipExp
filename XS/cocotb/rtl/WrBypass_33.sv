...
module WrBypass_33(
  ...
  wire        _GEN = io_wen & hit;
  wire        _GEN_0 = io_wen & ~hit;
  wire        _GEN_1 = hit_idx == 4'h0;
  wire        _GEN_2 = hit_idx == 4'h1;
  wire        _GEN_3 = hit_idx == 4'h2;
  wire        _GEN_4 = hit_idx == 4'h3;
  wire        _GEN_5 = hit_idx == 4'h4;
  wire        _GEN_6 = hit_idx == 4'h5;
  wire        _GEN_7 = hit_idx == 4'h6;
  wire        _GEN_8 = hit_idx == 4'h7;
  wire        _GEN_9 = hit_idx == 4'h8;
  wire        _GEN_10 = hit_idx == 4'h9;
  wire        _GEN_11 = hit_idx == 4'hA;
  wire        _GEN_12 = hit_idx == 4'hB;
  wire        _GEN_13 = hit_idx == 4'hC;
  wire        _GEN_14 = hit_idx == 4'hD;
  wire        _GEN_15 = hit_idx == 4'hE;
  wire [3:0]  state_reg_touch_way_sized = hit ? hit_idx : enq_idx;
  wire        _GEN_16 = enq_idx == 4'h0;
  wire        _GEN_17 = enq_idx == 4'h1;
  wire        _GEN_18 = enq_idx == 4'h2;
  wire        _GEN_19 = enq_idx == 4'h3;
  wire        _GEN_20 = enq_idx == 4'h4;
  wire        _GEN_21 = enq_idx == 4'h5;
  wire        _GEN_22 = enq_idx == 4'h6;
  wire        _GEN_23 = enq_idx == 4'h7;
  wire        _GEN_24 = enq_idx == 4'h8;
  wire        _GEN_25 = enq_idx == 4'h9;
  wire        _GEN_26 = enq_idx == 4'hA;
  wire        _GEN_27 = enq_idx == 4'hB;
  wire        _GEN_28 = enq_idx == 4'hC;
  wire        _GEN_29 = enq_idx == 4'hD;
  wire        _GEN_30 = enq_idx == 4'hE;
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      if (io_wen) begin
        if (hit) begin
          valids_0_0 <= io_write_way_mask_0 & _GEN_1 | valids_0_0;
          valids_0_1 <= io_write_way_mask_1 & _GEN_1 | valids_0_1;
          valids_1_0 <= io_write_way_mask_0 & _GEN_2 | valids_1_0;
          valids_1_1 <= io_write_way_mask_1 & _GEN_2 | valids_1_1;
          valids_2_0 <= io_write_way_mask_0 & _GEN_3 | valids_2_0;
          valids_2_1 <= io_write_way_mask_1 & _GEN_3 | valids_2_1;
          valids_3_0 <= io_write_way_mask_0 & _GEN_4 | valids_3_0;
          valids_3_1 <= io_write_way_mask_1 & _GEN_4 | valids_3_1;
          valids_4_0 <= io_write_way_mask_0 & _GEN_5 | valids_4_0;
          valids_4_1 <= io_write_way_mask_1 & _GEN_5 | valids_4_1;
          valids_5_0 <= io_write_way_mask_0 & _GEN_6 | valids_5_0;
          valids_5_1 <= io_write_way_mask_1 & _GEN_6 | valids_5_1;
          valids_6_0 <= io_write_way_mask_0 & _GEN_7 | valids_6_0;
          valids_6_1 <= io_write_way_mask_1 & _GEN_7 | valids_6_1;
          valids_7_0 <= io_write_way_mask_0 & _GEN_8 | valids_7_0;
          valids_7_1 <= io_write_way_mask_1 & _GEN_8 | valids_7_1;
          valids_8_0 <= io_write_way_mask_0 & _GEN_9 | valids_8_0;
          valids_8_1 <= io_write_way_mask_1 & _GEN_9 | valids_8_1;
          valids_9_0 <= io_write_way_mask_0 & _GEN_10 | valids_9_0;
          valids_9_1 <= io_write_way_mask_1 & _GEN_10 | valids_9_1;
          valids_10_0 <= io_write_way_mask_0 & _GEN_11 | valids_10_0;
          valids_10_1 <= io_write_way_mask_1 & _GEN_11 | valids_10_1;
          valids_11_0 <= io_write_way_mask_0 & _GEN_12 | valids_11_0;
          valids_11_1 <= io_write_way_mask_1 & _GEN_12 | valids_11_1;
          valids_12_0 <= io_write_way_mask_0 & _GEN_13 | valids_12_0;
          valids_12_1 <= io_write_way_mask_1 & _GEN_13 | valids_12_1;
          valids_13_0 <= io_write_way_mask_0 & _GEN_14 | valids_13_0;
          valids_13_1 <= io_write_way_mask_1 & _GEN_14 | valids_13_1;
          valids_14_0 <= io_write_way_mask_0 & _GEN_15 | valids_14_0;
          valids_14_1 <= io_write_way_mask_1 & _GEN_15 | valids_14_1;
          valids_15_0 <= io_write_way_mask_0 & (&hit_idx) | valids_15_0;
          valids_15_1 <= io_write_way_mask_1 & (&hit_idx) | valids_15_1;
        end
        else begin
          valids_0_0 <= io_write_way_mask_0 & _GEN_16 | ~_GEN_16 & valids_0_0;
          valids_0_1 <= io_write_way_mask_1 & _GEN_16 | ~_GEN_16 & valids_0_1;
          valids_1_0 <= io_write_way_mask_0 & _GEN_17 | ~_GEN_17 & valids_1_0;
          valids_1_1 <= io_write_way_mask_1 & _GEN_17 | ~_GEN_17 & valids_1_1;
          valids_2_0 <= io_write_way_mask_0 & _GEN_18 | ~_GEN_18 & valids_2_0;
          valids_2_1 <= io_write_way_mask_1 & _GEN_18 | ~_GEN_18 & valids_2_1;
          valids_3_0 <= io_write_way_mask_0 & _GEN_19 | ~_GEN_19 & valids_3_0;
          valids_3_1 <= io_write_way_mask_1 & _GEN_19 | ~_GEN_19 & valids_3_1;
          valids_4_0 <= io_write_way_mask_0 & _GEN_20 | ~_GEN_20 & valids_4_0;
          valids_4_1 <= io_write_way_mask_1 & _GEN_20 | ~_GEN_20 & valids_4_1;
          valids_5_0 <= io_write_way_mask_0 & _GEN_21 | ~_GEN_21 & valids_5_0;
          valids_5_1 <= io_write_way_mask_1 & _GEN_21 | ~_GEN_21 & valids_5_1;
          valids_6_0 <= io_write_way_mask_0 & _GEN_22 | ~_GEN_22 & valids_6_0;
          valids_6_1 <= io_write_way_mask_1 & _GEN_22 | ~_GEN_22 & valids_6_1;
          valids_7_0 <= io_write_way_mask_0 & _GEN_23 | ~_GEN_23 & valids_7_0;
          valids_7_1 <= io_write_way_mask_1 & _GEN_23 | ~_GEN_23 & valids_7_1;
          valids_8_0 <= io_write_way_mask_0 & _GEN_24 | ~_GEN_24 & valids_8_0;
          valids_8_1 <= io_write_way_mask_1 & _GEN_24 | ~_GEN_24 & valids_8_1;
          valids_9_0 <= io_write_way_mask_0 & _GEN_25 | ~_GEN_25 & valids_9_0;
          valids_9_1 <= io_write_way_mask_1 & _GEN_25 | ~_GEN_25 & valids_9_1;
          valids_10_0 <= io_write_way_mask_0 & _GEN_26 | ~_GEN_26 & valids_10_0;
          valids_10_1 <= io_write_way_mask_1 & _GEN_26 | ~_GEN_26 & valids_10_1;
          valids_11_0 <= io_write_way_mask_0 & _GEN_27 | ~_GEN_27 & valids_11_0;
          valids_11_1 <= io_write_way_mask_1 & _GEN_27 | ~_GEN_27 & valids_11_1;
          valids_12_0 <= io_write_way_mask_0 & _GEN_28 | ~_GEN_28 & valids_12_0;
          valids_12_1 <= io_write_way_mask_1 & _GEN_28 | ~_GEN_28 & valids_12_1;
          valids_13_0 <= io_write_way_mask_0 & _GEN_29 | ~_GEN_29 & valids_13_0;
          valids_13_1 <= io_write_way_mask_1 & _GEN_29 | ~_GEN_29 & valids_13_1;
          valids_14_0 <= io_write_way_mask_0 & _GEN_30 | ~_GEN_30 & valids_14_0;
          valids_14_1 <= io_write_way_mask_1 & _GEN_30 | ~_GEN_30 & valids_14_1;
      ...
      ever_written_0 <= io_wen & ~hit & (_GEN_16 | io_wen & _GEN_16) | ever_written_0;
      ever_written_1 <= io_wen & ~hit & (_GEN_17 | io_wen & _GEN_17) | ever_written_1;
      ever_written_2 <= io_wen & ~hit & (_GEN_18 | io_wen & _GEN_18) | ever_written_2;
      ever_written_3 <= io_wen & ~hit & (_GEN_19 | io_wen & _GEN_19) | ever_written_3;
      ever_written_4 <= io_wen & ~hit & (_GEN_20 | io_wen & _GEN_20) | ever_written_4;
      ever_written_5 <= io_wen & ~hit & (_GEN_21 | io_wen & _GEN_21) | ever_written_5;
      ever_written_6 <= io_wen & ~hit & (_GEN_22 | io_wen & _GEN_22) | ever_written_6;
      ever_written_7 <= io_wen & ~hit & (_GEN_23 | io_wen & _GEN_23) | ever_written_7;
      ever_written_8 <= io_wen & ~hit & (_GEN_24 | io_wen & _GEN_24) | ever_written_8;
      ever_written_9 <= io_wen & ~hit & (_GEN_25 | io_wen & _GEN_25) | ever_written_9;
      ever_written_10 <= io_wen & ~hit & (_GEN_26 | io_wen & _GEN_26) | ever_written_10;
      ever_written_11 <= io_wen & ~hit & (_GEN_27 | io_wen & _GEN_27) | ever_written_11;
      ever_written_12 <= io_wen & ~hit & (_GEN_28 | io_wen & _GEN_28) | ever_written_12;
      ever_written_13 <= io_wen & ~hit & (_GEN_29 | io_wen & _GEN_29) | ever_written_13;
      ever_written_14 <= io_wen & ~hit & (_GEN_30 | io_wen & _GEN_30) | ever_written_14;
      ever_written_15 <=
