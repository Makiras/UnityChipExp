...
module Queue10_GrantBuffer_Anon(
  ...
  ram_10x88 ram_ext (
    ...
    .W0_en   (do_enq),
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_pfSource, io_enq_bits_vaddr, io_enq_bits_set, io_enq_bits_tag})
  );
  assign io_enq_ready = ~full;
  assign io_deq_valid = io_deq_valid_0;
  assign io_deq_bits_tag = empty ? io_enq_bits_tag : _ram_ext_R0_data[30:0];
  assign io_deq_bits_set = empty ? io_enq_bits_set : _ram_ext_R0_data[39:31];
  assign io_deq_bits_vaddr = empty ? io_enq_bits_vaddr : _ram_ext_R0_data[83:40];
  assign io_deq_bits_pfSource = empty ? io_enq_bits_pfSource : _ram_ext_R0_data[87:84];
  assign io_count =
    ptr_match
