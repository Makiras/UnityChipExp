...
module RRArbiterInit_9(
  ...
  assign io_chosen_choice =
    ctrl_validMask_1 ? 2'h1 : ctrl_validMask_2 ? 2'h2 : ctrl_validMask_3 ? 2'h3 : _GEN_6;
  ...
  assign io_out_bits_nc = _GEN_4[io_chosen_choice];
  assign io_out_bits_memBackTypeMM = _GEN_5[io_chosen_choice];
endmodule
