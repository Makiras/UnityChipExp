...
module MSHRBuffer_1(
  ...
  `ifndef SYNTHESIS
    always @(posedge clock) begin
      ...
      if (~reset
          & (&(2'({1'h0, _wens_T_13}
                  + 2'({1'h0, _wens_T_15} + {1'h0, _wens_T_17}))))) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed: triple write to the same MSHR buffer entry\n    at MSHRBuffer.scala:52 assert(PopCount(wens) <= 2.U, \"triple write to the same MSHR buffer entry\")\n");
        if (`STOP_COND_)
          xs_assert_v2(`__FILE__, `__LINE__);
      ...
      if (~reset
          & (&(2'({1'h0, _wens_T_19}
                  + 2'({1'h0, _wens_T_21} + {1'h0, _wens_T_23}))))) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed: triple write to the same MSHR buffer entry\n    at MSHRBuffer.scala:52 assert(PopCount(wens) <= 2.U, \"triple write to the same MSHR buffer entry\")\n");
        if (`STOP_COND_)
          xs_assert_v2(`__FILE__, `__LINE__);
      ...
      if (~reset
          & (&(2'({1'h0, _wens_T_25}
                  + 2'({1'h0, _wens_T_27} + {1'h0, _wens_T_29}))))) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed: triple write to the same MSHR buffer entry\n    at MSHRBuffer.scala:52 assert(PopCount(wens) <= 2.U, \"triple write to the same MSHR buffer entry\")\n");
        if (`STOP_COND_)
          xs_assert_v2(`__FILE__, `__LINE__);
      ...
      if (~reset
          & (&(2'({1'h0, _wens_T_31}
                  + 2'({1'h0, _wens_T_33} + {1'h0, _wens_T_35}))))) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed: triple write to the same MSHR buffer entry\n    at MSHRBuffer.scala:52 assert(PopCount(wens) <= 2.U, \"triple write to the same MSHR buffer entry\")\n");
        if (`STOP_COND_)
          xs_assert_v2(`__FILE__, `__LINE__);
      ...
      if (~reset
          & (&(2'({1'h0, _wens_T_37}
                  + 2'({1'h0, _wens_T_39} + {1'h0, _wens_T_41}))))) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed: triple write to the same MSHR buffer entry\n    at MSHRBuffer.scala:52 assert(PopCount(wens) <= 2.U, \"triple write to the same MSHR buffer entry\")\n");
        if (`STOP_COND_)
          xs_assert_v2(`__FILE__, `__LINE__);
      ...
      if (~reset
          & (&(2'({1'h0, _wens_T_43}
                  + 2'({1'h0, _wens_T_45} + {1'h0, _wens_T_47}))))) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed: triple write to the same MSHR buffer entry\n    at MSHRBuffer.scala:52 assert(PopCount(wens) <= 2.U, \"triple write to the same MSHR buffer entry\")\n");
        if (`STOP_COND_)
          xs_assert_v2(`__FILE__, `__LINE__);
      ...
      if (~reset
          & (&(2'({1'h0, _wens_T_49}
                  + 2'({1'h0, _wens_T_51} + {1'h0, _wens_T_53}))))) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed: triple write to the same MSHR buffer entry\n    at MSHRBuffer.scala:52 assert(PopCount(wens) <= 2.U, \"triple write to the same MSHR buffer entry\")\n");
        if (`STOP_COND_)
          xs_assert_v2(`__FILE__, `__LINE__);
      ...
      if (~reset
          & (&(2'({1'h0, _wens_T_55}
                  + 2'({1'h0, _wens_T_57} + {1'h0, _wens_T_59}))))) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed: triple write to the same MSHR buffer entry\n    at MSHRBuffer.scala:52 assert(PopCount(wens) <= 2.U, \"triple write to the same MSHR buffer entry\")\n");
        if (`STOP_COND_)
          xs_assert_v2(`__FILE__, `__LINE__);
      ...
      if (~reset
          & (&(2'({1'h0, _wens_T_61}
                  + 2'({1'h0, _wens_T_63} + {1'h0, _wens_T_65}))))) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed: triple write to the same MSHR buffer entry\n    at MSHRBuffer.scala:52 assert(PopCount(wens) <= 2.U, \"triple write to the same MSHR buffer entry\")\n");
        if (`STOP_COND_)
          xs_assert_v2(`__FILE__, `__LINE__);
      ...
      if (~reset
          & (&(2'({1'h0, _wens_T_67}
                  + 2'({1'h0, _wens_T_69} + {1'h0, _wens_T_71}))))) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed: triple write to the same MSHR buffer entry\n    at MSHRBuffer.scala:52 assert(PopCount(wens) <= 2.U, \"triple write to the same MSHR buffer entry\")\n");
        if (`STOP_COND_)
          xs_assert_v2(`__FILE__, `__LINE__);
      ...
      if (~reset
          & (&(2'({1'h0, _wens_T_73}
                  + 2'({1'h0, _wens_T_75} + {1'h0, _wens_T_77}))))) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed: triple write to the same MSHR buffer entry\n    at MSHRBuffer.scala:52 assert(PopCount(wens) <= 2.U, \"triple write to the same MSHR buffer entry\")\n");
        if (`STOP_COND_)
          xs_assert_v2(`__FILE__, `__LINE__);
      ...
      if (~reset
          & (&(2'({1'h0, _wens_T_79}
                  + 2'({1'h0, _wens_T_81} + {1'h0, _wens_T_83}))))) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed: triple write to the same MSHR buffer entry\n    at MSHRBuffer.scala:52 assert(PopCount(wens) <= 2.U, \"triple write to the same MSHR buffer entry\")\n");
        if (`STOP_COND_)
          xs_assert_v2(`__FILE__, `__LINE__);
      ...
      if (~reset
          & (&(2'({1'h0, _wens_T_85}
                  + 2'({1'h0, _wens_T_87} + {1'h0, _wens_T_89}))))) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed: triple write to the same MSHR buffer entry\n    at MSHRBuffer.scala:52 assert(PopCount(wens) <= 2.U, \"triple write to the same MSHR buffer entry\")\n");
        if (`STOP_COND_)
          xs_assert_v2(`__FILE__, `__LINE__);
      ...
      if (~reset
          & (&(2'({1'h0, _wens_T_91}
                  + 2'({1'h0, _wens_T_93} + {1'h0, _wens_T_95}))))) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed: triple write to the same MSHR buffer entry\n    at MSHRBuffer.scala:52 assert(PopCount(wens) <= 2.U, \"triple write to the same MSHR buffer entry\")\n");
        if (`STOP_COND_)
          xs_assert_v2(`__FILE__, `__LINE__);
