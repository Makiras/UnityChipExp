    ...
    always @(posedge clock) begin
      if (~reset & ~_queue_io_enq_ready) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed: SourceC should never be full\n    at SourceC.scala:226 assert(io.in.ready, \"SourceC should never be full\") // WARNING\n");
        if (`STOP_COND_)
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        taskR_task_dirty = _RANDOM[5'h4][9];
        taskR_task_reqSource = _RANDOM[5'h5][10:7];
        taskR_data_data =
          {_RANDOM[5'h8][31:6],
           _RANDOM[5'h9],
           _RANDOM[5'hA],
