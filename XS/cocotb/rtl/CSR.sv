...
module CSR(
  ...
  reg         io_out_bits_ctrl_preDecode_r_valid;
  reg         io_out_bits_ctrl_preDecode_r_isRVC;
  reg  [1:0]  io_out_bits_ctrl_preDecode_r_brType;
  reg         io_out_bits_ctrl_preDecode_r_isCall;
  reg         io_out_bits_ctrl_preDecode_r_isRet;
  ...
  always @(posedge clock) begin
    if (_io_csrio_isPerfCnt_T_2) begin
      ...
      io_out_bits_ctrl_preDecode_r_valid <= io_in_bits_ctrl_preDecode_valid;
      io_out_bits_ctrl_preDecode_r_isRVC <= io_in_bits_ctrl_preDecode_isRVC;
      io_out_bits_ctrl_preDecode_r_brType <= io_in_bits_ctrl_preDecode_brType;
      io_out_bits_ctrl_preDecode_r_isCall <= io_in_bits_ctrl_preDecode_isCall;
      io_out_bits_ctrl_preDecode_r_isRet <= io_in_bits_ctrl_preDecode_isRet;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        robIdxReg_value = _RANDOM[5'h0][8:1];
        trapInstMod_io_fromDecode_trapInstInfo_next_valid_last_REG = _RANDOM[5'h0][9];
        trapInstMod_io_fromDecode_trapInstInfo_next_bits_r_instr =
          {_RANDOM[5'h0][31:10], _RANDOM[5'h1][9:0]};
        trapInstMod_io_fromDecode_trapInstInfo_next_bits_r_ftqPtr_flag =
          _RANDOM[5'h1][10];
        trapInstMod_io_fromDecode_trapInstInfo_next_bits_r_ftqPtr_value =
          _RANDOM[5'h1][16:11];
        trapInstMod_io_fromDecode_trapInstInfo_next_bits_r_ftqOffset =
          _RANDOM[5'h1][20:17];
        trapInstMod_io_faultCsrUop_bits_fuOpType_r = _RANDOM[5'h1][29:21];
        trapInstMod_io_faultCsrUop_bits_imm_r =
          {_RANDOM[5'h1][31:30], _RANDOM[5'h2], _RANDOM[5'h3][29:0]};
        trapInstMod_io_faultCsrUop_bits_ftqInfo_ftqPtr_r_flag = _RANDOM[5'h3][30];
        trapInstMod_io_faultCsrUop_bits_ftqInfo_ftqPtr_r_value =
          {_RANDOM[5'h3][31], _RANDOM[5'h4][4:0]};
        trapInstMod_io_faultCsrUop_bits_ftqInfo_ftqOffset_r = _RANDOM[5'h4][8:5];
        exceptionVec_3_r = _RANDOM[5'h4][9];
        exceptionVec_11_r = _RANDOM[5'h4][10];
        exceptionVec_9_r = _RANDOM[5'h4][11];
        exceptionVec_10_r = _RANDOM[5'h4][12];
        exceptionVec_8_r = _RANDOM[5'h4][13];
        io_out_bits_res_redirect_valid_r = _RANDOM[5'h4][14];
        io_out_bits_res_redirect_bits_ftqIdx_r_flag = _RANDOM[5'h4][15];
        io_out_bits_res_redirect_bits_ftqIdx_r_value = _RANDOM[5'h4][21:16];
        io_out_bits_res_redirect_bits_ftqOffset_r = _RANDOM[5'h4][25:22];
        io_out_bits_ctrl_robIdx_r_flag = _RANDOM[5'h4][26];
        io_out_bits_ctrl_robIdx_r_value = {_RANDOM[5'h4][31:27], _RANDOM[5'h5][2:0]};
        io_out_bits_ctrl_pdest_r = _RANDOM[5'h5][10:3];
        io_out_bits_ctrl_rfWen_r = _RANDOM[5'h5][11];
        io_out_bits_ctrl_preDecode_r_valid = _RANDOM[5'h5][12];
        io_out_bits_ctrl_preDecode_r_isRVC = _RANDOM[5'h5][13];
        io_out_bits_ctrl_preDecode_r_brType = _RANDOM[5'h5][15:14];
        io_out_bits_ctrl_preDecode_r_isCall = _RANDOM[5'h5][16];
        io_out_bits_ctrl_preDecode_r_isRet = _RANDOM[5'h5][17];
        io_out_bits_perfDebugInfo_r_eliminatedMove = _RANDOM[5'h5][18];
        io_out_bits_perfDebugInfo_r_renameTime =
          {_RANDOM[5'h5][31:19], _RANDOM[5'h6], _RANDOM[5'h7][18:0]};
        io_out_bits_perfDebugInfo_r_dispatchTime =
          {_RANDOM[5'h7][31:19], _RANDOM[5'h8], _RANDOM[5'h9][18:0]};
        io_out_bits_perfDebugInfo_r_enqRsTime =
          {_RANDOM[5'h9][31:19], _RANDOM[5'hA], _RANDOM[5'hB][18:0]};
        io_out_bits_perfDebugInfo_r_selectTime =
          {_RANDOM[5'hB][31:19], _RANDOM[5'hC], _RANDOM[5'hD][18:0]};
        io_out_bits_perfDebugInfo_r_issueTime =
          {_RANDOM[5'hD][31:19], _RANDOM[5'hE], _RANDOM[5'hF][18:0]};
        io_out_bits_perfDebugInfo_r_writebackTime =
          {_RANDOM[5'hF][31:19], _RANDOM[5'h10], _RANDOM[5'h11][18:0]};
        io_out_bits_perfDebugInfo_r_runahead_checkpoint_id =
          {_RANDOM[5'h11][31:19], _RANDOM[5'h12], _RANDOM[5'h13][18:0]};
        io_out_bits_perfDebugInfo_r_tlbFirstReqTime =
          {_RANDOM[5'h13][31:19], _RANDOM[5'h14], _RANDOM[5'h15][18:0]};
        io_out_bits_perfDebugInfo_r_tlbRespTime =
          {_RANDOM[5'h15][31:19], _RANDOM[5'h16], _RANDOM[5'h17][18:0]};
        io_error_0_REG = _RANDOM[5'h17][19];
        io_error_0_REG_1 = _RANDOM[5'h17][20];
        io_csrio_isPerfCnt_r = _RANDOM[5'h17][21];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        trapInstMod_io_fromDecode_trapInstInfo_next_valid_last_REG = 1'h0;
        exceptionVec_3_r = 1'h0;
  ...
  assign io_out_bits_ctrl_preDecode_valid = io_out_bits_ctrl_preDecode_r_valid;
  assign io_out_bits_ctrl_preDecode_isRVC = io_out_bits_ctrl_preDecode_r_isRVC;
  assign io_out_bits_ctrl_preDecode_brType = io_out_bits_ctrl_preDecode_r_brType;
  assign io_out_bits_ctrl_preDecode_isCall = io_out_bits_ctrl_preDecode_r_isCall;
  assign io_out_bits_ctrl_preDecode_isRet = io_out_bits_ctrl_preDecode_r_isRet;
