...
module LatchFastArbiter(
  ...
  reg  [3:0]  out_bits_reg_reqSource;
  reg  [13:0] chosen_reg;
  wire [13:0] valids =
    {io_in_13_valid,
     io_in_12_valid,
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        out_bits_reg_reqSource = _RANDOM[3'h3][5:2];
        chosen_reg = _RANDOM[3'h3][19:6];
        pendingMask = {_RANDOM[3'h3][31:20], _RANDOM[3'h4][1:0]};
        rrGrantMask = _RANDOM[3'h4][15:2];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        out_valid_reg = 1'h0;
        out_bits_reg_tag = 28'h0;
  ...
  assign io_out_bits_reqSource = out_bits_reg_reqSource;
endmodule
