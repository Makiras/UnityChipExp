...
module Queue2_TLBundleB_1(
  ...
  ram_2x309 ram_ext (
    ...
    .W0_clk  (clock),
    .W0_data
      ({io_enq_bits_data, io_enq_bits_address, io_enq_bits_param, io_enq_bits_opcode})
  );
  assign io_enq_ready = ~full;
  assign io_deq_valid = ~empty;
  assign io_deq_bits_opcode = _ram_ext_R0_data[2:0];
  assign io_deq_bits_param = _ram_ext_R0_data[4:3];
  assign io_deq_bits_address = _ram_ext_R0_data[52:5];
  assign io_deq_bits_data = _ram_ext_R0_data[308:53];
endmodule
