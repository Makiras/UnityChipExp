...
module RRArbiterInit_13(
  ...
  assign io_chosen_choice =
    ctrl_validMask_1 ? 2'h1 : ctrl_validMask_2 ? 2'h2 : ctrl_validMask_3 ? 2'h3 : _GEN_62;
  always @(posedge clock or posedge reset) begin
    if (reset)
      ...
      if (ctrl_validMask_1)
        ...
        ctrl_validMask_grantMask_lastGrant <= _GEN_62;
    end
  ...
  assign io_out_bits_fromL2pft = _GEN_21[io_chosen_choice];
  assign io_out_bits_needHint = _GEN_22[io_chosen_choice];
  assign io_out_bits_dirty = _GEN_23[io_chosen_choice];
  assign io_out_bits_way = _GEN_24[io_chosen_choice];
  assign io_out_bits_meta_dirty = _GEN_25[io_chosen_choice];
  assign io_out_bits_meta_state = _GEN_26[io_chosen_choice];
  assign io_out_bits_meta_clients = _GEN_27[io_chosen_choice];
  assign io_out_bits_meta_alias = _GEN_28[io_chosen_choice];
  assign io_out_bits_meta_prefetch = _GEN_29[io_chosen_choice];
  assign io_out_bits_meta_prefetchSrc = _GEN_30[io_chosen_choice];
  assign io_out_bits_meta_accessed = _GEN_31[io_chosen_choice];
  assign io_out_bits_meta_tagErr = _GEN_32[io_chosen_choice];
  assign io_out_bits_meta_dataErr = _GEN_33[io_chosen_choice];
  assign io_out_bits_metaWen = _GEN_34[io_chosen_choice];
  assign io_out_bits_tagWen = _GEN_35[io_chosen_choice];
  assign io_out_bits_dsWen = _GEN_36[io_chosen_choice];
  assign io_out_bits_wayMask = _GEN_37[io_chosen_choice];
  assign io_out_bits_replTask = _GEN_38[io_chosen_choice];
  assign io_out_bits_cmoTask = _GEN_39[io_chosen_choice];
  assign io_out_bits_reqSource = _GEN_40[io_chosen_choice];
  assign io_out_bits_mergeA = _GEN_41[io_chosen_choice];
  assign io_out_bits_aMergeTask_off = _GEN_42[io_chosen_choice];
  assign io_out_bits_aMergeTask_alias = _GEN_43[io_chosen_choice];
  assign io_out_bits_aMergeTask_vaddr = _GEN_44[io_chosen_choice];
  assign io_out_bits_aMergeTask_isKeyword = _GEN_45[io_chosen_choice];
  assign io_out_bits_aMergeTask_opcode = _GEN_46[io_chosen_choice];
  assign io_out_bits_aMergeTask_param = _GEN_47[io_chosen_choice];
  assign io_out_bits_aMergeTask_sourceId = _GEN_48[io_chosen_choice];
  assign io_out_bits_aMergeTask_meta_dirty = _GEN_49[io_chosen_choice];
  assign io_out_bits_aMergeTask_meta_state = _GEN_50[io_chosen_choice];
  assign io_out_bits_aMergeTask_meta_clients = _GEN_51[io_chosen_choice];
  assign io_out_bits_aMergeTask_meta_alias = _GEN_52[io_chosen_choice];
  assign io_out_bits_aMergeTask_meta_prefetch = _GEN_53[io_chosen_choice];
  assign io_out_bits_aMergeTask_meta_prefetchSrc = _GEN_54[io_chosen_choice];
  assign io_out_bits_aMergeTask_meta_accessed = _GEN_55[io_chosen_choice];
  assign io_out_bits_aMergeTask_meta_tagErr = _GEN_56[io_chosen_choice];
  assign io_out_bits_aMergeTask_meta_dataErr = _GEN_57[io_chosen_choice];
  assign io_out_bits_snpHitRelease = _GEN_58[io_chosen_choice];
  assign io_out_bits_snpHitReleaseToB = _GEN_59[io_chosen_choice];
  assign io_out_bits_snpHitReleaseWithData = _GEN_60[io_chosen_choice];
  assign io_out_bits_snpHitReleaseIdx = _GEN_61[io_chosen_choice];
endmodule
