...
module RASStack(
  ...
  wire              spec_near_overflowed_probe = spec_near_overflowed;
  ...
  wire [15:0][2:0]  _GEN_5 =
    {{commit_stack_15_ctr},
     ...
     {commit_stack_1_ctr},
     {commit_stack_0_ctr}};
  wire [49:0]       _GEN_6 = topEntry_inflightValid ? _GEN_1 : _GEN_4;
  wire [31:0]       _GEN_7 =
    {{spec_nos_31_flag},
     {spec_nos_30_flag},
     {spec_nos_29_flag},
  ...
  wire              _writeEntry_ctr_T_7 =
    (writeBypassValid ? writeBypassEntry_retAddr : _GEN_6) == io_spec_push_addr;
  wire [2:0]        _sctr_T = 3'(sctr + 3'h1);
  reg  [49:0]       timingTop_retAddr;
  wire              _GEN_10 =
    (writeBypassValid ? writeBypassEntry_retAddr : _GEN_6) != timingTop_retAddr;
  reg  [49:0]       realWriteEntry_next_retAddr;
  reg  [2:0]        realWriteEntry_next_ctr;
  wire              _GEN_11 = io_redirect_isCall | ~io_s3_missed_push;
  wire [49:0]       realWriteEntry_retAddr =
    _GEN_11 ? realWriteEntry_next_retAddr : io_s3_pushAddr;
  ...
  wire [5:0]        _GEN_12 = {1'h0, BOS_value};
  wire              _GEN_13 =
    io_commit_valid
    & (io_commit_meta_TOSW_flag == BOS_flag
         ? {1'h0, 5'(io_commit_meta_TOSW_value - BOS_value)}
         : 6'(6'({1'h0, io_commit_meta_TOSW_value} - 6'h20) - _GEN_12)) > 6'h2;
  `ifndef SYNTHESIS
  ...
  wire              _GEN_15 = _writeEntry_ctr_T_1 & io_redirect_meta_sctr != 3'h7;
  wire              _GEN_16 =
  ...
  wire [5:0]        _GEN_17 = 6'({io_s3_meta_TOSW_flag, io_s3_meta_TOSW_value} + 6'h1);
  wire [5:0]        _GEN_18 = 6'({TOSW_flag, TOSW_value} + 6'h1);
  wire              _GEN_19 = _writeEntry_ctr_T_7 & sctr != 3'h7;
  ...
  wire              _GEN_20 = io_redirect_meta_NOS_value >= BOS_value;
  wire              _GEN_21 = io_redirect_meta_NOS_flag ^ BOS_flag ^ _GEN_20;
  wire              _GEN_22 = topNos_value >= BOS_value;
  wire              _GEN_23 = topNos_flag ^ BOS_flag ^ _GEN_22;
  wire              _GEN_24 = io_s3_meta_NOS_value >= BOS_value;
  wire              _GEN_25 = io_s3_meta_NOS_flag ^ BOS_flag ^ _GEN_24;
  ...
  wire [4:0]        realWriteAddr_value =
    _GEN_11 ? realWriteAddr_next_value : io_s3_meta_TOSW_value;
  wire              realNos_flag = _GEN_11 ? realNos_next_flag : io_s3_meta_TOSR_flag;
  wire [4:0]        realNos_value = _GEN_11 ? realNos_next_value : io_s3_meta_TOSR_value;
  ...
  wire              _GEN_75 = _s3_missPushEntry_ctr_T & io_s3_meta_sctr != 3'h7;
  wire              inflightValid_4 =
    _GEN_23 & (topNos_flag ^ TOSW_flag ^ topNos_value < TOSW_value);
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      if (io_redirect_valid) begin
          ...
          io_redirect_isRet
            ? ((|io_redirect_meta_sctr)
                 ...
                 : inflightValid_8
                     ...
                     : _GEN_5[_sctr_T_16])
            : io_redirect_isCall ? (_GEN_15 ? _sctr_T_12 : 3'h0) : io_redirect_meta_sctr;
        TOSR_flag <=
          _GEN_16
        ...
        TOSW_flag <= io_redirect_isCall ? _GEN_14[5] : io_redirect_meta_TOSW_flag;
        TOSW_value <= io_redirect_isCall ? _GEN_14[4:0] : io_redirect_meta_TOSW_value;
      end
      else if (io_s3_cancel) begin
        ssp <=
          ~io_s3_missed_push | _GEN_75
        ...
        TOSR_flag <=
          io_s3_missed_push
            ...
            : _GEN_74 ? io_s3_meta_NOS_flag : io_s3_meta_TOSR_flag;
        TOSR_value <=
          io_s3_missed_push
            ? io_s3_meta_TOSW_value
            : _GEN_74 ? io_s3_meta_NOS_value : io_s3_meta_TOSR_value;
        TOSW_flag <= io_s3_missed_push ? _GEN_17[5] : io_s3_meta_TOSW_flag;
        TOSW_value <= io_s3_missed_push ? _GEN_17[4:0] : io_s3_meta_TOSW_value;
      end
      else begin
        if (~io_spec_pop_valid | (|sctr)) begin
          if (~io_spec_push_valid | _GEN_19) begin
          end
          else
            ssp <= 4'(ssp + 4'h1);
        end
        ...
        if (io_spec_push_valid) begin
          TOSW_flag <= _GEN_18[5];
          TOSW_value <= _GEN_18[4:0];
        end
      end
      spec_near_overflowed <=
        (TOSW_flag == BOS_flag
           ? {1'h0, 5'(TOSW_value - BOS_value)}
           : 6'(6'({1'h0, TOSW_value} - 6'h20) - _GEN_12)) > 6'h1C;
      ...
      timingTop_retAddr <=
        writeBypassValidWire
          ...
          : io_redirect_valid & io_redirect_isRet
              ? ((io_redirect_meta_NOS_flag ^ BOS_flag ^ _GEN_20)
                 & (io_redirect_meta_NOS_flag ^ io_redirect_meta_TOSW_flag
                    ^ io_redirect_meta_NOS_value < io_redirect_meta_TOSW_value)
                      ...
                      : realPush
                          ...
                          : io_s3_cancel
                              ? (io_s3_missed_push
                                   ? io_s3_pushAddr
                                   : io_s3_missed_pop
                                       ? ((io_s3_meta_NOS_flag ^ BOS_flag ^ _GEN_24)
                                          & (io_s3_meta_NOS_flag ^ io_s3_meta_TOSW_flag
                                             ^ io_s3_meta_NOS_value < io_s3_meta_TOSW_value)
