...
module Directory(
  ...
  reg  [37:0]      tagAll_s3_0;
  reg  [37:0]      tagAll_s3_1;
  reg  [37:0]      tagAll_s3_2;
  reg  [37:0]      tagAll_s3_3;
  reg  [37:0]      tagAll_s3_4;
  reg  [37:0]      tagAll_s3_5;
  reg  [37:0]      tagAll_s3_6;
  reg  [37:0]      tagAll_s3_7;
  wire             hitVec_1 = tagAll_s3_1[30:0] == req_s3_tag & (|metaAll_s3_1_state);
  wire             hitVec_2 = tagAll_s3_2[30:0] == req_s3_tag & (|metaAll_s3_2_state);
  wire             hitVec_3 = tagAll_s3_3[30:0] == req_s3_tag & (|metaAll_s3_3_state);
  wire             hitVec_4 = tagAll_s3_4[30:0] == req_s3_tag & (|metaAll_s3_4_state);
  wire             hitVec_5 = tagAll_s3_5[30:0] == req_s3_tag & (|metaAll_s3_5_state);
  wire             hitVec_6 = tagAll_s3_6[30:0] == req_s3_tag & (|metaAll_s3_6_state);
  wire             hitVec_7 = tagAll_s3_7[30:0] == req_s3_tag & (|metaAll_s3_7_state);
    ...
    (|_has_invalid_way_T)
      ? (_way_T | invalid_vec_2 | invalid_vec_3
           ...
           : invalid_vec_4 | invalid_vec_5
               ...
               : {2'h3, ~invalid_vec_6})
      : replaceWay;
  wire [7:0]       _GEN = {5'h0, chosenWay};
  wire [7:0]       _finalWay_T = freeWayMask_s3 >> _GEN;
  wire [2:0]       finalWay =
    _finalWay_T[0]
      ? chosenWay
      : freeWayMask_s3[0]
  ...
  wire [7:0]       _hit_s3_T =
    {tagAll_s3_0[30:0] == req_s3_tag & (|metaAll_s3_0_state),
     hitVec_1,
     hitVec_2,
     hitVec_3,
     hitVec_4,
  ...
  wire             _GEN_11 = resetFinish & (|_hit_s3_T);
  ...
  wire             _rrip_req_type_T_10 =
    ...
    | req_s3_replacerInfo_channel[2] & _GEN_5[way_s3] | refillReqValid_s3
  ...
  wire [7:0]       _GEN_15 = req_s3_wayMask >> _GEN;
  wire             _GEN_16 = reqValid_s3 & ~(_GEN_15[0]);
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        req_s2_wayMask = _RANDOM[5'h3][11:4];
        req_s2_replacerInfo_channel = _RANDOM[5'h3][14:12];
        req_s2_replacerInfo_opcode = _RANDOM[5'h3][17:15];
        req_s2_replacerInfo_reqSource = _RANDOM[5'h3][21:18];
        req_s2_replacerInfo_refill_prefetch = _RANDOM[5'h3][22];
        req_s2_refill = _RANDOM[5'h3][23];
        req_s2_mshrId = _RANDOM[5'h3][31:24];
        req_s3_tag = _RANDOM[5'h4][30:0];
        req_s3_set = {_RANDOM[5'h4][31], _RANDOM[5'h5][7:0]};
        req_s3_wayMask = _RANDOM[5'h5][15:8];
        req_s3_replacerInfo_channel = _RANDOM[5'h5][18:16];
        req_s3_replacerInfo_opcode = _RANDOM[5'h5][21:19];
        req_s3_replacerInfo_reqSource = _RANDOM[5'h5][25:22];
        ...
        refillReqValid_s2 = _RANDOM[5'h6][4];
        refillReqValid_s3 = _RANDOM[5'h6][5];
        metaAll_s3_0_dirty = _RANDOM[5'h6][6];
        metaAll_s3_0_state = _RANDOM[5'h6][8:7];
        metaAll_s3_0_clients = _RANDOM[5'h6][9];
        metaAll_s3_0_alias = _RANDOM[5'h6][11:10];
        metaAll_s3_0_prefetch = _RANDOM[5'h6][12];
        metaAll_s3_0_prefetchSrc = _RANDOM[5'h6][15:13];
        metaAll_s3_0_accessed = _RANDOM[5'h6][16];
        metaAll_s3_0_tagErr = _RANDOM[5'h6][17];
        metaAll_s3_0_dataErr = _RANDOM[5'h6][18];
        metaAll_s3_1_dirty = _RANDOM[5'h6][19];
        metaAll_s3_1_state = _RANDOM[5'h6][21:20];
        metaAll_s3_1_clients = _RANDOM[5'h6][22];
        metaAll_s3_1_alias = _RANDOM[5'h6][24:23];
        metaAll_s3_1_prefetch = _RANDOM[5'h6][25];
        metaAll_s3_1_prefetchSrc = _RANDOM[5'h6][28:26];
        metaAll_s3_1_accessed = _RANDOM[5'h6][29];
        metaAll_s3_1_tagErr = _RANDOM[5'h6][30];
        metaAll_s3_1_dataErr = _RANDOM[5'h6][31];
        metaAll_s3_2_dirty = _RANDOM[5'h7][0];
        metaAll_s3_2_state = _RANDOM[5'h7][2:1];
        metaAll_s3_2_clients = _RANDOM[5'h7][3];
        metaAll_s3_2_alias = _RANDOM[5'h7][5:4];
        metaAll_s3_2_prefetch = _RANDOM[5'h7][6];
        metaAll_s3_2_prefetchSrc = _RANDOM[5'h7][9:7];
        metaAll_s3_2_accessed = _RANDOM[5'h7][10];
        metaAll_s3_2_tagErr = _RANDOM[5'h7][11];
        metaAll_s3_2_dataErr = _RANDOM[5'h7][12];
        metaAll_s3_3_dirty = _RANDOM[5'h7][13];
        metaAll_s3_3_state = _RANDOM[5'h7][15:14];
        metaAll_s3_3_clients = _RANDOM[5'h7][16];
        metaAll_s3_3_alias = _RANDOM[5'h7][18:17];
        metaAll_s3_3_prefetch = _RANDOM[5'h7][19];
        metaAll_s3_3_prefetchSrc = _RANDOM[5'h7][22:20];
        metaAll_s3_3_accessed = _RANDOM[5'h7][23];
        metaAll_s3_3_tagErr = _RANDOM[5'h7][24];
        metaAll_s3_3_dataErr = _RANDOM[5'h7][25];
        metaAll_s3_4_dirty = _RANDOM[5'h7][26];
        metaAll_s3_4_state = _RANDOM[5'h7][28:27];
        metaAll_s3_4_clients = _RANDOM[5'h7][29];
        metaAll_s3_4_alias = _RANDOM[5'h7][31:30];
        metaAll_s3_4_prefetch = _RANDOM[5'h8][0];
        metaAll_s3_4_prefetchSrc = _RANDOM[5'h8][3:1];
        metaAll_s3_4_accessed = _RANDOM[5'h8][4];
        metaAll_s3_4_tagErr = _RANDOM[5'h8][5];
        metaAll_s3_4_dataErr = _RANDOM[5'h8][6];
        metaAll_s3_5_dirty = _RANDOM[5'h8][7];
        metaAll_s3_5_state = _RANDOM[5'h8][9:8];
        metaAll_s3_5_clients = _RANDOM[5'h8][10];
        metaAll_s3_5_alias = _RANDOM[5'h8][12:11];
        metaAll_s3_5_prefetch = _RANDOM[5'h8][13];
        metaAll_s3_5_prefetchSrc = _RANDOM[5'h8][16:14];
        metaAll_s3_5_accessed = _RANDOM[5'h8][17];
        metaAll_s3_5_tagErr = _RANDOM[5'h8][18];
        metaAll_s3_5_dataErr = _RANDOM[5'h8][19];
        metaAll_s3_6_dirty = _RANDOM[5'h8][20];
        metaAll_s3_6_state = _RANDOM[5'h8][22:21];
        metaAll_s3_6_clients = _RANDOM[5'h8][23];
        metaAll_s3_6_alias = _RANDOM[5'h8][25:24];
        metaAll_s3_6_prefetch = _RANDOM[5'h8][26];
        metaAll_s3_6_prefetchSrc = _RANDOM[5'h8][29:27];
        metaAll_s3_6_accessed = _RANDOM[5'h8][30];
        metaAll_s3_6_tagErr = _RANDOM[5'h8][31];
        metaAll_s3_6_dataErr = _RANDOM[5'h9][0];
        metaAll_s3_7_dirty = _RANDOM[5'h9][1];
        metaAll_s3_7_state = _RANDOM[5'h9][3:2];
        metaAll_s3_7_clients = _RANDOM[5'h9][4];
        metaAll_s3_7_alias = _RANDOM[5'h9][6:5];
        metaAll_s3_7_prefetch = _RANDOM[5'h9][7];
        metaAll_s3_7_prefetchSrc = _RANDOM[5'h9][10:8];
        metaAll_s3_7_accessed = _RANDOM[5'h9][11];
        metaAll_s3_7_tagErr = _RANDOM[5'h9][12];
        metaAll_s3_7_dataErr = _RANDOM[5'h9][13];
        tagAll_s3_0 = {_RANDOM[5'h9][31:14], _RANDOM[5'hA][19:0]};
        tagAll_s3_1 = {_RANDOM[5'hA][31:20], _RANDOM[5'hB][25:0]};
        tagAll_s3_2 = {_RANDOM[5'hB][31:26], _RANDOM[5'hC]};
        tagAll_s3_3 = {_RANDOM[5'hD], _RANDOM[5'hE][5:0]};
        tagAll_s3_4 = {_RANDOM[5'hE][31:6], _RANDOM[5'hF][11:0]};
        tagAll_s3_5 = {_RANDOM[5'hF][31:12], _RANDOM[5'h10][17:0]};
        tagAll_s3_6 = {_RANDOM[5'h10][31:18], _RANDOM[5'h11][23:0]};
        tagAll_s3_7 = {_RANDOM[5'h11][31:24], _RANDOM[5'h12][29:0]};
        freeWayMask_s3 = {_RANDOM[5'h12][31:30], _RANDOM[5'h13][5:0]};
        repl_state_s3 = _RANDOM[5'h13][21:6];
        REG = _RANDOM[5'h13][22];
        r_0 = _RANDOM[5'h13][23];
        r_1 = _RANDOM[5'h13][24];
        r_2 = _RANDOM[5'h13][25];
        r_3 = _RANDOM[5'h13][26];
        r_4 = _RANDOM[5'h13][27];
        r_5 = _RANDOM[5'h13][28];
        r_6 = _RANDOM[5'h13][29];
        r_7 = _RANDOM[5'h13][30];
        PSEL = {_RANDOM[5'h13][31], _RANDOM[5'h14][8:0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        resetFinish = 1'h0;
        resetIdx = 9'h1FF;
  ...
  assign io_resp_bits_tag = _GEN_0[way_s3][30:0];
  assign io_resp_bits_set = req_s3_set;
  assign io_resp_bits_way = way_s3;
  assign io_resp_bits_meta_dirty = _GEN_1[way_s3];
  assign io_resp_bits_meta_state = _GEN_2[way_s3];
  assign io_resp_bits_meta_clients = _GEN_3[way_s3];
  assign io_resp_bits_meta_alias = _GEN_4[way_s3];
  assign io_resp_bits_meta_prefetch = _GEN_5[way_s3];
  assign io_resp_bits_meta_prefetchSrc = _GEN_6[way_s3];
  assign io_resp_bits_meta_accessed = _GEN_7[way_s3];
  assign io_resp_bits_meta_tagErr = _GEN_8[way_s3];
  assign io_resp_bits_meta_dataErr = _GEN_9[way_s3];
  assign io_resp_bits_error =
    (^_GEN_0[way_s3] | ~(^_GEN_0[way_s3])
     & (|{^{_GEN_0[way_s3][36:26] & 11'h41F, 26'h0},
          ^{_GEN_0[way_s3][35:11] & 25'h1007FFF, 11'h0},
          ^{_GEN_0[way_s3][34:4] & 31'h403FC07F, 4'h0},
          ^{_GEN_0[way_s3][33:1] & 33'h131E1E3C7, 1'h0},
          ^(_GEN_0[way_s3][32:0] & 33'h11B33366D),
          ^(_GEN_0[way_s3][31:0] & 32'hD6AAAD5B)})) & reqValid_s3 & (|_GEN_2[way_s3]);
  ...
  assign io_replResp_bits_tag = _GEN_0[finalWay][30:0];
  assign io_replResp_bits_set = req_s3_set;
  assign io_replResp_bits_way = finalWay;
  assign io_replResp_bits_meta_dirty = _GEN_1[finalWay];
  assign io_replResp_bits_meta_state = _GEN_2[finalWay];
  assign io_replResp_bits_meta_clients = _GEN_3[finalWay];
  assign io_replResp_bits_meta_alias = _GEN_4[finalWay];
  assign io_replResp_bits_meta_prefetch = _GEN_5[finalWay];
  assign io_replResp_bits_meta_prefetchSrc = _GEN_6[finalWay];
  assign io_replResp_bits_meta_accessed = _GEN_7[finalWay];
  assign io_replResp_bits_meta_tagErr = _GEN_8[finalWay];
  assign io_replResp_bits_meta_dataErr = _GEN_9[finalWay];
