...
module TLBNonBlock_1(
  ...
  input  [6:0]  io_requestor_0_req_bits_memidx_idx,
  ...
  output [6:0]  io_requestor_0_resp_bits_memidx_idx,
  ...
  input  [6:0]  io_requestor_1_req_bits_memidx_idx,
  ...
  output [6:0]  io_requestor_1_resp_bits_memidx_idx,
  ...
  wire             _readResult_T_33 =
    ...
    & need_gpa_vpn == (_ptw_just_back_T_13
                         ...
                         : (&io_ptw_resp_bits_s2xlate)
                             ...
                             : readResult_s1tag);
  wire             _GEN_7 = _readResult_T_4 | _readResult_T_25;
  ...
  wire             miss_read_0 =
    ...
    & ~readResult_lastCycleRedirect;
  reg  [6:0]       readResult_io_requestor_0_resp_bits_memidx_r_idx;
    ...
    & need_gpa_vpn == (_ptw_just_back_T_13
                         ...
                         : (&io_ptw_resp_bits_s2xlate)
                             ? _GEN_10[_ptw_just_back_level_T_1
                                         ...
                                         : io_ptw_resp_bits_s2_entry_level]
                             : readResult_s1tag_1);
  wire             _GEN_11 = _readResult_T_41 | _readResult_T_62;
  ...
  wire             miss_read_1 =
    ...
    & ~readResult_lastCycleRedirect_1;
  reg  [6:0]       readResult_io_requestor_1_resp_bits_memidx_r_idx;
  ...
  wire             _GEN_18 = result_ok_last_REG & _portTranslateEnable_T;
  reg              r;
  wire             _GEN_19 = _GEN_18 & r;
  wire             _GEN_20 = _GEN_18 & miss_read_0;
  reg              r_1;
  wire             _GEN_21 = _GEN_20 & r_1;
  wire             _GEN_22 = result_ok_last_REG_1 & _portTranslateEnable_T_2;
  reg              r_2;
  wire             _GEN_23 = _GEN_22 & r_2;
  wire             _GEN_24 = _GEN_22 & miss_read_1;
  reg              r_3;
  wire             _GEN_25 = _GEN_24 & r_3;
  wire             _GEN_26 = io_ptw_resp_valid & io_ptw_resp_bits_s1_pf;
  ...
  wire             difftest_valid =
    ...
    & ~io_requestor_0_resp_bits_excp_0_pf_st_0 & ~io_requestor_0_resp_bits_excp_0_af_st_0
    & ~io_requestor_0_resp_bits_excp_0_gpf_st_0 & _portTranslateEnable_T;
  reg  [37:0]      difftest_vpn_r;
  reg              req_s2xlate_REG;
  wire             _req_s2xlate_T_41 = _vsatp_delay_io_out_mode == 4'h0;
  wire             _req_s2xlate_T_42 = _hgatp_delay_io_out_mode == 4'h0;
  reg              difftest_valid_REG_1;
  wire             difftest_1_valid =
    difftest_valid_REG_1 & req_out_v_1 & ~io_requestor_1_resp_bits_miss_0
    & ~io_requestor_1_resp_bits_excp_0_pf_st_0 & ~io_requestor_1_resp_bits_excp_0_af_st_0
    & ~io_requestor_1_resp_bits_excp_0_gpf_st_0 & _portTranslateEnable_T_2;
  ...
  wire             prevmEnable_0 =
    ~_req_s2xlate_T_24 & _prevmEnable_T_7 & _pres2xlateEnable_T_3;
  wire             _pres2xlateEnable_T_7 = premode_1 != 2'h3;
  wire             prevmEnable_1 =
    ~_req_s2xlate_T_36 & _prevmEnable_T_7 & _pres2xlateEnable_T_7;
  wire             pres2xlateEnable_0 =
    _req_s2xlate_T_24 & _pres2xlateEnable_T_5 & _pres2xlateEnable_T_3;
  wire             pres2xlateEnable_1 =
    _req_s2xlate_T_36 & _pres2xlateEnable_T_5 & _pres2xlateEnable_T_7;
  wire             _GEN_27 = premode_0 == 2'h1;
  wire             _GEN_28 = io_csr_priv_imode == 2'h0;
  wire [1:0]       pmm =
    (&premode_0)
      ? io_csr_pmm_mseccfg
      : ~_req_s2xlate_T_24 & _GEN_27
          ? io_csr_pmm_menvcfg
          : _req_s2xlate_T_24 & _GEN_27
              ? io_csr_pmm_henvcfg
              : io_requestor_0_req_bits_hyperinst & _GEN_28
                  ? io_csr_pmm_hstatus
                  : premode_0 == 2'h0 ? io_csr_pmm_senvcfg : 2'h0;
  wire             _GEN_29 = pmm == 2'h2;
  ...
  wire             _GEN_31 = prevmEnable_0 | pres2xlateEnable_0;
  wire             _GEN_32 = req_in_s2xlate_0 == 2'h2;
  wire             pregpf_0 =
  ...
  wire             preaf_0 = _GEN_30 & ~_GEN_31 & (|(EffectiveVa_0[63:48]));
  wire             _GEN_33 = premode_1 == 2'h1;
  wire [1:0]       pmm_1 =
    (&premode_1)
      ? io_csr_pmm_mseccfg
      : ~_req_s2xlate_T_36 & _GEN_33
          ? io_csr_pmm_menvcfg
          : _req_s2xlate_T_36 & _GEN_33
              ? io_csr_pmm_henvcfg
              : io_requestor_1_req_bits_hyperinst & _GEN_28
                  ? io_csr_pmm_hstatus
                  : premode_1 == 2'h0 ? io_csr_pmm_senvcfg : 2'h0;
  wire             _GEN_34 = pmm_1 == 2'h2;
  ...
  wire             _GEN_36 = prevmEnable_1 | pres2xlateEnable_1;
  wire             _GEN_37 = req_in_s2xlate_1 == 2'h2;
  wire             pregpf_1 =
  ...
  wire             preaf_1 = _GEN_35 & ~_GEN_36 & (|(EffectiveVa_1[63:48]));
  ...
  wire [43:0]      _GEN_39 = {6'h0, io_ptw_resp_bits_s2_entry_tag};
  wire [2:0]       _GEN_40 = _GEN_38[need_gpa_vpn[2:0]];
  ...
  wire [2:0]       _GEN_42 = _GEN_38[need_gpa_vpn[2:0]];
  wire [3:0][43:0] _GEN_43 =
    {{{io_ptw_resp_bits_s1_entry_ppn[40:24], need_gpa_vpn[26:0]}},
     {{io_ptw_resp_bits_s1_entry_ppn[40:15], need_gpa_vpn[17:0]}},
     {{io_ptw_resp_bits_s1_entry_ppn[40:6], need_gpa_vpn[8:0]}},
     {{io_ptw_resp_bits_s1_entry_ppn, _GEN_42}}};
  wire [2:0]       _GEN_44 = _GEN_38[io_requestor_0_req_bits_vaddr[14:12]];
  ...
  wire [2:0]       _GEN_46 = _GEN_38[io_requestor_1_req_bits_vaddr[14:12]];
  wire [3:0][43:0] _GEN_47 =
    {{{io_ptw_resp_bits_s1_entry_ppn[40:24], io_requestor_1_req_bits_vaddr[38:12]}},
     ...
     {{io_ptw_resp_bits_s1_entry_ppn, _GEN_46}}};
  wire [26:0]      readResult_gvpn_2 =
    readResult_onlyS2_1
      ? io_requestor_1_req_bits_vaddr[38:12]
      : _GEN_47[io_ptw_resp_bits_s1_entry_level][26:0];
  ...
  always @(posedge clock) begin
    if (io_requestor_0_req_valid) begin
      ...
      readResult_io_requestor_0_resp_bits_memidx_r_idx <=
        io_requestor_0_req_bits_memidx_idx;
    ...
    if (io_requestor_1_req_valid) begin
      ...
      readResult_io_requestor_1_resp_bits_memidx_r_idx <=
        io_requestor_1_req_bits_memidx_idx;
    ...
    req_s2xlate_REG <= _req_s2xlate_T_24;
    difftest_valid_REG_1 <= io_requestor_1_req_valid;
    req_s2xlate_REG_1 <= _req_s2xlate_T_36;
  end // always @(posedge)
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      resp_gpa_refill <=
        ~_GEN_11 & (_readResult_T_70 | ~_GEN_7 & (_readResult_T_33 | resp_gpa_refill));
      if (_GEN_11) begin
        if (_GEN_8) begin
        end
        else
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        readResult_io_requestor_0_resp_bits_memidx_r_idx = _RANDOM[7'h2D][18:12];
        ...
        readResult_io_requestor_1_resp_bits_memidx_r_idx = _RANDOM[7'h43][8:2];
        ...
        ptw_resp_bits_reg_1_s1_entry_level = _RANDOM[7'h4F][17:16];
        ptw_resp_bits_reg_1_s1_addr_low = _RANDOM[7'h50][31:29];
        ptw_resp_bits_reg_1_s1_valididx_0 = _RANDOM[7'h51][24];
        ptw_resp_bits_reg_1_s1_valididx_1 = _RANDOM[7'h51][25];
        ptw_resp_bits_reg_1_s1_valididx_2 = _RANDOM[7'h51][26];
        ptw_resp_bits_reg_1_s1_valididx_3 = _RANDOM[7'h51][27];
        ptw_resp_bits_reg_1_s1_valididx_4 = _RANDOM[7'h51][28];
        ptw_resp_bits_reg_1_s1_valididx_5 = _RANDOM[7'h51][29];
        ptw_resp_bits_reg_1_s1_valididx_6 = _RANDOM[7'h51][30];
        ptw_resp_bits_reg_1_s1_valididx_7 = _RANDOM[7'h51][31];
        ptw_resp_bits_reg_1_s2_entry_tag = {_RANDOM[7'h52][31:10], _RANDOM[7'h53][15:0]};
        ptw_resp_bits_reg_1_s2_entry_vmid = _RANDOM[7'h54][13:0];
        ptw_resp_bits_reg_1_s2_entry_level = _RANDOM[7'h55][30:29];
        ptw_already_back_last_REG_1 = _RANDOM[7'h56][13];
        result_ok_last_REG = _RANDOM[7'h56][15];
        result_ok_last_REG_1 = _RANDOM[7'h56][16];
        r = _RANDOM[7'h56][25];
        r_1 = _RANDOM[7'h56][26];
        r_2 = _RANDOM[7'h56][27];
        r_3 = _RANDOM[7'h56][28];
        difftest_valid_REG = _RANDOM[7'h56][29];
        difftest_vpn_r = {_RANDOM[7'h56][31:30], _RANDOM[7'h57], _RANDOM[7'h58][3:0]};
        req_s2xlate_REG = _RANDOM[7'h58][4];
        difftest_valid_REG_1 = _RANDOM[7'h58][5];
        difftest_vpn_r_1 = {_RANDOM[7'h58][31:6], _RANDOM[7'h59][11:0]};
        req_s2xlate_REG_1 = _RANDOM[7'h59][12];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        req_out_v_0 = 1'h0;
        req_out_v_1 = 1'h0;
  ...
  DummyDPICWrapper_9 difftest_module (
    ...
    .io_bits_ppn     ({28'h0, io_pmp_0_bits_addr_0[47:12]}),
    ...
    .io_bits_s2xlate
      (req_s2xlate_REG
         ? ((|_vsatp_delay_io_out_mode) & (|_hgatp_delay_io_out_mode)
              ...
              : _req_s2xlate_T_41
                  ? 2'h2
                  : {1'h0, _req_s2xlate_T_42 | io_requestor_0_resp_bits_excp_0_gpf_st_0})
         : 2'h0),
  ...
  DummyDPICWrapper_9 difftest_module_1 (
    ...
    .io_bits_ppn     ({28'h0, io_pmp_1_bits_addr_0[47:12]}),
    .io_bits_vsatp   ({io_csr_vsatp_mode, io_csr_vsatp_asid, io_csr_vsatp_ppn}),
    .io_bits_hgatp   ({io_csr_hgatp_mode, io_csr_hgatp_vmid, io_csr_hgatp_ppn}),
    .io_bits_s2xlate
      (req_s2xlate_REG_1
         ? ((|_vsatp_delay_io_out_mode) & (|_hgatp_delay_io_out_mode)
              ...
              : _req_s2xlate_T_41
                  ? 2'h2
                  : {1'h0, _req_s2xlate_T_42 | io_requestor_1_resp_bits_excp_0_gpf_st_0})
         : 2'h0),
    .io_bits_coreid  (difftest_coreid),
    .io_bits_index   (8'h8)
  );
      ...
      : (readResult_p_hit_last_REG
          ...
          : {8'h0,
             ...
             (readResult_p_hit_last_REG ? readResult_p_s1_isLeaf : resp_s1_isLeaf)
               ...
               : {_GEN_9[{readResult_isFakePte_0 & _readResult_vpn_idx_T_12, 1'h0}
  ...
  assign io_requestor_0_resp_bits_pbmt_0 =
    _portTranslateEnable_T ? _GEN_14[req_out_s2xlate_0] : 2'h0;
  ...
  assign io_requestor_0_resp_bits_memidx_idx =
    readResult_io_requestor_0_resp_bits_memidx_r_idx;
      ...
      : (readResult_p_hit_last_REG_1
          ...
          : {8'h0,
             ...
             (readResult_p_hit_last_REG_1 ? readResult_p_s1_isLeaf_1 : resp_s1_isLeaf)
               ...
               : {_GEN_13[{readResult_isFakePte_1_0 & _readResult_vpn_idx_T_12, 1'h0}
  ...
  assign io_requestor_1_resp_bits_pbmt_0 =
    _portTranslateEnable_T_2 ? _GEN_15[req_out_s2xlate_1] : 2'h0;
  ...
  assign io_requestor_1_resp_bits_memidx_idx =
    readResult_io_requestor_1_resp_bits_memidx_r_idx;
