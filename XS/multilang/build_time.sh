...
rm -rf dpi_cpp
echo "############# Codegen time #############" > "${LOG_DIR}/cpp-dpi_codegen_roc.txt"
...
rm -rf dpi_java
echo "############# Codegen time #############" > "${LOG_DIR}/java-dpi_codegen_roc.txt"
...
rm -rf dpi_golang
echo "############# Codegen time #############" > "${LOG_DIR}/golang-dpi_codegen_roc.txt"
