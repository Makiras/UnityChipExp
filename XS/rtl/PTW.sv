...
module PTW(
  ...
  wire             _GEN =
    perfEvents_0_2_probe ? (|io_req_bits_req_info_s2xlate) : (|req_s2xlate);
  ...
  wire             pageFault =
    ...
    | (~(_pageFault_pf_T_6 | io_mem_resp_bits[2]) & io_mem_resp_bits[0]
         ...
         : ~(io_mem_resp_bits[0]) | ~(io_mem_resp_bits[1]) & io_mem_resp_bits[2]
           | io_mem_resp_bits[63] & io_mem_resp_bits[13:10] != 4'h8
           | (_pageFault_pf_T_6 | io_mem_resp_bits[2]) & io_mem_resp_bits[0]
  ...
  wire             _GEN_5 = perfEvents_0_2_probe & io_req_bits_stage1Hit;
  wire             _GEN_6 = io_resp_ready & io_resp_valid_0;
  wire             _GEN_7 = perfEvents_0_2_probe & ~io_req_bits_stage1Hit;
  wire             _GEN_8 = _GEN_0 & io_req_bits_l3Hit;
  wire             _GEN_9 = _GEN_8 | io_req_bits_l2Hit;
  wire             _GEN_10 = _GEN_7 | _GEN_5;
  ...
  wire             _GEN_17 = s2xlate & need_last_s2xlate;
  wire             _GEN_18 = perfEvents_0_2_probe & io_req_bits_req_info_source == 2'h0;
  wire             _GEN_19 = perfEvents_0_2_probe & io_req_bits_req_info_source == 2'h1;
  wire             _GEN_20 = io_resp_valid_0 & ~io_resp_ready;
  wire             _GEN_21 = _GEN_6 & ppn_af;
  reg              r;
  wire             r_probe = r;
  wire             _GEN_22 = io_mem_req_valid_0 & ~io_mem_req_ready;
  reg              perfEvents_5_2;
  ...
  always @(posedge clock) begin
    ...
    if (_GEN_7) begin
      ppn <= _GEN_9 ? io_req_bits_ppn : satp_ppn;
    ...
    hptw_resp_stage2 <= _GEN_13 | ~_GEN_5 & hptw_resp_stage2;
    ...
    if (update_full_gvpn_mem_resp)
      ...
      full_gvpn_reg <=
        _GEN_24[full_gvpn_reg_idx] == 2'h0
          ? {_GEN_25[full_gvpn_reg_idx], _GEN_26[full_gvpn_reg_idx]}
          : {_GEN_24[full_gvpn_reg_idx] == 2'h1
               ? {_GEN_25[full_gvpn_reg_idx][40:6], _GEN_23[full_gvpn_reg_idx][5:0]}
               : _GEN_24[full_gvpn_reg_idx] == 2'h2
                   ? {_GEN_25[full_gvpn_reg_idx][40:15], _GEN_23[full_gvpn_reg_idx][14:0]}
                   : {_GEN_25[full_gvpn_reg_idx][40:24],
                      _GEN_23[full_gvpn_reg_idx][23:0]},
  ...
  wire             sent_to_pmp =
    ...
    & ~(mem_addr_update & ~_GEN_16 & (io_llptw_valid_0 | ~_GEN_17 & io_resp_valid_0));
  wire             _GEN_27 =
    sent_to_pmp ? io_pmp_resp_ld | io_pmp_resp_mmio : accessFault;
  wire             _GEN_28 = ~_GEN_5 & need_last_s2xlate;
  wire [1:0]       _GEN_29 =
    io_req_bits_l2Hit ? 2'h1 : _GEN_0 ? {1'h1, ~io_req_bits_l3Hit} : 2'h2;
  wire [14:0]      gvpn_wire = _GEN_9 ? io_req_bits_ppn[43:29] : satp_ppn[43:29];
  wire             _GEN_30 = ~_GEN_7 & (_GEN_6 & stage1Hit | ~_GEN_5 & idle);
  ...
  wire             _GEN_41 = ~_GEN_40 & (_GEN_39 | s_llptw_req);
  wire             _GEN_42 =
    _GEN_40 | _GEN_38 | _GEN_37 | _GEN_14 | _GEN_11 & _GEN_33
    | (_GEN_7
         ...
         : mem_addr_update);
  wire             _GEN_43 = mem_addr_update & _GEN_16;
  wire             _GEN_44 = io_llptw_ready & io_llptw_valid_0;
  wire             _GEN_45 = ~mem_addr_update | _GEN_16;
  wire             _GEN_46 = guestFault | accessFault | pageFault | ppn_af;
  wire             _GEN_47 = io_resp_valid_0 & _GEN_6;
  wire             _GEN_48 = ~_GEN_17 & _GEN_47;
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      s_pmp_check <=
        flush | _GEN_38 | _GEN_37 | _GEN_36 | ~(_GEN_11 & ~_GEN_33)
        & (~_GEN_7 | _check_gpa_high_fail_T | (&io_req_bits_req_info_s2xlate))
        & s_pmp_check;
      s_mem_req <=
        flush | (~_GEN_43 | s2xlate)
        & (perfEvents_4_2_probe | _GEN_39 | ~_GEN_36 & s_mem_req);
      s_llptw_req <=
        flush
        | (mem_addr_update
             ? _GEN_16 | (io_llptw_valid_0 ? _GEN_44 | _GEN_41 : _GEN_48 | _GEN_41)
             : _GEN_41);
      w_mem_resp <= flush | _GEN_40 | ~perfEvents_4_2_probe & (_GEN_39 | w_mem_resp);
      s_hptw_req <=
        flush | ~(mem_addr_update & _GEN_16 & s2xlate)
        & (_GEN_38 | _GEN_37 | _GEN_32
           | (~_GEN_7 | _check_gpa_high_fail_T | ~(&io_req_bits_req_info_s2xlate)
              | check_gpa_high_fail_1) & s_hptw_req);
      w_hptw_resp <= flush | _GEN_38 | _GEN_37 | _GEN_11 | ~_GEN_32 & w_hptw_resp;
      s_last_hptw_req <=
        flush | (~mem_addr_update | _GEN_16 | io_llptw_valid_0 | ~(_GEN_17 & ~_GEN_46))
        & (_GEN_38 | _GEN_37 | _GEN_35
           | (~(_GEN_7 & _check_gpa_high_fail_T) | check_gpa_high_fail) & ~_GEN_5
           & s_last_hptw_req);
      w_last_hptw_resp <=
        flush | _GEN_38 | _GEN_37 | _GEN_15 | ~_GEN_35 & w_last_hptw_resp;
      mem_addr_update <=
        ~flush
        & (mem_addr_update
             ? ~_GEN_16
               & (io_llptw_valid_0
                    ? ~_GEN_44 & _GEN_42
                    : _GEN_17 ? _GEN_46 & _GEN_42 : ~_GEN_47 & _GEN_42)
             : _GEN_42);
      idle <=
        flush
        | (_GEN_45 ? _GEN_30 : io_llptw_valid_0 ? _GEN_44 | _GEN_30 : _GEN_48 | _GEN_30);
      accessFault <=
        ~flush
        & (~mem_addr_update | _GEN_16 | io_llptw_valid_0 | _GEN_17 | ~io_resp_valid_0
             ? ~_GEN_7 & _GEN_27
             : ~(_GEN_6 | _GEN_7) & _GEN_27);
      if (_GEN_14)
      ...
      if (_GEN_45)
        need_last_s2xlate <= ~_GEN_39 & _GEN_34;
      else if (io_llptw_valid_0)
        need_last_s2xlate <= ~(_GEN_44 | _GEN_39) & _GEN_34;
      else
        need_last_s2xlate <= ~(_GEN_17 | _GEN_39) & _GEN_34;
      update_full_gvpn_mem_resp <=
        ~update_full_gvpn_mem_resp & (_GEN_40 | update_full_gvpn_mem_resp);
      pte_valid <= _GEN_40 | ~_GEN_7 & pte_valid;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        stage1_entry_0_pbmt = _RANDOM[6'h5][13:12];
        stage1_entry_0_perm_d = _RANDOM[6'h5][14];
        stage1_entry_0_perm_a = _RANDOM[6'h5][15];
        stage1_entry_0_perm_g = _RANDOM[6'h5][16];
        stage1_entry_0_perm_u = _RANDOM[6'h5][17];
        stage1_entry_0_perm_x = _RANDOM[6'h5][18];
        stage1_entry_0_perm_w = _RANDOM[6'h5][19];
        stage1_entry_0_perm_r = _RANDOM[6'h5][20];
        stage1_entry_0_level = _RANDOM[6'h5][22:21];
        stage1_entry_0_v = _RANDOM[6'h5][24];
        stage1_entry_0_ppn = {_RANDOM[6'h5][31:25], _RANDOM[6'h6], _RANDOM[6'h7][1:0]};
        stage1_entry_0_ppn_low = _RANDOM[6'h7][4:2];
        stage1_entry_0_pf = _RANDOM[6'h7][6];
        stage1_entry_1_tag = {_RANDOM[6'h7][31:7], _RANDOM[6'h8][9:0]};
        stage1_entry_1_asid = _RANDOM[6'h8][25:10];
        stage1_entry_1_vmid = {_RANDOM[6'h8][31:26], _RANDOM[6'h9][7:0]};
        stage1_entry_1_pbmt = _RANDOM[6'h9][9:8];
        stage1_entry_1_perm_d = _RANDOM[6'h9][10];
        stage1_entry_1_perm_a = _RANDOM[6'h9][11];
        stage1_entry_1_perm_g = _RANDOM[6'h9][12];
        stage1_entry_1_perm_u = _RANDOM[6'h9][13];
        stage1_entry_1_perm_x = _RANDOM[6'h9][14];
        stage1_entry_1_perm_w = _RANDOM[6'h9][15];
        stage1_entry_1_perm_r = _RANDOM[6'h9][16];
        stage1_entry_1_level = _RANDOM[6'h9][18:17];
        stage1_entry_1_v = _RANDOM[6'h9][20];
        stage1_entry_1_ppn = {_RANDOM[6'h9][31:21], _RANDOM[6'hA][29:0]};
        stage1_entry_1_ppn_low = {_RANDOM[6'hA][31:30], _RANDOM[6'hB][0]};
        stage1_entry_1_pf = _RANDOM[6'hB][2];
        stage1_entry_2_tag = {_RANDOM[6'hB][31:3], _RANDOM[6'hC][5:0]};
        stage1_entry_2_asid = _RANDOM[6'hC][21:6];
        stage1_entry_2_vmid = {_RANDOM[6'hC][31:22], _RANDOM[6'hD][3:0]};
        stage1_entry_2_pbmt = _RANDOM[6'hD][5:4];
        stage1_entry_2_perm_d = _RANDOM[6'hD][6];
        stage1_entry_2_perm_a = _RANDOM[6'hD][7];
        stage1_entry_2_perm_g = _RANDOM[6'hD][8];
        stage1_entry_2_perm_u = _RANDOM[6'hD][9];
        stage1_entry_2_perm_x = _RANDOM[6'hD][10];
        stage1_entry_2_perm_w = _RANDOM[6'hD][11];
        stage1_entry_2_perm_r = _RANDOM[6'hD][12];
        stage1_entry_2_level = _RANDOM[6'hD][14:13];
        stage1_entry_2_v = _RANDOM[6'hD][16];
        stage1_entry_2_ppn = {_RANDOM[6'hD][31:17], _RANDOM[6'hE][25:0]};
        stage1_entry_2_ppn_low = _RANDOM[6'hE][28:26];
        stage1_entry_2_pf = _RANDOM[6'hE][30];
        stage1_entry_3_tag = {_RANDOM[6'hE][31], _RANDOM[6'hF], _RANDOM[6'h10][1:0]};
        stage1_entry_3_asid = _RANDOM[6'h10][17:2];
        stage1_entry_3_vmid = _RANDOM[6'h10][31:18];
        stage1_entry_3_pbmt = _RANDOM[6'h11][1:0];
        stage1_entry_3_perm_d = _RANDOM[6'h11][2];
        stage1_entry_3_perm_a = _RANDOM[6'h11][3];
        stage1_entry_3_perm_g = _RANDOM[6'h11][4];
        stage1_entry_3_perm_u = _RANDOM[6'h11][5];
        stage1_entry_3_perm_x = _RANDOM[6'h11][6];
        stage1_entry_3_perm_w = _RANDOM[6'h11][7];
        stage1_entry_3_perm_r = _RANDOM[6'h11][8];
        stage1_entry_3_level = _RANDOM[6'h11][10:9];
        stage1_entry_3_v = _RANDOM[6'h11][12];
        stage1_entry_3_ppn = {_RANDOM[6'h11][31:13], _RANDOM[6'h12][21:0]};
        stage1_entry_3_ppn_low = _RANDOM[6'h12][24:22];
        stage1_entry_3_pf = _RANDOM[6'h12][26];
        stage1_entry_4_tag = {_RANDOM[6'h12][31:27], _RANDOM[6'h13][29:0]};
        stage1_entry_4_asid = {_RANDOM[6'h13][31:30], _RANDOM[6'h14][13:0]};
        stage1_entry_4_vmid = _RANDOM[6'h14][27:14];
        stage1_entry_4_pbmt = _RANDOM[6'h14][29:28];
        stage1_entry_4_perm_d = _RANDOM[6'h14][30];
        stage1_entry_4_perm_a = _RANDOM[6'h14][31];
        stage1_entry_4_perm_g = _RANDOM[6'h15][0];
        stage1_entry_4_perm_u = _RANDOM[6'h15][1];
        stage1_entry_4_perm_x = _RANDOM[6'h15][2];
        stage1_entry_4_perm_w = _RANDOM[6'h15][3];
        stage1_entry_4_perm_r = _RANDOM[6'h15][4];
        stage1_entry_4_level = _RANDOM[6'h15][6:5];
        stage1_entry_4_v = _RANDOM[6'h15][8];
        stage1_entry_4_ppn = {_RANDOM[6'h15][31:9], _RANDOM[6'h16][17:0]};
        stage1_entry_4_ppn_low = _RANDOM[6'h16][20:18];
        stage1_entry_4_pf = _RANDOM[6'h16][22];
        stage1_entry_5_tag = {_RANDOM[6'h16][31:23], _RANDOM[6'h17][25:0]};
        stage1_entry_5_asid = {_RANDOM[6'h17][31:26], _RANDOM[6'h18][9:0]};
        stage1_entry_5_vmid = _RANDOM[6'h18][23:10];
        stage1_entry_5_pbmt = _RANDOM[6'h18][25:24];
        stage1_entry_5_perm_d = _RANDOM[6'h18][26];
        stage1_entry_5_perm_a = _RANDOM[6'h18][27];
        stage1_entry_5_perm_g = _RANDOM[6'h18][28];
        stage1_entry_5_perm_u = _RANDOM[6'h18][29];
        stage1_entry_5_perm_x = _RANDOM[6'h18][30];
        stage1_entry_5_perm_w = _RANDOM[6'h18][31];
        stage1_entry_5_perm_r = _RANDOM[6'h19][0];
        stage1_entry_5_level = _RANDOM[6'h19][2:1];
        stage1_entry_5_v = _RANDOM[6'h19][4];
        stage1_entry_5_ppn = {_RANDOM[6'h19][31:5], _RANDOM[6'h1A][13:0]};
        stage1_entry_5_ppn_low = _RANDOM[6'h1A][16:14];
        stage1_entry_5_pf = _RANDOM[6'h1A][18];
        stage1_entry_6_tag = {_RANDOM[6'h1A][31:19], _RANDOM[6'h1B][21:0]};
        stage1_entry_6_asid = {_RANDOM[6'h1B][31:22], _RANDOM[6'h1C][5:0]};
        stage1_entry_6_vmid = _RANDOM[6'h1C][19:6];
        stage1_entry_6_pbmt = _RANDOM[6'h1C][21:20];
        stage1_entry_6_perm_d = _RANDOM[6'h1C][22];
        stage1_entry_6_perm_a = _RANDOM[6'h1C][23];
        stage1_entry_6_perm_g = _RANDOM[6'h1C][24];
        stage1_entry_6_perm_u = _RANDOM[6'h1C][25];
        stage1_entry_6_perm_x = _RANDOM[6'h1C][26];
        stage1_entry_6_perm_w = _RANDOM[6'h1C][27];
        stage1_entry_6_perm_r = _RANDOM[6'h1C][28];
        stage1_entry_6_level = _RANDOM[6'h1C][30:29];
        stage1_entry_6_v = _RANDOM[6'h1D][0];
        stage1_entry_6_ppn = {_RANDOM[6'h1D][31:1], _RANDOM[6'h1E][9:0]};
        stage1_entry_6_ppn_low = _RANDOM[6'h1E][12:10];
        stage1_entry_6_pf = _RANDOM[6'h1E][14];
        stage1_entry_7_tag = {_RANDOM[6'h1E][31:15], _RANDOM[6'h1F][17:0]};
        stage1_entry_7_asid = {_RANDOM[6'h1F][31:18], _RANDOM[6'h20][1:0]};
        stage1_entry_7_vmid = _RANDOM[6'h20][15:2];
        stage1_entry_7_pbmt = _RANDOM[6'h20][17:16];
        stage1_entry_7_perm_d = _RANDOM[6'h20][18];
        stage1_entry_7_perm_a = _RANDOM[6'h20][19];
        stage1_entry_7_perm_g = _RANDOM[6'h20][20];
        stage1_entry_7_perm_u = _RANDOM[6'h20][21];
        stage1_entry_7_perm_x = _RANDOM[6'h20][22];
        stage1_entry_7_perm_w = _RANDOM[6'h20][23];
        stage1_entry_7_perm_r = _RANDOM[6'h20][24];
        stage1_entry_7_level = _RANDOM[6'h20][26:25];
        stage1_entry_7_v = _RANDOM[6'h20][28];
        stage1_entry_7_ppn = {_RANDOM[6'h20][31:29], _RANDOM[6'h21], _RANDOM[6'h22][5:0]};
        stage1_entry_7_ppn_low = _RANDOM[6'h22][8:6];
        stage1_entry_7_pf = _RANDOM[6'h22][10];
        stage1_pteidx_0 = _RANDOM[6'h22][11];
        stage1_pteidx_1 = _RANDOM[6'h22][12];
        stage1_pteidx_2 = _RANDOM[6'h22][13];
        stage1_pteidx_3 = _RANDOM[6'h22][14];
        stage1_pteidx_4 = _RANDOM[6'h22][15];
        stage1_pteidx_5 = _RANDOM[6'h22][16];
        stage1_pteidx_6 = _RANDOM[6'h22][17];
        stage1_pteidx_7 = _RANDOM[6'h22][18];
        stage1_not_super = _RANDOM[6'h22][19];
        hptw_resp_stage2 = _RANDOM[6'h22][21];
        source = _RANDOM[6'h22][23:22];
        hptw_resp_entry_tag = {_RANDOM[6'h22][31:24], _RANDOM[6'h23][29:0]};
        hptw_resp_entry_vmid = _RANDOM[6'h24][27:14];
        hptw_resp_entry_pbmt = _RANDOM[6'h24][29:28];
        hptw_resp_entry_ppn =
          {_RANDOM[6'h24][31:30], _RANDOM[6'h25], _RANDOM[6'h26][3:0]};
        hptw_resp_entry_perm_d = _RANDOM[6'h26][4];
        hptw_resp_entry_perm_a = _RANDOM[6'h26][5];
        hptw_resp_entry_perm_g = _RANDOM[6'h26][6];
        hptw_resp_entry_perm_u = _RANDOM[6'h26][7];
        hptw_resp_entry_perm_x = _RANDOM[6'h26][8];
        hptw_resp_entry_perm_w = _RANDOM[6'h26][9];
        hptw_resp_entry_perm_r = _RANDOM[6'h26][10];
        hptw_resp_entry_level = _RANDOM[6'h26][12:11];
        hptw_resp_gpf = _RANDOM[6'h26][15];
        hptw_resp_gaf = _RANDOM[6'h26][16];
        update_full_gvpn_mem_resp = _RANDOM[6'h26][17];
        full_gvpn_reg = {_RANDOM[6'h26][31:18], _RANDOM[6'h27][29:0]};
        pte_valid = _RANDOM[6'h27][30];
        r = _RANDOM[6'h27][31];
        perfEvents_5_2 = _RANDOM[6'h28][0];
        io_perf_0_value_REG = _RANDOM[6'h28][1];
        io_perf_0_value_REG_1 = _RANDOM[6'h28][2];
        io_perf_1_value_REG = _RANDOM[6'h28][3];
        io_perf_1_value_REG_1 = _RANDOM[6'h28][4];
        io_perf_2_value_REG = _RANDOM[6'h28][5];
        io_perf_2_value_REG_1 = _RANDOM[6'h28][6];
        io_perf_3_value_REG = _RANDOM[6'h28][7];
        io_perf_3_value_REG_1 = _RANDOM[6'h28][8];
        io_perf_4_value_REG = _RANDOM[6'h28][9];
        io_perf_4_value_REG_1 = _RANDOM[6'h28][10];
        io_perf_5_value_REG = _RANDOM[6'h28][11];
        io_perf_5_value_REG_1 = _RANDOM[6'h28][12];
        io_perf_6_value_REG = _RANDOM[6'h28][13];
        io_perf_6_value_REG_1 = _RANDOM[6'h28][14];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        level = 2'h3;
        af_level = 2'h3;
