...
module Queue1_AXI4BundleARW(
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        ram = {_RANDOM[2'h0][31:1], _RANDOM[2'h1], _RANDOM[2'h2][30:0]};
        full = _RANDOM[2'h0][0];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        full = 1'h0;
  ...
  assign io_deq_bits_user_reqSource = full ? ram[82:79] : io_enq_bits_user_reqSource;
  assign io_deq_bits_echo_tl_state_size =
    full ? ram[86:83] : io_enq_bits_echo_tl_state_size;
  assign io_deq_bits_echo_tl_state_source =
    full ? ram[92:87] : io_enq_bits_echo_tl_state_source;
  assign io_deq_bits_wen = full ? ram[93] : io_enq_bits_wen;
endmodule
