...
module PrefetchFilter(
  ...
  wire        io_tlb_req_req_valid_probe =
  ...
  wire        _update_T_30_probe = s1_valid_r_last_REG & s1_hit_r;
  ...
  `ifndef SYNTHESIS
    always @(posedge clock) begin
      if (_update_T_30_probe & ~reset
          & 5'({1'h0,
                4'({1'h0,
                    3'({1'h0, 2'({1'h0, s1_update_vec[0]} + {1'h0, s1_update_vec[1]})}
                       + {1'h0, 2'({1'h0, s1_update_vec[2]} + {1'h0, s1_update_vec[3]})})}
                   + {1'h0,
                      3'({1'h0, 2'({1'h0, s1_update_vec[4]} + {1'h0, s1_update_vec[5]})}
                         + {1'h0,
                            2'({1'h0, s1_update_vec[6]} + {1'h0, s1_update_vec[7]})})})}
               + {1'h0,
                  4'({1'h0,
                      3'({1'h0, 2'({1'h0, s1_update_vec[8]} + {1'h0, s1_update_vec[9]})}
                         + {1'h0,
                            2'({1'h0, s1_update_vec[10]} + {1'h0, s1_update_vec[11]})})}
                     + {1'h0,
                        3'({1'h0,
                            2'({1'h0, s1_update_vec[12]} + {1'h0, s1_update_vec[13]})}
                           + {1'h0,
                              2'({1'h0, s1_update_vec[14]}
                                 + {1'h0, s1_update_vec[15]})})})}) != 5'h1) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed: sms_pf_filter: multi-hit\n    at SMSPrefetcher.scala:1062 assert(PopCount(s1_update_vec) === 1.U, \"sms_pf_filter: multi-hit\")\n");
        if (`STOP_COND_)
      ...
      if (~reset
        ...
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed: sms_pf_filter: tlb resp fires, but no tlb req from tlb_req_arb 2 cycles ago\n    at SMSPrefetcher.scala:1064 assert(!io.tlb_req.resp.fire || Cat(s2_tlb_fire_vec).orR, \"sms_pf_filter: tlb resp fires, but no tlb req from tlb_req_arb 2 cycles ago\")\n");
        if (`STOP_COND_)
          xs_assert_v2(`__FILE__, `__LINE__);
      end
    end // always @(posedge)
  `endif // not def SYNTHESIS
  wire        _GEN = io_tlb_req_resp_valid & io_tlb_req_resp_bits_miss;
  wire        _GEN_0 = s0_gen_req_valid & s0_access_way == 4'h0;
  wire        _GEN_1 = s0_gen_req_valid & s0_access_way == 4'h1;
  wire        _GEN_2 = s0_gen_req_valid & s0_access_way == 4'h2;
  wire        _GEN_3 = s0_gen_req_valid & s0_access_way == 4'h3;
  wire        _GEN_4 = s0_gen_req_valid & s0_access_way == 4'h4;
  wire        _GEN_5 = s0_gen_req_valid & s0_access_way == 4'h5;
  wire        _GEN_6 = s0_gen_req_valid & s0_access_way == 4'h6;
  wire        _GEN_7 = s0_gen_req_valid & s0_access_way == 4'h7;
  wire        _GEN_8 = s0_gen_req_valid & s0_access_way == 4'h8;
  wire        _GEN_9 = s0_gen_req_valid & s0_access_way == 4'h9;
  wire        _GEN_10 = s0_gen_req_valid & s0_access_way == 4'hA;
  wire        _GEN_11 = s0_gen_req_valid & s0_access_way == 4'hB;
  wire        _GEN_12 = s0_gen_req_valid & s0_access_way == 4'hC;
  wire        _GEN_13 = s0_gen_req_valid & s0_access_way == 4'hD;
  wire        _GEN_14 = s0_gen_req_valid & s0_access_way == 4'hE;
  wire        _GEN_15 = s0_gen_req_valid & (&s0_access_way);
  always @(posedge clock) begin
    if (alloc) begin
      ...
      if (s2_tlb_fire_vec_r_r_0 & ~io_tlb_req_resp_bits_miss
        ...
        entries_0_region_addr <= {2'h0, io_tlb_req_resp_bits_paddr_0[47:10]};
        entries_0_paddr_valid <= ~io_tlb_req_resp_bits_miss;
      end
      entries_0_region_bits <=
        {16{_update_T_30_probe & s1_update_vec[0]}} & s1_gen_req_region_bits
        | entries_0_region_bits;
    ...
    if (alloc_1) begin
      ...
      if (s2_tlb_fire_vec_r_r_1 & ~io_tlb_req_resp_bits_miss
          & io_tlb_req_resp_valid) begin
        entries_1_region_addr <= {2'h0, io_tlb_req_resp_bits_paddr_0[47:10]};
        entries_1_paddr_valid <= ~io_tlb_req_resp_bits_miss;
      end
      entries_1_region_bits <=
        {16{_update_T_30_probe & s1_update_vec[1]}} & s1_gen_req_region_bits
        | entries_1_region_bits;
    ...
    if (alloc_2) begin
      ...
      if (s2_tlb_fire_vec_r_r_2 & ~io_tlb_req_resp_bits_miss
          & io_tlb_req_resp_valid) begin
        entries_2_region_addr <= {2'h0, io_tlb_req_resp_bits_paddr_0[47:10]};
        entries_2_paddr_valid <= ~io_tlb_req_resp_bits_miss;
      end
      entries_2_region_bits <=
        {16{_update_T_30_probe & s1_update_vec[2]}} & s1_gen_req_region_bits
        | entries_2_region_bits;
    ...
    if (alloc_3) begin
      ...
      if (s2_tlb_fire_vec_r_r_3 & ~io_tlb_req_resp_bits_miss
          & io_tlb_req_resp_valid) begin
        entries_3_region_addr <= {2'h0, io_tlb_req_resp_bits_paddr_0[47:10]};
        entries_3_paddr_valid <= ~io_tlb_req_resp_bits_miss;
      end
      entries_3_region_bits <=
        {16{_update_T_30_probe & s1_update_vec[3]}} & s1_gen_req_region_bits
        | entries_3_region_bits;
    ...
    if (alloc_4) begin
      ...
      if (s2_tlb_fire_vec_r_r_4 & ~io_tlb_req_resp_bits_miss
          & io_tlb_req_resp_valid) begin
        entries_4_region_addr <= {2'h0, io_tlb_req_resp_bits_paddr_0[47:10]};
        entries_4_paddr_valid <= ~io_tlb_req_resp_bits_miss;
      end
      entries_4_region_bits <=
        {16{_update_T_30_probe & s1_update_vec[4]}} & s1_gen_req_region_bits
        | entries_4_region_bits;
    ...
    if (alloc_5) begin
      ...
      if (s2_tlb_fire_vec_r_r_5 & ~io_tlb_req_resp_bits_miss
          & io_tlb_req_resp_valid) begin
        entries_5_region_addr <= {2'h0, io_tlb_req_resp_bits_paddr_0[47:10]};
        entries_5_paddr_valid <= ~io_tlb_req_resp_bits_miss;
      end
      entries_5_region_bits <=
        {16{_update_T_30_probe & s1_update_vec[5]}} & s1_gen_req_region_bits
        | entries_5_region_bits;
    ...
    if (alloc_6) begin
      ...
      if (s2_tlb_fire_vec_r_r_6 & ~io_tlb_req_resp_bits_miss
          & io_tlb_req_resp_valid) begin
        entries_6_region_addr <= {2'h0, io_tlb_req_resp_bits_paddr_0[47:10]};
        entries_6_paddr_valid <= ~io_tlb_req_resp_bits_miss;
      end
      entries_6_region_bits <=
        {16{_update_T_30_probe & s1_update_vec[6]}} & s1_gen_req_region_bits
        | entries_6_region_bits;
    ...
    if (alloc_7) begin
      ...
      if (s2_tlb_fire_vec_r_r_7 & ~io_tlb_req_resp_bits_miss
          & io_tlb_req_resp_valid) begin
        entries_7_region_addr <= {2'h0, io_tlb_req_resp_bits_paddr_0[47:10]};
        entries_7_paddr_valid <= ~io_tlb_req_resp_bits_miss;
      end
      entries_7_region_bits <=
        {16{_update_T_30_probe & s1_update_vec[7]}} & s1_gen_req_region_bits
        | entries_7_region_bits;
    ...
    if (alloc_8) begin
      ...
      if (s2_tlb_fire_vec_r_r_8 & ~io_tlb_req_resp_bits_miss
          & io_tlb_req_resp_valid) begin
        entries_8_region_addr <= {2'h0, io_tlb_req_resp_bits_paddr_0[47:10]};
        entries_8_paddr_valid <= ~io_tlb_req_resp_bits_miss;
      end
      entries_8_region_bits <=
        {16{_update_T_30_probe & s1_update_vec[8]}} & s1_gen_req_region_bits
        | entries_8_region_bits;
    ...
    if (alloc_9) begin
      ...
      if (s2_tlb_fire_vec_r_r_9 & ~io_tlb_req_resp_bits_miss
          & io_tlb_req_resp_valid) begin
        entries_9_region_addr <= {2'h0, io_tlb_req_resp_bits_paddr_0[47:10]};
        entries_9_paddr_valid <= ~io_tlb_req_resp_bits_miss;
      end
      entries_9_region_bits <=
        {16{_update_T_30_probe & s1_update_vec[9]}} & s1_gen_req_region_bits
        | entries_9_region_bits;
    ...
    if (alloc_10) begin
      ...
      if (s2_tlb_fire_vec_r_r_10 & ~io_tlb_req_resp_bits_miss
          & io_tlb_req_resp_valid) begin
        entries_10_region_addr <= {2'h0, io_tlb_req_resp_bits_paddr_0[47:10]};
        entries_10_paddr_valid <= ~io_tlb_req_resp_bits_miss;
      end
      entries_10_region_bits <=
        {16{_update_T_30_probe & s1_update_vec[10]}} & s1_gen_req_region_bits
        | entries_10_region_bits;
    ...
    if (alloc_11) begin
      ...
      if (s2_tlb_fire_vec_r_r_11 & ~io_tlb_req_resp_bits_miss
          & io_tlb_req_resp_valid) begin
        entries_11_region_addr <= {2'h0, io_tlb_req_resp_bits_paddr_0[47:10]};
        entries_11_paddr_valid <= ~io_tlb_req_resp_bits_miss;
      end
      entries_11_region_bits <=
        {16{_update_T_30_probe & s1_update_vec[11]}} & s1_gen_req_region_bits
        | entries_11_region_bits;
    ...
    if (alloc_12) begin
      ...
      if (s2_tlb_fire_vec_r_r_12 & ~io_tlb_req_resp_bits_miss
          & io_tlb_req_resp_valid) begin
        entries_12_region_addr <= {2'h0, io_tlb_req_resp_bits_paddr_0[47:10]};
        entries_12_paddr_valid <= ~io_tlb_req_resp_bits_miss;
      end
      entries_12_region_bits <=
        {16{_update_T_30_probe & s1_update_vec[12]}} & s1_gen_req_region_bits
        | entries_12_region_bits;
    ...
    if (alloc_13) begin
      ...
      if (s2_tlb_fire_vec_r_r_13 & ~io_tlb_req_resp_bits_miss
          & io_tlb_req_resp_valid) begin
        entries_13_region_addr <= {2'h0, io_tlb_req_resp_bits_paddr_0[47:10]};
        entries_13_paddr_valid <= ~io_tlb_req_resp_bits_miss;
      end
      entries_13_region_bits <=
        {16{_update_T_30_probe & s1_update_vec[13]}} & s1_gen_req_region_bits
        | entries_13_region_bits;
    ...
    if (alloc_14) begin
      ...
      if (s2_tlb_fire_vec_r_r_14 & ~io_tlb_req_resp_bits_miss
          & io_tlb_req_resp_valid) begin
        entries_14_region_addr <= {2'h0, io_tlb_req_resp_bits_paddr_0[47:10]};
        entries_14_paddr_valid <= ~io_tlb_req_resp_bits_miss;
      end
      entries_14_region_bits <=
        {16{_update_T_30_probe & s1_update_vec[14]}} & s1_gen_req_region_bits
        | entries_14_region_bits;
    ...
    if (alloc_15) begin
      ...
      if (s2_tlb_fire_vec_r_r_15 & ~io_tlb_req_resp_bits_miss
          & io_tlb_req_resp_valid) begin
        entries_15_region_addr <= {2'h0, io_tlb_req_resp_bits_paddr_0[47:10]};
        entries_15_paddr_valid <= ~io_tlb_req_resp_bits_miss;
      end
      entries_15_region_bits <=
        {16{_update_T_30_probe & s1_update_vec[15]}} & s1_gen_req_region_bits
        | entries_15_region_bits;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        entries_0_region_addr = {_RANDOM[6'h0][31:11], _RANDOM[6'h1][18:0]};
        entries_0_region_bits = {_RANDOM[6'h1][31:19], _RANDOM[6'h2][2:0]};
        entries_0_filter_bits = _RANDOM[6'h2][18:3];
        entries_0_paddr_valid = _RANDOM[6'h2][21];
        entries_0_decr_mode = _RANDOM[6'h2][22];
        entries_1_region_tag = {_RANDOM[6'h2][31:27], _RANDOM[6'h3][5:0]};
        entries_1_region_addr = {_RANDOM[6'h3][31:6], _RANDOM[6'h4][13:0]};
        entries_1_region_bits = _RANDOM[6'h4][29:14];
        entries_1_filter_bits = {_RANDOM[6'h4][31:30], _RANDOM[6'h5][13:0]};
        entries_1_paddr_valid = _RANDOM[6'h5][16];
        entries_1_decr_mode = _RANDOM[6'h5][17];
        entries_2_region_tag = {_RANDOM[6'h5][31:22], _RANDOM[6'h6][0]};
        entries_2_region_addr = {_RANDOM[6'h6][31:1], _RANDOM[6'h7][8:0]};
        entries_2_region_bits = _RANDOM[6'h7][24:9];
        entries_2_filter_bits = {_RANDOM[6'h7][31:25], _RANDOM[6'h8][8:0]};
        entries_2_paddr_valid = _RANDOM[6'h8][11];
        entries_2_decr_mode = _RANDOM[6'h8][12];
        entries_3_region_tag = _RANDOM[6'h8][27:17];
        entries_3_region_addr = {_RANDOM[6'h8][31:28], _RANDOM[6'h9], _RANDOM[6'hA][3:0]};
        entries_3_region_bits = _RANDOM[6'hA][19:4];
        entries_3_filter_bits = {_RANDOM[6'hA][31:20], _RANDOM[6'hB][3:0]};
        entries_3_paddr_valid = _RANDOM[6'hB][6];
        entries_3_decr_mode = _RANDOM[6'hB][7];
        entries_4_region_tag = _RANDOM[6'hB][22:12];
        entries_4_region_addr = {_RANDOM[6'hB][31:23], _RANDOM[6'hC][30:0]};
        entries_4_region_bits = {_RANDOM[6'hC][31], _RANDOM[6'hD][14:0]};
        entries_4_filter_bits = _RANDOM[6'hD][30:15];
        entries_4_paddr_valid = _RANDOM[6'hE][1];
        entries_4_decr_mode = _RANDOM[6'hE][2];
        entries_5_region_tag = _RANDOM[6'hE][17:7];
        entries_5_region_addr = {_RANDOM[6'hE][31:18], _RANDOM[6'hF][25:0]};
        entries_5_region_bits = {_RANDOM[6'hF][31:26], _RANDOM[6'h10][9:0]};
        entries_5_filter_bits = _RANDOM[6'h10][25:10];
        entries_5_paddr_valid = _RANDOM[6'h10][28];
        entries_5_decr_mode = _RANDOM[6'h10][29];
        entries_6_region_tag = _RANDOM[6'h11][12:2];
        entries_6_region_addr = {_RANDOM[6'h11][31:13], _RANDOM[6'h12][20:0]};
        entries_6_region_bits = {_RANDOM[6'h12][31:21], _RANDOM[6'h13][4:0]};
        entries_6_filter_bits = _RANDOM[6'h13][20:5];
        entries_6_paddr_valid = _RANDOM[6'h13][23];
        entries_6_decr_mode = _RANDOM[6'h13][24];
        entries_7_region_tag = {_RANDOM[6'h13][31:29], _RANDOM[6'h14][7:0]};
        entries_7_region_addr = {_RANDOM[6'h14][31:8], _RANDOM[6'h15][15:0]};
        entries_7_region_bits = _RANDOM[6'h15][31:16];
        entries_7_filter_bits = _RANDOM[6'h16][15:0];
        entries_7_paddr_valid = _RANDOM[6'h16][18];
        entries_7_decr_mode = _RANDOM[6'h16][19];
        entries_8_region_tag = {_RANDOM[6'h16][31:24], _RANDOM[6'h17][2:0]};
        entries_8_region_addr = {_RANDOM[6'h17][31:3], _RANDOM[6'h18][10:0]};
        entries_8_region_bits = _RANDOM[6'h18][26:11];
        entries_8_filter_bits = {_RANDOM[6'h18][31:27], _RANDOM[6'h19][10:0]};
        entries_8_paddr_valid = _RANDOM[6'h19][13];
        entries_8_decr_mode = _RANDOM[6'h19][14];
        entries_9_region_tag = _RANDOM[6'h19][29:19];
        entries_9_region_addr =
          {_RANDOM[6'h19][31:30], _RANDOM[6'h1A], _RANDOM[6'h1B][5:0]};
        entries_9_region_bits = _RANDOM[6'h1B][21:6];
        entries_9_filter_bits = {_RANDOM[6'h1B][31:22], _RANDOM[6'h1C][5:0]};
        entries_9_paddr_valid = _RANDOM[6'h1C][8];
        entries_9_decr_mode = _RANDOM[6'h1C][9];
        entries_10_region_tag = _RANDOM[6'h1C][24:14];
        entries_10_region_addr =
          {_RANDOM[6'h1C][31:25], _RANDOM[6'h1D], _RANDOM[6'h1E][0]};
        entries_10_region_bits = _RANDOM[6'h1E][16:1];
        entries_10_filter_bits = {_RANDOM[6'h1E][31:17], _RANDOM[6'h1F][0]};
        entries_10_paddr_valid = _RANDOM[6'h1F][3];
        entries_10_decr_mode = _RANDOM[6'h1F][4];
        entries_11_region_tag = _RANDOM[6'h1F][19:9];
        entries_11_region_addr = {_RANDOM[6'h1F][31:20], _RANDOM[6'h20][27:0]};
        entries_11_region_bits = {_RANDOM[6'h20][31:28], _RANDOM[6'h21][11:0]};
        entries_11_filter_bits = _RANDOM[6'h21][27:12];
        entries_11_paddr_valid = _RANDOM[6'h21][30];
        entries_11_decr_mode = _RANDOM[6'h21][31];
        entries_12_region_tag = _RANDOM[6'h22][14:4];
        entries_12_region_addr = {_RANDOM[6'h22][31:15], _RANDOM[6'h23][22:0]};
        entries_12_region_bits = {_RANDOM[6'h23][31:23], _RANDOM[6'h24][6:0]};
        entries_12_filter_bits = _RANDOM[6'h24][22:7];
        entries_12_paddr_valid = _RANDOM[6'h24][25];
        entries_12_decr_mode = _RANDOM[6'h24][26];
        entries_13_region_tag = {_RANDOM[6'h24][31], _RANDOM[6'h25][9:0]};
        entries_13_region_addr = {_RANDOM[6'h25][31:10], _RANDOM[6'h26][17:0]};
        entries_13_region_bits = {_RANDOM[6'h26][31:18], _RANDOM[6'h27][1:0]};
        entries_13_filter_bits = _RANDOM[6'h27][17:2];
        entries_13_paddr_valid = _RANDOM[6'h27][20];
        entries_13_decr_mode = _RANDOM[6'h27][21];
        entries_14_region_tag = {_RANDOM[6'h27][31:26], _RANDOM[6'h28][4:0]};
        entries_14_region_addr = {_RANDOM[6'h28][31:5], _RANDOM[6'h29][12:0]};
        entries_14_region_bits = _RANDOM[6'h29][28:13];
        entries_14_filter_bits = {_RANDOM[6'h29][31:29], _RANDOM[6'h2A][12:0]};
        entries_14_paddr_valid = _RANDOM[6'h2A][15];
        entries_14_decr_mode = _RANDOM[6'h2A][16];
        entries_15_region_tag = _RANDOM[6'h2A][31:21];
        entries_15_region_addr = {_RANDOM[6'h2B], _RANDOM[6'h2C][7:0]};
        entries_15_region_bits = _RANDOM[6'h2C][23:8];
        entries_15_filter_bits = {_RANDOM[6'h2C][31:24], _RANDOM[6'h2D][7:0]};
        entries_15_paddr_valid = _RANDOM[6'h2D][10];
        entries_15_decr_mode = _RANDOM[6'h2D][11];
        valids_0 = _RANDOM[6'h2D][16];
        valids_1 = _RANDOM[6'h2D][17];
        valids_2 = _RANDOM[6'h2D][18];
        valids_3 = _RANDOM[6'h2D][19];
        valids_4 = _RANDOM[6'h2D][20];
        valids_5 = _RANDOM[6'h2D][21];
        valids_6 = _RANDOM[6'h2D][22];
        valids_7 = _RANDOM[6'h2D][23];
        valids_8 = _RANDOM[6'h2D][24];
        valids_9 = _RANDOM[6'h2D][25];
        valids_10 = _RANDOM[6'h2D][26];
        valids_11 = _RANDOM[6'h2D][27];
        valids_12 = _RANDOM[6'h2D][28];
        valids_13 = _RANDOM[6'h2D][29];
        valids_14 = _RANDOM[6'h2D][30];
        valids_15 = _RANDOM[6'h2D][31];
        state_reg = _RANDOM[6'h2E][14:0];
        prev_valid_last_REG = _RANDOM[6'h2E][15];
        prev_gen_req_region_tag = _RANDOM[6'h2E][26:16];
        s1_valid_r_last_REG = _RANDOM[6'h30][27];
        s1_hit_r = _RANDOM[6'h30][28];
        s1_gen_req_region_tag = {_RANDOM[6'h30][31:29], _RANDOM[6'h31][7:0]};
        s1_gen_req_region_addr = {_RANDOM[6'h31][31:8], _RANDOM[6'h32][15:0]};
        s1_gen_req_region_bits = _RANDOM[6'h32][31:16];
        s1_gen_req_paddr_valid = _RANDOM[6'h33][0];
        s1_gen_req_decr_mode = _RANDOM[6'h33][1];
        s1_replace_vec_r = _RANDOM[6'h33][23:8];
        s1_update_vec = {_RANDOM[6'h33][31:24], _RANDOM[6'h34][7:0]};
        s1_tlb_fire_vec_r_r_0 = _RANDOM[6'h34][8];
        s1_tlb_fire_vec_r_r_1 = _RANDOM[6'h34][9];
        s1_tlb_fire_vec_r_r_2 = _RANDOM[6'h34][10];
        s1_tlb_fire_vec_r_r_3 = _RANDOM[6'h34][11];
        s1_tlb_fire_vec_r_r_4 = _RANDOM[6'h34][12];
        s1_tlb_fire_vec_r_r_5 = _RANDOM[6'h34][13];
        s1_tlb_fire_vec_r_r_6 = _RANDOM[6'h34][14];
        s1_tlb_fire_vec_r_r_7 = _RANDOM[6'h34][15];
        s1_tlb_fire_vec_r_r_8 = _RANDOM[6'h34][16];
        s1_tlb_fire_vec_r_r_9 = _RANDOM[6'h34][17];
        s1_tlb_fire_vec_r_r_10 = _RANDOM[6'h34][18];
        s1_tlb_fire_vec_r_r_11 = _RANDOM[6'h34][19];
        s1_tlb_fire_vec_r_r_12 = _RANDOM[6'h34][20];
        s1_tlb_fire_vec_r_r_13 = _RANDOM[6'h34][21];
        s1_tlb_fire_vec_r_r_14 = _RANDOM[6'h34][22];
        s1_tlb_fire_vec_r_r_15 = _RANDOM[6'h34][23];
        s1_tlb_req_valid_last_REG = _RANDOM[6'h34][24];
        s1_tlb_req_bits_vaddr =
          {_RANDOM[6'h34][31:25], _RANDOM[6'h35], _RANDOM[6'h36][10:0]};
        s1_tlb_req_bits_fullva =
          {_RANDOM[6'h36][31:11], _RANDOM[6'h37], _RANDOM[6'h38][10:0]};
        s1_tlb_req_bits_checkfullva = _RANDOM[6'h38][11];
        s1_tlb_req_bits_cmd = _RANDOM[6'h38][14:12];
        s1_tlb_req_bits_hyperinst = _RANDOM[6'h38][15];
        s1_tlb_req_bits_hlvx = _RANDOM[6'h38][16];
        s1_tlb_req_bits_kill = _RANDOM[6'h38][20];
        s1_tlb_req_bits_isPrefetch = _RANDOM[6'h38][30];
        s1_tlb_req_bits_no_translate = _RANDOM[6'h38][31];
        s1_tlb_req_bits_debug_robIdx_flag = _RANDOM[6'h3C][16];
        s1_tlb_req_bits_debug_robIdx_value = _RANDOM[6'h3C][24:17];
        s1_tlb_req_bits_debug_isFirstIssue = _RANDOM[6'h3C][25];
        s2_tlb_fire_vec_r_r_0 = _RANDOM[6'h3C][26];
        s2_tlb_fire_vec_r_r_1 = _RANDOM[6'h3C][27];
        s2_tlb_fire_vec_r_r_2 = _RANDOM[6'h3C][28];
        s2_tlb_fire_vec_r_r_3 = _RANDOM[6'h3C][29];
        s2_tlb_fire_vec_r_r_4 = _RANDOM[6'h3C][30];
        s2_tlb_fire_vec_r_r_5 = _RANDOM[6'h3C][31];
        s2_tlb_fire_vec_r_r_6 = _RANDOM[6'h3D][0];
        s2_tlb_fire_vec_r_r_7 = _RANDOM[6'h3D][1];
        s2_tlb_fire_vec_r_r_8 = _RANDOM[6'h3D][2];
        s2_tlb_fire_vec_r_r_9 = _RANDOM[6'h3D][3];
        s2_tlb_fire_vec_r_r_10 = _RANDOM[6'h3D][4];
        s2_tlb_fire_vec_r_r_11 = _RANDOM[6'h3D][5];
        s2_tlb_fire_vec_r_r_12 = _RANDOM[6'h3D][6];
        s2_tlb_fire_vec_r_r_13 = _RANDOM[6'h3D][7];
        s2_tlb_fire_vec_r_r_14 = _RANDOM[6'h3D][8];
        s2_tlb_fire_vec_r_r_15 = _RANDOM[6'h3D][9];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        valids_0 = 1'h0;
        valids_1 = 1'h0;
  ...
  assign io_tlb_req_req_valid = io_tlb_req_req_valid_probe;
