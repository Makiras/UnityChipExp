...
module SnapshotGenerator_6(
  ...
  wire [2:0] _newEnqPtrCandidate_new_ptr_T_6 = 3'(_GEN_9 + 3'h1);
  wire [2:0] _newEnqPtrCandidate_new_ptr_T_11 = 3'(_GEN_9 + 3'h2);
  wire [2:0] _newEnqPtrCandidate_new_ptr_T_16 = 3'(_GEN_9 + 3'h3);
  wire       _GEN_10 = _GEN_7[_newEnqPtrCandidate_new_ptr_T_6[1:0]];
  wire       newEnqPtrQualified_1 =
    _GEN_10 & (~_GEN_10 | _GEN_8[_newEnqPtrCandidate_new_ptr_T_6[1:0]]);
  wire       _GEN_11 = _GEN_7[_newEnqPtrCandidate_new_ptr_T_11[1:0]];
  wire       newEnqPtrQualified_2 =
    _GEN_11 & (~_GEN_11 | _GEN_8[_newEnqPtrCandidate_new_ptr_T_11[1:0]]);
