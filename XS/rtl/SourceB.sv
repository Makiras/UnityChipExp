...
module SourceB(
  ...
  wire [2:0]  _GEN_0 = {1'h0, 2'({1'h0, probes_0_valid} + {1'h0, probes_1_valid})};
  wire [2:0]  _GEN_1 = {1'h0, 2'({1'h0, probes_2_valid} + {1'h0, probes_3_valid})};
  wire        update_probe = 3'(_GEN_0 + _GEN_1) == 3'h0;
  wire        update_1_probe = 3'(_GEN_0 + _GEN_1) == 3'h1;
  wire        update_2_probe = 3'(_GEN_0 + _GEN_1) == 3'h2;
  wire        update_3_probe = 3'(_GEN_0 + _GEN_1) == 3'h3;
  wire [1:0]  insertIdx =
    probes_0_valid ? (probes_1_valid ? {1'h1, probes_2_valid} : 2'h1) : 2'h0;
  wire        _GEN_2 = alloc & insertIdx == 2'h0;
  wire        _GEN_3 = alloc & insertIdx == 2'h1;
  wire        _GEN_4 = alloc & insertIdx == 2'h2;
  wire        _GEN_5 = alloc & (&insertIdx);
  wire        _probes_rdy_T =
    {conflictMask_0,
     conflictMask_1,
     conflictMask_2,
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      probes_0_valid <=
        ~(_issueArb_io_in_0_ready & _issueArb_io_in_0_valid_T)
        & (_GEN_2 | probes_0_valid);
      probes_0_rdy <=
        probes_0_valid & ~_GEN_7[probes_0_waitG[3:0]]
        | (_GEN_2 ? _probes_rdy_T : probes_0_rdy);
      if (_GEN_2) begin
        probes_0_waitG <= _GEN_6;
      ...
      probes_1_valid <=
        ...
        & (_GEN_3 | probes_1_valid);
      probes_1_rdy <=
        probes_1_valid & ~_GEN_7[probes_1_waitG[3:0]]
        | (_GEN_3 ? _probes_rdy_T : probes_1_rdy);
      if (_GEN_3) begin
        probes_1_waitG <= _GEN_6;
      ...
      probes_2_valid <=
        ...
        & (_GEN_4 | probes_2_valid);
      probes_2_rdy <=
        probes_2_valid & ~_GEN_7[probes_2_waitG[3:0]]
        | (_GEN_4 ? _probes_rdy_T : probes_2_rdy);
      if (_GEN_4) begin
        probes_2_waitG <= _GEN_6;
      ...
      probes_3_valid <=
        ...
        & (_GEN_5 | probes_3_valid);
      probes_3_rdy <=
        probes_3_valid & ~_GEN_7[probes_3_waitG[3:0]]
        | (_GEN_5 ? _probes_rdy_T : probes_3_rdy);
      if (_GEN_5) begin
        probes_3_waitG <= _GEN_6;
