...
module TageTable_2(
  ...
  wire [10:0] idx_history_probe =
    io_req_bits_ghist[10:0]
    ^ {io_req_bits_ghist[21], io_req_bits_ghist[20:11] ^ io_req_bits_ghist[31:22]};
  wire        _GEN = idx_history_probe != io_req_bits_folded_hist_hist_17_folded_hist;
  `ifndef SYNTHESIS
