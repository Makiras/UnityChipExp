...
module SyncDataModuleTemplate_BackendPC_64entry(
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        raddr_dup_1_1 = {_RANDOM[5'h6][31:28], _RANDOM[5'h7][1:0]};
        ...
        raddr_dup_1_2 = _RANDOM[5'hD][23:18];
        ...
        raddr_dup_1_3 = _RANDOM[5'h14][13:8];
        ...
        raddr_dup_15 = {_RANDOM[5'h1A][31:30], _RANDOM[5'h1B][3:0]};
  ...
  assign io_rdata_1_startAddr =
    (raddr_dup_15[5:4] == 2'h0 ? _dataBanks_0_io_rdata_1_startAddr : 50'h0)
    | (raddr_dup_15[5:4] == 2'h1 ? _dataBanks_1_io_rdata_1_startAddr : 50'h0)
    | (raddr_dup_15[5:4] == 2'h2 ? _dataBanks_2_io_rdata_1_startAddr : 50'h0)
    | ((&(raddr_dup_15[5:4])) ? _dataBanks_3_io_rdata_1_startAddr : 50'h0);
