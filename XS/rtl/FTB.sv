...
module FTB(
  ...
  reg          s2_fauftb_ftb_entry_dup_1_isCall;
  reg          s2_fauftb_ftb_entry_dup_1_isRet;
  reg          s2_fauftb_ftb_entry_dup_1_isJalr;
  ...
  reg          s2_fauftb_ftb_entry_dup_1_last_may_be_rvi_call;
  ...
  reg          s2_fauftb_ftb_entry_dup_3_isCall;
  reg          s2_fauftb_ftb_entry_dup_3_isRet;
  reg          s2_fauftb_ftb_entry_dup_3_isJalr;
  ...
  reg          s2_fauftb_ftb_entry_dup_3_last_may_be_rvi_call;
  ...
  wire         s2_multi_hit_probe = _ftbBank_io_read_multi_hits_valid & io_s2_fire_0;
  wire         s2_multi_hit_enable_probe = s2_multi_hit_probe & ~s2_close_ftb_req;
  ...
  reg          s2_ftbBank_dup_1_isCall;
  reg          s2_ftbBank_dup_1_isRet;
  reg          s2_ftbBank_dup_1_isJalr;
  ...
  reg          s2_ftbBank_dup_1_last_may_be_rvi_call;
  ...
  reg          s2_ftbBank_dup_3_isCall;
  reg          s2_ftbBank_dup_3_isRet;
  reg          s2_ftbBank_dup_3_isJalr;
  ...
  wire         s2_ftb_entry_dup_0_brSlots_0_sharing =
    s2_close_ftb_req
  ...
  wire         s2_ftb_entry_dup_0_last_may_be_rvi_call =
    s2_close_ftb_req
  ...
  wire         s2_ftb_entry_dup_1_isCall =
    s2_close_ftb_req ? s2_fauftb_ftb_entry_dup_1_isCall : s2_ftbBank_dup_1_isCall;
  wire         s2_ftb_entry_dup_1_isRet =
    s2_close_ftb_req ? s2_fauftb_ftb_entry_dup_1_isRet : s2_ftbBank_dup_1_isRet;
  wire         s2_ftb_entry_dup_1_isJalr =
    s2_close_ftb_req ? s2_fauftb_ftb_entry_dup_1_isJalr : s2_ftbBank_dup_1_isJalr;
  wire [3:0]   io_out_s2_full_pred_1_offsets_0_0 =
    s2_close_ftb_req
  ...
  wire [3:0]   s2_ftb_entry_dup_1_tailSlot_offset =
    s2_close_ftb_req
  ...
  wire         s2_ftb_entry_dup_1_last_may_be_rvi_call =
    s2_close_ftb_req
      ? s2_fauftb_ftb_entry_dup_1_last_may_be_rvi_call
      : s2_ftbBank_dup_1_last_may_be_rvi_call;
  ...
  wire [3:0]   io_out_s2_full_pred_2_offsets_0_0 =
    s2_close_ftb_req
  ...
  wire [3:0]   s2_ftb_entry_dup_2_tailSlot_offset =
    s2_close_ftb_req
  ...
  wire         s2_ftb_entry_dup_2_last_may_be_rvi_call =
    s2_close_ftb_req
  ...
  wire         s2_ftb_entry_dup_3_isCall =
    s2_close_ftb_req ? s2_fauftb_ftb_entry_dup_3_isCall : s2_ftbBank_dup_3_isCall;
  wire         s2_ftb_entry_dup_3_isRet =
    s2_close_ftb_req ? s2_fauftb_ftb_entry_dup_3_isRet : s2_ftbBank_dup_3_isRet;
  wire         s2_ftb_entry_dup_3_isJalr =
    s2_close_ftb_req ? s2_fauftb_ftb_entry_dup_3_isJalr : s2_ftbBank_dup_3_isJalr;
  ...
  wire         s2_ftb_entry_dup_3_last_may_be_rvi_call =
    s2_close_ftb_req
      ? s2_fauftb_ftb_entry_dup_3_last_may_be_rvi_call
      : s2_ftbBank_dup_3_last_may_be_rvi_call;
  ...
  reg          s3_ftb_entry_dup_1_isCall;
  reg          s3_ftb_entry_dup_1_isRet;
  reg          s3_ftb_entry_dup_1_isJalr;
  reg  [3:0]   s3_ftb_entry_dup_1_brSlots_0_offset;
  ...
  reg  [3:0]   s3_ftb_entry_dup_1_tailSlot_offset;
  ...
  reg          s3_ftb_entry_dup_1_last_may_be_rvi_call;
  ...
  reg  [3:0]   s3_ftb_entry_dup_2_brSlots_0_offset;
  ...
  reg  [3:0]   s3_ftb_entry_dup_2_tailSlot_offset;
  ...
  reg          s3_ftb_entry_dup_2_last_may_be_rvi_call;
  reg          s3_ftb_entry_dup_2_strong_bias_0;
  reg          s3_ftb_entry_dup_2_strong_bias_1;
  reg          s3_ftb_entry_dup_3_isCall;
  reg          s3_ftb_entry_dup_3_isRet;
  reg          s3_ftb_entry_dup_3_isJalr;
  ...
  reg          s3_ftb_entry_dup_3_last_may_be_rvi_call;
  ...
  reg  [63:0]  s2_ftb_meta_c;
  reg  [66:0]  s2_ftb_meta;
  reg  [63:0]  s2_multi_hit_meta_c;
  reg  [8:0]   fauftb_ftb_entry_consistent_counter;
  reg          update_valid;
  wire         update_valid_probe = update_valid;
  ...
  reg  [515:0] update_meta_r;
  wire         ftb_false_hit = update_valid & update_r_false_hit;
  wire         _GEN_0 = s2_close_ftb_req & io_s2_fire_0;
  wire         _GEN_1 = ~s2_close_ftb_req & io_s2_fire_0;
  wire         reopenCounter_probe = ~s1_close_ftb_req & s2_close_ftb_req & io_s2_fire_0;
  wire         falseHitReopenCounter_probe = ftb_false_hit & s1_close_ftb_req;
  wire         _GEN_2 = s1_close_ftb_req & io_redirectFromIFU;
  ...
  wire         io_out_s2_full_pred_0_fallThroughErr_0 =
  ...
  wire         io_out_s2_full_pred_1_fallThroughErr_0 =
  ...
  wire         io_out_s2_full_pred_2_fallThroughErr_0 =
  ...
  reg  [66:0]  io_out_last_stage_meta_r;
  wire         _GEN_3 =
    s3_ftb_entry_dup_0_valid & s3_hit_dup_0 & io_s3_fire_0
    & ({1'h0, s3_pc_dup_s3_pc_seg_2_value[4:1]} >= endLowerwithCarry_4
       | endLowerwithCarry_4 > 5'({1'h0, s3_pc_dup_s3_pc_seg_2_value[4:1]} - 5'h10));
  wire         u_valid_probe = update_valid & ~update_r_old_entry & ~s0_close_ftb_req;
  wire         update_now = u_valid_probe & update_meta_r[64];
  wire         update_need_read = u_valid_probe & ~(update_meta_r[64]);
  reg          io_s1_ready_REG;
  wire [3:0]   ftb_write_entry_pftAddr =
    update_now ? update_r_ftb_entry_pftAddr : _delay2_entry_pipMod_io_out_bits_pftAddr;
  wire         ftb_write_entry_carry =
  ...
  wire         write_valid = update_now | _write_valid_delay_io_out;
  reg  [1:0]   ftbBank_io_update_write_way_REG;
  reg          ftbBank_io_update_write_alloc_REG;
  `ifndef SYNTHESIS
    always @(posedge clock) begin
      if (_GEN_0 & ~reset
          & ~(s2_fauftb_ftb_entry_dup_0_valid == s2_ftb_entry_dup_0_valid
              & s2_fauftb_ftb_entry_dup_0_brSlots_0_offset == io_out_s2_full_pred_0_offsets_0_0
              & s2_fauftb_ftb_entry_dup_0_brSlots_0_lower == s2_ftb_entry_dup_0_brSlots_0_lower
              & s2_fauftb_ftb_entry_dup_0_brSlots_0_tarStat == s2_ftb_entry_dup_0_brSlots_0_tarStat
              & s2_fauftb_ftb_entry_dup_0_brSlots_0_sharing == s2_ftb_entry_dup_0_brSlots_0_sharing
              & s2_fauftb_ftb_entry_dup_0_brSlots_0_valid == s2_ftb_entry_dup_0_brSlots_0_valid
              & s2_fauftb_ftb_entry_dup_0_tailSlot_offset == s2_ftb_entry_dup_0_tailSlot_offset
              & s2_fauftb_ftb_entry_dup_0_tailSlot_lower == s2_ftb_entry_dup_0_tailSlot_lower
              & s2_fauftb_ftb_entry_dup_0_tailSlot_tarStat == s2_ftb_entry_dup_0_tailSlot_tarStat
              & s2_fauftb_ftb_entry_dup_0_tailSlot_sharing == s2_ftb_entry_dup_0_tailSlot_sharing
              & s2_fauftb_ftb_entry_dup_0_tailSlot_valid == s2_ftb_entry_dup_0_tailSlot_valid
              & s2_fauftb_ftb_entry_dup_0_pftAddr == s2_ftb_entry_dup_0_pftAddr
              & s2_fauftb_ftb_entry_dup_0_carry == s2_ftb_entry_dup_0_carry
              & s2_fauftb_ftb_entry_dup_0_isCall == s2_ftb_entry_dup_0_isCall
              & s2_fauftb_ftb_entry_dup_0_isRet == s2_ftb_entry_dup_0_isRet
              & s2_fauftb_ftb_entry_dup_0_isJalr == s2_ftb_entry_dup_0_isJalr
              & s2_fauftb_ftb_entry_dup_0_last_may_be_rvi_call == s2_ftb_entry_dup_0_last_may_be_rvi_call
              & s2_fauftb_ftb_entry_dup_0_strong_bias_0 == s2_ftb_entry_dup_0_strong_bias_0
              & s2_fauftb_ftb_entry_dup_0_strong_bias_1 == s2_ftb_entry_dup_0_strong_bias_1)) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed: Entry inconsistency after ftb req is closed!\n    at FTB.scala:761 assert(s2_close_consistent, s\"Entry inconsistency after ftb req is closed!\")\n");
        if (`STOP_COND_)
          xs_assert_v2(`__FILE__, `__LINE__);
      end
      if (~_GEN_0 & _GEN_1 & ~reset
          & ~(s2_ftbBank_dup_0_valid == s2_ftb_entry_dup_0_valid
              & s2_ftbBank_dup_0_brSlots_0_offset == io_out_s2_full_pred_0_offsets_0_0
              & s2_ftbBank_dup_0_brSlots_0_lower == s2_ftb_entry_dup_0_brSlots_0_lower
              & s2_ftbBank_dup_0_brSlots_0_tarStat == s2_ftb_entry_dup_0_brSlots_0_tarStat
              & s2_ftbBank_dup_0_brSlots_0_sharing == s2_ftb_entry_dup_0_brSlots_0_sharing
              & s2_ftbBank_dup_0_brSlots_0_valid == s2_ftb_entry_dup_0_brSlots_0_valid
              & s2_ftbBank_dup_0_tailSlot_offset == s2_ftb_entry_dup_0_tailSlot_offset
              & s2_ftbBank_dup_0_tailSlot_lower == s2_ftb_entry_dup_0_tailSlot_lower
              & s2_ftbBank_dup_0_tailSlot_tarStat == s2_ftb_entry_dup_0_tailSlot_tarStat
              & s2_ftbBank_dup_0_tailSlot_sharing == s2_ftb_entry_dup_0_tailSlot_sharing
              & s2_ftbBank_dup_0_tailSlot_valid == s2_ftb_entry_dup_0_tailSlot_valid
              & s2_ftbBank_dup_0_pftAddr == s2_ftb_entry_dup_0_pftAddr
              & s2_ftbBank_dup_0_carry == s2_ftb_entry_dup_0_carry
              & s2_ftbBank_dup_0_isCall == s2_ftb_entry_dup_0_isCall
              & s2_ftbBank_dup_0_isRet == s2_ftb_entry_dup_0_isRet
              & s2_ftbBank_dup_0_isJalr == s2_ftb_entry_dup_0_isJalr
              & s2_ftbBank_dup_0_last_may_be_rvi_call == s2_ftb_entry_dup_0_last_may_be_rvi_call
              & s2_ftbBank_dup_0_strong_bias_0 == s2_ftb_entry_dup_0_strong_bias_0
              & s2_ftbBank_dup_0_strong_bias_1 == s2_ftb_entry_dup_0_strong_bias_1)) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed: Entry inconsistency after ftb req is not closed!\n    at FTB.scala:763 assert(s2_not_close_consistent, s\"Entry inconsistency after ftb req is not closed!\")\n");
        if (`STOP_COND_)
          xs_assert_v2(`__FILE__, `__LINE__);
      end
      ...
      if (write_valid & ~reset
          & 50'(write_pc
                + 50'h20) < {ftb_write_entry_carry
                               ? 45'(write_pc[49:5] + 45'h1)
                               : write_pc[49:5],
                             ftb_write_entry_pftAddr,
                             1'h0}) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed: FTB write_entry fallThrough address error!\n    at FTB.scala:876 assert(write_pc + (FetchWidth * 4).U >= ftb_write_fallThrough, s\"FTB write_entry fallThrough address error!\")\n");
        if (`STOP_COND_)
          xs_assert_v2(`__FILE__, `__LINE__);
      end
    end // always @(posedge)
  `endif // not def SYNTHESIS
  reg          REG_2;
  wire         _GEN_4 = REG_2 & s1_hit;
  reg          REG_3;
  wire         _GEN_5 = REG_3 & ~s1_hit;
  wire         perfEvents_0_2_probe = update_valid & update_meta_r[64];
  wire         _GEN_6 = update_valid & ~(update_meta_r[64]);
  wire         _GEN_7 = update_valid & update_r_old_entry;
  wire         _GEN_8 = s0_close_ftb_req & u_valid_probe;
  ...
  wire [8:0]   _GEN_10 = {1'h0, s1_pc_dup_0[20:13]};
  wire [8:0]   _GEN_11 = {1'h0, s1_pc_dup_1[20:13]};
  wire [8:0]   _GEN_12 = {1'h0, s1_pc_dup_2[20:13]};
  wire [8:0]   _GEN_13 = {1'h0, s1_pc_dup_3[20:13]};
  wire [28:0]  _GEN_14 = {s2_pc_dup_s2_pc_seg_0_value, s2_pc_dup_s2_pc_seg_1_value[11:9]};
  wire [8:0]   _GEN_15 = {1'h0, s2_pc_dup_s2_pc_seg_1_value[8:1]};
  wire [28:0]  _GEN_16 =
    {s2_pc_dup_s2_pc_seg_0_value_1, s2_pc_dup_s2_pc_seg_1_value_1[11:9]};
  wire [8:0]   _GEN_17 = {1'h0, s2_pc_dup_s2_pc_seg_1_value_1[8:1]};
  wire [28:0]  _GEN_18 =
    {s2_pc_dup_s2_pc_seg_0_value_2, s2_pc_dup_s2_pc_seg_1_value_2[11:9]};
  wire [8:0]   _GEN_19 = {1'h0, s2_pc_dup_s2_pc_seg_1_value_2[8:1]};
  wire [28:0]  _GEN_20 =
    {s2_pc_dup_s2_pc_seg_0_value_3, s2_pc_dup_s2_pc_seg_1_value_3[11:9]};
  wire [8:0]   _GEN_21 = {1'h0, s2_pc_dup_s2_pc_seg_1_value_3[8:1]};
  ...
  always @(posedge clock) begin
    ...
    if (io_s1_fire_0) begin
      ...
      s2_ftb_meta <=
        {s1_close_ftb_req ? 2'h0 : _ftbBank_io_read_hits_bits, s1_hit, s2_ftb_meta_c};
      ...
      last_stage_pc_middle_plus_one <= 9'(_GEN_10 + 9'h1);
      last_stage_pc_middle_minus_one <= 9'(_GEN_10 - 9'h1);
      io_out_s2_full_pred_0_fallThroughAddr_stashed_carry <= s1_read_resp_carry;
    end
    if (io_s1_fire_1) begin
      s2_fauftb_ftb_entry_dup_1_isCall <= io_fauftb_entry_in_isCall;
      s2_fauftb_ftb_entry_dup_1_isRet <= io_fauftb_entry_in_isRet;
      s2_fauftb_ftb_entry_dup_1_isJalr <= io_fauftb_entry_in_isJalr;
      ...
      s2_ftbBank_dup_1_isCall <= _ftbBank_io_read_resp_isCall;
      s2_ftbBank_dup_1_isRet <= _ftbBank_io_read_resp_isRet;
      s2_ftbBank_dup_1_isJalr <= _ftbBank_io_read_resp_isJalr;
      ...
      s2_ftbBank_dup_1_last_may_be_rvi_call <= _ftbBank_io_read_resp_last_may_be_rvi_call;
      ...
      last_stage_pc_middle_plus_one_1 <= 9'(_GEN_11 + 9'h1);
      last_stage_pc_middle_minus_one_1 <= 9'(_GEN_11 - 9'h1);
    ...
    if (io_s1_fire_2) begin
      ...
      last_stage_pc_middle_plus_one_2 <= 9'(_GEN_12 + 9'h1);
      last_stage_pc_middle_minus_one_2 <= 9'(_GEN_12 - 9'h1);
      io_out_s2_full_pred_2_fallThroughAddr_stashed_carry <= s1_read_resp_carry;
    end
    if (io_s1_fire_3) begin
      s2_fauftb_ftb_entry_dup_3_isCall <= io_fauftb_entry_in_isCall;
      s2_fauftb_ftb_entry_dup_3_isRet <= io_fauftb_entry_in_isRet;
      s2_fauftb_ftb_entry_dup_3_isJalr <= io_fauftb_entry_in_isJalr;
      ...
      s2_ftbBank_dup_3_isCall <= _ftbBank_io_read_resp_isCall;
      s2_ftbBank_dup_3_isRet <= _ftbBank_io_read_resp_isRet;
      s2_ftbBank_dup_3_isJalr <= _ftbBank_io_read_resp_isJalr;
      ...
      s2_ftbBank_dup_3_last_may_be_rvi_call <= _ftbBank_io_read_resp_last_may_be_rvi_call;
      ...
      last_stage_pc_middle_plus_one_3 <= 9'(_GEN_13 + 9'h1);
      last_stage_pc_middle_minus_one_3 <= 9'(_GEN_13 - 9'h1);
    ...
    if (io_s2_fire_0) begin
      ...
      s3_ftb_entry_dup_0_brSlots_0_sharing <=
        s2_multi_hit_enable_probe
          ...
          : s2_ftb_entry_dup_0_brSlots_0_sharing;
      ...
      s3_multi_hit_dup_0 <= s2_multi_hit_enable_probe;
      last_stage_pc_higher_4 <=
        {s2_pc_dup_s2_pc_seg_0_value, s2_pc_dup_s2_pc_seg_1_value[11:9]};
      last_stage_pc_middle_4 <= s2_pc_dup_s2_pc_seg_1_value[8:1];
      last_stage_pc_higher_plus_one_4 <= 29'(_GEN_14 + 29'h1);
      last_stage_pc_higher_minus_one_4 <= 29'(_GEN_14 - 29'h1);
      last_stage_pc_middle_plus_one_4 <= 9'(_GEN_15 + 9'h1);
      last_stage_pc_middle_minus_one_4 <= 9'(_GEN_15 - 9'h1);
      io_out_last_stage_meta_r <=
        s2_multi_hit_enable_probe
          ? {_ftbBank_io_read_multi_hits_bits, s2_multi_hit_probe, s2_multi_hit_meta_c}
          : s2_ftb_meta;
    end
    if (io_s2_fire_1) begin
      s3_ftb_entry_dup_1_isCall <=
        s2_multi_hit_enable_probe
          ? _ftbBank_io_read_multi_entry_isCall
          : s2_ftb_entry_dup_1_isCall;
      s3_ftb_entry_dup_1_isRet <=
        s2_multi_hit_enable_probe
          ? _ftbBank_io_read_multi_entry_isRet
          : s2_ftb_entry_dup_1_isRet;
      s3_ftb_entry_dup_1_isJalr <=
        s2_multi_hit_enable_probe
          ? _ftbBank_io_read_multi_entry_isJalr
          : s2_ftb_entry_dup_1_isJalr;
      s3_ftb_entry_dup_1_brSlots_0_offset <=
        s2_multi_hit_enable_probe
          ? _ftbBank_io_read_multi_entry_brSlots_0_offset
          : io_out_s2_full_pred_1_offsets_0_0;
      ...
      s3_ftb_entry_dup_1_tailSlot_offset <=
        s2_multi_hit_enable_probe
          ? _ftbBank_io_read_multi_entry_tailSlot_offset
          : s2_ftb_entry_dup_1_tailSlot_offset;
      ...
      s3_ftb_entry_dup_1_last_may_be_rvi_call <=
        s2_multi_hit_enable_probe
          ? _ftbBank_io_read_multi_entry_last_may_be_rvi_call
          : s2_ftb_entry_dup_1_last_may_be_rvi_call;
      ...
      s3_multi_hit_dup_1 <= s2_multi_hit_enable_probe;
      last_stage_pc_higher_5 <=
        {s2_pc_dup_s2_pc_seg_0_value_1, s2_pc_dup_s2_pc_seg_1_value_1[11:9]};
      last_stage_pc_middle_5 <= s2_pc_dup_s2_pc_seg_1_value_1[8:1];
      last_stage_pc_higher_plus_one_5 <= 29'(_GEN_16 + 29'h1);
      last_stage_pc_higher_minus_one_5 <= 29'(_GEN_16 - 29'h1);
      last_stage_pc_middle_plus_one_5 <= 9'(_GEN_17 + 9'h1);
      last_stage_pc_middle_minus_one_5 <= 9'(_GEN_17 - 9'h1);
    end
    if (io_s2_fire_2) begin
      ...
      s3_ftb_entry_dup_2_brSlots_0_offset <=
        s2_multi_hit_enable_probe
          ? _ftbBank_io_read_multi_entry_brSlots_0_offset
          : io_out_s2_full_pred_2_offsets_0_0;
      ...
      s3_ftb_entry_dup_2_tailSlot_offset <=
        s2_multi_hit_enable_probe
          ? _ftbBank_io_read_multi_entry_tailSlot_offset
          : s2_ftb_entry_dup_2_tailSlot_offset;
      ...
      s3_ftb_entry_dup_2_last_may_be_rvi_call <=
        s2_multi_hit_enable_probe
          ? _ftbBank_io_read_multi_entry_last_may_be_rvi_call
      ...
      s3_multi_hit_dup_2 <= s2_multi_hit_enable_probe;
      last_stage_pc_higher_6 <=
        {s2_pc_dup_s2_pc_seg_0_value_2, s2_pc_dup_s2_pc_seg_1_value_2[11:9]};
      last_stage_pc_middle_6 <= s2_pc_dup_s2_pc_seg_1_value_2[8:1];
      last_stage_pc_higher_plus_one_6 <= 29'(_GEN_18 + 29'h1);
      last_stage_pc_higher_minus_one_6 <= 29'(_GEN_18 - 29'h1);
      last_stage_pc_middle_plus_one_6 <= 9'(_GEN_19 + 9'h1);
      last_stage_pc_middle_minus_one_6 <= 9'(_GEN_19 - 9'h1);
    end
    if (io_s2_fire_3) begin
      s3_ftb_entry_dup_3_isCall <=
        s2_multi_hit_enable_probe
          ? _ftbBank_io_read_multi_entry_isCall
          : s2_ftb_entry_dup_3_isCall;
      s3_ftb_entry_dup_3_isRet <=
        s2_multi_hit_enable_probe
          ? _ftbBank_io_read_multi_entry_isRet
          : s2_ftb_entry_dup_3_isRet;
      s3_ftb_entry_dup_3_isJalr <=
        s2_multi_hit_enable_probe
          ? _ftbBank_io_read_multi_entry_isJalr
          : s2_ftb_entry_dup_3_isJalr;
      ...
      s3_ftb_entry_dup_3_last_may_be_rvi_call <=
        s2_multi_hit_enable_probe
          ? _ftbBank_io_read_multi_entry_last_may_be_rvi_call
          : s2_ftb_entry_dup_3_last_may_be_rvi_call;
      ...
      s3_multi_hit_dup_3 <= s2_multi_hit_enable_probe;
      last_stage_pc_higher_7 <=
        {s2_pc_dup_s2_pc_seg_0_value_3, s2_pc_dup_s2_pc_seg_1_value_3[11:9]};
      last_stage_pc_middle_7 <= s2_pc_dup_s2_pc_seg_1_value_3[8:1];
      last_stage_pc_higher_plus_one_7 <= 29'(_GEN_20 + 29'h1);
      last_stage_pc_higher_minus_one_7 <= 29'(_GEN_20 - 29'h1);
      last_stage_pc_middle_plus_one_7 <= 9'(_GEN_21 + 9'h1);
      last_stage_pc_middle_minus_one_7 <= 9'(_GEN_21 - 9'h1);
    end
    ...
    io_perf_1_value_REG <= update_valid & ~(update_meta_r[64]);
    io_perf_1_value_REG_1 <= io_perf_1_value_REG;
  end // always @(posedge)
  wire         needReopen = s0_close_ftb_req & (ftb_false_hit | io_redirectFromIFU);
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      if (io_s2_fire_0)
        s3_hit_dup_0 <= s2_multi_hit_enable_probe ? s2_multi_hit_probe : s2_hit_dup_0;
      if (io_s2_fire_1)
        s3_hit_dup_1 <= s2_multi_hit_enable_probe ? s2_multi_hit_probe : s2_hit_dup_1;
      if (io_s2_fire_2)
        s3_hit_dup_2 <= s2_multi_hit_enable_probe ? s2_multi_hit_probe : s2_hit_dup_2;
      if (io_s2_fire_3)
        s3_hit_dup_3 <= s2_multi_hit_enable_probe ? s2_multi_hit_probe : s2_hit_dup_3;
      s2_ftb_meta_c <= 64'(s2_ftb_meta_c + 64'h1);
      s2_multi_hit_meta_c <= 64'(s2_multi_hit_meta_c + 64'h1);
      if (needReopen)
        fauftb_ftb_entry_consistent_counter <= 9'h0;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s0_close_ftb_req = _RANDOM[8'h12][26];
        s1_close_ftb_req = _RANDOM[8'h12][27];
        s2_close_ftb_req = _RANDOM[8'h12][28];
        s2_fauftb_ftb_entry_dup_0_isCall = _RANDOM[8'h12][29];
        s2_fauftb_ftb_entry_dup_0_isRet = _RANDOM[8'h12][30];
        s2_fauftb_ftb_entry_dup_0_isJalr = _RANDOM[8'h12][31];
        s2_fauftb_ftb_entry_dup_0_valid = _RANDOM[8'h13][0];
        s2_fauftb_ftb_entry_dup_0_brSlots_0_offset = _RANDOM[8'h13][4:1];
        s2_fauftb_ftb_entry_dup_0_brSlots_0_sharing = _RANDOM[8'h13][5];
        s2_fauftb_ftb_entry_dup_0_brSlots_0_valid = _RANDOM[8'h13][6];
        s2_fauftb_ftb_entry_dup_0_brSlots_0_lower = _RANDOM[8'h13][18:7];
        s2_fauftb_ftb_entry_dup_0_brSlots_0_tarStat = _RANDOM[8'h13][20:19];
        s2_fauftb_ftb_entry_dup_0_tailSlot_offset = _RANDOM[8'h13][24:21];
        s2_fauftb_ftb_entry_dup_0_tailSlot_sharing = _RANDOM[8'h13][25];
        s2_fauftb_ftb_entry_dup_0_tailSlot_valid = _RANDOM[8'h13][26];
        s2_fauftb_ftb_entry_dup_0_tailSlot_lower =
          {_RANDOM[8'h13][31:27], _RANDOM[8'h14][14:0]};
        s2_fauftb_ftb_entry_dup_0_tailSlot_tarStat = _RANDOM[8'h14][16:15];
        s2_fauftb_ftb_entry_dup_0_pftAddr = _RANDOM[8'h14][20:17];
        s2_fauftb_ftb_entry_dup_0_carry = _RANDOM[8'h14][21];
        s2_fauftb_ftb_entry_dup_0_last_may_be_rvi_call = _RANDOM[8'h14][22];
        s2_fauftb_ftb_entry_dup_0_strong_bias_0 = _RANDOM[8'h14][23];
        s2_fauftb_ftb_entry_dup_0_strong_bias_1 = _RANDOM[8'h14][24];
        s2_fauftb_ftb_entry_dup_1_isCall = _RANDOM[8'h14][25];
        s2_fauftb_ftb_entry_dup_1_isRet = _RANDOM[8'h14][26];
        s2_fauftb_ftb_entry_dup_1_isJalr = _RANDOM[8'h14][27];
        s2_fauftb_ftb_entry_dup_1_brSlots_0_offset =
          {_RANDOM[8'h14][31:29], _RANDOM[8'h15][0]};
        s2_fauftb_ftb_entry_dup_1_brSlots_0_valid = _RANDOM[8'h15][2];
        s2_fauftb_ftb_entry_dup_1_brSlots_0_lower = _RANDOM[8'h15][14:3];
        s2_fauftb_ftb_entry_dup_1_brSlots_0_tarStat = _RANDOM[8'h15][16:15];
        s2_fauftb_ftb_entry_dup_1_tailSlot_offset = _RANDOM[8'h15][20:17];
        s2_fauftb_ftb_entry_dup_1_tailSlot_sharing = _RANDOM[8'h15][21];
        s2_fauftb_ftb_entry_dup_1_tailSlot_valid = _RANDOM[8'h15][22];
        s2_fauftb_ftb_entry_dup_1_tailSlot_lower =
          {_RANDOM[8'h15][31:23], _RANDOM[8'h16][10:0]};
        s2_fauftb_ftb_entry_dup_1_tailSlot_tarStat = _RANDOM[8'h16][12:11];
        s2_fauftb_ftb_entry_dup_1_pftAddr = _RANDOM[8'h16][16:13];
        s2_fauftb_ftb_entry_dup_1_carry = _RANDOM[8'h16][17];
        s2_fauftb_ftb_entry_dup_1_last_may_be_rvi_call = _RANDOM[8'h16][18];
        s2_fauftb_ftb_entry_dup_1_strong_bias_0 = _RANDOM[8'h16][19];
        s2_fauftb_ftb_entry_dup_1_strong_bias_1 = _RANDOM[8'h16][20];
        s2_fauftb_ftb_entry_dup_2_isCall = _RANDOM[8'h16][21];
        s2_fauftb_ftb_entry_dup_2_isRet = _RANDOM[8'h16][22];
        s2_fauftb_ftb_entry_dup_2_isJalr = _RANDOM[8'h16][23];
        s2_fauftb_ftb_entry_dup_2_brSlots_0_offset = _RANDOM[8'h16][28:25];
        s2_fauftb_ftb_entry_dup_2_brSlots_0_valid = _RANDOM[8'h16][30];
        s2_fauftb_ftb_entry_dup_2_brSlots_0_lower =
          {_RANDOM[8'h16][31], _RANDOM[8'h17][10:0]};
        s2_fauftb_ftb_entry_dup_2_brSlots_0_tarStat = _RANDOM[8'h17][12:11];
        s2_fauftb_ftb_entry_dup_2_tailSlot_offset = _RANDOM[8'h17][16:13];
        s2_fauftb_ftb_entry_dup_2_tailSlot_sharing = _RANDOM[8'h17][17];
        s2_fauftb_ftb_entry_dup_2_tailSlot_valid = _RANDOM[8'h17][18];
        s2_fauftb_ftb_entry_dup_2_tailSlot_lower =
          {_RANDOM[8'h17][31:19], _RANDOM[8'h18][6:0]};
        s2_fauftb_ftb_entry_dup_2_tailSlot_tarStat = _RANDOM[8'h18][8:7];
        s2_fauftb_ftb_entry_dup_2_pftAddr = _RANDOM[8'h18][12:9];
        s2_fauftb_ftb_entry_dup_2_carry = _RANDOM[8'h18][13];
        s2_fauftb_ftb_entry_dup_2_last_may_be_rvi_call = _RANDOM[8'h18][14];
        s2_fauftb_ftb_entry_dup_2_strong_bias_0 = _RANDOM[8'h18][15];
        s2_fauftb_ftb_entry_dup_2_strong_bias_1 = _RANDOM[8'h18][16];
        s2_fauftb_ftb_entry_dup_3_isCall = _RANDOM[8'h18][17];
        s2_fauftb_ftb_entry_dup_3_isRet = _RANDOM[8'h18][18];
        s2_fauftb_ftb_entry_dup_3_isJalr = _RANDOM[8'h18][19];
        s2_fauftb_ftb_entry_dup_3_brSlots_0_offset = _RANDOM[8'h18][24:21];
        s2_fauftb_ftb_entry_dup_3_brSlots_0_valid = _RANDOM[8'h18][26];
        s2_fauftb_ftb_entry_dup_3_brSlots_0_lower =
          {_RANDOM[8'h18][31:27], _RANDOM[8'h19][6:0]};
        s2_fauftb_ftb_entry_dup_3_brSlots_0_tarStat = _RANDOM[8'h19][8:7];
        s2_fauftb_ftb_entry_dup_3_tailSlot_offset = _RANDOM[8'h19][12:9];
        s2_fauftb_ftb_entry_dup_3_tailSlot_sharing = _RANDOM[8'h19][13];
        s2_fauftb_ftb_entry_dup_3_tailSlot_valid = _RANDOM[8'h19][14];
        s2_fauftb_ftb_entry_dup_3_tailSlot_lower =
          {_RANDOM[8'h19][31:15], _RANDOM[8'h1A][2:0]};
        s2_fauftb_ftb_entry_dup_3_tailSlot_tarStat = _RANDOM[8'h1A][4:3];
        s2_fauftb_ftb_entry_dup_3_pftAddr = _RANDOM[8'h1A][8:5];
        s2_fauftb_ftb_entry_dup_3_carry = _RANDOM[8'h1A][9];
        s2_fauftb_ftb_entry_dup_3_last_may_be_rvi_call = _RANDOM[8'h1A][10];
        s2_fauftb_ftb_entry_dup_3_strong_bias_0 = _RANDOM[8'h1A][11];
        s2_fauftb_ftb_entry_dup_3_strong_bias_1 = _RANDOM[8'h1A][12];
        s2_fauftb_ftb_entry_hit_dup_0 = _RANDOM[8'h1A][13];
        s2_fauftb_ftb_entry_hit_dup_1 = _RANDOM[8'h1A][14];
        s2_fauftb_ftb_entry_hit_dup_2 = _RANDOM[8'h1A][15];
        s2_fauftb_ftb_entry_hit_dup_3 = _RANDOM[8'h1A][16];
        s2_ftbBank_dup_0_isCall = _RANDOM[8'h1A][18];
        s2_ftbBank_dup_0_isRet = _RANDOM[8'h1A][19];
        s2_ftbBank_dup_0_isJalr = _RANDOM[8'h1A][20];
        s2_ftbBank_dup_0_valid = _RANDOM[8'h1A][21];
        s2_ftbBank_dup_0_brSlots_0_offset = _RANDOM[8'h1A][25:22];
        s2_ftbBank_dup_0_brSlots_0_sharing = _RANDOM[8'h1A][26];
        s2_ftbBank_dup_0_brSlots_0_valid = _RANDOM[8'h1A][27];
        s2_ftbBank_dup_0_brSlots_0_lower = {_RANDOM[8'h1A][31:28], _RANDOM[8'h1B][7:0]};
        s2_ftbBank_dup_0_brSlots_0_tarStat = _RANDOM[8'h1B][9:8];
        s2_ftbBank_dup_0_tailSlot_offset = _RANDOM[8'h1B][13:10];
        s2_ftbBank_dup_0_tailSlot_sharing = _RANDOM[8'h1B][14];
        s2_ftbBank_dup_0_tailSlot_valid = _RANDOM[8'h1B][15];
        s2_ftbBank_dup_0_tailSlot_lower = {_RANDOM[8'h1B][31:16], _RANDOM[8'h1C][3:0]};
        s2_ftbBank_dup_0_tailSlot_tarStat = _RANDOM[8'h1C][5:4];
        s2_ftbBank_dup_0_pftAddr = _RANDOM[8'h1C][9:6];
        s2_ftbBank_dup_0_carry = _RANDOM[8'h1C][10];
        s2_ftbBank_dup_0_last_may_be_rvi_call = _RANDOM[8'h1C][11];
        s2_ftbBank_dup_0_strong_bias_0 = _RANDOM[8'h1C][12];
        s2_ftbBank_dup_0_strong_bias_1 = _RANDOM[8'h1C][13];
        s2_ftbBank_dup_1_isCall = _RANDOM[8'h1C][14];
        s2_ftbBank_dup_1_isRet = _RANDOM[8'h1C][15];
        s2_ftbBank_dup_1_isJalr = _RANDOM[8'h1C][16];
        s2_ftbBank_dup_1_brSlots_0_offset = _RANDOM[8'h1C][21:18];
        s2_ftbBank_dup_1_brSlots_0_valid = _RANDOM[8'h1C][23];
        s2_ftbBank_dup_1_brSlots_0_lower = {_RANDOM[8'h1C][31:24], _RANDOM[8'h1D][3:0]};
        s2_ftbBank_dup_1_brSlots_0_tarStat = _RANDOM[8'h1D][5:4];
        s2_ftbBank_dup_1_tailSlot_offset = _RANDOM[8'h1D][9:6];
        s2_ftbBank_dup_1_tailSlot_sharing = _RANDOM[8'h1D][10];
        s2_ftbBank_dup_1_tailSlot_valid = _RANDOM[8'h1D][11];
        s2_ftbBank_dup_1_tailSlot_lower = _RANDOM[8'h1D][31:12];
        s2_ftbBank_dup_1_tailSlot_tarStat = _RANDOM[8'h1E][1:0];
        s2_ftbBank_dup_1_pftAddr = _RANDOM[8'h1E][5:2];
        s2_ftbBank_dup_1_carry = _RANDOM[8'h1E][6];
        s2_ftbBank_dup_1_last_may_be_rvi_call = _RANDOM[8'h1E][7];
        s2_ftbBank_dup_1_strong_bias_0 = _RANDOM[8'h1E][8];
        s2_ftbBank_dup_1_strong_bias_1 = _RANDOM[8'h1E][9];
        s2_ftbBank_dup_2_isCall = _RANDOM[8'h1E][10];
        s2_ftbBank_dup_2_isRet = _RANDOM[8'h1E][11];
        s2_ftbBank_dup_2_isJalr = _RANDOM[8'h1E][12];
        s2_ftbBank_dup_2_brSlots_0_offset = _RANDOM[8'h1E][17:14];
        s2_ftbBank_dup_2_brSlots_0_valid = _RANDOM[8'h1E][19];
        s2_ftbBank_dup_2_brSlots_0_lower = _RANDOM[8'h1E][31:20];
        s2_ftbBank_dup_2_brSlots_0_tarStat = _RANDOM[8'h1F][1:0];
        s2_ftbBank_dup_2_tailSlot_offset = _RANDOM[8'h1F][5:2];
        s2_ftbBank_dup_2_tailSlot_sharing = _RANDOM[8'h1F][6];
        s2_ftbBank_dup_2_tailSlot_valid = _RANDOM[8'h1F][7];
        s2_ftbBank_dup_2_tailSlot_lower = _RANDOM[8'h1F][27:8];
        s2_ftbBank_dup_2_tailSlot_tarStat = _RANDOM[8'h1F][29:28];
        s2_ftbBank_dup_2_pftAddr = {_RANDOM[8'h1F][31:30], _RANDOM[8'h20][1:0]};
        s2_ftbBank_dup_2_carry = _RANDOM[8'h20][2];
        s2_ftbBank_dup_2_last_may_be_rvi_call = _RANDOM[8'h20][3];
        s2_ftbBank_dup_2_strong_bias_0 = _RANDOM[8'h20][4];
        s2_ftbBank_dup_2_strong_bias_1 = _RANDOM[8'h20][5];
        s2_ftbBank_dup_3_isCall = _RANDOM[8'h20][6];
        s2_ftbBank_dup_3_isRet = _RANDOM[8'h20][7];
        s2_ftbBank_dup_3_isJalr = _RANDOM[8'h20][8];
        s2_ftbBank_dup_3_brSlots_0_offset = _RANDOM[8'h20][13:10];
        s2_ftbBank_dup_3_brSlots_0_valid = _RANDOM[8'h20][15];
        s2_ftbBank_dup_3_brSlots_0_lower = _RANDOM[8'h20][27:16];
        s2_ftbBank_dup_3_brSlots_0_tarStat = _RANDOM[8'h20][29:28];
        s2_ftbBank_dup_3_tailSlot_offset = {_RANDOM[8'h20][31:30], _RANDOM[8'h21][1:0]};
        s2_ftbBank_dup_3_tailSlot_sharing = _RANDOM[8'h21][2];
        s2_ftbBank_dup_3_tailSlot_valid = _RANDOM[8'h21][3];
        s2_ftbBank_dup_3_tailSlot_lower = _RANDOM[8'h21][23:4];
        s2_ftbBank_dup_3_tailSlot_tarStat = _RANDOM[8'h21][25:24];
        s2_ftbBank_dup_3_pftAddr = _RANDOM[8'h21][29:26];
        s2_ftbBank_dup_3_carry = _RANDOM[8'h21][30];
        s2_ftbBank_dup_3_last_may_be_rvi_call = _RANDOM[8'h21][31];
        s2_ftbBank_dup_3_strong_bias_0 = _RANDOM[8'h22][0];
        s2_ftbBank_dup_3_strong_bias_1 = _RANDOM[8'h22][1];
        s3_ftb_entry_dup_0_isCall = _RANDOM[8'h22][2];
        s3_ftb_entry_dup_0_isRet = _RANDOM[8'h22][3];
        s3_ftb_entry_dup_0_isJalr = _RANDOM[8'h22][4];
        s3_ftb_entry_dup_0_valid = _RANDOM[8'h22][5];
        s3_ftb_entry_dup_0_brSlots_0_offset = _RANDOM[8'h22][9:6];
        s3_ftb_entry_dup_0_brSlots_0_sharing = _RANDOM[8'h22][10];
        s3_ftb_entry_dup_0_brSlots_0_valid = _RANDOM[8'h22][11];
        s3_ftb_entry_dup_0_brSlots_0_lower = _RANDOM[8'h22][23:12];
        s3_ftb_entry_dup_0_brSlots_0_tarStat = _RANDOM[8'h22][25:24];
        s3_ftb_entry_dup_0_tailSlot_offset = _RANDOM[8'h22][29:26];
        s3_ftb_entry_dup_0_tailSlot_sharing = _RANDOM[8'h22][30];
        s3_ftb_entry_dup_0_tailSlot_valid = _RANDOM[8'h22][31];
        s3_ftb_entry_dup_0_tailSlot_lower = _RANDOM[8'h23][19:0];
        s3_ftb_entry_dup_0_tailSlot_tarStat = _RANDOM[8'h23][21:20];
        s3_ftb_entry_dup_0_pftAddr = _RANDOM[8'h23][25:22];
        s3_ftb_entry_dup_0_carry = _RANDOM[8'h23][26];
        s3_ftb_entry_dup_0_last_may_be_rvi_call = _RANDOM[8'h23][27];
        s3_ftb_entry_dup_0_strong_bias_0 = _RANDOM[8'h23][28];
        s3_ftb_entry_dup_0_strong_bias_1 = _RANDOM[8'h23][29];
        s3_ftb_entry_dup_1_isCall = _RANDOM[8'h23][30];
        s3_ftb_entry_dup_1_isRet = _RANDOM[8'h23][31];
        s3_ftb_entry_dup_1_isJalr = _RANDOM[8'h24][0];
        s3_ftb_entry_dup_1_brSlots_0_offset = _RANDOM[8'h24][5:2];
        s3_ftb_entry_dup_1_brSlots_0_valid = _RANDOM[8'h24][7];
        s3_ftb_entry_dup_1_brSlots_0_lower = _RANDOM[8'h24][19:8];
        s3_ftb_entry_dup_1_brSlots_0_tarStat = _RANDOM[8'h24][21:20];
        s3_ftb_entry_dup_1_tailSlot_offset = _RANDOM[8'h24][25:22];
        s3_ftb_entry_dup_1_tailSlot_sharing = _RANDOM[8'h24][26];
        s3_ftb_entry_dup_1_tailSlot_valid = _RANDOM[8'h24][27];
        s3_ftb_entry_dup_1_tailSlot_lower = {_RANDOM[8'h24][31:28], _RANDOM[8'h25][15:0]};
        s3_ftb_entry_dup_1_tailSlot_tarStat = _RANDOM[8'h25][17:16];
        s3_ftb_entry_dup_1_pftAddr = _RANDOM[8'h25][21:18];
        s3_ftb_entry_dup_1_carry = _RANDOM[8'h25][22];
        s3_ftb_entry_dup_1_last_may_be_rvi_call = _RANDOM[8'h25][23];
        s3_ftb_entry_dup_1_strong_bias_0 = _RANDOM[8'h25][24];
        s3_ftb_entry_dup_1_strong_bias_1 = _RANDOM[8'h25][25];
        s3_ftb_entry_dup_2_isCall = _RANDOM[8'h25][26];
        s3_ftb_entry_dup_2_isRet = _RANDOM[8'h25][27];
        s3_ftb_entry_dup_2_isJalr = _RANDOM[8'h25][28];
        s3_ftb_entry_dup_2_brSlots_0_offset =
          {_RANDOM[8'h25][31:30], _RANDOM[8'h26][1:0]};
        s3_ftb_entry_dup_2_brSlots_0_valid = _RANDOM[8'h26][3];
        s3_ftb_entry_dup_2_brSlots_0_lower = _RANDOM[8'h26][15:4];
        s3_ftb_entry_dup_2_brSlots_0_tarStat = _RANDOM[8'h26][17:16];
        s3_ftb_entry_dup_2_tailSlot_offset = _RANDOM[8'h26][21:18];
        s3_ftb_entry_dup_2_tailSlot_sharing = _RANDOM[8'h26][22];
        s3_ftb_entry_dup_2_tailSlot_valid = _RANDOM[8'h26][23];
        s3_ftb_entry_dup_2_tailSlot_lower = {_RANDOM[8'h26][31:24], _RANDOM[8'h27][11:0]};
        s3_ftb_entry_dup_2_tailSlot_tarStat = _RANDOM[8'h27][13:12];
        s3_ftb_entry_dup_2_pftAddr = _RANDOM[8'h27][17:14];
        s3_ftb_entry_dup_2_carry = _RANDOM[8'h27][18];
        s3_ftb_entry_dup_2_last_may_be_rvi_call = _RANDOM[8'h27][19];
        s3_ftb_entry_dup_2_strong_bias_0 = _RANDOM[8'h27][20];
        s3_ftb_entry_dup_2_strong_bias_1 = _RANDOM[8'h27][21];
        s3_ftb_entry_dup_3_isCall = _RANDOM[8'h27][22];
        s3_ftb_entry_dup_3_isRet = _RANDOM[8'h27][23];
        s3_ftb_entry_dup_3_isJalr = _RANDOM[8'h27][24];
        s3_ftb_entry_dup_3_brSlots_0_offset = _RANDOM[8'h27][29:26];
        s3_ftb_entry_dup_3_brSlots_0_valid = _RANDOM[8'h27][31];
        s3_ftb_entry_dup_3_brSlots_0_lower = _RANDOM[8'h28][11:0];
        s3_ftb_entry_dup_3_brSlots_0_tarStat = _RANDOM[8'h28][13:12];
        s3_ftb_entry_dup_3_tailSlot_offset = _RANDOM[8'h28][17:14];
        s3_ftb_entry_dup_3_tailSlot_sharing = _RANDOM[8'h28][18];
        s3_ftb_entry_dup_3_tailSlot_valid = _RANDOM[8'h28][19];
        s3_ftb_entry_dup_3_tailSlot_lower = {_RANDOM[8'h28][31:20], _RANDOM[8'h29][7:0]};
        s3_ftb_entry_dup_3_tailSlot_tarStat = _RANDOM[8'h29][9:8];
        s3_ftb_entry_dup_3_pftAddr = _RANDOM[8'h29][13:10];
        s3_ftb_entry_dup_3_carry = _RANDOM[8'h29][14];
        s3_ftb_entry_dup_3_last_may_be_rvi_call = _RANDOM[8'h29][15];
        s3_ftb_entry_dup_3_strong_bias_0 = _RANDOM[8'h29][16];
        s3_ftb_entry_dup_3_strong_bias_1 = _RANDOM[8'h29][17];
        real_s3_fallThroughErr_dup_0 = _RANDOM[8'h29][18];
        real_s3_fallThroughErr_dup_1 = _RANDOM[8'h29][19];
        real_s3_fallThroughErr_dup_2 = _RANDOM[8'h29][20];
        real_s3_fallThroughErr_dup_3 = _RANDOM[8'h29][21];
        s2_ftb_hit_dup_0 = _RANDOM[8'h29][22];
        s2_ftb_hit_dup_1 = _RANDOM[8'h29][23];
        s2_ftb_hit_dup_2 = _RANDOM[8'h29][24];
        s2_ftb_hit_dup_3 = _RANDOM[8'h29][25];
        s3_hit_dup_0 = _RANDOM[8'h29][26];
        s3_hit_dup_1 = _RANDOM[8'h29][27];
        s3_hit_dup_2 = _RANDOM[8'h29][28];
        s3_hit_dup_3 = _RANDOM[8'h29][29];
        s3_multi_hit_dup_0 = _RANDOM[8'h29][30];
        s3_multi_hit_dup_1 = _RANDOM[8'h29][31];
        s3_multi_hit_dup_2 = _RANDOM[8'h2A][0];
        s3_multi_hit_dup_3 = _RANDOM[8'h2A][1];
        s2_ftb_meta_c = {_RANDOM[8'h2A][31:2], _RANDOM[8'h2B], _RANDOM[8'h2C][1:0]};
        s2_ftb_meta = {_RANDOM[8'h2C][31:2], _RANDOM[8'h2D], _RANDOM[8'h2E][4:0]};
        s2_multi_hit_meta_c = {_RANDOM[8'h2E][31:5], _RANDOM[8'h2F], _RANDOM[8'h30][4:0]};
        fauftb_ftb_entry_consistent_counter = _RANDOM[8'h30][13:5];
        update_valid = _RANDOM[8'h30][14];
        update_r_ftb_entry_isCall = _RANDOM[8'h34][21];
        update_r_ftb_entry_isRet = _RANDOM[8'h34][22];
        update_r_ftb_entry_isJalr = _RANDOM[8'h34][23];
        update_r_ftb_entry_valid = _RANDOM[8'h34][24];
        update_r_ftb_entry_brSlots_0_offset = _RANDOM[8'h34][28:25];
        update_r_ftb_entry_brSlots_0_sharing = _RANDOM[8'h34][29];
        update_r_ftb_entry_brSlots_0_valid = _RANDOM[8'h34][30];
        update_r_ftb_entry_brSlots_0_lower = {_RANDOM[8'h34][31], _RANDOM[8'h35][10:0]};
        update_r_ftb_entry_brSlots_0_tarStat = _RANDOM[8'h35][12:11];
        update_r_ftb_entry_tailSlot_offset = _RANDOM[8'h35][16:13];
        update_r_ftb_entry_tailSlot_sharing = _RANDOM[8'h35][17];
        update_r_ftb_entry_tailSlot_valid = _RANDOM[8'h35][18];
        update_r_ftb_entry_tailSlot_lower = {_RANDOM[8'h35][31:19], _RANDOM[8'h36][6:0]};
        update_r_ftb_entry_tailSlot_tarStat = _RANDOM[8'h36][8:7];
        update_r_ftb_entry_pftAddr = _RANDOM[8'h36][12:9];
        update_r_ftb_entry_carry = _RANDOM[8'h36][13];
        update_r_ftb_entry_last_may_be_rvi_call = _RANDOM[8'h36][14];
        update_r_ftb_entry_strong_bias_0 = _RANDOM[8'h36][15];
        update_r_ftb_entry_strong_bias_1 = _RANDOM[8'h36][16];
        update_r_false_hit = _RANDOM[8'h36][31];
        update_r_old_entry = _RANDOM[8'h37][2];
        update_meta_r =
          {_RANDOM[8'h50][31:27],
           _RANDOM[8'h51],
           _RANDOM[8'h52],
           ...
           _RANDOM[8'h5F],
           _RANDOM[8'h60][30:0]};
        last_stage_pc_higher = {_RANDOM[8'h60][31], _RANDOM[8'h61][27:0]};
        last_stage_pc_middle = {_RANDOM[8'h61][31:28], _RANDOM[8'h62][3:0]};
        last_stage_pc_higher_plus_one = {_RANDOM[8'h62][31:4], _RANDOM[8'h63][0]};
        last_stage_pc_higher_minus_one = _RANDOM[8'h63][29:1];
        last_stage_pc_middle_plus_one = {_RANDOM[8'h63][31:30], _RANDOM[8'h64][6:0]};
        last_stage_pc_middle_minus_one = _RANDOM[8'h64][15:7];
        io_out_s2_full_pred_0_fallThroughAddr_stashed_carry = _RANDOM[8'h66][16];
        last_stage_pc_higher_1 = {_RANDOM[8'h66][31:17], _RANDOM[8'h67][13:0]};
        last_stage_pc_middle_1 = _RANDOM[8'h67][21:14];
        last_stage_pc_higher_plus_one_1 = {_RANDOM[8'h67][31:22], _RANDOM[8'h68][18:0]};
        last_stage_pc_higher_minus_one_1 = {_RANDOM[8'h68][31:19], _RANDOM[8'h69][15:0]};
        last_stage_pc_middle_plus_one_1 = _RANDOM[8'h69][24:16];
        last_stage_pc_middle_minus_one_1 = {_RANDOM[8'h69][31:25], _RANDOM[8'h6A][1:0]};
        io_out_s2_full_pred_1_fallThroughAddr_stashed_carry = _RANDOM[8'h6C][2];
        last_stage_pc_higher_2 = _RANDOM[8'h6C][31:3];
        last_stage_pc_middle_2 = _RANDOM[8'h6D][7:0];
        last_stage_pc_higher_plus_one_2 = {_RANDOM[8'h6D][31:8], _RANDOM[8'h6E][4:0]};
        last_stage_pc_higher_minus_one_2 = {_RANDOM[8'h6E][31:5], _RANDOM[8'h6F][1:0]};
        last_stage_pc_middle_plus_one_2 = _RANDOM[8'h6F][10:2];
        last_stage_pc_middle_minus_one_2 = _RANDOM[8'h6F][19:11];
        io_out_s2_full_pred_2_fallThroughAddr_stashed_carry = _RANDOM[8'h71][20];
        last_stage_pc_higher_3 = {_RANDOM[8'h71][31:21], _RANDOM[8'h72][17:0]};
        last_stage_pc_middle_3 = _RANDOM[8'h72][25:18];
        last_stage_pc_higher_plus_one_3 = {_RANDOM[8'h72][31:26], _RANDOM[8'h73][22:0]};
        last_stage_pc_higher_minus_one_3 = {_RANDOM[8'h73][31:23], _RANDOM[8'h74][19:0]};
        last_stage_pc_middle_plus_one_3 = _RANDOM[8'h74][28:20];
        last_stage_pc_middle_minus_one_3 = {_RANDOM[8'h74][31:29], _RANDOM[8'h75][5:0]};
        io_out_s2_full_pred_3_fallThroughAddr_stashed_carry = _RANDOM[8'h77][6];
        last_stage_pc_higher_4 = {_RANDOM[8'h77][31:7], _RANDOM[8'h78][3:0]};
        last_stage_pc_middle_4 = _RANDOM[8'h78][11:4];
        last_stage_pc_higher_plus_one_4 = {_RANDOM[8'h78][31:12], _RANDOM[8'h79][8:0]};
        last_stage_pc_higher_minus_one_4 = {_RANDOM[8'h79][31:9], _RANDOM[8'h7A][5:0]};
        last_stage_pc_middle_plus_one_4 = _RANDOM[8'h7A][14:6];
        last_stage_pc_middle_minus_one_4 = _RANDOM[8'h7A][23:15];
        last_stage_pc_higher_5 = {_RANDOM[8'h7C][31:24], _RANDOM[8'h7D][20:0]};
        last_stage_pc_middle_5 = _RANDOM[8'h7D][28:21];
        last_stage_pc_higher_plus_one_5 = {_RANDOM[8'h7D][31:29], _RANDOM[8'h7E][25:0]};
        last_stage_pc_higher_minus_one_5 = {_RANDOM[8'h7E][31:26], _RANDOM[8'h7F][22:0]};
        last_stage_pc_middle_plus_one_5 = _RANDOM[8'h7F][31:23];
        last_stage_pc_middle_minus_one_5 = _RANDOM[8'h80][8:0];
        last_stage_pc_higher_6 = {_RANDOM[8'h82][31:9], _RANDOM[8'h83][5:0]};
        last_stage_pc_middle_6 = _RANDOM[8'h83][13:6];
        last_stage_pc_higher_plus_one_6 = {_RANDOM[8'h83][31:14], _RANDOM[8'h84][10:0]};
        last_stage_pc_higher_minus_one_6 = {_RANDOM[8'h84][31:11], _RANDOM[8'h85][7:0]};
        last_stage_pc_middle_plus_one_6 = _RANDOM[8'h85][16:8];
        last_stage_pc_middle_minus_one_6 = _RANDOM[8'h85][25:17];
        last_stage_pc_higher_7 = {_RANDOM[8'h87][31:26], _RANDOM[8'h88][22:0]};
        last_stage_pc_middle_7 = _RANDOM[8'h88][30:23];
        last_stage_pc_higher_plus_one_7 = {_RANDOM[8'h88][31], _RANDOM[8'h89][27:0]};
        last_stage_pc_higher_minus_one_7 = {_RANDOM[8'h89][31:28], _RANDOM[8'h8A][24:0]};
        last_stage_pc_middle_plus_one_7 = {_RANDOM[8'h8A][31:25], _RANDOM[8'h8B][1:0]};
        last_stage_pc_middle_minus_one_7 = _RANDOM[8'h8B][10:2];
        io_out_last_stage_meta_r =
          {_RANDOM[8'h8D][31:11], _RANDOM[8'h8E], _RANDOM[8'h8F][13:0]};
        io_s1_ready_REG = _RANDOM[8'h8F][14];
        ftbBank_io_update_write_way_REG = _RANDOM[8'h8F][16:15];
        ftbBank_io_update_write_alloc_REG = _RANDOM[8'h8F][17];
        REG_2 = _RANDOM[8'h8F][18];
        REG_3 = _RANDOM[8'h8F][19];
        io_perf_0_value_REG = _RANDOM[8'h8F][20];
        io_perf_0_value_REG_1 = _RANDOM[8'h8F][21];
        io_perf_1_value_REG = _RANDOM[8'h8F][22];
        io_perf_1_value_REG_1 = _RANDOM[8'h8F][23];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        s2_pc_dup_s2_pc_seg_0_value = 26'h0;
        s2_pc_dup_s2_pc_seg_1_value = 12'h0;
  ...
  FTBBank ftbBank (
    ...
    .io_update_access
      (u_valid_probe & ~(update_meta_r[64])),
    .io_update_pc                                         (write_pc),
    .io_update_write_data_valid                           (write_valid),
    ...
    .io_update_write_data_bits_entry_pftAddr              (ftb_write_entry_pftAddr),
    .io_update_write_data_bits_entry_carry                (ftb_write_entry_carry),
    ...
    .io_update_write_way
      (update_now ? update_meta_r[66:65] : ftbBank_io_update_write_way_REG),
  ...
  DelayN_1 write_valid_delay (
    .clock  (clock),
    .io_in  (u_valid_probe & ~(update_meta_r[64])),
  ...
  assign io_out_s2_full_pred_0_fallThroughAddr =
    io_out_s2_full_pred_0_fallThroughErr_0
      ...
      : {io_out_s2_full_pred_0_fallThroughAddr_stashed_carry
         ...
         s2_ftb_entry_dup_0_pftAddr,
         1'h0};
  assign io_out_s2_full_pred_0_fallThroughErr = io_out_s2_full_pred_0_fallThroughErr_0;
  assign io_out_s2_full_pred_0_is_jal =
    s2_ftb_entry_dup_0_tailSlot_valid & ~s2_ftb_entry_dup_0_isJalr;
  assign io_out_s2_full_pred_0_is_jalr =
    s2_ftb_entry_dup_0_tailSlot_valid & s2_ftb_entry_dup_0_isJalr;
  assign io_out_s2_full_pred_0_is_call =
    s2_ftb_entry_dup_0_tailSlot_valid & s2_ftb_entry_dup_0_isCall;
  assign io_out_s2_full_pred_0_is_ret =
    s2_ftb_entry_dup_0_tailSlot_valid & s2_ftb_entry_dup_0_isRet;
  ...
  assign io_out_s2_full_pred_1_fallThroughAddr =
    io_out_s2_full_pred_1_fallThroughErr_0
      ...
      : {io_out_s2_full_pred_1_fallThroughAddr_stashed_carry
         ...
         s2_ftb_entry_dup_1_pftAddr,
         1'h0};
  assign io_out_s2_full_pred_1_fallThroughErr = io_out_s2_full_pred_1_fallThroughErr_0;
  assign io_out_s2_full_pred_1_is_jal =
    s2_ftb_entry_dup_1_tailSlot_valid & ~s2_ftb_entry_dup_1_isJalr;
  assign io_out_s2_full_pred_1_is_jalr =
    s2_ftb_entry_dup_1_tailSlot_valid & s2_ftb_entry_dup_1_isJalr;
  assign io_out_s2_full_pred_1_is_call =
    s2_ftb_entry_dup_1_tailSlot_valid & s2_ftb_entry_dup_1_isCall;
  assign io_out_s2_full_pred_1_is_ret =
    s2_ftb_entry_dup_1_tailSlot_valid & s2_ftb_entry_dup_1_isRet;
  ...
  assign io_out_s2_full_pred_2_fallThroughAddr =
    io_out_s2_full_pred_2_fallThroughErr_0
      ...
      : {io_out_s2_full_pred_2_fallThroughAddr_stashed_carry
         ...
         s2_ftb_entry_dup_2_pftAddr,
         1'h0};
  assign io_out_s2_full_pred_2_fallThroughErr = io_out_s2_full_pred_2_fallThroughErr_0;
  assign io_out_s2_full_pred_2_is_jal =
  ...
  assign io_out_s2_full_pred_3_is_jal =
    s2_ftb_entry_dup_3_tailSlot_valid & ~s2_ftb_entry_dup_3_isJalr;
  assign io_out_s2_full_pred_3_is_jalr =
    s2_ftb_entry_dup_3_tailSlot_valid & s2_ftb_entry_dup_3_isJalr;
  assign io_out_s2_full_pred_3_is_call =
    s2_ftb_entry_dup_3_tailSlot_valid & s2_ftb_entry_dup_3_isCall;
  assign io_out_s2_full_pred_3_is_ret =
    s2_ftb_entry_dup_3_tailSlot_valid & s2_ftb_entry_dup_3_isRet;
  ...
  assign io_out_s3_full_pred_0_targets_1 =
    {s3_ftb_entry_dup_0_tailSlot_sharing
       ...
       : {(_tail_target_T_94 ? last_stage_pc_higher_plus_one_4 : 29'h0)
          ...
          s3_ftb_entry_dup_0_tailSlot_lower},
     1'h0};
  assign io_out_s3_full_pred_0_offsets_0 = s3_ftb_entry_dup_0_brSlots_0_offset;
  assign io_out_s3_full_pred_0_offsets_1 = s3_ftb_entry_dup_0_tailSlot_offset;
  ...
  assign io_out_s3_full_pred_0_is_jal =
    s3_ftb_entry_dup_0_tailSlot_valid & ~s3_ftb_entry_dup_0_isJalr;
  assign io_out_s3_full_pred_0_is_jalr =
    s3_ftb_entry_dup_0_tailSlot_valid & s3_ftb_entry_dup_0_isJalr;
  assign io_out_s3_full_pred_0_is_call =
    s3_ftb_entry_dup_0_tailSlot_valid & s3_ftb_entry_dup_0_isCall;
  assign io_out_s3_full_pred_0_is_ret =
    s3_ftb_entry_dup_0_tailSlot_valid & s3_ftb_entry_dup_0_isRet;
  ...
  assign io_out_s3_full_pred_1_targets_1 =
    {s3_ftb_entry_dup_1_tailSlot_sharing
       ...
       : {(_tail_target_T_115 ? last_stage_pc_higher_plus_one_5 : 29'h0)
          ...
          s3_ftb_entry_dup_1_tailSlot_lower},
     1'h0};
  assign io_out_s3_full_pred_1_offsets_0 = s3_ftb_entry_dup_1_brSlots_0_offset;
  assign io_out_s3_full_pred_1_offsets_1 = s3_ftb_entry_dup_1_tailSlot_offset;
  ...
  assign io_out_s3_full_pred_1_is_jal =
    s3_ftb_entry_dup_1_tailSlot_valid & ~s3_ftb_entry_dup_1_isJalr;
  assign io_out_s3_full_pred_1_is_jalr =
    s3_ftb_entry_dup_1_tailSlot_valid & s3_ftb_entry_dup_1_isJalr;
  assign io_out_s3_full_pred_1_is_call =
    s3_ftb_entry_dup_1_tailSlot_valid & s3_ftb_entry_dup_1_isCall;
  assign io_out_s3_full_pred_1_is_ret =
    s3_ftb_entry_dup_1_tailSlot_valid & s3_ftb_entry_dup_1_isRet;
  ...
  assign io_out_s3_full_pred_2_targets_1 =
    {s3_ftb_entry_dup_2_tailSlot_sharing
       ...
       : {(_tail_target_T_136 ? last_stage_pc_higher_plus_one_6 : 29'h0)
          ...
          s3_ftb_entry_dup_2_tailSlot_lower},
     1'h0};
  assign io_out_s3_full_pred_2_offsets_0 = s3_ftb_entry_dup_2_brSlots_0_offset;
  assign io_out_s3_full_pred_2_offsets_1 = s3_ftb_entry_dup_2_tailSlot_offset;
  ...
  assign io_out_s3_full_pred_2_is_jal =
  ...
  assign io_out_s3_full_pred_3_is_jal =
    s3_ftb_entry_dup_3_tailSlot_valid & ~s3_ftb_entry_dup_3_isJalr;
  assign io_out_s3_full_pred_3_is_jalr =
    s3_ftb_entry_dup_3_tailSlot_valid & s3_ftb_entry_dup_3_isJalr;
  assign io_out_s3_full_pred_3_is_call =
    s3_ftb_entry_dup_3_tailSlot_valid & s3_ftb_entry_dup_3_isCall;
  assign io_out_s3_full_pred_3_is_ret =
    s3_ftb_entry_dup_3_tailSlot_valid & s3_ftb_entry_dup_3_isRet;
  ...
  assign io_out_last_stage_meta = {449'h0, io_out_last_stage_meta_r};
