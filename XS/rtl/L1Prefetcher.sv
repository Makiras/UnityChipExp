...
module L1Prefetcher(
  ...
  wire        _probe;
  wire        _pf_queue_filter_io_tlb_req_req_valid;
  ...
  wire        _stride_meta_array_io_stream_lookup_req_valid;
  wire [49:0] _stride_meta_array_io_stream_lookup_req_bits_vaddr;
  ...
  wire        io_tlb_req_resp_valid_probe = io_tlb_req_resp_valid;
  wire        _probe_0 =
  ...
  StrideMetaArray stride_meta_array (
    ...
    .io_stream_lookup_req_valid         (_stride_meta_array_io_stream_lookup_req_valid),
    .io_stream_lookup_req_bits_vaddr
      (_stride_meta_array_io_stream_lookup_req_bits_vaddr)
  );
  ...
  wire        _probe_2;
  assign _probe_2 = _stream_train_filter_io_train_req_valid;
  StreamBitVectorArray stream_bit_vec_array (
    ...
    .io_stream_lookup_req_bits_vaddr
      (_stride_meta_array_io_stream_lookup_req_bits_vaddr),
    .io_stream_lookup_resp              (_probe)
  );
  MutiLevelPrefetchFilter pf_queue_filter (
    .clock                                   (clock),
    .reset                                   (reset),
    .io_l1_prefetch_req_valid                (_probe_0),
    .io_l1_prefetch_req_bits_region
      (_stream_bit_vec_array_io_l1_prefetch_req_valid
         ? _stream_bit_vec_array_io_l1_prefetch_req_bits_region
         : _stride_meta_array_io_l1_prefetch_req_bits_region),
    ...
    .io_l2_l3_prefetch_req_valid             (_probe_1),
    .io_l2_l3_prefetch_req_bits_region
      (_stream_bit_vec_array_io_l2_l3_prefetch_req_valid
         ? _stream_bit_vec_array_io_l2_l3_prefetch_req_bits_region
         : _stride_meta_array_io_l2_l3_prefetch_req_bits_region),
    ...
    .io_tlb_req_req_valid                    (_pf_queue_filter_io_tlb_req_req_valid),
  ...
  wire        _probe_3;
  assign _probe_3 = _pf_queue_filter_io_tlb_req_req_valid;
  assign io_tlb_req_req_valid = _pf_queue_filter_io_tlb_req_req_valid;
