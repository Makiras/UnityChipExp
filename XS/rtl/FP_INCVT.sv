...
module FP_INCVT(
  ...
  wire [63:0]  rounderMapIn =
    _rounderMapIn_T
      ? fracSrcLeft
      : isFroundOrFroundnxReg ? froundFrac : _shiftLeft_T_1[63:0];
  wire         selectInRounder = isFp2Int | isFroundOrFroundnxReg & froundExpLessThanBias;
  ...
  wire [10:0]  froundMaxExpNext =
    {3'h0, {3'h0, io_output1H[1] ? 5'h19 : 5'h0} | (io_output1H[2] ? 8'h96 : 8'h0)}
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      if (io_fire) begin
        ...
        froundFrac <=
          {_fracValueSrc_T_1, input_0[51:0], 11'h0}
          >> 11'(11'(froundMaxExpNext - input_0[62:52]) - 11'h1);
        ...
        froundExpGreaterThanMaxExp <= input_0[62:52] >= froundMaxExpNext;
        fracShiftMask <=
          11'(({3'h0,
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        froundFrac = {_RANDOM[4'h8][31:16], _RANDOM[4'h9], _RANDOM[4'hA][15:0]};
        froundExpLessThanBias = _RANDOM[4'hA][16];
        froundExpGreaterThanMaxExp = _RANDOM[4'hA][17];
        fracShiftMask = _RANDOM[4'hA][28:18];
        froundOldExp = {_RANDOM[4'hA][31:29], _RANDOM[4'hB][7:0]};
        froundOldFrac = {_RANDOM[4'hB][31:8], _RANDOM[4'hC][27:0]};
        fcvtmodFracReg = {_RANDOM[4'hC][31:28], _RANDOM[4'hD], _RANDOM[4'hE][27:0]};
        fcvtmodTrueExpReg = {_RANDOM[4'hE][31:28], _RANDOM[4'hF][6:0]};
        fcvtmodNxReg = _RANDOM[4'hF][7];
        fcvtmodExpLessThanBias = _RANDOM[4'hF][8];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        fireReg_last_r = 1'h0;
        expNotZeroSrc = 1'h0;
