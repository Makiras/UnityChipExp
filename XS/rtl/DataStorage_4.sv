...
module DataStorage_4(
  ...
  wire [1:0]   debug_stack_used =
    2'({1'h0, |{bank_en_0, bank_en_1, bank_en_2, bank_en_3}}
       + {1'h0, |{bank_en_4, bank_en_5, bank_en_6, bank_en_7}});
  wire         _GEN_12 = debug_stack_used == 2'h1;
  wire         _GEN_13 = debug_stack_used == 2'h2;
