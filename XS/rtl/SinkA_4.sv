...
module SinkA_4(
  ...
  `ifndef SYNTHESIS
    always @(posedge clock) begin
      if (bufferLeakCnt == 12'h320 & ~reset) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed: buffer leak at index 0\n    at SinkA.scala:82 assert(false.B, \"buffer leak at index 0\")\n");
        if (`STOP_COND_)
