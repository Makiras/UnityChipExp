...
module TLBNonBlock_2(
  ...
  wire             isLd = req_out_0_cmd[1:0] == 2'h0 & ~_isSt_T_5;
  ...
  wire             hasPf =
    ((~(~_modeCheck_T_8
     ...
     & isLd | (~(~_modeCheck_T_8 & readResult_0_4_0_w) | readResult_0_4_0_pf) & isSt
     | (~readResult_0_4_0_a
        | ~(readResult_p_hit_last_REG
              ? readResult_p_perm_d
              : _entries_io_r_resp_0_bits_perm_0_d)) & isSt
     | (~(~_modeCheck_T_8 & readResult_0_4_0_x) | readResult_0_4_0_pf) & isInst
     | ~readResult_0_4_0_a & isInst) & portTranslateEnable_0 & ~onlyS2 & ~af_2
    & ~(~readResult_0_4_0_v & ~readResult_0_4_0_pf & ~readResult_0_4_0_af & ~onlyS2)
    & ~(~(readResult_0_4_0_r | readResult_0_4_0_w | readResult_0_4_0_x)
  ...
  wire             io_requestor_0_resp_bits_excp_0_gpf_ld =
    REG
  ...
  wire             io_requestor_0_resp_bits_excp_0_gpf_st =
    REG
  ...
  assign hasGpf_0 =
    hit_read_0
    & (io_requestor_0_resp_bits_excp_0_gpf_ld | io_requestor_0_resp_bits_excp_0_gpf_st
  ...
  wire             _io_requestor_1_resp_bits_excp_0_pf_ld_T_1 =
    ...
    & isLd_2;
  wire             hasPf_2 =
    (_io_requestor_1_resp_bits_excp_0_pf_ld_T_1 | stPf_2 | stUpdate_2
  ...
  wire             _GEN_7 = result_ok_last_REG & portTranslateEnable_0;
  reg              r;
  wire             _GEN_8 = _GEN_7 & r;
  wire             _GEN_9 = _GEN_7 & miss_read_0;
  reg              r_1;
  wire             _GEN_10 = _GEN_9 & r_1;
  wire             _GEN_11 = result_ok_last_REG_1 & portTranslateEnable_1;
  wire             _GEN_12 = _GEN_11 & miss_read_1;
  wire             _GEN_13 = io_ptw_resp_valid & io_ptw_resp_bits_s1_pf;
  ...
  wire [3:0][43:0] _GEN_15 =
    {{{io_ptw_resp_bits_s1_entry_ppn[40:24], io_requestor_0_req_bits_vaddr[38:12]}},
     ...
     {{io_ptw_resp_bits_s1_entry_ppn, _GEN_14[io_requestor_0_req_bits_vaddr[14:12]]}}};
  wire [26:0]      readResult_gvpn =
    readResult_onlyS2
      ? io_requestor_0_req_bits_vaddr[38:12]
      : _GEN_15[io_ptw_resp_bits_s1_entry_level][26:0];
  ...
  wire [3:0][43:0] _GEN_16 =
    {{{io_ptw_resp_bits_s1_entry_ppn[40:24], io_requestor_1_req_bits_vaddr[38:12]}},
     ...
     {{io_ptw_resp_bits_s1_entry_ppn, _GEN_14[io_requestor_1_req_bits_vaddr[14:12]]}}};
  wire [26:0]      readResult_gvpn_2 =
    readResult_onlyS2_1
      ? io_requestor_1_req_bits_vaddr[38:12]
      : _GEN_16[io_ptw_resp_bits_s1_entry_level][26:0];
  ...
  wire             _GEN_22 = prevmEnable_0 | pres2xlateEnable_0;
  wire             _GEN_23 = req_in_s2xlate_0 == 2'h2;
  wire             pregpf_0 =
    _GEN_21 & _GEN_22 & _GEN_23
    & (Sv48x4Enable
         ? (|(EffectiveVa_0[63:50]))
         : Sv39x4Enable & (|(EffectiveVa_0[63:41])));
  wire             _GEN_24 = _readResult_T_5 | ~_readResult_T_25;
  wire             _GEN_25 = _readResult_T_42 | ~_readResult_T_62;
  wire             _GEN_26 =
    _GEN_21 & _GEN_22 & ~_GEN_23
    & (Sv48Enable
         ? {{16{EffectiveVa_0[47]}}, EffectiveVa_0[47:0]} != EffectiveVa_0
         : Sv39Enable & {{25{EffectiveVa_0[38]}}, EffectiveVa_0[38:0]} != EffectiveVa_0)
    | pregpf_0 | _GEN_21 & ~_GEN_22 & (|(EffectiveVa_0[63:48]));
  always @(posedge clock) begin
    ...
    need_gpa_robidx_flag <=
      _GEN_25 & (_GEN_24 ? need_gpa_robidx_flag : req_out_0_debug_robIdx_flag);
    if (_GEN_25) begin
      if (_GEN_24) begin
      end
      else
    ...
    if (io_ptw_resp_valid) begin
      readResult_p_ppn <=
        readResult_onlyS2 | (&req_in_s2xlate_0)
          ? {6'h0, _GEN_17[io_ptw_resp_bits_s2_entry_level]}
          : _GEN_15[io_ptw_resp_bits_s1_entry_level];
      ...
      readResult_p_ppn_1 <=
        readResult_onlyS2_1 | (&req_in_s2xlate_1)
          ? {6'h0, _GEN_18[io_ptw_resp_bits_s2_entry_level]}
  ...
  wire [2:0]       _readResult_s1tag_T_2 = _GEN_27 | _GEN_28;
  ...
  wire [2:0]       _readResult_s1tag_T_10 = _GEN_27 | _GEN_28;
        ...
        & (io_ptw_resp_valid & need_gpa
           & need_gpa_vpn == (_ptw_just_back_T_13
                                ...
                                : (&io_ptw_resp_bits_s2xlate)
                                    ? _GEN_29[_ptw_just_back_level_T_1
                                                ? io_ptw_resp_bits_s1_entry_level
                                                : io_ptw_resp_bits_s2_entry_level]
                                    : readResult_s1tag_1)
           ...
           & (io_ptw_resp_valid & need_gpa
              & need_gpa_vpn == (_ptw_just_back_T_13
                                   ? io_ptw_resp_bits_s2_entry_tag
                                   : (&io_ptw_resp_bits_s2xlate)
                                       ? _GEN_30[_ptw_just_back_level_T_1
                                                   ? io_ptw_resp_bits_s1_entry_level
                                                   : io_ptw_resp_bits_s2_entry_level]
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        ptw_resp_bits_reg_s1_entry_level = _RANDOM[7'h46][20:19];
        ptw_resp_bits_reg_s1_addr_low = _RANDOM[7'h48][2:0];
        ptw_resp_bits_reg_s1_valididx_0 = _RANDOM[7'h48][27];
        ptw_resp_bits_reg_s1_valididx_1 = _RANDOM[7'h48][28];
        ptw_resp_bits_reg_s1_valididx_2 = _RANDOM[7'h48][29];
        ptw_resp_bits_reg_s1_valididx_3 = _RANDOM[7'h48][30];
        ptw_resp_bits_reg_s1_valididx_4 = _RANDOM[7'h48][31];
        ptw_resp_bits_reg_s1_valididx_5 = _RANDOM[7'h49][0];
        ptw_resp_bits_reg_s1_valididx_6 = _RANDOM[7'h49][1];
        ptw_resp_bits_reg_s1_valididx_7 = _RANDOM[7'h49][2];
        ptw_resp_bits_reg_s2_entry_tag = {_RANDOM[7'h49][31:13], _RANDOM[7'h4A][18:0]};
        ptw_resp_bits_reg_s2_entry_vmid = _RANDOM[7'h4B][16:3];
        ptw_resp_bits_reg_s2_entry_level = _RANDOM[7'h4D][1:0];
        ptw_already_back_last_REG = _RANDOM[7'h4D][16];
        ptw_resp_bits_reg_1_s2xlate = _RANDOM[7'h4D][19:18];
        ptw_resp_bits_reg_1_s1_entry_tag = {_RANDOM[7'h4D][31:20], _RANDOM[7'h4E][22:0]};
        ptw_resp_bits_reg_1_s1_entry_asid = {_RANDOM[7'h4E][31:23], _RANDOM[7'h4F][6:0]};
        ptw_resp_bits_reg_1_s1_entry_vmid = _RANDOM[7'h4F][20:7];
        ptw_resp_bits_reg_1_s1_entry_level = _RANDOM[7'h4F][31:30];
        ptw_resp_bits_reg_1_s1_addr_low = _RANDOM[7'h51][13:11];
        ptw_resp_bits_reg_1_s1_valididx_0 = _RANDOM[7'h52][6];
        ptw_resp_bits_reg_1_s1_valididx_1 = _RANDOM[7'h52][7];
        ptw_resp_bits_reg_1_s1_valididx_2 = _RANDOM[7'h52][8];
        ptw_resp_bits_reg_1_s1_valididx_3 = _RANDOM[7'h52][9];
        ptw_resp_bits_reg_1_s1_valididx_4 = _RANDOM[7'h52][10];
        ptw_resp_bits_reg_1_s1_valididx_5 = _RANDOM[7'h52][11];
        ptw_resp_bits_reg_1_s1_valididx_6 = _RANDOM[7'h52][12];
        ptw_resp_bits_reg_1_s1_valididx_7 = _RANDOM[7'h52][13];
        ptw_resp_bits_reg_1_s2_entry_tag = {_RANDOM[7'h52][31:24], _RANDOM[7'h53][29:0]};
        ptw_resp_bits_reg_1_s2_entry_vmid = _RANDOM[7'h54][27:14];
        ptw_resp_bits_reg_1_s2_entry_level = _RANDOM[7'h56][12:11];
        ptw_already_back_last_REG_1 = _RANDOM[7'h56][27];
        result_ok_last_REG = _RANDOM[7'h56][29];
        result_ok_last_REG_1 = _RANDOM[7'h56][30];
        r = _RANDOM[7'h57][7];
        r_1 = _RANDOM[7'h57][8];
        difftest_vpn_r = {_RANDOM[7'h57][31:12], _RANDOM[7'h58][17:0]};
        req_s2xlate_REG = _RANDOM[7'h58][18];
        difftest_vpn_r_1 = {_RANDOM[7'h58][31:20], _RANDOM[7'h59][25:0]};
        req_s2xlate_REG_1 = _RANDOM[7'h59][26];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        req_out_v_0 = 1'h0;
        req_out_v_1 = 1'h0;
      ...
      (req_s2xlate_REG
         ? ((|_vsatp_delay_io_out_mode) & (|_hgatp_delay_io_out_mode)
              ...
              : _req_s2xlate_T_41
                  ? 2'h2
                  : {1'h0,
                     _req_s2xlate_T_42 | io_requestor_0_resp_bits_excp_0_gpf_instr
      ...
      (req_s2xlate_REG_1
         ? ((|_vsatp_delay_io_out_mode) & (|_hgatp_delay_io_out_mode)
              ...
              : _req_s2xlate_T_41
                  ? 2'h2
                  : {1'h0,
                     _req_s2xlate_T_42 | io_requestor_1_resp_bits_excp_0_gpf_instr
  ...
  assign io_requestor_1_resp_bits_pbmt_0 =
    portTranslateEnable_1 ? _GEN_4[req_out_s2xlate_1] : 2'h0;
  ...
  assign io_requestor_1_resp_bits_excp_0_pf_st =
    (stPf_2 | stUpdate_2) & s1_valid_2 & ~af_4 & ~isFakePte_2 & ~isNonLeaf_2;
  assign io_requestor_1_resp_bits_excp_0_af_ld =
    af_4 & ~(|(req_out_1_cmd[1:0])) & fault_valid_2;
  assign io_requestor_1_resp_bits_excp_0_af_st =
    af_4 & req_out_1_cmd[1:0] == 2'h1 & fault_valid_2;
