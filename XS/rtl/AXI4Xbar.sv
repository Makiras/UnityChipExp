...
module AXI4Xbar(
  ...
  wire        _arFIFOMap_0_T_6 =
    _in_0_r_bits_T_35 == 2'h0 & _arFIFOMap_3_T_4 & _in_0_r_bits_T_8;
  ...
  wire        _awFIFOMap_0_T_5 = _in_0_b_bits_T_17 == 2'h0 & _awFIFOMap_3_T_4;
  ...
  assign nodeIn_ar_ready = _portsAROI_in_0_ar_ready_T_8 & _GEN_11[auto_in_ar_bits_id];
  reg         latched;
  ...
  `ifndef SYNTHESIS
    wire prefixOR_2 = prefixOR_1 | winner_5_1;
    wire prefixOR_3 = prefixOR_2 | winner_5_2;
    wire prefixOR_2_1 = winner_6_0 | winner_6_1;
    wire prefixOR_3_1 = prefixOR_2_1 | winner_6_2;
    always @(posedge clock) begin
      ...
      if (~reset & ~(~_arFIFOMap_0_T_2 | arFIFOMap_0_count != 2'h2)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (~reset & ~(~_awFIFOMap_0_T_2 | awFIFOMap_0_count != 2'h2)) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed\n    at Xbar.scala:123 assert (!req_fire  || count =/= flight.U)\n");
        if (`STOP_COND_)
          xs_assert_v2(`__FILE__, `__LINE__);
      ...
      if (~reset
          & ~((~prefixOR_1 | ~winner_5_1) & (~prefixOR_2 | ~winner_5_2)
              & (~prefixOR_3 | ~winner_5_3)
              & (~(prefixOR_3 | winner_5_3) | ~winner_5_4))) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (~reset
          & ~(~anyValid | prefixOR_1 | winner_5_1 | winner_5_2 | winner_5_3
              | winner_5_4)) begin
        if (`ASSERT_VERBOSE_COND_)
      ...
      if (~reset
          & ~((~winner_6_0 | ~winner_6_1) & (~prefixOR_2_1 | ~winner_6_2)
              & (~prefixOR_3_1 | ~winner_6_3)
              & (~(prefixOR_3_1 | winner_6_3) | ~winner_6_4))) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed\n    at Xbar.scala:275 assert((prefixOR zip winner) map { case (p,w) => !p || !w } reduce {_ && _})\n");
        if (`STOP_COND_)
          xs_assert_v2(`__FILE__, `__LINE__);
      ...
      if (~reset
          & ~(~anyValid_1 | winner_6_0 | winner_6_1 | winner_6_2 | winner_6_3
              | winner_6_4)) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed\n    at Xbar.scala:277 assert (!anyValid || winner.reduce(_||_))\n");
        if (`STOP_COND_)
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      arFIFOMap_0_count <=
        2'(2'(arFIFOMap_0_count + {1'h0, _arFIFOMap_0_T_2}) - {1'h0, _arFIFOMap_0_T_6});
      awFIFOMap_0_count <=
        2'(2'(awFIFOMap_0_count + {1'h0, _awFIFOMap_0_T_2}) - {1'h0, _awFIFOMap_0_T_5});
      arFIFOMap_1_count <=
        1'(1'(arFIFOMap_1_count + _arFIFOMap_1_T_2) - _arFIFOMap_1_T_6);
      awFIFOMap_1_count <=
        1'(1'(awFIFOMap_1_count + _awFIFOMap_1_T_2) - _awFIFOMap_1_T_5);
      arFIFOMap_2_count <=
        1'(1'(arFIFOMap_2_count + _arFIFOMap_2_T_2) - _arFIFOMap_2_T_6);
      awFIFOMap_2_count <=
        1'(1'(awFIFOMap_2_count + _awFIFOMap_2_T_2) - _awFIFOMap_2_T_5);
      arFIFOMap_3_count <=
        1'(1'(arFIFOMap_3_count + _arFIFOMap_3_T_2) - _arFIFOMap_3_T_6);
      awFIFOMap_3_count <=
        1'(1'(awFIFOMap_3_count + _awFIFOMap_3_T_2) - _awFIFOMap_3_T_5);
      latched <=
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        arFIFOMap_1_count = _RANDOM[2'h0][10];
        awFIFOMap_1_count = _RANDOM[2'h0][14];
        arFIFOMap_2_count = _RANDOM[2'h0][18];
        awFIFOMap_2_count = _RANDOM[2'h0][22];
        arFIFOMap_3_count = _RANDOM[2'h0][26];
        awFIFOMap_3_count = _RANDOM[2'h0][30];
