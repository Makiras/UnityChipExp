...
module ActiveGenerationTable(
  ...
  wire        s1_update_probe = s1_update_last_REG;
  ...
  wire        s1_alloc_probe = s1_alloc_last_REG;
  ...
  `ifndef SYNTHESIS
    always @(posedge clock) begin
      if (s1_update_last_REG & ~reset
          & 5'({1'h0,
                4'({1'h0,
                    3'({1'h0, 2'({1'h0, s1_update_mask_0} + {1'h0, s1_update_mask_1})}
                       + {1'h0, 2'({1'h0, s1_update_mask_2} + {1'h0, s1_update_mask_3})})}
                   + {1'h0,
                      3'({1'h0, 2'({1'h0, s1_update_mask_4} + {1'h0, s1_update_mask_5})}
                         + {1'h0,
                            2'({1'h0, s1_update_mask_6} + {1'h0, s1_update_mask_7})})})}
               + {1'h0,
                  4'({1'h0,
                      3'({1'h0, 2'({1'h0, s1_update_mask_8} + {1'h0, s1_update_mask_9})}
                         + {1'h0,
                            2'({1'h0, s1_update_mask_10} + {1'h0, s1_update_mask_11})})}
                     + {1'h0,
                        3'({1'h0,
                            2'({1'h0, s1_update_mask_12} + {1'h0, s1_update_mask_13})}
                           + {1'h0,
                              2'({1'h0, s1_update_mask_14}
                                 + {1'h0, s1_update_mask_15})})})}) != 5'h1) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed: multi-agt-update\n    at SMSPrefetcher.scala:439 assert(PopCount(s1_update_mask) === 1.U, \"multi-agt-update\")\n");
        if (`STOP_COND_)
          xs_assert_v2(`__FILE__, `__LINE__);
      end
      if (s1_alloc_last_REG & ~reset
          & 5'({1'h0,
                4'({1'h0,
                    3'({1'h0, 2'({1'h0, s1_replace_mask[0]} + {1'h0, s1_replace_mask[1]})}
                       + {1'h0,
                          2'({1'h0, s1_replace_mask[2]} + {1'h0, s1_replace_mask[3]})})}
                   + {1'h0,
                      3'({1'h0,
                          2'({1'h0, s1_replace_mask[4]} + {1'h0, s1_replace_mask[5]})}
                         + {1'h0,
                            2'({1'h0, s1_replace_mask[6]}
                               + {1'h0, s1_replace_mask[7]})})})}
               + {1'h0,
                  4'({1'h0,
                      3'({1'h0,
                          2'({1'h0, s1_replace_mask[8]} + {1'h0, s1_replace_mask[9]})}
                         + {1'h0,
                            2'({1'h0, s1_replace_mask[10]}
                               + {1'h0, s1_replace_mask[11]})})}
                     + {1'h0,
                        3'({1'h0,
                            2'({1'h0, s1_replace_mask[12]} + {1'h0, s1_replace_mask[13]})}
                           + {1'h0,
                              2'({1'h0, s1_replace_mask[14]}
                                 + {1'h0, s1_replace_mask[15]})})})}) != 5'h1) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed: multi-agt-alloc\n    at SMSPrefetcher.scala:442 assert(PopCount(s1_replace_mask) === 1.U, \"multi-agt-alloc\")\n");
        if (`STOP_COND_)
          xs_assert_v2(`__FILE__, `__LINE__);
      end
    end // always @(posedge)
  ...
  wire        _io_s1_sel_stride_T = s1_alloc_last_REG & s1_cross_region_match;
  wire        s1_pht_lookup_valid =
    ~(prev_lookup_valid_last_REG & (_io_s1_sel_stride_T | s1_update_last_REG)
      & ((s1_update_last_REG
           ...
           : ~(_s1_pf_gen_vaddr_inc_T_2[15])) & s1_in_active_page & io_agt_en)
    & prev_lookup_valid_last_REG;
  reg         s2_do_dcache_evict_last_REG;
  ...
  wire        s2_evict_valid_probe = s2_evict_valid_last_REG;
  reg         s2_update;
  reg         s2_real_update;
  ...
  wire        _GEN_1 =
    s1_alloc_last_REG & s1_replace_mask[0] | s1_update_last_REG & s1_update_mask_0;
  wire        _GEN_2 =
    s1_alloc_last_REG & s1_replace_mask[1] | s1_update_last_REG & s1_update_mask_1;
  wire        _GEN_3 =
    s1_alloc_last_REG & s1_replace_mask[2] | s1_update_last_REG & s1_update_mask_2;
  wire        _GEN_4 =
    s1_alloc_last_REG & s1_replace_mask[3] | s1_update_last_REG & s1_update_mask_3;
  wire        _GEN_5 =
    s1_alloc_last_REG & s1_replace_mask[4] | s1_update_last_REG & s1_update_mask_4;
  wire        _GEN_6 =
    s1_alloc_last_REG & s1_replace_mask[5] | s1_update_last_REG & s1_update_mask_5;
  wire        _GEN_7 =
    s1_alloc_last_REG & s1_replace_mask[6] | s1_update_last_REG & s1_update_mask_6;
  wire        _GEN_8 =
    s1_alloc_last_REG & s1_replace_mask[7] | s1_update_last_REG & s1_update_mask_7;
  wire        _GEN_9 =
    s1_alloc_last_REG & s1_replace_mask[8] | s1_update_last_REG & s1_update_mask_8;
  wire        _GEN_10 =
    s1_alloc_last_REG & s1_replace_mask[9] | s1_update_last_REG & s1_update_mask_9;
  wire        _GEN_11 =
    s1_alloc_last_REG & s1_replace_mask[10] | s1_update_last_REG & s1_update_mask_10;
  wire        _GEN_12 =
    s1_alloc_last_REG & s1_replace_mask[11] | s1_update_last_REG & s1_update_mask_11;
  wire        _GEN_13 =
    s1_alloc_last_REG & s1_replace_mask[12] | s1_update_last_REG & s1_update_mask_12;
  wire        _GEN_14 =
    s1_alloc_last_REG & s1_replace_mask[13] | s1_update_last_REG & s1_update_mask_13;
  wire        _GEN_15 =
    s1_alloc_last_REG & s1_replace_mask[14] | s1_update_last_REG & s1_update_mask_14;
  wire        _GEN_16 =
    s1_alloc_last_REG & s1_replace_mask[15] | s1_update_last_REG & s1_update_mask_15;
  wire        _GEN_17 = s2_evict_valid_last_REG & ~s2_do_dcache_evict_last_REG;
  wire        _GEN_18 = s2_evict_valid_last_REG & s2_do_dcache_evict_last_REG;
  wire        _GEN_19 = s2_evict_valid_last_REG & s2_evict_entry_access_cnt == 4'h1;
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      s2_do_dcache_evict_last_REG <= 1'h0;
      ...
      s2_do_dcache_evict_last_REG <= s1_do_dcache_evict_last_REG;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s2_do_dcache_evict_last_REG = _RANDOM[6'h30][27];
