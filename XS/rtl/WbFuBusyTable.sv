...
module WbFuBusyTable(
  ...
  wire [2:0] intWbBusyTable_0_2 =
    {io_in_intSchdBusyTable_0_0_intWbBusyTable[2:1],
     io_in_intSchdBusyTable_0_0_intWbBusyTable[0]
       | io_in_intSchdBusyTable_0_1_intWbBusyTable}
    | io_in_fpSchdBusyTable_0_0_intWbBusyTable;
  wire [4:0] intWbBusyTable_2_2 =
    {2'h0,
     io_in_intSchdBusyTable_1_0_intWbBusyTable[2],
     {io_in_intSchdBusyTable_1_0_intWbBusyTable[1],
      io_in_intSchdBusyTable_1_0_intWbBusyTable[0]
        | io_in_intSchdBusyTable_1_1_intWbBusyTable}
       | io_in_fpSchdBusyTable_1_0_intWbBusyTable}
    | io_in_vfSchdBusyTable_0_1_intWbBusyTable;
  wire [1:0] intWbBusyTable_4_2 =
    {1'h0, io_in_intSchdBusyTable_2_0_intWbBusyTable}
  ...
  wire [2:0] vfWbBusyTable_3_2 =
    {2'h0, io_in_intSchdBusyTable_2_1_vfWbBusyTable}
  ...
  wire [2:0] v0WbBusyTable_3_2 =
    {2'h0, io_in_intSchdBusyTable_2_1_v0WbBusyTable}
    | io_in_vfSchdBusyTable_1_1_v0WbBusyTable;
  assign io_out_intRespRead_3_0_intWbBusyTable =
    io_in_intSchdBusyTable_3_0_intWbBusyTable;
  assign io_out_intRespRead_2_1_fpWbBusyTable = fpWbBusyTable_3_2[2:0];
  assign io_out_intRespRead_2_1_vfWbBusyTable = vfWbBusyTable_3_2[0];
  assign io_out_intRespRead_2_1_v0WbBusyTable = v0WbBusyTable_3_2[0];
  assign io_out_intRespRead_2_1_vlWbBusyTable = io_in_intSchdBusyTable_2_1_vlWbBusyTable;
  assign io_out_intRespRead_2_0_intWbBusyTable = intWbBusyTable_4_2[0];
  ...
  assign io_out_fpRespRead_2_0_intWbBusyTable = intWbBusyTable_4_2;
  ...
  assign io_out_vfRespRead_1_1_vfWbBusyTable = vfWbBusyTable_3_2;
  assign io_out_vfRespRead_1_1_v0WbBusyTable = v0WbBusyTable_3_2;
