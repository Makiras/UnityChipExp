  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        data_fpu_wflags = _RANDOM[6'h18][6];
        data_vpu_vma = _RANDOM[6'h18][15];
        data_vpu_vta = _RANDOM[6'h18][16];
        data_vpu_vsew = _RANDOM[6'h18][18:17];
        data_vpu_vlmul = _RANDOM[6'h18][21:19];
        data_vpu_vm = _RANDOM[6'h18][30];
        data_vpu_vstart = {_RANDOM[6'h18][31], _RANDOM[6'h19][6:0]};
        data_vpu_vuopIdx = _RANDOM[6'h19][25:19];
        data_vpu_isExt = _RANDOM[6'h1E][9];
        data_vpu_isNarrow = _RANDOM[6'h1E][10];
        data_vpu_isDstMask = _RANDOM[6'h1E][11];
        data_vpu_isOpMask = _RANDOM[6'h1E][12];
        data_perfDebugInfo_eliminatedMove = _RANDOM[6'h1F][5];
        ...
        data_perfDebugInfo_selectTime =
          {_RANDOM[6'h25][31:6], _RANDOM[6'h26], _RANDOM[6'h27][5:0]};
        data_perfDebugInfo_issueTime =
          {_RANDOM[6'h27][31:6], _RANDOM[6'h28], _RANDOM[6'h29][5:0]};
        data_perfDebugInfo_writebackTime =
          {_RANDOM[6'h29][31:6], _RANDOM[6'h2A], _RANDOM[6'h2B][5:0]};
        data_perfDebugInfo_runahead_checkpoint_id =
          {_RANDOM[6'h2B][31:6], _RANDOM[6'h2C], _RANDOM[6'h2D][5:0]};
        data_perfDebugInfo_tlbFirstReqTime =
          {_RANDOM[6'h2D][31:6], _RANDOM[6'h2E], _RANDOM[6'h2F][5:0]};
        data_perfDebugInfo_tlbRespTime =
          {_RANDOM[6'h2F][31:6], _RANDOM[6'h30], _RANDOM[6'h31][5:0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        valid = 1'h0;
    end // initial
