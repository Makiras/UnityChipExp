...
module SMSPrefetcher(
  ...
  wire        _active_gen_table_io_s1_sel_stride;
  ...
  wire        _probe = train_vld_s0_last_REG;
  reg  [49:0] train_s0_pc;
  ...
  wire        _probe_0 = _pht_io_pf_gen_req_valid & io_pht_en;
  wire        _GEN = io_ld_in_0_valid & io_ld_in_0_bits_miss;
  wire        _GEN_0 = io_ld_in_0_valid & (|(io_ld_in_0_bits_meta_prefetch[2:1]));
  wire        _GEN_1 = io_ld_in_1_valid & io_ld_in_1_bits_miss;
  wire        _GEN_2 = io_ld_in_1_valid & (|(io_ld_in_1_bits_meta_prefetch[2:1]));
  wire        _GEN_3 = io_ld_in_2_valid & io_ld_in_2_bits_miss;
  wire        _GEN_4 = io_ld_in_2_valid & (|(io_ld_in_2_bits_meta_prefetch[2:1]));
  wire        _GEN_5 = _pht_io_pf_gen_req_valid & ~io_pht_en;
  ...
  wire [21:0] _GEN_6 = {1'h0, _train_filter_io_train_req_bits_vaddr[30:10]};
  wire [21:0] _train_region_addr_p1_T_1 = 22'(_GEN_6 + 22'h1);
  wire [21:0] _train_region_addr_m1_T_1 = 22'(_GEN_6 - 22'h1);
  always @(posedge clock) begin
    if (_train_filter_io_train_req_valid) begin
      train_s0_pc <= _train_filter_io_train_req_bits_pc;
      train_region_tag_s0 <=
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        train_s0_pc = {_RANDOM[4'h3][31:3], _RANDOM[4'h4][20:0]};
  ...
  wire        _probe_1;
  assign _probe_1 = _train_filter_io_train_req_valid;
  ActiveGenerationTable active_gen_table (
    ...
    .io_s1_sel_stride                         (_active_gen_table_io_s1_sel_stride),
  ...
  wire        _probe_2;
  assign _probe_2 = _active_gen_table_io_s2_evict_valid;
  wire        _probe_3;
  assign _probe_3 = _active_gen_table_io_s2_pht_lookup_valid;
  StridePF stride (
    .clock                (clock),
    .reset                (reset),
    .io_s0_lookup_valid   (train_vld_s0_last_REG),
    .io_s0_lookup_bits_pc (train_s0_pc[9:0]),
    .io_s1_valid          (_active_gen_table_io_s1_sel_stride)
  );
  ...
  wire        _probe_4;
  assign _probe_4 = _pht_io_pf_gen_req_valid;
  PrefetchFilter pf_filter (
    .clock                                  (clock),
    .reset                                  (reset),
    .io_gen_req_valid                       (_probe_0),
  ...
  wire        _probe_5;
  assign _probe_5 = _pf_filter_io_l2_pf_addr_valid;
