  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        ctrlReg_isW = _RANDOM[5'h0][10];
        ctrlReg_isHi = _RANDOM[5'h0][11];
        io_out_bits_ctrl_robIdx_r_flag = _RANDOM[5'h0][12];
        io_out_bits_ctrl_robIdx_r_value = _RANDOM[5'h0][20:13];
        io_out_bits_ctrl_pdest_r = _RANDOM[5'h0][28:21];
        io_out_bits_ctrl_rfWen_r = _RANDOM[5'h0][29];
        io_out_bits_perfDebugInfo_r_eliminatedMove = _RANDOM[5'h0][30];
        io_out_bits_perfDebugInfo_r_renameTime =
          {_RANDOM[5'h0][31], _RANDOM[5'h1], _RANDOM[5'h2][30:0]};
        io_out_bits_perfDebugInfo_r_dispatchTime =
          {_RANDOM[5'h2][31], _RANDOM[5'h3], _RANDOM[5'h4][30:0]};
        io_out_bits_perfDebugInfo_r_enqRsTime =
          {_RANDOM[5'h4][31], _RANDOM[5'h5], _RANDOM[5'h6][30:0]};
        io_out_bits_perfDebugInfo_r_selectTime =
          {_RANDOM[5'h6][31], _RANDOM[5'h7], _RANDOM[5'h8][30:0]};
