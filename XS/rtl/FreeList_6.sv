...
module FreeList_6(
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      freeSlotCnt <=
        _tailPtrNext_new_ptr_T_1[2] == _headPtrNext_new_ptr_T_1[2]
          ? {1'h0, 2'(_tailPtrNext_new_ptr_T_1[1:0] - _headPtrNext_new_ptr_T_1[1:0])}
          : 3'(3'({1'h0, _tailPtrNext_new_ptr_T_1[1:0]} - 3'h4)
               - {1'h0, _headPtrNext_new_ptr_T_1[1:0]});
    end
  ...
  assign io_validCount = 3'(3'h4 - freeSlotCnt);
  assign io_empty = freeSlotCnt == 3'h0;
endmodule
