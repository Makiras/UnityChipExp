...
module FTBEntryGen(
  ...
  wire        may_have_to_replace =
    io_old_entry_brSlots_0_valid & io_old_entry_tailSlot_valid;
  wire        pft_need_to_change = is_new_br & may_have_to_replace;
  ...
  wire [15:0] _GEN_8 =
    {{io_mispredict_vec_15},
     ...
     {io_mispredict_vec_1},
     {io_mispredict_vec_0}};
  wire        io_is_new_br_0 = io_hit & is_new_br;
  ...
  assign io_is_old_entry =
    io_hit & ~is_new_br & ~jalr_target_modified & ~strong_bias_modified;
  assign io_is_new_br = io_is_new_br_0;
  ...
  assign io_is_br_full = io_is_new_br_0 & may_have_to_replace;
endmodule
