...
module ICacheMetaArray(
  ...
  wire              _io_read_ready_T_1_probe = io_flush_0_valid | io_flush_1_valid;
  wire              io_read_ready_0 =
    ~io_write_valid & ~_io_read_ready_T_1_probe & ~io_flushAll
    & _tagArrays_0_io_r_req_ready & _tagArrays_1_io_r_req_ready;
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      else if (_io_read_ready_T_1_probe) begin
        valid_array_0 <=
