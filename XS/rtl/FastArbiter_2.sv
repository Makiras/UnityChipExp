...
module FastArbiter_2(
  ...
  input        io_in_0_valid,
  input  [3:0] io_in_0_bits_pfSource,
  output       io_in_1_ready,
  input        io_in_1_valid,
  input  [3:0] io_in_1_bits_pfSource,
  output       io_in_2_ready,
  input        io_in_2_valid,
  input  [3:0] io_in_2_bits_pfSource,
  output       io_in_3_ready,
  input        io_in_3_valid,
  input  [3:0] io_in_3_bits_pfSource,
  output       io_out_valid,
  ...
  assign io_out_bits_pfSource =
    (chosenOH[0] ? io_in_0_bits_pfSource : 4'h0)
    | (chosenOH[1] ? io_in_1_bits_pfSource : 4'h0)
    | (chosenOH[2] ? io_in_2_bits_pfSource : 4'h0)
    | (chosenOH[3] ? io_in_3_bits_pfSource : 4'h0);
endmodule
