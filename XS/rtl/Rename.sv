...
module Rename(
  ...
  input          io_snptIsFull,
  input  [7:0]   io_debug_int_rat_0,
  input  [7:0]   io_debug_int_rat_1,
  input  [7:0]   io_debug_int_rat_2,
  input  [7:0]   io_debug_int_rat_3,
  input  [7:0]   io_debug_int_rat_4,
  input  [7:0]   io_debug_int_rat_5,
  input  [7:0]   io_debug_int_rat_6,
  input  [7:0]   io_debug_int_rat_7,
  input  [7:0]   io_debug_int_rat_8,
  input  [7:0]   io_debug_int_rat_9,
  input  [7:0]   io_debug_int_rat_10,
  input  [7:0]   io_debug_int_rat_11,
  input  [7:0]   io_debug_int_rat_12,
  input  [7:0]   io_debug_int_rat_13,
  input  [7:0]   io_debug_int_rat_14,
  input  [7:0]   io_debug_int_rat_15,
  input  [7:0]   io_debug_int_rat_16,
  input  [7:0]   io_debug_int_rat_17,
  input  [7:0]   io_debug_int_rat_18,
  input  [7:0]   io_debug_int_rat_19,
  input  [7:0]   io_debug_int_rat_20,
  input  [7:0]   io_debug_int_rat_21,
  input  [7:0]   io_debug_int_rat_22,
  input  [7:0]   io_debug_int_rat_23,
  input  [7:0]   io_debug_int_rat_24,
  input  [7:0]   io_debug_int_rat_25,
  input  [7:0]   io_debug_int_rat_26,
  input  [7:0]   io_debug_int_rat_27,
  input  [7:0]   io_debug_int_rat_28,
  input  [7:0]   io_debug_int_rat_29,
  input  [7:0]   io_debug_int_rat_30,
  input  [7:0]   io_debug_int_rat_31,
  ...
  wire [9:0]  _robIdxHeadNext_diff_T_10 =
    10'({1'h0, robIdxHeadNext_new_value_1} - 10'hA0);
  wire        robIdxHeadNext_reverse_flag_1 =
    $signed(_robIdxHeadNext_diff_T_10) > -10'sh1;
  ...
  wire [8:0]  _GEN_24 =
    {io_in_0_bits_exceptionVec_0,
     ...
     io_in_0_bits_exceptionVec_2,
     io_in_0_bits_exceptionVec_22};
  wire        _GEN_25 = isMove_0 | (|_GEN_24) | io_in_0_bits_trigger == 4'h1;
  ...
  reg  [63:0] uops_0_debugInfo_renameTime_c;
  ...
  wire [8:0]  _GEN_26 =
    {io_in_1_bits_exceptionVec_0,
     ...
     io_in_1_bits_exceptionVec_2,
     io_in_1_bits_exceptionVec_22};
  wire        _GEN_27 = isMove_1 | (|_GEN_26) | io_in_1_bits_trigger == 4'h1;
  ...
  reg  [63:0] uops_1_debugInfo_renameTime_c;
  ...
  wire [8:0]  _GEN_28 =
    {io_in_2_bits_exceptionVec_0,
     ...
     io_in_2_bits_exceptionVec_2,
     io_in_2_bits_exceptionVec_22};
  wire        _GEN_29 = isMove_2 | (|_GEN_28) | io_in_2_bits_trigger == 4'h1;
  ...
  reg  [63:0] uops_2_debugInfo_renameTime_c;
  ...
  wire [8:0]  _GEN_30 =
    {io_in_3_bits_exceptionVec_0,
     ...
     io_in_3_bits_exceptionVec_2,
     io_in_3_bits_exceptionVec_22};
  wire        _GEN_31 = isMove_3 | (|_GEN_30) | io_in_3_bits_trigger == 4'h1;
  ...
  reg  [63:0] uops_3_debugInfo_renameTime_c;
  ...
  wire [8:0]  _GEN_32 =
    {io_in_4_bits_exceptionVec_0,
     ...
     io_in_4_bits_exceptionVec_2,
     io_in_4_bits_exceptionVec_22};
  wire        _GEN_33 = isMove_4 | (|_GEN_32) | io_in_4_bits_trigger == 4'h1;
  ...
  reg  [63:0] uops_4_debugInfo_renameTime_c;
  ...
  wire [8:0]  _GEN_34 =
    {io_in_5_bits_exceptionVec_0,
     ...
     io_in_5_bits_exceptionVec_2,
     io_in_5_bits_exceptionVec_22};
  wire        _GEN_35 = isMove_5 | (|_GEN_34) | io_in_5_bits_trigger == 4'h1;
  assign uops_5_lastUop = _compressUnit_io_out_needRobFlags_5 & io_in_5_bits_lastUop;
  reg  [63:0] uops_5_debugInfo_renameTime_c;
  ...
  wire        fused_lui_load_1 =
    ...
    & io_in_2_bits_fuType == 35'h8000 & io_in_1_valid & destToSrc_indexMatch_6;
  ...
  wire        fused_lui_load_2 =
    ...
    & io_in_3_bits_fuType == 35'h8000 & io_in_2_valid & destToSrc_indexMatch_17;
  ...
  wire        fused_lui_load_3 =
    ...
    & io_in_4_bits_fuType == 35'h8000 & io_in_3_valid & destToSrc_indexMatch_33;
  ...
  wire        fused_lui_load_4 =
    ...
    & io_in_5_bits_fuType == 35'h8000 & io_in_4_valid & destToSrc_indexMatch_54;
  wire [3:0]  io_out_5_bits_srcType_0_0 =
    fused_lui_load_4 ? 4'h0 : io_in_5_bits_srcType_0;
  wire        _is_fused_lui_load_T = io_out_0_ready & io_out_0_valid_0;
    ...
    always @(posedge clock) begin
      if (io_out_0_valid_0 & io_in_0_bits_rfWen & ~reset
        ...
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed: rfWen cannot be 1 when Int regfile ldest is 0\n    at Rename.scala:664 assert(x.bits.ldest =/= 0.U, \"rfWen cannot be 1 when Int regfile ldest is 0\")\n");
        if (`STOP_COND_)
  ...
  wire        recStall_probe = io_redirect_valid | io_rabCommits_isWalk;
  wire        ctrlRecStall_probe =
    io_redirect_valid
      ? io_redirect_bits_debugIsCtrl
      : io_rabCommits_isWalk & debugRedirect_debugIsCtrl;
  wire        mvioRecStall_probe =
    io_redirect_valid
      ? io_redirect_bits_debugIsMemVio
      : io_rabCommits_isWalk & debugRedirect_debugIsMemVio;
  wire        otherRecStall_probe =
    recStall_probe & ~(ctrlRecStall_probe | mvioRecStall_probe);
  wire        _multiFlStall_T = ~io_out_0_valid_0 & ~recStall_probe & io_in_0_valid;
  wire [2:0]  _multiFlStall_T_19 =
    3'({1'h0,
  ...
  wire        io_stallReason_in_backReason_valid_0 =
    io_stallReason_out_backReason_valid | ~io_in_0_ready_0;
  wire [5:0]  io_stallReason_in_backReason_bits_0 =
    io_stallReason_out_backReason_valid
      ? 6'h28
      : ctrlRecStall_probe
          ? 6'h24
          : mvioRecStall_probe
              ...
              : otherRecStall_probe
                  ? 6'h26
                  : _multiFlStall_T & _fpFreeList_io_canAllocate
                    & _vecFreeList_io_canAllocate & _v0FreeList_io_canAllocate
                    & _vlFreeList_io_canAllocate & ~_intFreeList_io_canAllocate
                      ? 6'h12
                      : _multiFlStall_T & _intFreeList_io_canAllocate
                        & _vecFreeList_io_canAllocate & _v0FreeList_io_canAllocate
                                ...
                                & _vlFreeList_io_canAllocate & ~_v0FreeList_io_canAllocate
                                  ...
                                  : _multiFlStall_T & _intFreeList_io_canAllocate
                                    ...
                                    & ~_vlFreeList_io_canAllocate
                                      ? 6'h16
                                      : _multiFlStall_T & (|(_multiFlStall_T_19[2:1]))
                                          ? 6'h17
                                          : 6'h28;
  wire [2:0]  _GEN_36 =
    3'({1'h0,
       ...
       + {1'h0,
          2'({1'h0, io_in_3_valid} + 2'({1'h0, io_in_4_valid} + {1'h0, io_in_5_valid}))});
  wire [2:0]  _GEN_37;
  ...
  wire [2:0]  _GEN_39 =
    3'({1'h0,
        2'({1'h0, _io_out_0_bits_snapshot_T_6}
           + 2'({1'h0, _io_out_1_bits_snapshot_T_6}
                + {1'h0, _io_out_2_bits_snapshot_T_6}))}
       + {1'h0,
          2'({1'h0, _io_out_3_bits_snapshot_T_6}
             + 2'({1'h0, _io_out_4_bits_snapshot_T_6}
                  + {1'h0, _io_out_5_bits_snapshot_T_6}))});
  wire [2:0]  _GEN_40;
  ...
  wire [2:0]  _GEN_44 =
    3'({1'h0,
        2'({1'h0, io_out_0_valid_0}
           + 2'({1'h0, io_out_1_valid_0} + {1'h0, io_out_2_valid_0}))}
       + {1'h0,
          2'({1'h0, io_out_3_valid_0}
             + 2'({1'h0, io_out_4_valid_0} + {1'h0, io_out_5_valid_0}))});
  wire [2:0]  _GEN_45 =
    3'({1'h0,
        2'({1'h0, _is_fused_lui_load_T}
           + 2'({1'h0, _is_fused_lui_load_T_4} + {1'h0, _is_fused_lui_load_T_8}))}
       + {1'h0,
          2'({1'h0, _is_fused_lui_load_T_12}
             + 2'({1'h0, _is_fused_lui_load_T_16} + {1'h0, _is_fused_lui_load_T_20}))});
  wire [2:0]  _GEN_46 =
    3'({1'h0,
        2'({1'h0, _is_fused_lui_load_T & io_in_0_bits_isMove}
           + 2'({1'h0, _is_fused_lui_load_T_4 & io_in_1_bits_isMove}
                + {1'h0, _is_fused_lui_load_T_8 & io_in_2_bits_isMove}))}
       + {1'h0,
          2'({1'h0, _is_fused_lui_load_T_12 & io_in_3_bits_isMove}
             + 2'({1'h0, _is_fused_lui_load_T_16 & io_in_4_bits_isMove}
                  + {1'h0, _is_fused_lui_load_T_20 & io_in_5_bits_isMove}))});
  wire [2:0]  _GEN_47 =
    3'({1'h0,
        2'({1'h0,
            _is_fused_lui_load_T & io_in_0_bits_fuType == 35'h8000
              & io_in_0_bits_srcType_0 == 4'h0}
           + 2'({1'h0,
                 _is_fused_lui_load_T_4 & io_in_1_bits_fuType == 35'h8000
                   & io_out_1_bits_srcType_0_0 == 4'h0}
                + {1'h0,
                   _is_fused_lui_load_T_8 & io_in_2_bits_fuType == 35'h8000
                     & io_out_2_bits_srcType_0_0 == 4'h0}))}
       + {1'h0,
          2'({1'h0,
              _is_fused_lui_load_T_12 & io_in_3_bits_fuType == 35'h8000
                & io_out_3_bits_srcType_0_0 == 4'h0}
             + 2'({1'h0,
                   _is_fused_lui_load_T_16 & io_in_4_bits_fuType == 35'h8000
                     & io_out_4_bits_srcType_0_0 == 4'h0}
                  + {1'h0,
                     _is_fused_lui_load_T_20 & io_in_5_bits_fuType == 35'h8000
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      uops_0_debugInfo_renameTime_c <= 64'h0;
      uops_1_debugInfo_renameTime_c <= 64'h0;
      uops_2_debugInfo_renameTime_c <= 64'h0;
      uops_3_debugInfo_renameTime_c <= 64'h0;
      uops_4_debugInfo_renameTime_c <= 64'h0;
      uops_5_debugInfo_renameTime_c <= 64'h0;
      ...
      uops_0_debugInfo_renameTime_c <= 64'(uops_0_debugInfo_renameTime_c + 64'h1);
      uops_1_debugInfo_renameTime_c <= 64'(uops_1_debugInfo_renameTime_c + 64'h1);
      uops_2_debugInfo_renameTime_c <= 64'(uops_2_debugInfo_renameTime_c + 64'h1);
      uops_3_debugInfo_renameTime_c <= 64'(uops_3_debugInfo_renameTime_c + 64'h1);
      uops_4_debugInfo_renameTime_c <= 64'(uops_4_debugInfo_renameTime_c + 64'h1);
      uops_5_debugInfo_renameTime_c <= 64'(uops_5_debugInfo_renameTime_c + 64'h1);
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        uops_0_debugInfo_renameTime_c =
          {_RANDOM[6'h0][31:10], _RANDOM[6'h1], _RANDOM[6'h2][9:0]};
        uops_1_debugInfo_renameTime_c =
          {_RANDOM[6'h2][31:10], _RANDOM[6'h3], _RANDOM[6'h4][9:0]};
        uops_2_debugInfo_renameTime_c =
          {_RANDOM[6'h4][31:10], _RANDOM[6'h5], _RANDOM[6'h6][9:0]};
        uops_3_debugInfo_renameTime_c =
          {_RANDOM[6'h6][31:10], _RANDOM[6'h7], _RANDOM[6'h8][9:0]};
        uops_4_debugInfo_renameTime_c =
          {_RANDOM[6'h8][31:10], _RANDOM[6'h9], _RANDOM[6'hA][9:0]};
        uops_5_debugInfo_renameTime_c =
          {_RANDOM[6'hA][31:10], _RANDOM[6'hB], _RANDOM[6'hC][9:0]};
        ...
        debugRedirect_debugIsCtrl = _RANDOM[6'h20][7];
        debugRedirect_debugIsMemVio = _RANDOM[6'h20][8];
  ...
  MEFreeList intFreeList (
    ...
    .io_debug_rat_0          (io_debug_int_rat_0),
    .io_debug_rat_1          (io_debug_int_rat_1),
    .io_debug_rat_2          (io_debug_int_rat_2),
    .io_debug_rat_3          (io_debug_int_rat_3),
    .io_debug_rat_4          (io_debug_int_rat_4),
    .io_debug_rat_5          (io_debug_int_rat_5),
    .io_debug_rat_6          (io_debug_int_rat_6),
    .io_debug_rat_7          (io_debug_int_rat_7),
    .io_debug_rat_8          (io_debug_int_rat_8),
    .io_debug_rat_9          (io_debug_int_rat_9),
    .io_debug_rat_10         (io_debug_int_rat_10),
    .io_debug_rat_11         (io_debug_int_rat_11),
    .io_debug_rat_12         (io_debug_int_rat_12),
    .io_debug_rat_13         (io_debug_int_rat_13),
    .io_debug_rat_14         (io_debug_int_rat_14),
    .io_debug_rat_15         (io_debug_int_rat_15),
    .io_debug_rat_16         (io_debug_int_rat_16),
    .io_debug_rat_17         (io_debug_int_rat_17),
    .io_debug_rat_18         (io_debug_int_rat_18),
    .io_debug_rat_19         (io_debug_int_rat_19),
    .io_debug_rat_20         (io_debug_int_rat_20),
    .io_debug_rat_21         (io_debug_int_rat_21),
    .io_debug_rat_22         (io_debug_int_rat_22),
    .io_debug_rat_23         (io_debug_int_rat_23),
    .io_debug_rat_24         (io_debug_int_rat_24),
    .io_debug_rat_25         (io_debug_int_rat_25),
    .io_debug_rat_26         (io_debug_int_rat_26),
    .io_debug_rat_27         (io_debug_int_rat_27),
    .io_debug_rat_28         (io_debug_int_rat_28),
    .io_debug_rat_29         (io_debug_int_rat_29),
    .io_debug_rat_30         (io_debug_int_rat_30),
    .io_debug_rat_31         (io_debug_int_rat_31),
  ...
  assign io_out_0_bits_pc = io_in_0_bits_pc;
  assign io_out_0_bits_foldpc = io_in_0_bits_foldpc;
  ...
  assign io_out_0_bits_canRobCompress = io_in_0_bits_canRobCompress;
  ...
  assign io_out_0_bits_numUops =
    _compressUnit_io_out_needRobFlags_0
      ? (_GEN_25 ? 7'h0 : io_in_0_bits_numUops)
      : {4'h0,
  ...
  assign io_out_0_bits_numWB =
    _compressUnit_io_out_needRobFlags_0
      ? (_GEN_25 ? 7'h0 : io_in_0_bits_numWB)
      : {4'h0,
         3'(_compressUnit_io_out_instrSizes_0
            - (3'({1'h0,
                   2'({1'h0, _compressUnit_io_out_masks_0[0] & isMove_0}
  ...
  assign io_out_0_bits_debugInfo_renameTime = uops_0_debugInfo_renameTime_c;
  assign io_out_0_bits_debug_fuType = io_in_0_bits_debug_fuType;
  ...
  assign io_out_1_bits_pc = io_in_1_bits_pc;
  assign io_out_1_bits_foldpc = io_in_1_bits_foldpc;
  ...
  assign io_out_1_bits_hasException = (|_GEN_26) | io_in_1_bits_trigger == 4'h1;
  ...
  assign io_out_1_bits_canRobCompress = io_in_1_bits_canRobCompress;
  ...
  assign io_out_1_bits_numUops =
    _compressUnit_io_out_needRobFlags_1
      ? (_compressUnit_io_out_needRobFlags_0
           ? (_GEN_27 ? 7'h0 : io_in_1_bits_numUops)
           : {4'h0,
  ...
  assign io_out_1_bits_numWB =
    _compressUnit_io_out_needRobFlags_1
      ? (_compressUnit_io_out_needRobFlags_0
           ? (_GEN_27 ? 7'h0 : io_in_1_bits_numWB)
           : {4'h0,
              3'(_compressUnit_io_out_instrSizes_1
                 - (3'({1'h0,
                        2'({1'h0, _compressUnit_io_out_masks_1[0] & isMove_0}
  ...
  assign io_out_1_bits_debugInfo_renameTime = uops_1_debugInfo_renameTime_c;
  assign io_out_1_bits_debug_fuType = io_in_1_bits_debug_fuType;
  ...
  assign io_out_2_bits_pc = io_in_2_bits_pc;
  assign io_out_2_bits_foldpc = io_in_2_bits_foldpc;
  ...
  assign io_out_2_bits_hasException = (|_GEN_28) | io_in_2_bits_trigger == 4'h1;
  ...
  assign io_out_2_bits_canRobCompress = io_in_2_bits_canRobCompress;
  ...
  assign io_out_2_bits_numUops =
    _compressUnit_io_out_needRobFlags_2
      ? (_compressUnit_io_out_needRobFlags_1
           ? (_GEN_29 ? 7'h0 : io_in_2_bits_numUops)
           : {4'h0,
  ...
  assign io_out_2_bits_numWB =
    _compressUnit_io_out_needRobFlags_2
      ? (_compressUnit_io_out_needRobFlags_1
           ? (_GEN_29 ? 7'h0 : io_in_2_bits_numWB)
           : {4'h0,
              3'(_compressUnit_io_out_instrSizes_2
                 - (3'({1'h0,
                        2'({1'h0, _compressUnit_io_out_masks_2[0] & isMove_0}
  ...
  assign io_out_2_bits_debugInfo_renameTime = uops_2_debugInfo_renameTime_c;
  assign io_out_2_bits_debug_fuType = io_in_2_bits_debug_fuType;
  ...
  assign io_out_3_bits_pc = io_in_3_bits_pc;
  assign io_out_3_bits_foldpc = io_in_3_bits_foldpc;
  ...
  assign io_out_3_bits_hasException = (|_GEN_30) | io_in_3_bits_trigger == 4'h1;
  ...
  assign io_out_3_bits_canRobCompress = io_in_3_bits_canRobCompress;
  ...
  assign io_out_3_bits_numUops =
    _compressUnit_io_out_needRobFlags_3
      ? (_compressUnit_io_out_needRobFlags_2
           ? (_GEN_31 ? 7'h0 : io_in_3_bits_numUops)
           : {4'h0,
  ...
  assign io_out_3_bits_numWB =
    _compressUnit_io_out_needRobFlags_3
      ? (_compressUnit_io_out_needRobFlags_2
           ? (_GEN_31 ? 7'h0 : io_in_3_bits_numWB)
           : {4'h0,
              3'(_compressUnit_io_out_instrSizes_3
                 - (3'({1'h0,
                        2'({1'h0, _compressUnit_io_out_masks_3[0] & isMove_0}
  ...
  assign io_out_3_bits_debugInfo_renameTime = uops_3_debugInfo_renameTime_c;
  assign io_out_3_bits_debug_fuType = io_in_3_bits_debug_fuType;
  ...
  assign io_out_4_bits_pc = io_in_4_bits_pc;
  assign io_out_4_bits_foldpc = io_in_4_bits_foldpc;
  ...
  assign io_out_4_bits_hasException = (|_GEN_32) | io_in_4_bits_trigger == 4'h1;
  ...
  assign io_out_4_bits_canRobCompress = io_in_4_bits_canRobCompress;
  ...
  assign io_out_4_bits_numUops =
    _compressUnit_io_out_needRobFlags_4
      ? (_compressUnit_io_out_needRobFlags_3
           ? (_GEN_33 ? 7'h0 : io_in_4_bits_numUops)
           : {4'h0,
  ...
  assign io_out_4_bits_numWB =
    _compressUnit_io_out_needRobFlags_4
      ? (_compressUnit_io_out_needRobFlags_3
           ? (_GEN_33 ? 7'h0 : io_in_4_bits_numWB)
           : {4'h0,
              3'(_compressUnit_io_out_instrSizes_4
                 - (3'({1'h0,
                        2'({1'h0, _compressUnit_io_out_masks_4[0] & isMove_0}
  ...
  assign io_out_4_bits_debugInfo_renameTime = uops_4_debugInfo_renameTime_c;
  assign io_out_4_bits_debug_fuType = io_in_4_bits_debug_fuType;
  ...
  assign io_out_5_bits_pc = io_in_5_bits_pc;
  assign io_out_5_bits_foldpc = io_in_5_bits_foldpc;
  ...
  assign io_out_5_bits_canRobCompress = io_in_5_bits_canRobCompress;
  ...
  assign io_out_5_bits_numUops =
    _compressUnit_io_out_needRobFlags_5
      ? (_compressUnit_io_out_needRobFlags_4
           ? (_GEN_35 ? 7'h0 : io_in_5_bits_numUops)
           : {4'h0,
  ...
  assign io_out_5_bits_numWB =
    _compressUnit_io_out_needRobFlags_5
      ? (_compressUnit_io_out_needRobFlags_4
           ? (_GEN_35 ? 7'h0 : io_in_5_bits_numWB)
           : {4'h0,
              3'(_compressUnit_io_out_instrSizes_5
                 - (3'({1'h0,
                        2'({1'h0, _compressUnit_io_out_masks_5[0] & isMove_0}
  ...
  assign io_out_5_bits_debugInfo_renameTime = uops_5_debugInfo_renameTime_c;
  assign io_out_5_bits_debug_fuType = io_in_5_bits_debug_fuType;
  assign io_out_5_bits_numLsElem =
    io_in_5_valid & isVlsType_5 & ~(io_in_5_bits_vpu_isVleff & uops_5_lastUop)
      ...
      : 5'h0;
  assign io_stallReason_in_backReason_valid = io_stallReason_in_backReason_valid_0;
  assign io_stallReason_in_backReason_bits = io_stallReason_in_backReason_bits_0;
  assign io_stallReason_out_reason_0 =
    io_stallReason_in_backReason_valid_0
      ? io_stallReason_in_backReason_bits_0
      : io_stallReason_in_reason_0;
  assign io_stallReason_out_reason_1 =
    io_stallReason_in_backReason_valid_0
      ? io_stallReason_in_backReason_bits_0
      : io_stallReason_in_reason_1;
  assign io_stallReason_out_reason_2 =
    io_stallReason_in_backReason_valid_0
      ? io_stallReason_in_backReason_bits_0
      : io_stallReason_in_reason_2;
  assign io_stallReason_out_reason_3 =
    io_stallReason_in_backReason_valid_0
      ? io_stallReason_in_backReason_bits_0
      : io_stallReason_in_reason_3;
  assign io_stallReason_out_reason_4 =
    io_stallReason_in_backReason_valid_0
      ? io_stallReason_in_backReason_bits_0
      : io_stallReason_in_reason_4;
  assign io_stallReason_out_reason_5 =
    io_stallReason_in_backReason_valid_0
      ? io_stallReason_in_backReason_bits_0
      : io_stallReason_in_reason_5;
