  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        data_fpWen = _RANDOM[6'h18][3];
        data_vecWen = _RANDOM[6'h18][4];
        data_v0Wen = _RANDOM[6'h18][5];
        data_fpu_wflags = _RANDOM[6'h18][8];
        data_vpu_vma = _RANDOM[6'h18][17];
        data_vpu_vta = _RANDOM[6'h18][18];
        data_vpu_vsew = _RANDOM[6'h18][20:19];
        data_vpu_vlmul = _RANDOM[6'h18][23:21];
        data_vpu_vm = _RANDOM[6'h19][0];
        data_vpu_vstart = _RANDOM[6'h19][8:1];
        data_vpu_fpu_isFoldTo1_2 = _RANDOM[6'h19][16];
        data_vpu_fpu_isFoldTo1_4 = _RANDOM[6'h19][17];
        data_vpu_fpu_isFoldTo1_8 = _RANDOM[6'h19][18];
        data_vpu_vuopIdx = _RANDOM[6'h19][27:21];
        data_vpu_lastUop = _RANDOM[6'h19][28];
        data_vpu_isNarrow = _RANDOM[6'h1E][12];
        data_vpu_isDstMask = _RANDOM[6'h1E][13];
        data_perfDebugInfo_eliminatedMove = _RANDOM[6'h1F][7];
        data_perfDebugInfo_renameTime =
          {_RANDOM[6'h1F][31:8], _RANDOM[6'h20], _RANDOM[6'h21][7:0]};
        data_perfDebugInfo_dispatchTime =
          {_RANDOM[6'h21][31:8], _RANDOM[6'h22], _RANDOM[6'h23][7:0]};
        ...
        data_perfDebugInfo_writebackTime =
          {_RANDOM[6'h29][31:8], _RANDOM[6'h2A], _RANDOM[6'h2B][7:0]};
        data_perfDebugInfo_runahead_checkpoint_id =
          {_RANDOM[6'h2B][31:8], _RANDOM[6'h2C], _RANDOM[6'h2D][7:0]};
        data_perfDebugInfo_tlbFirstReqTime =
          {_RANDOM[6'h2D][31:8], _RANDOM[6'h2E], _RANDOM[6'h2F][7:0]};
        data_perfDebugInfo_tlbRespTime =
          {_RANDOM[6'h2F][31:8], _RANDOM[6'h30], _RANDOM[6'h31][7:0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        valid = 1'h0;
    end // initial
