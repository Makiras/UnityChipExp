...
module VFDivSqrt(
  ...
  `endif // not def SYNTHESIS
  wire         _GEN_0 = io_in_ready_0 | _io_out_bits_perfDebugInfo_T;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        outCtrl_r_vpu_vma = _RANDOM[6'h1][7];
        outCtrl_r_vpu_vta = _RANDOM[6'h1][8];
        outCtrl_r_vpu_vsew = _RANDOM[6'h1][10:9];
        outCtrl_r_vpu_vlmul = _RANDOM[6'h1][13:11];
        outCtrl_r_vpu_vm = _RANDOM[6'h1][22];
        outCtrl_r_vpu_vstart = _RANDOM[6'h1][30:23];
        outCtrl_r_vpu_vuopIdx = _RANDOM[6'h2][17:11];
        outCtrl_r_vpu_isNarrow = _RANDOM[6'h7][2];
        outCtrl_r_vpu_isDstMask = _RANDOM[6'h7][3];
        outData_r_src_4 = _RANDOM[6'h7][16:9];
        outData_r_src_3 =
          {_RANDOM[6'h7][31:17],
           _RANDOM[6'h8],
           _RANDOM[6'h9],
        ...
        outData_r_src_2 =
          {_RANDOM[6'hB][31:17],
           ...
           _RANDOM[6'hE],
           _RANDOM[6'hF][16:0]};
        io_out_bits_ctrl_robIdx_r_flag = _RANDOM[6'h1B][17];
        io_out_bits_ctrl_robIdx_r_value = _RANDOM[6'h1B][25:18];
        io_out_bits_ctrl_pdest_r = {_RANDOM[6'h1B][31:26], _RANDOM[6'h1C][1:0]};
        io_out_bits_ctrl_vecWen_r = _RANDOM[6'h1C][2];
        io_out_bits_ctrl_v0Wen_r = _RANDOM[6'h1C][3];
        io_out_bits_ctrl_fpu_r_wflags = _RANDOM[6'h1C][6];
        io_out_bits_perfDebugInfo_r_eliminatedMove = _RANDOM[6'h22][17];
        ...
        io_out_bits_perfDebugInfo_r_dispatchTime =
          {_RANDOM[6'h24][31:18], _RANDOM[6'h25], _RANDOM[6'h26][17:0]};
        io_out_bits_perfDebugInfo_r_enqRsTime =
          {_RANDOM[6'h26][31:18], _RANDOM[6'h27], _RANDOM[6'h28][17:0]};
        io_out_bits_perfDebugInfo_r_selectTime =
          {_RANDOM[6'h28][31:18], _RANDOM[6'h29], _RANDOM[6'h2A][17:0]};
        io_out_bits_perfDebugInfo_r_issueTime =
          {_RANDOM[6'h2A][31:18], _RANDOM[6'h2B], _RANDOM[6'h2C][17:0]};
        io_out_bits_perfDebugInfo_r_writebackTime =
          {_RANDOM[6'h2C][31:18], _RANDOM[6'h2D], _RANDOM[6'h2E][17:0]};
        io_out_bits_perfDebugInfo_r_runahead_checkpoint_id =
          {_RANDOM[6'h2E][31:18], _RANDOM[6'h2F], _RANDOM[6'h30][17:0]};
        io_out_bits_perfDebugInfo_r_tlbFirstReqTime =
          {_RANDOM[6'h30][31:18], _RANDOM[6'h31], _RANDOM[6'h32][17:0]};
        io_out_bits_perfDebugInfo_r_tlbRespTime =
          {_RANDOM[6'h32][31:18], _RANDOM[6'h33], _RANDOM[6'h34][17:0]};
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_out_bits_res_fflags =
    (_GEN_3[0] ? _vfdivs_0_io_fflags_o[4:0] : 5'h0)
    | (_GEN_3[1] ? _vfdivs_0_io_fflags_o[9:5] : 5'h0)
    | (_GEN_3[2] ? _vfdivs_0_io_fflags_o[14:10] : 5'h0)
    | (_GEN_3[3] ? _vfdivs_0_io_fflags_o[19:15] : 5'h0)
    | (_GEN_3[4] ? _vfdivs_1_io_fflags_o[4:0] : 5'h0)
    | (_GEN_3[5] ? _vfdivs_1_io_fflags_o[9:5] : 5'h0)
    | (_GEN_3[6] ? _vfdivs_1_io_fflags_o[14:10] : 5'h0)
    | (_GEN_3[7] ? _vfdivs_1_io_fflags_o[19:15] : 5'h0);
