...
module RefillUnit(
  ...
  wire         io_refillBufWrite_valid_0 = _io_refillBufWrite_valid_T & last;
  reg          zero;
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      zero <= (~io_refillBufWrite_valid_0 | io_sinkD_bits_data == 256'h0) & zero;
    end
  ...
  assign io_refillBufWrite_valid = io_refillBufWrite_valid_0;
