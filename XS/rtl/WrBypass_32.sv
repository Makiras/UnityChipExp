...
module WrBypass_32(
  ...
  wire       _GEN_1 = hit_idx == 3'h0;
  wire       _GEN_2 = hit_idx == 3'h1;
  wire       _GEN_3 = hit_idx == 3'h2;
  wire       _GEN_4 = hit_idx == 3'h3;
  wire       _GEN_5 = hit_idx == 3'h4;
  wire       _GEN_6 = hit_idx == 3'h5;
  wire       _GEN_7 = hit_idx == 3'h6;
  wire [2:0] state_reg_touch_way_sized = hit ? hit_idx : enq_idx;
  wire       _GEN_8 = enq_idx == 3'h0;
  wire       _GEN_9 = enq_idx == 3'h1;
  wire       _GEN_10 = enq_idx == 3'h2;
  wire       _GEN_11 = enq_idx == 3'h3;
  wire       _GEN_12 = enq_idx == 3'h4;
  wire       _GEN_13 = enq_idx == 3'h5;
  wire       _GEN_14 = enq_idx == 3'h6;
    ...
    if (reset) begin
      ...
      if (io_wen) begin
        if (hit) begin
          ...
          valids_0_0 <= io_write_way_mask_0 & _GEN_8 | ~_GEN_8 & valids_0_0;
          valids_0_1 <= io_write_way_mask_1 & _GEN_8 | ~_GEN_8 & valids_0_1;
          valids_1_0 <= io_write_way_mask_0 & _GEN_9 | ~_GEN_9 & valids_1_0;
          valids_1_1 <= io_write_way_mask_1 & _GEN_9 | ~_GEN_9 & valids_1_1;
          valids_2_0 <= io_write_way_mask_0 & _GEN_10 | ~_GEN_10 & valids_2_0;
          valids_2_1 <= io_write_way_mask_1 & _GEN_10 | ~_GEN_10 & valids_2_1;
          valids_3_0 <= io_write_way_mask_0 & _GEN_11 | ~_GEN_11 & valids_3_0;
          valids_3_1 <= io_write_way_mask_1 & _GEN_11 | ~_GEN_11 & valids_3_1;
          valids_4_0 <= io_write_way_mask_0 & _GEN_12 | ~_GEN_12 & valids_4_0;
          valids_4_1 <= io_write_way_mask_1 & _GEN_12 | ~_GEN_12 & valids_4_1;
          valids_5_0 <= io_write_way_mask_0 & _GEN_13 | ~_GEN_13 & valids_5_0;
          valids_5_1 <= io_write_way_mask_1 & _GEN_13 | ~_GEN_13 & valids_5_1;
          valids_6_0 <= io_write_way_mask_0 & _GEN_14 | ~_GEN_14 & valids_6_0;
          valids_6_1 <= io_write_way_mask_1 & _GEN_14 | ~_GEN_14 & valids_6_1;
      ...
      ever_written_0 <= io_wen & ~hit & (_GEN_8 | io_wen & _GEN_8) | ever_written_0;
      ever_written_1 <= io_wen & ~hit & (_GEN_9 | io_wen & _GEN_9) | ever_written_1;
      ever_written_2 <= io_wen & ~hit & (_GEN_10 | io_wen & _GEN_10) | ever_written_2;
      ever_written_3 <= io_wen & ~hit & (_GEN_11 | io_wen & _GEN_11) | ever_written_3;
      ever_written_4 <= io_wen & ~hit & (_GEN_12 | io_wen & _GEN_12) | ever_written_4;
      ever_written_5 <= io_wen & ~hit & (_GEN_13 | io_wen & _GEN_13) | ever_written_5;
      ever_written_6 <= io_wen & ~hit & (_GEN_14 | io_wen & _GEN_14) | ever_written_6;
      ever_written_7 <=
