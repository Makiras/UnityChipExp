  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        perfVec_1_eliminatedMove = _RANDOM[5'h7][7];
        perfVec_1_renameTime = {_RANDOM[5'h7][31:8], _RANDOM[5'h8], _RANDOM[5'h9][7:0]};
        perfVec_1_dispatchTime = {_RANDOM[5'h9][31:8], _RANDOM[5'hA], _RANDOM[5'hB][7:0]};
        perfVec_1_enqRsTime = {_RANDOM[5'hB][31:8], _RANDOM[5'hC], _RANDOM[5'hD][7:0]};
        perfVec_1_selectTime = {_RANDOM[5'hD][31:8], _RANDOM[5'hE], _RANDOM[5'hF][7:0]};
        perfVec_1_issueTime = {_RANDOM[5'hF][31:8], _RANDOM[5'h10], _RANDOM[5'h11][7:0]};
