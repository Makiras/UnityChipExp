...
module TLXbar_2(
  ...
  wire        _in_1_b_valid_T = auto_out_0_b_valid | auto_out_1_b_valid;
  reg         state_5_0;
  reg         state_5_1;
  reg         state_5_2;
  reg         state_5_3;
  ...
  wire        in_1_b_valid =
    beatsLeft_5
      ...
      : _in_1_b_valid_T | auto_out_2_b_valid | auto_out_3_b_valid;
  ...
  `ifndef SYNTHESIS
    ...
    always @(posedge clock) begin
      ...
      if (~reset
          & ~(~(_in_1_b_valid_T | auto_out_2_b_valid | auto_out_3_b_valid) | winner_5_0
              | winner_5_1 | winner_5_2 | winner_5_3)) begin
        if (`ASSERT_VERBOSE_COND_)
          $fwrite(32'h80000002, "Assertion failed\n    at Arbiter.scala:79 assert (!valids.reduce(_||_) || winner.reduce(_||_))\n");
        if (`STOP_COND_)
          xs_assert_v2(`__FILE__, `__LINE__);
