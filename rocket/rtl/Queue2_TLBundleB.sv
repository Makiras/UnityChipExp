...
module Queue2_TLBundleB(	// src/main/scala/chisel3/util/Decoupled.scala:243:7
  ...
  ram_2x39 ram_ext (	// src/main/scala/chisel3/util/Decoupled.scala:256:91
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_address, 5'h6, io_enq_bits_param})	// src/main/scala/chisel3/util/Decoupled.scala:256:91
  );
  ...
  assign io_deq_bits_size = _ram_ext_R0_data[4:2];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  assign io_deq_bits_source = _ram_ext_R0_data[6:5];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  assign io_deq_bits_address = _ram_ext_R0_data[38:7];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
endmodule
