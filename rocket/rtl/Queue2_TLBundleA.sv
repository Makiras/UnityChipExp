...
module Queue2_TLBundleA(	// src/main/scala/chisel3/util/Decoupled.scala:243:7
  ...
  ram_2x42 ram_ext (	// src/main/scala/chisel3/util/Decoupled.scala:256:91
    ...
    .W0_clk  (clock),
    .W0_data
      ({io_enq_bits_mask, io_enq_bits_address, io_enq_bits_source, io_enq_bits_size})	// src/main/scala/chisel3/util/Decoupled.scala:256:91
  );
  ...
  assign io_deq_bits_source = _ram_ext_R0_data[4:3];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
  assign io_deq_bits_address = _ram_ext_R0_data[33:5];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91
